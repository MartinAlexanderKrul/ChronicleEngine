...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13, for portrait reference — no physical description existed in canon prior to this note.** Forties, compact and weathered, the look of someone who came up on the Red Line Corridor's shop floor rather than a boardroom — a well-worn Ironline jacket, sleeves pushed to the elbow, hands that have handled crates as often as contracts. Fast, warm, appraising eyes that miss nothing about you. **Extended 2026-09-23 (real date), for portrait reference:** White, Irish-American, compact and weathered. Short dark-red hair going grey, cut practically; sharp green eyes with deep laugh lines; a few freckles. The well-worn Ironline jacket over a plain grey T-shirt. Reference setting: the Ironline guild hall on the Red Line Corridor, crates and a loading dock blurred behind her, warm industrial light."
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13, for portrait reference — no physical description existed in canon prior to this note.** Nondescript on purpose — average height, forgettable clothing, the studied blandness of a man who has spent a career being the person nobody remembers afterward. Restless eyes that never stop tracking a room's exits, a fast, low, reassuring voice that never quite settles into a straight answer. **Extended 2026-09-23 (real date), for portrait reference:** White, of indeterminate middle age. Short dark hair that is neither neat nor messy; restless grey eyes; a clean-shaven face that is hard to recall a minute later. A plain dark windbreaker over a grey hoodie. Reference setting: the back booth of an all-night Chicago diner, blurred counter and neon in the window behind him."
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13, for portrait reference — no physical description existed in canon prior to this note.** Late thirties, polished in an imported American style — expensive fitted suit, easy first-name confidence — laid over a Prague bluntness that surfaces when he's rattled. A salesman's warm handshake and a hot-running, slightly too-eager energy underneath it. **Extended 2026-09-23 (real date), for portrait reference:** Czech, tall and broad-shouldered. Dark-blond hair cut in a sharp American style; restless light-blue eyes; a wide, practised smile. A slate-grey fitted suit and open-collared white shirt, a Horizon Guild — Europe lapel pin. Reference setting: the Horizon Guild — Europe Prague branch office, a glass-walled lobby with Prague's rooftops blurred behind him."

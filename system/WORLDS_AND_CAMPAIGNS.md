...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0006` | 2026-07-26 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 2 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0006`** (captured 2026-07-26, mid-way through a second C-grade harvest job, on a mandatory break). Protagonist Alexander Pendragon cleared his first Gate as a striker (Red Line Corridor, true grade E), then pivoted to harvest/support work once the corrected rule (`EVT-000062`, world-rule commit `d53114b`) established that his E-card only caps strike/combat contracts, not harvest work at any grade. He completed a C-grade harvest job at the Cicero Scar (`EVT-000063`; 7 declared C-crystals, ≈$5,700 pending, plus 170 undeclared System-shop gold from a private sale unknown to anyone) and is mid-way through a second C-grade job, the Frozen Gallery (`EVT-000064`, `EVT-000065`, `EVT-000066`): three vein assignments worked, 104 crystals mined, 63 in the current declarable count, and four undeclared private sales of 12 crystals each — total private gold now 8,330, unknown to anyone. A deliberately performed exhaustion drew a genuine mandatory break from site coordinator Dale, during which Alexander studied the strike element's tactics, gaining an externally-observed combat framework unknown to any NPC. He is a Bearer, Level 2, XP 60/200, 0 unspent stat points (Strength 13, Agility 12, Vitality 10, Perception 11, Intelligence 10), daily-quest streak 2/7 with a pending grant (+3 stat points & full restore) unaccepted — unknown to everyone. The checkpoint was captured under **Gatefall World Rule Profile 1.0, a workshop draft (unfrozen)** — restoring it surfaces the *unfrozen — not save-trustworthy* warning (Rules Section 14.6, Decision 074). The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` restores `900_CHECKPOINT_0006`.

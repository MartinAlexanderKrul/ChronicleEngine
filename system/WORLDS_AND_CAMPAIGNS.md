...
| `worlds/gatefall/` | 0.1 (World Rule Profile 1.4) | Active | 1 | `/system` |
...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0010` | 2026-07-28 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 2 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0010`, captured mid-combat** (2026-07-28, Alexander inside a Gate fighting a wounded elite — restoring resumes directly into the fight). Protagonist Alexander Pendragon cleared his first Gate as a striker (Red Line Corridor, true grade E), pivoted to harvest/support work (`EVT-000062`), completed two C-grade harvest jobs (Cicero Scar, Frozen Gallery — ≈$24,663 harvest share, his largest payout, alongside ≈$2,313 and ≈$5,700), and privately accumulated 25,330 gold across seven undeclared System-shop sales, unknown to anyone. On his 2026-07-27 rest day he bought a C-grade dagger and an instant-dungeon key (gold 22,520), and arranged a fifth crew slot with striker Priya Okafor.\n\n  On **2026-07-28** he entered Okafor's posted Gate — assessed low-confidence D, resolved on entry to **true grade C**, a real mismatch for the 5-hunter waiver-tier crew (Julian, Renata, Owen newly met; archetype Ashfield, population 12 common/1 elite/1 boss). He killed his first beast solo above his own System tier, taking a near-lethal hit (historical Health 0/40) that he survived only by claiming a banked daily-quest grant mid-collapse — the underdog-bonus XP crossed him to **Level 3**. He then dual-wielded both daggers (summoning the C-grade one mid-motion, twice now directly observed by Owen without comment) to stop the Gate's elite after crew lead Priya fumbled her own intercept and was wounded. The elite is wounded but active; the boss is unencountered; combat is ongoing.\n\n  The live campaign explicitly adopted frozen **World Rule Profile 1.4** through `EVT-000072`–`EVT-000074` before the next exchange. Migration removed historical daily XP, leaving Level 3 at **80/300**, and settled completed-level growth and the pending Level 3 recovery: base Stats are 18/14/12/13/12, effective Stats 18/23/15/13/12, Health 60/60, Mana 24/24, and 10 stat points are unallocated. All four completed dailies include off-screen squat sets and preserve streak 4; pending rewards are Ability Points +3, one Status Recovery, and four unopened Daily Random Boxes. Its C/E Quickknives carry weapon power 7/2; E Bastion torso/hands/legs armor produces 8.7% physical reduction. The current six-offer Daily Premium cycle remains Spellthread Focus [E], Adaptive Watcher Torso [C], Ascendant Heartward Sigil [D], Quicksilver Phial, Dagger Mastery Rune [E], and Runic Key [D], all unpurchased. Checkpoint 0010 remains immutable under 1.1; restoring it must reapply the recorded 1.1→1.2→1.3→1.4 migrations before play. The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` targets `900_CHECKPOINT_0010`.

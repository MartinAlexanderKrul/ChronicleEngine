...
**Checkpoints:** 84 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0084`)
...
**Latest capture:** `900_CHECKPOINT_0084` — kind `manual`, profile 1.71 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0083`, source `EVT-000497`.

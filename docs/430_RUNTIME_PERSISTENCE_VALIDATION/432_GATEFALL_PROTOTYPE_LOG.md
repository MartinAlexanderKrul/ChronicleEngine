...
**Checkpoints:** 64 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0064`)
...
**Latest capture:** `900_CHECKPOINT_0064` — kind `manual`, profile 1.47 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0063`, source `EVT-000354`.

...
```yaml
current_funds:
  as_of_event: EVT-000687
  as_of_game_date: "2026-08-23T23:30:00-05:00"
  cash_usd: 329287.22
  gold: 732481
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**2026-08-23 09:52-23:30 (`EVT-000680`-`EVT-000687`): no money moved in either direction.** Gold holds at 732,481, cash $329,287.22. Two items given away free — Skill Rune Mend [D-Rank] and one Elixir of a Stat, both to Owen Callahan — neither a sale. Prior: **2026-08-23 04:42-09:52 (`EVT-000671`-`EVT-000678`): no money moved in either direction.** Gold holds at 732,481 and cash at $329,287.22. Two objects were claimed free this span — the unclassified warm object (`ENT-000220`) and the eleven correlation logbooks (`ENT-000221`) — both recorded on `100_CHARACTER_SHEET.md`'s Special group, neither a purchase, sale, or declared income. Prior: **2026-08-23 04:15-04:42 (`EVT-000665`-`EVT-000670`): no money moved in either direction.** Gold holds at 732,481 and cash at $329,287.22; nothing was bought, sold, or declared. **Three non-monetary movements are recorded on the character sheet rather than here**: three Greater Mana Potions in from the Daily Random Box (`EVT-000665`), the **mana-null disc left behind** on the slab at the Cicero warp heart (`EVT-000666`), and the taken hand-instrument's pinned Meridian reading **overwritten** by a fresh cycle at the same spot. Prior: **2026-08-22 18:00 — gold 319,661 -> 330,881** (+11,220 g, 66 C-Rank crystals from the fourth instance). Net across the whole C-Rank run: 30,000 g in keys against 43,350 g of crystal sales, a 10,000 g resale rune and a spare key still banked. Prior: **2026-08-22 16:00-17:30 — gold 317,531 -> 287,531 -> 319,661; cash unchanged.** Out: **-30,000 g** on three Instant-Dungeon Keys [C-Rank] at 10,000 g each (`EVT-000624`). In: **+32,130 g** for 189 Mana Crystal [C-Rank] at 170 g (`EVT-000627`). **C-Rank pays for itself where D-Rank did not** — and a 10,000 g resale rune and a free [C-Rank] key came out on top of it. Prior: **2026-08-22 14:45-16:00 — gold 313,341 -> 302,091 -> 317,531; cash unchanged at $329,287.22.** Out: **-11,250 g** on five Instant-Dungeon Keys [D-Rank] at the Section 12.5 catalogue price of 2,250 g each (`EVT-000616`). In: **+5,440 g** for 136 Mana Crystal [D-Rank] at 40 g, and **+10,000 g** for the banked Skill Rune — Keen Sense [C-Rank] at 50% of its 20,000 g anchor (`EVT-000618`). **Net +4,190 g on the afternoon**, against 2,900 XP and a level. **A Runtime error is corrected here rather than buried:** the shop was twice asserted to buy crystals only, and the run was priced as a 2,510 g loss on that basis. Section 12.5's **Resale** paragraph repurchases catalogue equipment at 25% and unused consumables, runes and keys at 50%, refusing only named artifacts, commissioned gear, broken gear, mundane possessions, **cores**, and story objects — which this ledger's own core lines already said. Thirteen D-Rank cores and four instructional drops remain unsold. Prior: **Cash 287,587.22 -> 329,287.22**: +$52,500.00 as Ada Reyes's Cicero Scar declaration finally cleared (`EVT-000609`, filed 2026-08-20, well past the standard 1-2 business day window), then -$10,800 at Walt Adamik's (`EVT-000611`: mana-null disc $1,800, 400-capacity mana-storage cell $9,000). **Gold 367,341 -> 313,341**: -30,000 for the Adaptive Gale Torso [A-Rank] (Daily Premium Cobalt cycle) and -24,000 for a catalogue Arcanist Feet [A-Rank], both at `EVT-000609`. USD and gold do not exchange (Profile Section 12.5). No pending payouts outstanding."
```
...
## This Checkpoint's Movement (`EVT-000646`-`EVT-000653`)

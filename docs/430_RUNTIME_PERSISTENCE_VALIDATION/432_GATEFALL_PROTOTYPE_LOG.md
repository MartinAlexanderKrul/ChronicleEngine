...
**Checkpoints:** 140 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0140`)
...
| frozen | 0009–0140 | 132 |

**Latest capture:** `900_CHECKPOINT_0140` — kind `session-save`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0139`, source `EVT-000901`.

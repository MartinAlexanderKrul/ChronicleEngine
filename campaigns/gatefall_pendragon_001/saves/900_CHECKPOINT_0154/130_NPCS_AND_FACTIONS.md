...
state: "Live, active. Retainer $5,000/month, drafting the guild-founding framework; owes nothing further until Alexander confirms his two board nominees. Disclosed to her Coalition supervisor for transparency."
...
history: "Formed `EVT-000986`, the same call that closed his Coalition affiliation."
```
...
history: "Introduction via Renata Okonkwo-Vance, `EVT-000847` (2026-09-05). First direct contact `EVT-000909` (2026-09-10). Meeting confirmed by text, `EVT-000917` (2026-09-11). First in-person meeting, network pitch, and teleportation disclosure, `EVT-001015` (2026-09-16)."
```
...
state: "Independent board seat on the Pendragon Guild accepted, `EVT-001009` — full vote, no guild membership, tested on whether it could really overrule Alexander before she said yes. Accepted the Thursday Prague meeting invitation. No relationship history beyond this one meeting."
...
history: "Formed 2026-09-16 (`EVT-001009`), first meeting, Denver, arranged same-day via Kane's phone call."
```

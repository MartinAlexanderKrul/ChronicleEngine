...
canonical_state:
  ...
  situation: "About ten days licensed. As of 2026-07-23 he is no longer unaffiliated: Tanya Voss took him onto her five-hunter Red Line Corridor crew (`REL-000063`) after he committed at the Coalition case table, and the contract is signed and filed with BGM Region V. He has bought his first hunter-grade kit (four E-grade items, $2,000) and spent the day before the clear training with it. As of 08:00 2026-07-24 he is at the Red Line Corridor Gate entrance with the crew, about to enter his first Gate — the first real test of the reputation that called him the city's weakest E-rank."

...
**Checkpoints:** 151 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0151`)
...
| frozen | 0009–0151 | 143 |

**Latest capture:** `900_CHECKPOINT_0151` — kind `session`, profile 1.116 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0150`, source `EVT-000992`.

...
**Checkpoints:** 70 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0070`)
...
**Latest capture:** `900_CHECKPOINT_0070` — kind `manual`, profile 1.57 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0069`, source `EVT-000405`.

...
Assert-Contains $profile 'World Rule Profile 1\.40' 'Gatefall profile is not version 1.40.'
...
Assert-Contains (Get-MigrationRecord '1.39' '1.40') '1\.39.+1\.40 compatibility treatment' 'The 1.39 to 1.40 migration record lacks its treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.40' 'Gatefall README does not advertise Profile 1.40.'
...
Assert-Contains $character 'profile_version: "1\.40"' 'Live Gatefall character has not adopted Profile 1.40.'

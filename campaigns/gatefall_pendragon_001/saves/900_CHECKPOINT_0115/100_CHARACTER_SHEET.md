...
provenance:
  source: EVT-000658
  game_date: "2026-08-23T03:58:00-05:00"
...
canonical_state:
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-23T03:58:00-05:00"
      mana_recovery_mode: active
      mana_recovery_remainder_units: 0
      health_recovery_mode: light
      health_recovery_remainder_units: 0
      note: "**Settled at the promotion barrier (`EVT-000658`), anchor 2026-08-22 23:55 -> 2026-08-23 03:58** - four hours three minutes, crossing midnight. Mode **active** throughout: walking a flooded gallery, working an investigation and holding an anchor is not rest and none is invented. **No damage taken at any point**, so Health never left cap. Five Mana spent (Keen Sense 1, Silent Step 4) against Conduit [S]'s continuous in-scene accrual at 35%/hr of a 1,386 pool, which absorbs it many times over. Both pools close at the level-43 maxima **2,756/2,756** and **1,386/1,386**, remainders zero at cap. Prior anchor movements are narrated by the promotion Events that moved them and by `170_CHANGELOG.md`."
    ...
    tracked_counters:
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 44 }
      ...
      - { path: skills.dimensional_projection.successful_uses, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 26 }
      - { path: skills.dimensional_projection.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 15 }
      ...
      - { path: skills.rift_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000519, current_value: 12 }
    ...
    inventory:
      ...
      materials:
        ...
        - "**Mana Crystal [D-Rank] × 60** — was 50; **+10 corrected at `EVT-000624`**, `Prospector`'s +2-per-deposit having been dropped across all five D-Rank instances (`F-017`)."

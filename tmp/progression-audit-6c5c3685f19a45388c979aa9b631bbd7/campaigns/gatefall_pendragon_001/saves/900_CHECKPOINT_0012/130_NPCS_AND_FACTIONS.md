...
canonical_state:
  ...
  condition: "Wounded but functional — thrown hard by the elite's lunge after a fumbled intercept (`EVT-000071`). Alexander gave her a lesser healing potion before the boss fight (`EVT-000079`), restoring her Health enough to fight properly; the underlying wound's severity was untouched (Profile Section 6.4) and she still favors the side. Untreated by Owen, who spent his one used touch on Alexander instead."

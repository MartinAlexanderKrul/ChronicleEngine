...
state: "**Attending Monday's crew training (2026-08-17, 18:00, the freight yard off Ashland) as an active evaluator, not a courtesy visit.** Not committed, not signed, and explicit that she is judging the crew on what she sees rather than on the invitation — the same condition she gave Kesha Morrison six weeks running. Alexander closed by telling her to be ready to show something herself, which she accepted. **Unresolved on Alexander's side:** he stated privately to Owen that he is 'not sure about her,' which Owen disputed on the spot; nothing about that has been said to Reyna."
history: "Named by Kesha Morrison 2026-08-11 (`EVT-000273`) as the first real candidate for the crew; contacted by text the same evening (`EVT-000298`); declined a faster solo meeting in favour of waiting five days to see both crew leads together (`EVT-000306`). First met in person 2026-08-15 at the Loyola lakefront (`EVT-000409`), a location chosen deliberately over a café, which she approved of unprompted."
```
...
state: "**Live working arrangement, first session Tuesday 2026-08-18 evening**, time to follow by text. Identification complete and **$800 owed, unpaid**. Research-and-teaching combined at $200/hour, 3-4 hour sessions, first three a mutual trial. **She holds the Dormant Core [S-Rank] in physical custody** as a non-negotiable condition — ownership unchanged, no return date agreed. Materials supplied by Alexander each session; a substantial deposit of intent already left on her bench. **Contact is direct rather than through Wade Bishop, at Alexander's explicit request** — she has his real personal number, not a disposable one, and copied it into her ledger under his name."

...
provenance:
  source: EVT-000713
  game_date: "2026-08-25 ~10:5x -05:00"
  real_date: "2026-08-25"
type: Character
subtype: artificer
scope: local
...
canonical_state:
  ...
  contents: "**Unread.** The newest volume was open on the desk mid-entry when taken; its content beyond that fact is not yet established canon. The other ten are unopened."
...
canonical_state:
  ...
  agenda: "Arranged the introduction to Desmond Farraday inside minutes of Alexander's request; handed off the B-Rank security escort at the door without a word exchanged. Gave a direct-line contact card. No further action recorded."
...
canonical_state:
  ...
  knowledge: "**What she knows about Alexander, and its single channel.** A source inside BGM Region V told her that a freelance hunter previously carded E-Rank was re-assessed and carded **S-Rank** at the Region V field office on the afternoon of 2026-08-23, and gave her his name. That is the whole of it, and it arrived roughly sixteen hours after the reading - **faster than the officer's own honest warning of guild attention within the week**, which means it was given rather than leaked slowly through regional logging.\n\n  **What she does not have.** No channel to the System, to any Bearer-only quantity on the Profile 14.4.1 register, to the Nakamura arrangement, to the fenced warehouse, `ENT-000216`-`ENT-000221`, the BGM cooperation arrangement, Wade Bishop, or the Ironline roster. She has not spoken to Alexander at all - the voicemail is one-way and unanswered. **She does not know whether the story is true**, which is precisely why she called."
  want: "**The story confirmed in his own words before she runs it.** She said so plainly and her conduct matches: two calls and a voicemail inside fifteen minutes, then nothing. Underneath it, the professional version - to be the reporter who had the first unaffiliated S-Rank in the country on the record rather than the one who printed a rumour."
  fear: "**Running it wrong.** She named this herself before naming anything else - *I know how that sentence sounds if it is wrong* - and it is what makes her callable rather than merely a hazard. The flaw it produces: silence reads to her as tacit confirmation rather than as a reason to stop, because a story she believes is true and cannot confirm still gets written, just without him in it."
  secret: "**Who inside Region V gave her the name.** Not established, and deliberately not authored here - it is the door rather than a field. What canon holds is only that the channel exists and moved inside sixteen hours."
  voice: "**States the awkward thing first and then explains why she is saying it** - the voicemail leads with the source and the claim, not with a greeting. Unhurried, no urgency tactics, no deadline. Offers the subject an out (*a lawyer or the Coalition, I will take that too*) in the same breath as the ask. Reads a callback number once and trusts it landed."
  beliefs:
    - claim: "Alexander Pendragon was carded S-Rank at BGM Region V on 2026-08-23."
      ground: "Told by a source inside Region V."
      confidence: confident
      accuracy: true
      since: EVT-000691
    - claim: "He will call back rather than let it run uncontested."
      ground: "Assumed from how subjects of this kind of story usually behave once they understand it is already moving."
      confidence: uncertain
      accuracy: unresolved
      since: EVT-000691
  agenda: "**Active; advances on the clock whether or not Alexander answers.** `Advanced` through **2026-08-24 06:03** - two calls (23:04, 23:19) and one voicemail, then deliberate silence. She is holding the story for his comment and has set no stated deadline, which is not the same as holding it indefinitely: her own `fear` makes an unanswered call read as tacit confirmation eventually rather than as a stop. **What she does next is hers, not Alexander's to trigger** - and nothing in canon yet establishes when her patience ends."
```

...
scope: world
# This save: EVT-001219, EVT-001222, EVT-001223, EVT-001224 (Gatefall: Pendragon -- Kane ENT-000242: the directors, the Director's memorandum, Europe and the EU notifications).
# Prior save: EVT-001213, EVT-001214 (Gatefall: Pendragon -- Kane ENT-000242: the morning to noon; attends the Director; the briefing).
# Prior save: EVT-001210, EVT-001211 (Gatefall: Pendragon -- Kane ENT-000242: the morning at Winnetka; the Director's meeting moved to tonight).
# Prior save: EVT-001200, EVT-001203 (Gatefall: Pendragon -- Kane ENT-000242: the alert, Asia and Europe, the map and the regulators).
# Prior save: EVT-001185, EVT-001190, EVT-001191, EVT-001193 (Gatefall: Pendragon -- Naomi Okafor ENT-000107 met, the annex
#   signed, the statement's existence learned; Kane ENT-000242, the Region V answer, the rota, the night). No closed-channel ruling.
# Prior save: EVT-001148, EVT-001155, EVT-001156, EVT-001158, EVT-001160 (Kane ENT-000242: beer night, the first
#   kiss and the night together, tasked with pushing the regulator permits personally). No closed-channel ruling.
# Prior save: EVT-001148, EVT-001150, EVT-001153 (Kane ENT-000242: the morning report and GB-58/GB-59 dispatch,
#   the London tunnel-access decision, beer-night arrival). One closed-channel ruling this span (Kane, Wade Bishop).
# Prior save: EVT-001111, EVT-001112, EVT-001114, EVT-001117 (Elena Cho ENT-000291 and Kane ENT-000242, lessons, the night, the errands).
...
**Fear/Flaw:** She is a career administrator terrified of the one thing her instruments keep telling her and her mandate cannot let her say aloud, so she manages the fear by burying its evidence — and mistakes the burial for control.

**Secret:** She holds the real, unpublished break-rate statistics, and she has reviewed incident-review logs from two anomalous clears in the district where the ranking sensors read a Gate empty and then registered a *second mana signature that appeared only after entry* — as if the trial materialized around the hunters inside. She has kept the logs off the record and the analysis unfunded, because opening the question invites a panic she has no answer for and no budget to survive.

**Agenda (this month):** Keep the Auction Desk's contract cadence moving fast enough that City Hall stops calling, without letting the Ranking Bench's confidence bands slip so thin that a mis-Rank kills a party and hands her the failure she has spent a decade avoiding — a squeeze the rising break rate makes worse every week.

**Relationships:** Eleanor "Nell" Foss (ENT-000111), her own senior appraiser, whose brand-anomaly report she quietly shelved. Preston Vaughn (ENT-000108, Horizon Guild) — crossing into industry — the major whose lobbyists lean on her auction cadence and whom she cannot afford to alienate before her next posting.

Okafor runs a meeting like a woman defusing something. She is unfailingly courteous, speaks in the passive voice of federal memoranda, and answers a hard question with the procedure that governs it rather than the fact behind it. A scene with her feels like being managed by someone very good at it — she gives you her full attention, remembers your name, concedes nothing, and leaves you certain she knows more than she said and equally certain you will never prove it. The only tell is the pause: ask her about the break rate directly and she takes a half-second too long before reaching for the published number.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Fifties, composed and immaculately turned out — a career administrator's tailored blazer, hair pulled back without a strand out of place. A face schooled into permanent courteous attention, the kind that gives away nothing until the half-second pause before a hard question."
  personality: "Courteous, procedural, controlled; manages fear by managing information."
  knowledge: "**Added `EVT-001185` (Gatefall: Pendragon):** met Alexander Pendragon in person; that Incident Review's line reviewer Harlan Boyce holds a signed statement from him on the lakefront Gate (its existence, not its content); the Pendragon Guild's modified dispatch annex, which she signed. Holds the real unpublished break-rate statistics; has reviewed incident logs showing Gates that read empty then registered a second mana signature only after entry, and has kept them off the record."
```

---

## Preston Vaughn — Horizon Guild

**Name / rank / role:** Preston Vaughn, not awakened — a pure corporate operator. Guildmaster and chief executive of Horizon Guild (ENT-000100), the publicly traded major, running the board, the trophy wall, and the ace's contract from the top floor of Horizon Tower (ENT-000092).

**Want:** To turn Horizon from Chicago's best guild into a global brand — and he has decided the move that does it is putting a *second* S-Rank under the Horizon name, on the other side of the Atlantic, before any rival thinks of it.

**Fear/Flaw:** He commands the most powerful hunters on Earth and cannot enter a Gate himself, which he compensates for by treating people as assets on a balance sheet — and he is starting to do it to the one asset that cannot be replaced.

**Secret:** He is the money and the will behind Horizon Europe's play for the Czech S-Rank — pushing his own European branch, over Continental Command's caution, to land Tereza Blažková as the marquee acquisition that makes Horizon a two-S-Rank global name. If it lands, it guts Karlov Guild and the CGA's whole retention strategy in one signature; Vaughn regards that as someone else's problem.

**Agenda (this month):** Manufacture a populist counter to Ironline's recruiting before the pipeline story reaches an earnings call, while quietly wiring the resources and the cover his Prague branch needs to move on Blažková without the acquisition showing up on Horizon's public books yet.

**Relationships:** Dominic Crane (ENT-000109), his ace and his brand, whom he is beginning to over-schedule. Ondřej Dušek (ENT-000117, Horizon Guild — Europe) — crossing into the separately run European entity — his instrument in Prague. Naomi Okafor (ENT-000107, BGM Region V) — crossing into the regulator — whose auction cadence he pressures through lobbyists.

Vaughn is warm in the way of a man who has closed a great many deals across a great many tables. He calls hunters "talent," calls the ace "our franchise," and can make a contract that halves your leverage sound like a favor he pulled strings for. A scene with him is smooth and slightly airless — he agrees with you, flatters your position, and somewhere in the geniality the terms have shifted his way. He never raises his voice because he has never been in a room where he needed to; the tower does the intimidating for him.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Sixties, silver-haired, the polished ease of old money and older deals — a bespoke suit that never quite looks tailored because it always looks natural on him. Warm, practiced smile, the specific charm of a man who has never once needed to raise his voice to get what he wants. **Extended 2026-09-23:** White, tall and trim. Silver hair swept back with care; clear, amused blue eyes; a tan that suggests yachts rather than Gates. A navy bespoke suit, white pocket square, no tie. Reference setting: the top floor of Horizon Tower in Chicago, floor-to-ceiling windows and the city blurred behind him, golden evening light."
...
**Fear/Flaw:** The world's one iron law is that rank never changes, and Crane has begun to feel himself slipping *inside* it — and an S-Rank who fears he is fading has no one he can say it to, because he is a policy, not a person, to everyone who depends on him.

**Secret:** He has been quietly paying appraiser Nell Foss to re-measure him off the books, outside any BGM procedure, trying to prove to himself that his pool hasn't shrunk — the exact re-measurement machinery the exposure pipeline runs on, turned inward by the one man in the city who should have nothing to fear from it. If it ever surfaced that Horizon's ace was secretly testing his own rank, the stock would move on it.

**Agenda (this month):** Take only the clears he is sure of and let the Ace's Circle wave off the marquee contracts Investor Relations keeps pushing, buying time to settle the question of whether the slip is real before anyone with a camera notices.

**Relationships:** Preston Vaughn (ENT-000108), his guildmaster, who is scheduling him harder than the Ace's Circle thinks is safe. Eleanor "Nell" Foss (ENT-000111, BGM Region V) — crossing into the regulator — his off-book appraiser and the only person who knows his private fear.

Crane is quieter in a room than his press suggests — the public swagger is a costume he can put on for a camera and takes off the moment the lens is gone. One-to-one he is watchful, a little formal, and genuinely decent to lower-ranks, which reads as humility and is closer to hunger: he is looking at working hunters wondering what it feels like to still be climbing. A scene with him has a held-breath quality, a big man being careful, until the subject touches ability or measurement and something in him goes very still.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Big — a Horizon marquee ace's frame, built for cameras and boss chambers alike — with the guarded stillness of someone privately auditing every inch of himself. Short black hair, precisely barbered; dark brown eyes; clean-shaven with a squared jaw and a nose broken once and reset, giving it a slight leftward set that no amount of guild PR photography quite hides. Off-duty in a fitted black quarter-zip and dark tailored trousers, camera-ready even at rest — nothing that would look out of place walking straight from a gym onto a stage. Handsome in a magazine-cover way that photographs better than it feels in the room; watchful eyes that go very still the moment ability or measurement comes up. Reference setting: just off a lit press stage, a blurred Horizon Guild step-and-repeat and stage lights behind him, the practiced calm of someone about to be photographed."
...
**Relationships:** Preston Vaughn (ENT-000108, Horizon Guild) — crossing into her chief rival — whose pipeline she embarrasses one hire at a time. Eleanor "Nell" Foss (ENT-000111, BGM Region V) — crossing into the regulator — the appraiser whose re-measurement request she is quietly working to keep off her hidden recruit.

Brannigan talks like the shop floor she came off — fast, profane, funny, allergic to corporate euphemism — and she remembers the name of every hunter she has ever staged a party with. A scene with her feels like being taken seriously by someone with no time to waste: she'll buy you a coffee off a folding table, ask exactly the right question about your last clear, and offer you a deal before you've decided you want one. The warmth is real. So is the calculation underneath it, and the better she likes you, the harder she is already working out what you're worth.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Forties, compact and weathered, the look of someone who came up on the Red Line Corridor's shop floor rather than a boardroom — a well-worn Ironline jacket, sleeves pushed to the elbow, hands that have handled crates as often as contracts. Fast, warm, appraising eyes that miss nothing about you. **Extended 2026-09-23:** White, Irish-American, compact and weathered. Short dark-red hair going grey, cut practically; sharp green eyes with deep laugh lines; a few freckles. The well-worn Ironline jacket over a plain grey T-shirt. Reference setting: the Ironline guild hall on the Red Line Corridor, crates and a loading dock blurred behind her, warm industrial light."
...
**Name / rank / role:** Eleanor "Nell" Foss, B-Rank Perception-class awakened, non-combatant. Senior licensed appraiser on BGM Region V's (ENT-000099) Ranking Bench — one of the people the whole ranking system rests on, who reads mana in beasts, hunters, loot, and Gates all on the one Rank. Her signature, **Provenance**, reads not just a signature's Rank but its history — age, old injury, wear — which is why her Ranks carry the bench's best confidence and why she cannot un-see what she has seen.
...
**Fear/Flaw:** Her gift is accuracy and her curse is that she cannot stop looking; she has seen something the bestiary cannot explain and cannot make herself un-see it, even as staying quiet would be far better for her career.

**Secret:** She has logged an old, *healed* weapon-wound and an identical seared brand on beast remains pulled from Gates on opposite sides of the planet — matches nothing in any BGM bestiary, and means the beasts had lives before these Gates. She wrote it up. Director Okafor shelved it. Foss kept her copy, and has told exactly one person who might listen.

**Agenda (this month):** Get her brand file in front of someone outside Region V's chain of command who won't bury it — an independent appraiser, a journalist, a hunter who has seen the same thing — while covering the off-book re-measurements she is doing for a client she will not name.

**Relationships:** Naomi Okafor (ENT-000107), her director, who shelved her report and signs her assignments. Dominic Crane (ENT-000109, Horizon Guild) — crossing into industry — the private client whose fading she is measuring in secret and whose fear she now shares a little of.

Foss is precise in a way that unnerves people — she notices the thing you were hoping she'd miss, and says it plainly, because a soft Rank is how hunters her clients' age die. She is dry, tired, and kind under the tiredness, the way people are kind when they've measured enough bad outcomes to stop pretending numbers are neutral. A scene with her feels like being read accurately, which is uncomfortable; she'll tell you your true Rank, your gear's true Rank, and — if she trusts you — the one Rank she can't get anyone above her to write down.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Fifties, unshowy and precise, the dry practicality of someone who spends her working life reading truths people would rather she missed. Sensible, well-worn clothes, tired eyes softened by real kindness, and the particular stillness of a person who notices exactly what you hoped she wouldn't. **Extended 2026-09-23:** Black, Chicagoan, of average height and softly built. Short natural hair gone mostly grey; tired but kind dark-brown eyes behind reading glasses; a small gold cross at the throat. A cardigan over a collared blouse, a BGM appraiser's badge. Reference setting: the BGM Region V appraisal wing in Chicago, measurement equipment and a quiet corridor blurred behind her."
...
**Fear/Flaw:** He is a coward with good instincts, which has kept him alive and small; his flaw is that he knows the smart play is to stay small and he can no longer stand it, so he is reaching for exactly the volume that gets fences like him noticed and prosecuted.

**Secret:** His westward pipeline runs through the Prague smuggler "Sova," and it is beginning to carry more than money — a core or two that read *wrong* on the one appraisal he risked, off any Rank he knows. He does not understand what he is moving; he only knows it prices like nothing else and that the people who want it do not haggle.

**Agenda (this month):** Consolidate the Chicago-to-Prague flow into something he controls rather than merely feeds, and find out — carefully, without spooking his buyers — why the anomalous cores are worth what they're worth.

**Relationships:** "Sova" (ENT-000118), his Prague counterpart and the far end of his westward lane. Denise "Dee" Brannigan (ENT-000110, Ironline Guild) — crossing into the licensed economy — whose Red Line low-ranks are where a good share of his undeclared cores come off, and who has so far found it convenient not to know his face.

Deacon talks fast and low, all reassurance and hedged promises, a man who has never once given a straight answer where a comforting one would do. He meets you somewhere with two exits and watches the near one the whole time. A scene with him is greasy and quick — he is friendly, he is useful, he will get you a price no licensed buyer can, and every word out of him is calibrated to keep you needing him and unable to trust him. Push him and he doesn't threaten; he simply isn't there the next time you look.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Nondescript on purpose — average height, forgettable clothing, the studied blandness of a man who has spent a career being the person nobody remembers afterward. Restless eyes that never stop tracking a room's exits, a fast, low, reassuring voice that never quite settles into a straight answer. **Extended 2026-09-23:** White, of indeterminate middle age. Short dark hair that is neither neat nor messy; restless grey eyes; a clean-shaven face that is hard to recall a minute later. A plain dark windbreaker over a grey hoodie. Reference setting: the back booth of an all-night Chicago diner, blurred counter and neon in the window behind him."
...
**Name / rank / role:** Miloš Beran, E-Rank awakened, career civil servant. Director of the Czech Gate Administration (ENT-000103) — the underfunded, proud national agency whose entire strategy is organized around keeping one person from leaving the country. His signature, **Letter-Perfect**, a modest E-Rank gift, keeps every page he has ever read exact in his memory — which is why nothing he has decided to bury needs to exist on paper for him to hold it.
...
**Fear/Flaw:** He is a small agency's director carrying a nation-sized secret and a nation-sized dependency, and his flaw is that he has confused holding the line with holding the truth down — he manages every crisis by making sure no one else can see it.

**Secret:** He has seen the Libeň analyst's chart — worldwide break frequency not rising but *doubling on a fixed interval*, a clean geometric curve that extended hits vertical in a nameable year. The analyst worked out of the trailer at the Libeň Scar (ENT-000096) and has stopped returning calls. The CGA has issued nothing, and Beran intends to keep it that way, partly to prevent panic and partly because a country that believes the clock is real will not spend a fortune retaining an S-Rank to fight it.

**Agenda (this month):** Squeeze the discretionary budget to make whatever contract Blažková is attached to go flawlessly, prop Karlov Guild up against the foreign bids just enough to keep her frame intact, and make sure the Libeň file stays a rumor among survey teams rather than a chart with a year on it.

**Relationships:** Tereza Blažková (ENT-000114, Karlov Guild) — crossing from regulator into guild — the one asset his whole agency exists to retain. Vlastimil Karlov (ENT-000115, Karlov Guild) — crossing into the guild — the local guildmaster he props up because a solvent Karlov is the frame that keeps the S-Rank in Prague.

Beran is courtly, anxious, and exhausting in his thoroughness — he answers a simple question with the full history of the policy and never quite arrives at the point, which is a technique, not a failing. He apologizes for the building, the budget, the coffee, and offers all three anyway. A scene with him feels like being received by a man performing calm over something that is keeping him up at night; the performance is good, but he touches the papers on his desk too often, squaring an edge that was already square.
...
**Fear/Flaw:** She has spent three years as everyone's argument — the CGA's insurance, Karlov's survival, the internationals' prize — and her flaw is that the resentment has curdled into a temptation to blow it all up just to prove she can, whatever it costs the people counting on her.

**Secret:** She has taken Horizon Europe's approach further than anyone home knows — met with Ondřej Dušek more than once, seen Zenith's numbers, and come genuinely close to signing away. She has told no one at Karlov and no one at the CGA. One signature ends Karlov Guild, guts the CGA's whole retention strategy, and turns the country's proudest fact inside out, and she is the only person who currently knows how near it is.

**Agenda (this month):** Decide — actually decide, after three years of being decided for — whether to stay and be Prague's forever or leave and be a hunter, while giving Karlov, the CGA, and Horizon Europe each just enough to keep her options open.

**Relationships:** Vlastimil Karlov (ENT-000115), her guildmaster, who trusts her loyalty more than he has any right to. Ondřej Dušek (ENT-000117, Horizon Guild — Europe) — crossing into the foreign intrusion — who is courting her hardest. Miloš Beran (ENT-000113, Czech Gate Administration) — crossing into the regulator — whose entire agency is built on her not doing what she is contemplating.

Blažková is plain-spoken to the point of rudeness, because she is the one person in any Prague room who cannot be compelled and she has stopped pretending otherwise. She is funny, restless, contemptuous of ceremony, and visibly bored by being told how important she is. A scene with her feels dangerous in a specific way — she is friendly and direct and entirely capable of doing whatever she likes, and everyone around her is arranging themselves to keep her happy while she watches them do it. She is kinder to nobodies than to officials; a hunter with no name gets her real attention where a director gets her patience.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Late twenties, athletic and unglamorous by design — a national celebrity who dresses like she'd rather be anywhere else being photographed. Short choppy dirty-blonde hair, growing out unevenly on purpose; green eyes; a light scatter of freckles across the nose and a single dimple, left cheek only, that shows even in her most unimpressed expressions. A faded band t-shirt and mismatched track pants, an old national-team jacket slung over one shoulder rather than worn. Restless energy, quick sharp eyes, an easy grin that shows exactly how bored she is with ceremony. Carries herself like someone permanently a half-step from walking out of the room. Reference setting: a worn Prague training hall, bare concrete and mismatched equipment behind her, unglamorous fluorescent light."
  personality: "Plain-spoken, restless, contemptuous of ceremony; resentment curdling toward self-destruction."
  knowledge: "Knows how close she has come to signing with a foreign guild — closer than anyone at Karlov or the CGA suspects; holds that decision alone. **2026-09-20 (`EVT-001033`, `EVT-001040`):** referred Alexander to Sanne Verhoeven for a same-day, quiet shoot, asking nothing about it; saw the finished cut at the Pendragon Guild's first board meeting and voted yes to air it; committed Czech Television national airtime. **2026-09-21 (`EVT-001045`, `EVT-001051`):** told by Alexander to move it to today, Europe-only if necessary; holds the cut file, walked it into Czech Television herself; relayed to Reinhardt and Aubrac. No channel to the Sorcha call or the lakefront Gate beyond public reports."
```
...
**Fear/Flaw:** His whole strength is that relationships and continuity still count in a small city, and his flaw is that he believes it so completely he cannot see the arithmetic closing in — he mistakes loyalty for a wall when it has become a bet.

**Secret:** He knows Blažková is being courted and suspects she is wavering, and he is hiding it — from the CGA, whose support depends on her staying, and from his own heir, whose modernizing panic he does not want confirmed. He is gambling the guild's future on being able to hold her on loyalty alone, and he has told no one that it is a gamble.

**Agenda (this month):** Keep Karlov winning enough Old Town heritage contracts to look like a guild worth staying in, refuse the three foreign approaches one more cycle, and hold Blažková close without letting her — or anyone — see how much of the guild's survival now rests on her not leaving.

**Relationships:** Ivana Karlová (ENT-000116), his heir, whose loyalty he counts on and whose judgment he overrides. Miloš Beran (ENT-000113, Czech Gate Administration) — crossing into the regulator — his patron and pressure, propping the guild up for reasons of state. Tereza Blažková (ENT-000114), his S-Rank and, secretly, his single point of failure.

Karlov is old-world courteous and immovable, a man who receives you under the photographs of everyone who built the thing you are asking him to change. He tells stories — about the Gatefall, about contracts signed with the grandfathers of today's officials — and the stories are the argument. A scene with him feels like sitting with living history that has decided history is enough; he is gracious, genuinely wise about the city, and closed as a vault on the one subject that matters. When the internationals come up he smiles and changes the subject to something that happened in 2016.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Sixties to seventies, old-world courteous, dignified in a slightly outdated way — good but unfashionable tailoring, a full head of grey hair, the calm gravity of a man who has been receiving guests under the same photographs for decades."
...
**Fear/Flaw:** She loves the guild enough to betray its principles for it, and cannot always tell the difference between saving the family and proving she was right — the resentment of an heir told to wait her turn sits under everything she does.

**Secret:** She has been meeting Ondřej Dušek of Horizon Europe behind the Family's back, exploring exactly the partnership her grandfather would call surrender — and, short of cash to move independently, she has quietly sold a few undeclared cores through the smuggler "Sova" to fund her own maneuvering. The heir to Prague's most principled guild is dealing with both the foreign intrusion and the black market at once, and believes she is doing it to save the house.

**Agenda (this month):** Get far enough into talks with Horizon Europe to bring the Family a deal it can't dismiss out of hand, before Blažková's situation or the foreign siege forces a worse one — and cover the small illicit sales keeping her liquid.

**Relationships:** Vlastimil Karlov (ENT-000115), her grandfather and guildmaster, whose refusal to change she is going around. Ondřej Dušek (ENT-000117, Horizon Guild — Europe) — crossing into the rival foreign guild — her secret counterpart. "Sova" (ENT-000118) — crossing outside every institution — her quiet source of off-book cash.

Ivana is quick, impatient, and better at the numbers than anyone else in Karlov House, which she knows and does not bother hiding. She argues in facts and margins where her grandfather argues in stories, and the collision between them is the guild's whole future in miniature. A scene with her feels like talking to someone running out of time who has decided you might be useful — she is candid past what's wise, testing whether you're an ally, and there is a raw nerve under the competence: she is doing something she is not sure she can live with and needs, badly, for it to work.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Thirties, sharp and quick-moving, modern professional dress that stands out against her guild's old-world furniture — the visible impatience of someone doing arithmetic on her family's future in real time. Candid, direct eyes, a raw nerve just under the competence. **Extended 2026-09-23:** Czech, slim and sharp-featured. Dark-brown hair in a sleek low ponytail; direct hazel eyes; a strong brow. A fitted black blazer over a white T-shirt, a smartwatch she keeps glancing at. Reference setting: a room in Karlov House, Prague, old-world furniture and framed photographs of the guild's founding blurred behind her."
...
**Fear/Flaw:** He is the local who left, resented as a traitor by the city he still lives in, and he manages that wound by needing to be proven right so badly that he over-promises upward — his flaw is ambition running ahead of what he can actually deliver.

**Secret:** His whole standing rests on the S-Rank play, and he has told Continental Command it is closer than it is, staking his own credibility on delivering Blažková this year. He is working two back-channels to do it — Ivana Karlová inside Karlov itself, and the parent's champion Preston Vaughn across the Atlantic — and if either collapses, or if Continental Command loses patience with the whole Prague adventure first, his position goes with it.

**Agenda (this month):** Convert his contacts into momentum before his own bosses' patience runs out — keep Blažková leaning toward signing, keep Ivana talking partnership, and keep Vaughn's backing warm — without letting the CGA see enough to start quietly favoring Karlov on every close call.

**Relationships:** Ivana Karlová (ENT-000116, Karlov Guild) — crossing into the rival local guild — his inside contact and a partnership he is dangling. Preston Vaughn (ENT-000108, Horizon Guild) — crossing to the American parent — his patron and the money behind the play. Tereza Blažková (ENT-000114, Karlov Guild) — crossing into Karlov's roster — his target.

Dušek is polished in the American style his branch imported — first names, easy confidence, a pitch for everything — laid over a Prague bluntness that surfaces when he's rattled. He knows exactly what the city thinks of him and has armored it into a kind of aggressive charm: *you'd have left too, for this money.* A scene with him feels like being recruited whether or not that's why you came; he is persuasive, genuinely well-funded, and running slightly too hot, a man selling a certainty he needs to be true more than he knows it is.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Late thirties, polished in an imported American style — expensive fitted suit, easy first-name confidence — laid over a Prague bluntness that surfaces when he's rattled. A salesman's warm handshake and a hot-running, slightly too-eager energy underneath it. **Extended 2026-09-23:** Czech, tall and broad-shouldered. Dark-blond hair cut in a sharp American style; restless light-blue eyes; a wide, practised smile. A slate-grey fitted suit and open-collared white shirt, a Horizon Guild — Europe lapel pin. Reference setting: the Horizon Guild — Europe Prague branch office, a glass-walled lobby with Prague's rooftops blurred behind him."
...
**Fear/Flaw:** She survives on being unseen and unmeasured, and her flaw is greed dressed as ambition: she has started moving cargo she should have refused because the money is too good to leave to a competitor, and each such job is a thread back to her.

**Secret:** She is moving artifacts and cores pulled from the Libeň Scar (ENT-000096) perimeter and from private hands that read *wrong* — one core carried an old healed scar and a seared brand matching nothing anyone will name — westward to buyers who pay for exactly that strangeness. She also knows which of her routes the CGA's enforcement has quietly chosen not to close, and she is careful never to ask why.

**Agenda (this month):** Lock down the anomalous-cargo lane before a rival smuggler or a CGA ranking official who stops looking away notices its value, and keep her Chicago end ("Deacon") and her local sources fed without any of them learning how the others connect.

**Relationships:** "Deacon" (ENT-000112) — the Chicago end of her westward lane, whom she keeps at arm's length. Ivana Karlová (ENT-000116, Karlov Guild) — crossing into the city's most principled guild — the unlikely client quietly selling her undeclared cores, whose secret is now also Sova's leverage.

Sova is quiet, watchful, and almost impossible to read — she gives a meeting the minimum words it needs and studies you for the whole of it. She never uses a name, never confirms more than she must, and has a way of making silence do the negotiating. A scene with her feels like being carefully assessed by someone deciding whether you are cargo, client, or risk; she is not threatening, exactly, but nothing about her invites a second unplanned question. What she moves, she moves without curiosity — except lately, about the cargo that prices like nothing else, which is the first thing in years to make her ask.
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Deliberately unmemorable — plain dark clothing, nothing that would stand out in a crowd or a photograph, the specific anonymity of someone whose whole trade depends on being hard to describe afterward. Quiet, watchful eyes that study you the entire length of a meeting and give nothing back. **Extended 2026-09-23:** Of indeterminate age and origin. Short dark hair under a plain knit cap; quiet, watchful grey eyes; an unremarkable face with nothing to hold onto. A dark wool coat with the collar turned up. Reference setting: a dim Prague side street at night, wet cobbles and a single streetlamp blurred behind him."
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13, for portrait reference — no physical description existed in canon prior to this note; revised the same day at the player's direction to specify a Black man, a deliberate authorial choice.** Late thirties, a Black man built like a camera-ready professional athlete — the kind of physique a federal PR office would put on a poster. Close-cropped black hair with a precise fade; dark brown eyes; a short beard trimmed tight to the jaw, and a small keloid scar along one cheekbone. A confident, practiced press-photo smile that doesn't quite reach eyes that look privately exhausted. Sharp, expensive-looking navy-and-silver tactical-branded gear with a national-hero aesthetic. Reference setting: before a blurred podium backdrop, soft federal-blue lighting and out-of-focus flags, studio-quality light."
...
canonical_state:
  ...
  appearance: "**Authored 2026-09-13 for portrait reference.** Forties, precise and controlled bearing, closer to an engineer than a showman. Steel-grey hair, cropped short and receding slightly at the temples; pale blue eyes; clean-shaven but for a thin white scar crossing one eyebrow from an old containment collapse. Cool, assessing expression, immaculately maintained slate-grey tactical gear built for methodical siege-and-containment work rather than flash, no patches or branding. Understated continental-European presentation. Reference setting: the edge of an industrial containment site, reinforced barriers and cool floodlighting behind him, overcast European daylight."
  personality: "Precise, courteous, immovable; a siege-everything caution that is half doctrine and half trauma."
  knowledge: "Knows Brandhof's true Prague objective is the acquisition of Karlov Guild itself, not the S-Rank the three internationals appear to be bidding for; is running the Blažková courtship as a feint. **Met Alexander in person 2026-09-17** (`EVT-001021`): told directly about teleportation including passenger transport (the fifth confirmed holder), the Pendragon Guild pitch, and offered/accepted a provisional independent board seat. **Concluded independently, without being told, that Alexander personally ended the Jiu Valley Exclusion** — read from the timeline, the scale, and Alexander's own lack of reaction to Cade naming it — and has not asked for confirmation. **Told directly, 2026-09-18 (Frankfurt), that Alexander's parents died in the Damen Avenue Break** when Alexander was fifteen. Confirmation of the Jiu Valley kill offered but deferred to a quieter venue, undated. First anchor in Germany set at Brandhof's own courtyard the same visit. **2026-09-20/21 (`EVT-001039`, `EVT-001040`):** told in full, at his own apartment in Frankfurt, that Alexander ended the Jiu Valley Exclusion — and how: Sorcha Bellweather walked him to the observation platform (her own lost trainees included), an anchor there, a concealed approach, a ~45,000-Health read, three Ruptures. **The only person told Sorcha's part; Sorcha does not know he knows.** Has seen the finished broadcast cut; voted yes to air it at the Pendragon Guild's first board meeting, his caveat about Sorcha's exposure standing; working German placement. **2026-09-21 (`EVT-001047`, `EVT-001051`):** placed it on ZDF *heute* at 19:00 and confirmed Alexander's identity to ZDF off camera; told Alexander had spoken to Sorcha that morning (no content). Offered Brandhof's Washington lawyers for her, through Alexander only."
```
...
scope: world
lifecycle: active
moved_by_events: "`EVT-000854` `EVT-000857` `EVT-001013` `EVT-001014` `EVT-001045` `EVT-001047` `EVT-001048` `EVT-001050` `EVT-001051` `EVT-001079` `EVT-001084` `EVT-001092` `EVT-001093` `EVT-001095` `EVT-001111` `EVT-001112` `EVT-001114` `EVT-001117` `EVT-001210` `EVT-001211` `EVT-001213` `EVT-001214` `EVT-001222` `EVT-001223` `EVT-001224`"
aliases:
  - name: "Elias Kane"
    quality: current
canonical_state:
  ...
  location: "**2026-10-01 evening: the Winnetka house, the study** (`EVT-001224`). Home: Chicago."
  ...
  knowledge: "Knows Alexander is a confirmed unaffiliated S-Rank. Knows the GB-14 incident and Alexander's own account of it — ten hunters dead, Alexander arrived carrying two survivors — told directly, 2026-09-06. Knows Alexander's teleportation capability including passenger transport, told directly the same evening; reacted with real professional weight about the value and danger of that information, advised discretion, did not push for mechanism detail. **Told directly 2026-09-12** that Alexander has been sitting on a large stockpile of money for some time, that his first personal purchase from it is the Winnetka house (bought the same day, no place else to sleep that night was the actual trigger), and — offered in a joking tone that didn't land as a joke to either of them — that money was previously spent running black-market-adjacent operations: building containment cages for S-Rank-class threats, overpaying artificers for off-book work. No specifics (no names, no locations, no amounts) were given; Kane filed it without alarm rather than pressing for detail, and shared in return that his own government salary has never made his apartment feel like his. **Told/confirmed 2026-09-13** that Alexander is the one who ended the Jiu Valley Exclusion — no method, no numbers, no names given; confirmed by tone and a half-joke rather than a flat statement, but Kane read it correctly and Alexander did not deny it. Kane's own reaction: not alarm, but real recalibration — the first time the scale of what Alexander actually is has landed on him personally rather than as an abstract fact. **Told 2026-09-13 (same morning) that Alexander has a boyfriend — Owen, not named by surname — that they fought seriously the night before (2026-09-12), and that Alexander does not currently see a future in it.** This is the first Kane has heard of Owen's existence at all. No detail beyond that given — no name beyond 'Owen', no specifics of the fight, no channel to Owen himself, the shared apartment, or anything else about that relationship. **Also told, same conversation:** the Jiu Valley kill was 'almost no challenge' for Alexander personally — no method, no numbers, just that scale of casual understatement. Kane's read: darkly amused, genuinely recalibrating Alexander's actual ceiling upward again. No channel to anything about the far side, the Ninth Quiet, the Rockwell bay, or any of Alexander's other private threads — nothing beyond what these three conversations have actually covered. **2026-09-20 (`EVT-001040`, `EVT-001041`):** has seen the finished broadcast cut (the Jiu Valley statement he already knew the fact behind, the guild pitch, the silent instant-dungeon footage — no channel to what the place was, and still none to the 2026-09-15 dungeons or the far-side circuits). Voted yes to air it; knows it targets 2026-09-22 and that Alexander will talk to Sorcha first. Stayed the night at Alexander's ask. **2026-09-21 (`EVT-001045`-`EVT-001051`):** read Mercer's newsletter himself; heard Alexander's side of Tereza's call (moved to today, Europe if need be); was on the balcony during the Sorcha call and has no channel to what was said in it; advised the self-published US release; ran with him, stood at the lakefront Gate, heard the tech read the drone's S, saw him walk out unhurt; watched it air beside him. **2026-09-24/25 (`EVT-001092`, `EVT-001093`, `EVT-001095`):** was told by Alexander that Elena Cho is a new S-Rank and *part of our S Rank family*; watched her arrive by touch-transport; told her the National register facts himself; heard the associate-agreement idea (1 USD, no obligations, walk-out at will); was asked to command the guild element on the Calumet A-Rank and accepted at once. He inferred her nervousness from her bag hopping in her hand and offered Standfast on her door himself. **He does not know her sleep episodes, and has no channel to the System, Flux Sight or anything Bearer-only.** Was not told of any Kesha shortlist (that line in play was a Runtime error, struck). **Added `EVT-001213`:** watched his own wet shirt vanish the instant it left his skin, in the boathouse sauna -- *that's new* -- and asked nothing; no mechanism, no name for it."
  want: "This morning, before anyone else's clock starts: one ordinary hour with Alexander that nobody scheduled. Then, once Washington opens (07:00 Chicago), to learn who at BGM National means to stop Tuesday's broadcast before they move -- the one job the board gave him (`EVT-001040`)."
  fear: "That he is, to Alexander too, a man kept on hand -- available, useful, and grateful for it, the shape every institution he has served has already given him. 'Friends' was his own answer on 2026-09-13 and he is afraid it was the true one."
  secret: "He already knows where BGM's resistance to the broadcast will come from -- the same National office that drafted the unofficial 'coordination visibility' reporting line on Alexander (`EVT-001002`) -- and that stopping it will spend the only leverage he holds there, his own post. He has not said that this is the price, because said aloud it becomes something Alexander owes him."
  voice: "Dry, easy, few words; teases without ever asking Alexander to account for his time. Understates everything, himself included. When something actually lands the dryness drops out completely, he says the plain thing once, and then changes the subject."
  beliefs:
    - claim: "BGM National's silence on his counter-terms is a stall he can outlast, not a refusal."
      ground: "Inferred from years of how the Bureau says no -- never in writing first; texted 'figures' on 2026-09-20 (`EVT-001033`)."
      confidence: confident
      accuracy: unknown
      since: EVT-001033
    - claim: "Alexander should air it; there is no version where keeping it quiet gets safer."
      ground: "Watched the cut and voted (`EVT-001040`)."
      confidence: certain
      accuracy: unknown
      since: EVT-001040
  agenda: "**2026-10-01 13:31-19:47 (`EVT-001219`, `EVT-001222`, `EVT-001223`, `EVT-001224`, Gatefall: Pendragon).** Region VIII signed; the Director named, Margaret Hale; his one-page at 16:38 (Hale, Pike, possibly Renata; the line; *if Pike pushes, I take it*). **The US regions:** Chicago and Washington from the morning; Houston (VI, with Dallas), New York (II, in writing), Boston (I), Miami (IV), Region VIII this afternoon; **IX and X on the Director's paragraph by 21:00**. At National: read the memorandum clean, touched Alexander's knee twice, heard Hale say *they should have kept you*. **Europe:** the map to Tereza at 19:14 (Warsaw; Bucharest with Petroșani; Madrid, whose authority asked first; Milan, Anjali's filing tomorrow; Lisbon, the Alfama site, Dario's idea). **Owned the European filing mistake** -- he had treated each country like a BGM region -- and on the EU ruling sent **notifications at 19:43 Chicago (02:43 local) to the Czech, Dutch and Swedish agencies**, citing Germany's and France's acceptances; told not to apologise, *prove me better with Israel and Turkey*. Messaged Anjali Monday's and Tuesday's recruitment schedule. *Now I have nothing left to do today.* The treasury: $1.7M in hand, ≈$14.7M owed, $3.2M committed, payroll $53.5M due 10-31; *tight, arithmetic not hope*; he'll say on the 20th if it's short. **Prior:** **2026-10-01 09:38-12:52 (`EVT-001213`, `EVT-001214`, Gatefall: Pendragon).** Room **7C, seventh floor**, BGM National HQ; **the Director asked that he attend too**. Asked by Alexander whether he *wanted* to go -- *nobody asks me that* -- said yes, for himself: he knows how that building sets a room. Replied *Mr. Kane will attend*. **New York's letter in writing and signed, 11:00; seven directors to go.** Briefed Alexander at 12:30: the Director wants the meeting before the regional directors sign; she'll ask for visibility (a national liaison, the same reporting line on Alexander his old office tried in September, and those drafters may be in the building); she can tell the rest to sign in a day. **Agreed line:** the guild's annex contacts nationally and Anjali's office as named point, yes; nothing on Alexander personally -- no reporting line, location data or mechanism answers. If pushed, Kane says no. **Owes:** a one-page briefing in Alexander's inbox **by 17:00**; they leave from Winnetka **at 18:20**. Wore Alexander's hoodie and his favourite joggers. **Prior:** **2026-10-01 08:38-09:38 (`EVT-001210`, `EVT-001211`, Gatefall: Pendragon).** Regional calls from the study: **Houston in; New York wants it in writing today; eight directors to go.** Put the legal pad face down for the hour. At about 09:30 BGM National's Director's office, having seen Okafor's letter, asked to meet Alexander in person before any regional director signs, Friday 10:00 Eastern; Kane told them he'd ask, not that he'd come. On Alexander's word he moved it: **tonight, Thu 10-01, 19:30 Eastern (18:30 Chicago), BGM National headquarters, the Director in person** (accepted, 🎲 68 +1 -> 88); room number to follow. Friday clear for Seoul. **Owes still:** the Europe map by 20:00, the remaining directors, Friday 17:00 status. **Prior:** **2026-10-01 (`EVT-001200`, `EVT-001203`, Gatefall: Pendragon).** Up first at the 06:04 alert; timed Evanston at eight minutes. Laid out his three regions straight (Tokyo, months; Seoul, Han Seung-woo's whole guild; Australia, wanting a resident or named S-Rank) and arranged Han's meeting. **Owns:** the Europe map with Tereza and Kesha by 20:00 Chicago; Australia and Oceania; calls to every US regional director today on Okafor's letter; status on all fourteen filed offices by Friday 17:00. Called the three of them *domestic* on a call with Tereza. **Prior:** **2026-09-30 evening into 10-01 (`EVT-001190`, `EVT-001191`, `EVT-001193`, Gatefall: Pendragon).** Brought the Region V annex answer he owed and learned Alexander had gone to Okafor himself; said plainly he had wanted to be the one to bring it, owned not calling at 09:10, promised the problem when he gets it next time. Named the risk to Boyce now that Okafor knows the statement exists. Agreed to the S-Rank training rota. A text at 21:48 he read screen-away and pocketed without a word. Awake in the dark when Alexander came back at 00:03: *You went.* **Prior:** **2026-09-30 morning (`EVT-001160`).** Left Winnetka for HQ ahead of Alexander, tasked with personally pushing Chicago's own stuck regulator filing — a direct call to Region V rather than routing through Anjali — plus another push on his National contact; committed to a concrete answer by evening. **2026-09-29 evening into night (`EVT-001155`-`EVT-001158`).** Genuinely bad at the video games and unbothered by it; rattled by the horror movie despite denying it. Asked Alexander directly and honestly whether the four-day tour gap was partly about needing space — took the honest, practical answer at face value, no further probing. **First kiss with Alexander this evening, and — his own unprompted admission that the thought had crossed his mind — a first kiss with Dario Wexler later the same night**, careful rather than performed. Stayed the night, all three together; morning after, easy and unbothered, approving rather than territorial about Dario. `REL-000125` (Kane and Dario's own relationship) minted the same night. **2026-09-29 (`EVT-001148`-`EVT-001153`).** At Guild HQ from 06:00, countersigning Renata's regional filings; flagged `GB-58`/`GB-59` on Alexander's own Chicago route the moment they posted and dispatched them through ordinary guild channels without waiting on sign-off (Priya's crew on the B, a D-Rank pair on the D) — both cleared clean. Texted about the kitchen, Dario, and the beer-night invite; confirmed for 19:00. **Asked, without cause given at first, to replace London's day manager** ('I don't trust her'); pushed back once for an actual reason, got one on the second try (tunnel-mechanism exposure, not a personnel complaint) and accepted it as legitimate — pulling Imogen Hartley's tunnel-room authorization and searching for a replacement candidate, not yet executed, nothing said to her about it yet. Arrived at Winnetka by car for beer night, Dario alongside him. **2026-09-26/27 (`EVT-001111`, `EVT-001112`, `EVT-001114`, `EVT-001117`).** Spent the night with Alexander and asked him to stay; told him about school (the quiet one handed the key to the supply cupboard). Took the errands on Istanbul, Tel Aviv and Canada and a Canadian broker by 14:00 (met at 14:04); called the glazier for Elena's window. Standfast homework hour still owed. Second in command over operations, with the edge cases owed as a table. **2026-09-25 (`EVT-001095`):** commands the guild element on Region V's Calumet A-Rank Gate - name and roster to the duty desk by 10:00, a drone read of the mouth first, on the line by 09:00 and inside by 09:30, out and a call to Alexander if the read changes; rings Renata's roster office at 07:00 Central (general terms, no name); then the region-by-region Gate registrations, New York first through Silas Grech, Boston through the same office. **Prior, superseded:** **2026-09-21 (`EVT-001051`):** National legal asked the video platform to hold the premiere for review; by 11:46 it was withdrawn, and Kane told Alexander only 'It's handled.' What it cost him is his secret's to carry. Prior: from the 2026-09-20 board vote he took BGM interference as his. From 07:00 Chicago on 2026-09-21 he works his own National contacts quietly, from his phone rather than anyone's office, to learn who will move against the broadcast and when; he reports only if asked. Authored 2026-09-21 06:00 ahead of his first line (Decision 092; this record sits past the campaign's `disposition_baseline`)."
```
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Mid-30s, South Asian, medium height and compactly built — the settled, no-wasted-motion physique of an area-control specialist who wins fights by holding ground rather than outrunning it. Black hair kept in a chin-length practical bob; dark brown eyes; a small beauty mark just above her upper lip. A level, assessing gaze. A fitted teal Ashwood Collective softshell jacket over black leggings, sturdy trail boots — built for standing still under pressure rather than moving fast. Reference setting: an open training yard, the Rocky Mountains blurred on the horizon, cool overcast Denver light."
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Late 30s, white, big and heavily built — a front-line breaker's frame, made for absorbing a Gate-break's opening shock and holding a line rather than for finesse. Reddish-brown hair buzzed close, thinning at the crown; pale blue eyes; heavy reddish-brown stubble, a sunburned nose, deep weather lines fanning from the eyes. A permanent squint, a thick neck and forearms. A faded orange Redline Guild work coverall, unzipped to the waist over a stained white tank, heavy steel-toed boots. Reference setting: a Gulf Coast industrial dockside, refinery towers and humid haze behind him, harsh midday sun."
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Mid-40s, white, lean and deliberately unremarkable-looking — guild policy keeps him camera-shy, so he dresses to disappear into a crowd rather than stand out in one: a drab green rain shell over a grey fleece, an unmarked ballcap pulled low, nothing marking him as Cascade Guild at all. Mousy brown-grey hair kept short and neutral; pale grey eyes, forgettable and hard to recall afterward; clean-shaven but for a faint mole on one cheek, the one feature anyone actually remembers. A quiet, watchful face that gives away nothing to a lens. Reference setting: misty Pacific Northwest evergreen forest, rain-heavy grey light, low visibility, half-turned from the camera."
  personality: "Unestablished — no scene has reached him."
  knowledge: "No channel to Alexander. Aware, if at all, only through Renata's national-roster outreach."
```
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Mid-30s, Black, medium height, wiry and weather-toughened — built for standing waist-deep in floodwater for hours rather than for a boss chamber. Deep brown locs pulled back off her face; dark brown eyes, sharp and quick; high cheekbones and a small gap between her front teeth that shows on the rare full smile, used to reading a rising water line at a glance. A mustard-yellow rain slicker over waders, sleeves rolled to the elbow — clearly seen real storms rather than press events. Reference setting: a flooded New Orleans street at dusk, storm clouds and reflected streetlights in standing water behind her."
  personality: "Unestablished — no scene has reached her."
  knowledge: "No channel to Alexander. Aware, if at all, only through Renata's national-roster outreach."
```
...
canonical_state:
  ...
  capabilities: "S-Rank combat; signature unestablished."
  appearance: "Authored 2026-09-22 for portrait reference. Early 30s, white, tall and conventionally handsome in the deliberate way an old-money guild grooms its flagship — an expensive haircut, a navy blazer over a crisp white shirt with no tie, old-money-casual even in training gear underneath. Sandy-blond hair, side-swept and precisely cut; blue eyes; clean-shaven with a strong jaw and a faint dimple in the chin. A practiced camera-ready smile that doesn't quite reach eyes doing their own separate, more careful calculation. Reference setting: a polished marble guild headquarters lobby, brass fixtures and soft interior light behind him."
  personality: "Unestablished — no scene has reached him."
  knowledge: "No channel to Alexander. Aware, if at all, only through Renata's national-roster outreach."
```
...
canonical_state:
  ...
  capabilities: "S-Rank combat; signature unestablished."
  appearance: "Authored 2026-09-22 for portrait reference. Late 30s, white, medium height, deliberately hard to place — a beige windbreaker and plain jeans, the kind of outfit that could belong to anyone, the practiced anonymity of someone who has spent years staying off a searchable public record on purpose. Mousy brown hair, shoulder-length and usually tied back, sometimes dyed a different shade to avoid recognition; hazel eyes; a faint birthmark on her jaw, mostly covered by hair. Sharp, guarded eyes, sun-weathered LA skin. Nothing about her reads as S-Rank at a glance, which is evidently the point. Reference setting: an anonymous LA parking structure, flat harsh daylight, nothing distinctive in frame."
  personality: "Unestablished — no scene has reached her."
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Early 40s, white, a working-class Detroit build — thick through the shoulders and forearms from years of industrial-Gate clears, a face lined and weathered rather than camera-groomed. Close-cropped grey buzz cut; brown eyes; a heavy grey mustache and a faded burn scar across one hand from an industrial accident. A steady, unbothered expression, faded blue Anchor Guild coveralls with sleeves pushed up, heavy leather work gloves tucked in a back pocket. Reference setting: a factory floor near an industrial Gate containment rig, sodium work-lights and machinery behind him."
  personality: "Unestablished — no scene has reached him."
  knowledge: "No channel to Alexander. Aware, if at all, only through Renata's national-roster outreach."
```
...
canonical_state:
  ...
  capabilities: "S-Rank combat; signature unestablished."
  appearance: "Authored 2026-09-22 for portrait reference. Mid-20s, Latina, compact and athletic, visibly younger than the company she's newly keeping. Long dark brown hair, often worn in a practical braid for cameras; dark brown eyes; a small gold stud in one nostril. An easy camera-friendly smile her guild is clearly leaning on, though something more uncertain shows through in unguarded moments. A bright coral Vanguard Collective athletic set, still crisp and looking slightly too new on her. Reference setting: a bright Miami skyline at golden hour, palm trees and pastel Art Deco buildings behind her."
  personality: "Unestablished — no scene has reached her."
  knowledge: "No channel to Alexander. Aware, if at all, only through Renata's national-roster outreach."
```
...
canonical_state:
  ...
  affiliation: "Unaffiliated — considering a Pendragon Guild associate agreement"
  home: "Winnetka, USA (Alexander's lakefront house)"
  ...
  age: "Early twenties — a second-year master's student in water engineering at the time of her awakening. Exact age not yet stated."
  role: "Unaffiliated, unregistered publicly as S-Rank. A second-year master's student with zero hunter background until the night of 2026-09-12, when a Gate opened two blocks from her apartment in Sacramento and awakened her directly at S-Rank. Read at the testing office Sunday 2026-09-13; not carded, at her own request. Considering a 1 USD non-exclusive associate agreement with the Pendragon Guild (nothing signed)."
  location: "**The Winnetka lakefront house, guest room (second door on the right, lake window), a guest since 2026-09-24 21:33 Chicago** (`EVT-001092`); last placed there 2026-09-29, mid-flambé in the kitchen (`EVT-001148`). Otherwise her Sacramento apartment (2C, second floor front), shared with a roommate she left a note for on 2026-09-24 and called from the house."
  ...
  appearance: "Authored 2026-09-22 for portrait reference. Early 20s, Korean-American, slight build, still dresses like a grad student rather than a hunter — a grey university hoodie, dark jeans, a canvas laptop bag she hasn't swapped out. Black hair, shoulder-length, usually pulled back into a messy bun or ponytail rather than styled; dark brown eyes with faint circles under them; a light scatter of stress breakouts along the jaw she doesn't bother covering. Tired eyes from a life recently upended; an expressive face that telegraphs nerves before she catches it. Nothing about her reads as S-Rank at a glance, which is exactly the disconnect the people around her keep noticing. Reference setting: a cluttered small apartment bedroom, textbooks and a laptop visible on a desk behind her, warm lamp light."
  ...
  secret: "**It fires in her sleep.** Since about 2026-09-16 things pile on the bed; on the night of 2026-09-23 her whole loaded bookshelf hung a hand's width from her face until she thought of her mother's kitchen. She told no one until Alexander (2026-09-24, `EVT-001091`); her roommate's absence that night was arranged for this reason. Alexander knows; nobody else does."
  voice: "Careful, a little nervous, honest rather than performative — apologizes for the call being strange, thanks him unprompted and **keeps a running count of her own thank-yous aloud**; turns a sentence a quarter turn when it will not come out right; laughs at herself when she is scared."
  beliefs:
    - claim: "The power only ever takes her own things, and the rule holds unless she is frightened."
      ground: "Tested on purpose on a bad day: her roommate's mug never moved. She also knows the shelf, hers, came within a hand of her face."
      confidence: suspects
      accuracy: unknown
      since: EVT-001091
...
canonical_state:
  ...
  appearance: "Camera-composed even off-duty — the specific practiced ease of someone who has spent years being photographed and has stopped fighting it. Ash-blonde hair, precisely cut into a chin-length bob; grey-blue eyes; fair skin with faint laugh lines at the eyes and minimal off-duty makeup, a cream silk blouse and tailored trousers, a light trench coat draped over one arm. Warm rather than cold in person, more so than her public packaging suggests. Reference setting: a quiet Paris street at golden hour, a café awning and soft bokeh city lights behind her."
  ...
  knowledge: "Met Alexander in person 2026-09-17, Prague. Told about the independent S-Rank network and the Pendragon Guild the same evening; accepted a provisional board seat, reserving the right to withdraw if it reads as image management rather than real judgment. **Told directly that Alexander can teleport, including passenger transport** — the sixth confirmed holder. Witnessed the five-passenger demonstration to Winnetka firsthand. **Told, 2026-09-18 (Paris), that Alexander and Owen Callahan recently ended their relationship** — no other detail about Owen given. No channel to the Jiu Valley Exclusion disclosure, the far side, or anything about Alexander's own combat history beyond GB-14's public account. **2026-09-20/21 (`EVT-001040`):** learned from the broadcast cut itself, at the Pendragon Guild's first board meeting at Winnetka, that Alexander ended the Jiu Valley Exclusion alone — the statement's own words, no method, no numbers, nothing of Sorcha Bellweather's part. Has seen the silent instant-dungeon footage with no channel to what the place was. Voted yes to air it; wants a second look at the final edit before placing it in France. **2026-09-21 (`EVT-001047`, `EVT-001051`):** second look done, name behind it; placed it in France 2's 20h news at his choice. Knows the Mercer piece and the Council request (public). No channel to Sorcha's part or her filing."

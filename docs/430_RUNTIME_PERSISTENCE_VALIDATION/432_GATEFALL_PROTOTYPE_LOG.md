...
**Checkpoints:** 100 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0100`)
...
**Latest capture:** `900_CHECKPOINT_0100` — kind `session-save`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0099`, source `EVT-000573`.

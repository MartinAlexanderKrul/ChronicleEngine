...
**Checkpoints:** 135 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0135`)
...
| frozen | 0009–0135 | 127 |

**Latest capture:** `900_CHECKPOINT_0135` — kind `session-save`, profile 1.110 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0134`, source `EVT-000858`.

...
**Checkpoints:** 97 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0097`)
...
**Latest capture:** `900_CHECKPOINT_0097` — kind `manual`, profile 1.79 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0096`, source `EVT-000559`.

...
**Checkpoints:** 131 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0131`)
...
| frozen | 0009–0131 | 123 |

**Latest capture:** `900_CHECKPOINT_0131` — kind `session-save`, profile 1.108 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0130`, source `EVT-000814`.

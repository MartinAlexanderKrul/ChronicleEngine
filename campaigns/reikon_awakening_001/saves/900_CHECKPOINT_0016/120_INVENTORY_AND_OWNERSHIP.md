...
canonical_state:
  ...
  possession: "Hunters' Authority Association desk"
  location: "Hunters' Authority headquarters, Verholt, core appraisal desk"
  quantity: 1
```
...
provenance:
  ...
  event_time: "Year 31 AR, morning after the Ashgate closure"
  record_time: "2026-07-22T00:00:00Z"
  uncertainty: "This holding was received in play (206 Section 12.2's universal 1 core = 3 vells rate) but not written to canon at the time; recorded now as a correction. Whether any additional Association assignment-completion bonus exists beyond core-sale value is an unauthored, flagged claim (EVT-000048) and is NOT included in this quantity."
type: Resource
subtype: currency-holding
scope: personal
lifecycle: active
aliases:
  - name: "Daedalus's vell purse"
    quality: current
canonical_state:
  category: "Civilian coin, the Aldish Republic's minted currency (206 Section 12.2). Received as payment for the appraised Ashgate Rift core, taken as coin rather than core-equivalent units."
  condition: Excellent
  ownership: "ENT-000051 (legal)"
  possession: ENT-000051
  location: "Tannery district, just outside the collapsed E-Rift (carried)"

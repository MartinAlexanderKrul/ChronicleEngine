...
canonical_state:
  age: 25
  location: ENT-000087
  condition: "Health and Mana full (60/60, 24/24) after the Profile 1.4 migration settled the previously pending Level 3 recovery (`EVT-000074`); no lasting injury. The earlier near-lethal hit and 0/40 recovery remain resolved history and were not recalculated. The System has attached (see `system_state`); he is no longer an ordinary licensed hunter, though nothing about him looks different to anyone who can't see what he can."
  ...
  system_state:
    ...
    stats:
      ...
      intelligence: 12
    effective_stats:
      strength: "18 (base 18 + equipment 0)"
      agility: "23 (base 14 + equipment 9)"
      vitality: "15 (base 12 + equipment 3)"
      perception: "13 (base 13 + equipment 0)"
      intelligence: "12 (base 12 + equipment 0)"
    system_tier: E
    equipment:

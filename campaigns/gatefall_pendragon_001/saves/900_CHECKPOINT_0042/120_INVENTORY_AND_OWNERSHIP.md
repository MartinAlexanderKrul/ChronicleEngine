...
### E-Rank Gear (Purchased 2026-07-23, Ironbound)

- **Reinforced Leather Jacket [E-Rank]** — **SOLD.** Bastion torso armor, Good, Vitality +1, physical reduction 3%. Purchased from Ironbound for $800 (`EVT-000058`); superseded and unequipped when the Adaptive Bastion Torso [E-Rank] was purchased and equipped (`EVT-000083`), then sold back to the System shop for 15 g.
- **E-Rank Quickknife** — **SOLD.** Quickknife, Good, off hand, Agility +2, armed strike ×0.75. Purchased from Ironbound for $500 (`EVT-000058`); superseded and unequipped when the Ghost Quickknife [B-Rank] took the off-hand slot, then sold back to the System shop for 25 g the same sitting (`EVT-000096`).
- **Reinforced Gauntlets [E-Rank]** — **SOLD.** Bastion hands armor, Good, Vitality +1, physical reduction 3%. Purchased from Ironbound for $600 (`EVT-000058`); superseded and unequipped when the Horizon Gale Gauntlets [C-Rank] were purchased and equipped (`EVT-000094`), then sold back to the System shop for 15 g.
- **Shin Guards [E-Rank]** — **Bastion legs armor · Good · Vitality +1 · physical reduction 3%**. Purchased from Ironbound for $100 (`EVT-000058`). Currently **equipped** (`EVT-000094`).

### Daily Premium Purchases (2026-07-29, System shop)

- **Adaptive Bastion Torso [E-Rank]** — Good, Vitality +3, physical reduction 6%. Bought for 120 g via the 2026-07-29 Daily Premium cycle (`EVT-000083`). Currently **equipped** (`EVT-000094`) — replaced the Reinforced Leather Jacket.
- **Ascendant Hunter's Band [E-Rank]** — accessory, Strength +4. Bought for 160 g via the same cycle (`EVT-000083`). **Equipped**, accessory slot 1.
- **Premium Rune (Stone Skin)** — consumed on use (`EVT-000083`); taught Stone Skin [D-Rank] at Novice mastery. No longer an inventory item.

### Daily Premium Purchases (2026-07-30, System shop)

Bought from the 2026-07-30 06:00 cycle on the evening of 2026-07-30 (`EVT-000088`), the first time Alexander opened the tab that cycle. Three of six offers taken, 4,420 g total; **gold 20,255 → 15,835**. The Aegis Guard Shield [E-Rank] (200 g), Adaptive Watcher Head [E-Rank] (120 g), and Premium Crystal Key [D-Rank] (4,500 g) were left unbought and expire at the 2026-07-31 06:00 rotation.

- **Ascendant Hunter's Band [D-Rank]** — accessory, Strength +5. Bought for 720 g. **Equipped** (`EVT-000094`) in the second accessory slot alongside the E-Rank Band (Strength +4) — the profile permits duplicate accessory types in the two slots, and both bonuses apply (Strength +9 total).
- **Mender's Seal** — clears one Minor injury outright, or steps one Moderate injury down to Minor; restores no Health (Profile Section 12.5). Bought for 1,200 g. Banked, unused. Acts on the severity axis, which potions, Status Recoveries, and level-ups cannot touch (Section 6.4).
- **Premium Rune (Rupture)** — bought for 2,500 g and **consumed on use the same evening**; taught **Rupture [E-Rank]** (Mana 12, ×2.0 of the E-Rank skill-rank baseline 10) at Novice mastery. No longer an inventory item. Consumed alone, behind a closed door, unwitnessed.

### Daily Random Box Contents (2026-07-31, System)

Opened in the small hours of 2026-07-31 (`EVT-000089`) — all four banked boxes, each rolled on the Section 8.1 d100 at System Rank E. Two purses of System gold (500 g each, d100 43 and 56) took **gold 15,835 → 16,835**; that balance is Bearer state owned by `100_CHARACTER_SHEET.md`.

- **Titan Boots [E-Rank]** — Titan feet armor, Good, Strength +1, physical reduction 3%. Won on d100 82 → ranked gear (chassis d20 10 → armor; slot d5 5 → feet; style d5 2 → Titan). **Equipped** (`EVT-000094`) — the feet slot had been empty since he was licensed.
- **Lesser mana potion ×2** and **lesser healing potion ×1** — the potion cache rolled on d100 19 (E-Rank tier: lesser), composition rolled 2 mana / 1 healing. Banked, unwithdrawn. The mana potions are his first of that kind; he acquired nothing that spends Mana until 2026-07-29.

### Boss Drop (Red Line Corridor, 2026-07-24)

- **Armored Greave [E-Rank]** — **Bastion legs armor · Good · Vitality +1 · physical reduction 3%**. Grip-soled, joint-hinged leg armor salvaged from the Red Line Corridor boss (`EVT-000059`), suited to broken/vertical terrain. Stored and **not equipped** because the legs slot is occupied by the Shin Guards; whether it is Alexander's to keep or goes to the pooled split remains undecided (`EVT-000060`).

### Mining Tools

- **Resonance Chisel (original)** — **Broken; applies no line and is unusable** (Profile Section 11.5, Condition). Basic-model harvest tool, purchased from Diane at Ironbound for $80 (`EVT-000063`). Its head sheared from the shaft on a natural critical fumble while Alexander pushed an exhausted seam near the Ashfield Gate's aperture (`EVT-000080`, Section 4.8 — repeated attempts wear tools). Retained as scrap. It served two C-Rank harvest jobs and part of a third clear before failing.
- **Resonance Chisel (standard replacement)** — Purchased 2026-07-29 for $75 at **Vanguard Trade & Gear** (`ENT-000140`), a licensed Chicago outfitter distinct from Ironbound (`EVT-000083`). Functionally identical to the original. Undamaged, unused.
- **"Longhaul" Resonance Chisel** — Purchased the same visit for $140, same vendor (`EVT-000083`). Heavier-duty grip and a reinforced head, per the clerk's claim; no mechanical distinction authored beyond flavor. Undamaged, unused.

### Horizon Outfitters Purchase (2026-07-31, Michigan Avenue)

Bought $15,500 total (cash $34,381 → $18,881), Gale line (Agility-focused), licensed C-Rank market anchor from Profile Section 12.8.1 (`EVT-000094`).

- **Horizon Gale Gauntlets [C-Rank]** — Good, Agility +3, physical reduction 8%. $12,500. **Equipped**, superseding the sold Reinforced Gauntlets [E-Rank].
- **Horizon Gale Coif [D-Rank]** (head) — Good, Agility +2, physical reduction 5%. $3,000. **Equipped** — the head slot had been empty since licensing.

### Sable & Kern C-Rank Harvest Job — Halsted Depot (2026-07-31)

Confirmed C-Rank, archetype Foundry Hollow, referred by Kesha Morrison. Crew: Sable and Kern (`ENT-000141`, `ENT-000142`), Ruth (`ENT-000143`), Denny (`ENT-000144`), contractor entity `ENT-000145` (`REL-000067`).

- **10 C-Rank crystals mined solo** across a second vein (7) and a rushed third vein (3), worked out of the crew's direct sightline. **4 sold privately** to the System shop (170 g each, 680 g total, undeclared — unknown to the crew). **6 declared** to the crew pool.
- **Crew total declared: 16 C-Rank crystals**, $40,000 gross at licensed rates. Sable & Kern's 10% cut ($4,000) off the top, remaining $36,000 split four ways ($9,000 each).
- **≈$9,000 pending** — Alexander's even-fourth share, filing/processing 1–2 business days per the standing Coalition-adjacent pattern. Not yet received; not counted in cash on hand.

### Ashfield Gate Haul (2026-07-28) — **split agreed 2026-07-29 (`EVT-000083`)**

Taken from the cleared Ashfield Gate (`EVT-000080`). Declared and split at the Coalition case table on 2026-07-29, standard terms: 10% leader's share to Priya Okafor, the remaining 90% divided equally among all five (Priya included in the equal split).

- **16 C-Rank crystals** — five taken from the common beasts killed inside, eleven mined (4 by Alexander, 6 by the crew, 1 hand-worked after the chisel broke). At licensed C rates (~$2,500 each), ≈$40,000.
- **2 C-Rank cores** — one from the elite, one extracted from the boss by Alexander personally (strong success, clean and uncracked). At licensed C rates (~$6,250 each), ≈$12,500.
- **Crystal/core pool declared value: $52,500.** Split: Priya $5,250 (leader's share) + $9,450 (equal share) = $14,700; Julian, Renata, Owen, and Alexander each $9,450. Priya carried the physical crystals and cores to file with her report the morning of 2026-07-30; Alexander's $9,450 share is not yet in hand, pending that filing and processing.
- **Longshot [C-Rank]** — Gate-forged mana-bearing bow, the boss drop (d100 6 → equipment; d20 7 → Longshot). **Perception +5, Agility +2, weapon power 7, ranged armed strike ×0.75, two-handed.** No one on the crew uses a bow (shotgun, sensor, mender, and two close-quarters strikers); by group agreement it will be sold and the proceeds split the same five ways once appraised. Not yet appraised or sold.

### Two Solo Instant-Dungeon Clears (2026-07-31, afternoon)

Bought and equipped the **Ghost Quickknife [B-Rank]** from the Daily Premium tab (`EVT-000096`), 18,000 g, moved to main hand; sold the superseded E-Rank Quickknife above.

**First clear (`EVT-000097`)** — the E-Rank instant-dungeon key already banked, archetype Overgrown Temple. 4 common beasts, 1 elite (shrine guardian), and the boss killed. Loot: 6 E-Rank crystals, 2 E-Rank cores (corrected mid-session — elites and bosses drop a crystal in addition to their core, Section 11.1), a boss-drop rune (rerolled from known Stone Skin to **Flash Step [D-Rank]**, learned), and the archetype's bonus loot roll, an **Elixir of a Stat**. Instance closed on the boss kill; no separate looting window. Back on the bench, sold all 6 crystals (60 g) and the Elixir (2,500 g), consumed the Flash Step rune, bought a **Stabilization Seal** (150 g, banked unused) and a second **Instant-Dungeon Key [E-Rank]** (500 g).

**Second clear (`EVT-000099`)** — the newly bought key, archetype Hive (doubled common count, both elite slots converted to additional commons — 0 elites). 6 common beasts and the boss killed; drank both **Lesser Mana Potions** (+20 Mana total, none remain) before the final approach. Boss drop: a third **Instant-Dungeon Key [E-Rank]**, now banked. Loot from this clear: 7 E-Rank crystals, 1 E-Rank core — unsold, still banked. Rupture's mastery advanced Novice → Practiced on the boss kill (Section 7.4), its third materially-distinct contributing use.

Never hit in either clear.

### Third Instant-Dungeon Clear (2026-07-31, late afternoon, `EVT-000101`)

The last banked key, archetype **Frozen Gallery** (Mana recovery halved inside). Population 7 common/2 elite/1 boss. Killed: 1 common at the entrance, 1 elite + 2 commons in the first chamber, 1 elite + 2 commons in the antechamber guarding the boss, and the boss itself — 5 of 7 commons, both elites, the boss. Loot: 8 E-Rank crystals, 3 E-Rank cores (1 per elite, 1 from the boss), and a boss-drop **Instant-Dungeon Key [E-Rank]** (81–90 result). The opening unseen strike on the boss fumbled naturally; its reflexive counter and a mid-combo counter both landed for real (Health 88→62, then 88→68 after a claimed Status Recovery), no lasting injury. A calculated finishing strike ended it legendarily. XP 380→580/700 across the clear.

**Post-dungeon, on the bench (`EVT-000102`).** Sold all 15 banked E-Rank crystals (the second clear's 7 plus this clear's 8) to the System shop at 10 g each — 150 g; gold 1,965 → 2,115. The nine banked E-Rank cores from these two clears (3 from clear two + 3 from clear three, plus the original 3 already banked from the first clear = 6 sellable-nowhere total) remain unsold — the System shop still refuses cores at any price.

Current banked totals after all three clears and the bench sale: **0 E-Rank crystals** (all sold), **6 E-Rank cores** (unsellable to the System shop, Section 12.5, though the licensed mundane market prices a core at ≈$375 each; these carry no provenance from an unregulated clear), **1 Instant-Dungeon Key [E-Rank]** (fresh, from the third clear's boss), **1 Stabilization Seal**.

### Fourth Instant-Dungeon Clear (2026-08-01, mid-morning, `EVT-000109`)

Opened with the key carried in from the third clear, run alone from Owen Callahan's kitchen while Owen was out at Renata's. Archetype **Crypt** — total darkness, ambush check on entering combat, −1 modifier step on sight-dependent actions. Population 12 common / 1 elite / 1 boss.

- **Killed:** all 12 commons, the elite (a ceiling-walking predator), and the boss — a six-limbed, eyeless, frill-headed predator that hunted him by sound from the walls rather than the floor. Never hit; Health held at maximum the whole clear.
- **Loot:** **14 E-Rank crystals** (12 commons + 1 elite + 1 boss, per the Section 11.1 ruling that elites and bosses drop a crystal alongside their core) and **2 E-Rank cores** (elite, boss).
- **Boss drop:** d100 87 (81–90) → **Instant-Dungeon Key [E-Rank]**, banked and later spent on the fifth clear.
- **Sold the same morning:** all 14 crystals to the System shop at 10 g each — 140 g; **gold 2,115 → 2,255**.

### Fifth Instant-Dungeon Clear (2026-08-02, afternoon, `EVT-000113`)

Opened with the Crypt's dropped key, from his own apartment desk with the crew dossiers finished. Archetype **Flooded Mine** — standing water throughout, −1 modifier step on Strength and Agility actions, drowning risk in the deep. Population 12 common / 2 elite / 1 boss.

- **Killed:** all 12 commons, both elites, and the boss — a Serpentine-bodied, Control-signature thing denned in a flooded chamber. He went under once losing footing against the second elite and was never actually struck; Health held at maximum.
- **Loot:** **15 E-Rank crystals** (12 commons + 2 elites + 1 boss) and **3 E-Rank cores** (2 elites, boss).
- **Boss drop:** d100 34 (01–40) → **equipment** at the instance Rank → **Gale Torso [E-Rank]** (Agility +1, physical reduction 3%). **Sold** to the System shop for 15 g rather than equipped: taking it would have vacated the Adaptive Bastion Torso's Vitality +3, dropping effective Vitality 29→26 and maximum Health 116→104 for a single point of Agility at identical protection.
- **Sold on return:** all 15 crystals (150 g) and the Gale Torso (15 g); **gold 2,255 → 2,420**.

### System Shop Purchases (2026-08-02, `EVT-000114`)

Both bought from the **standard unlimited catalogue**, not the Daily Premium tab. The live 2026-08-02 Premium cycle offered a Premium Rune teaching Keen Sense at **2,500 g** whose Rank roll had come up E-Rank — an identical teaching to the catalogue's flat E-Rank rune at 1,000 g, with the premium markup buying nothing.

- **E-Rank skill rune — Keen Sense**, 1,000 g. Consumed on use; taught **Keen Sense [E-Rank]** (Mana 2, +1 modifier step on detection for the scene) at Novice mastery. No longer an inventory item.
- **E-Rank skill rune — Dagger Mastery**, 1,000 g. Consumed on use; taught **Dagger Mastery [E-Rank]** (passive, +0.10 to a Quickknife's chassis multiplier) at Novice mastery. Both equipped Quickknives now resolve at **×0.85** rather than ×0.75. No longer an inventory item.

**Gold across the sitting:** 2,420 → 2,920 (a 500 g Daily Random Box purse) → 1,920 → **920** after the two runes.

### Daily Random Box Contents (2026-08-02, `EVT-000114`)

Both boxes banked from the eighth and ninth daily completions, opened together at his apartment desk. Neither was streak-upgraded — streaks 8 and 9 are not positive multiples of seven (Section 8.1).

- **System gold** — d100 58 (36–60), E-Rank purse, **500 g**. That balance is Bearer state owned by `100_CHARACTER_SHEET.md`.
- **Quickstep Charm [E-Rank]** — d100 91 (81–93) → ranked gear at System Rank E; accessory, Good, **Agility +1**. **Banked, unequipped.** Both accessory slots hold Ascendant Hunter's Bands (Strength +4 and +5, +9 total); equipping the Charm would trade five or four points of Strength for one of Agility.

**Current banked totals after all five clears and every sale:** **0 E-Rank crystals**, **11 E-Rank cores** (6 carried + 2 Crypt + 3 Flooded Mine — still unsellable to the System shop under Section 12.5, still worth ≈$375 each on the licensed mundane market and still carrying no provenance any licensed buyer would accept), **0 Instant-Dungeon Keys** (the self-sustaining key chain running since `EVT-000097` broke when the Flooded Mine boss rolled equipment instead of a key — a further run now costs 500 g or a fresh drop), **1 Stabilization Seal**, **1 Mender's Seal**, **1 Quickstep Charm [E-Rank]**, **1 Channeling Focus [E-Rank]**, **10 lesser healing potions**, **0 lesser mana potions**, **2 antidotes**.

---

## Generic Holdings

- **$60,806.50 USD** in cash/checking, as of 2026-08-07 ~06:15 AM: $20,806.50 (two coffees deducted from $20,813.50 at `EVT-000166`) + $40,000.00 (Denise Ferro harvest payout, landed overdue — see Pending Income below) = $60,806.50. Not docked for tuition; the debt is tracked as a monthly liability, below. (Superseded figures, retained for provenance: $20,813.50 as of `EVT-000153`, 2026-08-05; $10,051 as of `EVT-000139`, 2026-08-04; $18,881 → +$9,450 [Ashfield share] → −$18,500 [Owen's protective gear] = $9,831 as of `EVT-000118`; was $34,381 as of `EVT-000083`, then $18,881 after the 2026-07-31 Horizon Outfitters purchase, `EVT-000094`.)
...
**Gold stands at 920** as of `EVT-000114` (2,115 carried into 2026-08-01; +140 for the Crypt clear's 14 crystals; +150 for the Flooded Mine clear's 15; +15 for the sold Gale Torso; +500 from a Daily Random Box purse; −2,000 for two standard-catalogue E-Rank skill runes). System-shop **gold**, the dimensional inventory's banked holdings (**4 lesser healing potions** — six sold `EVT-000118`, one given to Priya Okafor during the boss fight, `EVT-000079`; **0 lesser mana potions** — both drunk `EVT-000099`; **2 antidotes**; **0 instant-dungeon keys** — the chain broke at `EVT-000113`; **1 Runic Key [E-Rank]**, unused, `EVT-000118`; **0 E-Rank crystals** — all sold; **9 E-Rank cores** — two drawn out and declared as part of the Cicero Gate's report, `EVT-000121`; **1 Stabilization Seal**; **1 Mender's Seal**; the Quickstep Charm [E-Rank] **sold** `EVT-000118`; the unequipped **Channeling Focus [E-Rank]** won from a Daily Random Box, `EVT-000075`), both Quickknives (the **Ghost Quickknife [B-Rank]**, now main hand; and the **C-Rank**, now off hand, moved when the Ghost Quickknife was bought, `EVT-000096`) — both now resolving at chassis ×0.85 rather than ×0.75 since Dagger Mastery was learned (`EVT-000114`) — the nine equipment slots, and the current Daily Premium cycle are **Bearer state owned by `100_CHARACTER_SHEET.md`'s `system_state`** (Profile Sections 11.5, 12.5, 12.9, 14.1). That record governs their current values; this ledger does not restate them. The **full nine-slot loadout remains equipped**, weapon slots swapped this session (`EVT-000096`). Profile 1.2 normalization and loadout state were adopted under `EVT-000072`, the current premium offer Ranks were migrated under Profile 1.3 in `EVT-000073`, and Profile 1.4 added weapon power under `EVT-000074`; no ownership or provenance changed. World Rule Profile 1.10→1.11 was adopted on the bench (`EVT-000100`) — additive, nothing here recomputed.

## Pending Income

**Nothing currently outstanding.** The Denise Ferro share below cleared, overdue but landed.
...
- **Suppression Emitter [Rank unconfirmed].** Unmarked matte-black cylinder, stripped decommissioned surveillance-suppression hardware. Its operating method blinds instrument-based anomaly/Gate-signature detection in a tight radius; personal perception, awakened senses, and System-side detection are unaffected. Operational duration and charge remain unestablished. Unlicensed and illegal to possess given the provenance Walt supplied.
- **Unlicensed Lockpick Set [Rank unconfirmed].** Awakened-made locksmith's work whose teeth read a lock's mechanism and reshape before seating. No combat application is established.

The legendary Keen Sense result (d100 91, `EVT-000212`) validly established operating intent and method. It did **not** establish either item's Rank or hidden origin; reliable item Rank/full appraisal requires Flux Sight at B-Rank (Profile Sections 4.4 and 7.3), as reconciled at `EVT-000214`. Both items are unused and remain Alexander's property.

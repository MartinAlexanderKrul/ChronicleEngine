...
Assert-Contains $profile 'World Rule Profile 1\.28' 'Gatefall profile is not version 1.28.'
Assert-Contains $profile '1\.27.+1\.28 compatibility treatment' 'Gatefall profile lacks the 1.27 to 1.28 compatibility treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.28' 'Gatefall README does not advertise Profile 1.28.'
...
Assert-Contains $character 'profile_version: "1\.28"' 'Live Gatefall character has not adopted Profile 1.28.'

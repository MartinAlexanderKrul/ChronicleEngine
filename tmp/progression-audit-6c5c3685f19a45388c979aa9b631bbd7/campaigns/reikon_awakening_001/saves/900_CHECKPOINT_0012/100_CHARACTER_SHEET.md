...
canonical_state:
  ...
  situation: "In his own rented room (ENT-000066) at dawn, the morning after reporting to Dr. Kalens and the Hunters' Authority. He gave the Institute his complete basement findings the same evening he owed them and logged the clear with the Association; Kalens, Dr. Soren, and Marta are now actively working the severance problem with real data rather than none. The core itself remains in Warehouse 7, still bonded and unextracted. Daedalus just woke to a System-granted one-use technique, Emberbrand, with no stated reason and no instruction beyond its own terms."
...
system:
  ...
  active_intervention:
    name: "Emberbrand"
    source_event: EVT-000040
    effect: "The next successful Fireball or Combustion Touch Daedalus lands strikes at the critical-success (2.0x) band multiplier (206 Section 6.4), regardless of the natural roll, provided the attack succeeds. It does not grant success, does not touch the die, and does not affect any other Ability."
    eligible_actions: ["Fireball", "Combustion Touch"]
    cost: "No cost beyond the Ability's own ordinary Mana cost (206 Section 5)."
    uses_remaining: 1
    granted: "Year 31 AR, dawn (EVT-000040)"
    expiry: "The next sunrise after being granted, whichever comes first: spent on a successful cast, or the expiry time elapsing unused."
  stats:
    power: 8
    endurance: 9
    speed: 10
...
Level 2 with both Ascension points allocated: Mana Affinity 14 and Fireball Strength 1. `max_mana` = 14; `max_health` = 105. Every ability remains Lv 1; Fireball costs 12 at 1.10× magnitude, Flame Shield costs 2/second, Combustion Touch 6, Endurance Surge 10, Reinforced Body 0. Effective band **E** (pool 14). Next threshold `T(2)` = 130. Current state: 31/130 XP, 14/14 Mana, 105/105 HP — a full night's rest closed the treated moderate wounds to no active injury, and mana recovery settled to full overnight. The owner-authored life-burn anomaly expired when the fourth Breaker died and is not an available Ability. A fresh System intervention, Emberbrand, is now active: one use, forcing the critical-success damage band on Daedalus's next successful Fireball or Combustion Touch, expiring at the next sunrise if unused. Trained non-System skills: foundational Swordsmanship (two recorded sessions), practiced aerobic conditioning (three recorded 10 km runs), and practiced bodyweight conditioning (two recorded 100-pushup sessions).

...
### Pending — as of 2026-08-17 11:15

- **$221,540.00** — Wade Bishop's trial payout, filed **Friday** 2026-08-14, processing. **Not overdue, and the earlier framing was wrong.** The prior line read "now three days out on a stated 1-2 *business* day window" while counting calendar days across a weekend. 2026-08-14 is a Friday; 2026-08-15 and 2026-08-16 are a Saturday and a Sunday and clear nothing. **Monday 2026-08-17 is the first business day of that window**, so the payout is due today or tomorrow and is late on neither. Corrected at `EVT-000448`.
- **$9,418.60** — Cicero Scar harvest cut (`EVT-000398`, 12/43 declared, 20% of a $168,750 clear), filed Saturday 2026-08-15, processing. First business day is likewise today.
- **$60,677.42** — Dale Pruitt B-Rank harvest cut (`EVT-000415`, 19/31 declared, 20% of a ≈$495,000 clear), filed Sunday 2026-08-16, processing.

**Total pending, unreceived: $291,636.02.** None of the three has landed as of this anchor.

**Cash on hand: $2,574.00** — down from $45,074.00, which it had held since 2026-08-15. Two transactions on 2026-08-17, both at Walt Adamik's shop (`EVT-000446`, `EVT-000447`): **−$2,500.00** for the Mana Reservoir [C-Rank], and **−$40,000.00** as the opening capital of the `OBJ-29` partnership. Gold unchanged at **97,811**; no System-shop transaction this span.

**This is the thinnest Alexander's cash has been since 2026-08-03, and it is thin against live obligations rather than in the abstract:** $400 in cash is due to Duane on arrival at the freight yard **tonight**, and $800 is owed to Priscilla Nakamura with no due date named. Both remain covered by $2,574 with $1,374 to spare, so nothing is at risk — but the margin is real, and the $291,636.02 that would erase it is a processing queue rather than money he holds. He committed the $40,000 knowing the pending column, not the cleared one.

### Owed Out — as of 2026-08-17 11:15

- **$800.00** — Priscilla Nakamura (`ENT-000203`), identification of the Dormant Core [S-Rank], billed at her difficulty rate at `EVT-000410` and **not paid at the workshop**. No due date named; the next natural settlement point is the Tuesday 2026-08-18 session. Unchanged.
- **$400.00** — Duane (`ENT-000199`), the freight yard off Ashland, cash on arrival Monday 2026-08-17 (`EVT-000373`). **Due tonight**, and now the nearer of the two against a $2,574.00 balance.

**Both remain covered.** See the cash note above the Owed Out heading for why the margin is worth watching rather than worrying about.

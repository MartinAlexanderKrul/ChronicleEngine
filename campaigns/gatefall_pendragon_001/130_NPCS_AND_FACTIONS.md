...
canonical_state:
  ...
  secret: "**She is past her own stated window and has not called.** She gave 2–3 days on 2026-08-14; it is 2026-08-18 and nothing has come back. Whatever the reason — a thread that went somewhere she did not expect, a finding she wants confirmed before she reports it, or ordinary overrun — **she has not communicated it**, which is out of pattern for someone who flags limits plainly. **Known to:** her alone."
  ...
  beliefs:
    - claim: "Anything routed through a formation mill leaves a records trail if you pull enough threads."
      ...
      accuracy: unresolved
      since: "standing"
  agenda: "**Active; advances on the clock, and is currently overdue.** `Advanced` through **2026-08-18 21:20**.\n\n  - **Two threads engaged 2026-08-14** (`EVT-000374`) on a stated 2–3 day window that landed Monday/Tuesday. **Nothing has come back.** She is working, stalled, or holding something; the record does not say which, and the next settlement should decide it from her own state rather than from whether Alexander asks.\n  - **Other clients.** She has a practice; this is one job on a referral, not her only work."
  situation: |

...
| V04-19b | The character model reaches live play | Characters recorded from here carry a disposition and an agenda, authored at first play | **Pending — needs play** | No longer vacuous but not yet exercised: 0 Characters sit above a baseline today, by construction. The next NPC play writes is the first evidence |

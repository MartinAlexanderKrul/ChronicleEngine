...
- **Engine Rules:** 0.2.0
- **Data Model:** 0.1.5
- **Campaign time:** 2026-08-09, approximately 19:30 CDT (`-05:00`)
- **Latest restorable checkpoint:** `saves/900_CHECKPOINT_0047/` — An apartment chosen, a rent split named, and a job with Owen's name on it.
...
- **Pending rewards:** Status Recovery ×10 only.
- **Daily streak:** 2, unchanged this session (no new daily-quest cycle fell within the session's timeframe).
...
- **Current location:** His own apartment, on the couch, ~19:30, Owen asleep against his shoulder.
- **Immediate obligations:** None outstanding tonight. The next daily quest issues at 06:00 on 2026-08-10.
...
- `OBJ-15`: the Rogers Park two-bedroom is chosen in principle but **unseen** — next action is arranging an actual viewing.
...
```yaml
trigger_telemetry:
  as_of: "2026-08-09T19:30:00-05:00"

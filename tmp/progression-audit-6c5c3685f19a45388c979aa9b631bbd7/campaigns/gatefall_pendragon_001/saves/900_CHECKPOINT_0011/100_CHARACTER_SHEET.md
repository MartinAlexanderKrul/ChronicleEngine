...
canonical_state:
  ...
  system_state:
    bearer: true
    profile_version: "1.4"
    profile_migration_event: EVT-000074
    ...
    pending_rewards:
      ...
      status_recovery: 1
      daily_random_box: 3
      note: "Profile 1.4 migration `EVT-000074` granted one unopened Daily Random Box for each of the four recorded completed dailies. The one pending Profile 1.3 daily bundle from 2026-07-28 separately became Ability Points +3 and one Status Recovery; its box is included in the original count of four. One box was opened `EVT-000075` (2026-07-28), yielding an E-grade Channeling Focus; three remain unopened. The Level 3 grant settled during migration; the Level 3→4 grant (`EVT-000076`) settled immediately on crossing per Section 3.2 — no level-up reward remains pending, only the three independent daily-reward types above."
    stats:
      strength: 22
      agility: 15
      vitality: 14
      ...
      intelligence: 16
    effective_stats:
      strength: "22 (base 22 + equipment 0)"
      agility: "24 (base 15 + equipment 9)"
      vitality: "17 (base 14 + equipment 3)"
      perception: "17 (base 17 + equipment 0)"
      intelligence: "16 (base 16 + equipment 0)"
    system_tier: E
    equipment:
    ...
    daily_quest:
      ...
      next_issue: "2026-07-29T06:00:00"
...
Alexander then read the battlefield on his own initiative for a tactical picture (Perception-governed, d100 40, net +1 — demonstrated capability edge offset by Ashfield's burn-haze obscuring sightlines — effective 60, partial success): burn-scarring density climbs steadily northeast of the party's position, a real directional lead toward wherever the boss and unlocated den structure are, but the same scarring intensifying rather than tapering suggests the terrain gets worse, not safer, approaching it — an unconfirmed but concerning implication, not a clean read. Alexander reported both the lead and its catch to Priya. As of this checkpoint, the crew is standing at the same position, elite dead, boss unencountered and unlocated beyond the northeast lead, remaining common-beast pack status unconfirmed (last known: Julian and Renata still working whatever was left of it), Priya wounded but on her feet, Owen uninjured with his kit unused. Priya has asked Alexander directly for the crew's next move — push northeast, fall back to regroup and treat Priya's wound first, or split someone off to run down the remaining pack — and is waiting on his answer. No further exchange has resolved past this point."

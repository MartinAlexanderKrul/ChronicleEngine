...
**Checkpoints:** 63 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0063`)
...
**Latest capture:** `900_CHECKPOINT_0063` — kind `manual`, profile 1.46 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0062`, source `EVT-000347`.

...
provenance:
  source: EVT-000546
  game_date: "2026-08-19T18:55:00-05:00"
...
moved_by_events: "**Every Event whose `participation_audits` claim it moved this record.** Decision 085 requires the record to *reference* such an Event; it has never required the record to *narrate* it, and `160_CAMPAIGN_CHRONICLE.md` narrates every one in full. This index exists so state fields can hold values while their reasoning lives where it is authoritative - citing and narrating are different obligations and only the first is cheap. Maintained at promotion.
  ...
  `EVT-000271` `EVT-000273` `EVT-000274` `EVT-000277` `EVT-000278` `EVT-000279` `EVT-000280` `EVT-000282` `EVT-000284` `EVT-000285` `EVT-000286` `EVT-000287` `EVT-000289` `EVT-000290` `EVT-000291` `EVT-000292` `EVT-000293` `EVT-000294` `EVT-000296` `EVT-000300` `EVT-000301` `EVT-000302` `EVT-000303` `EVT-000304` `EVT-000308` `EVT-000311` `EVT-000312` `EVT-000316` `EVT-000317` `EVT-000318` `EVT-000319` `EVT-000320` `EVT-000323` `EVT-000324` `EVT-000325` `EVT-000326` `EVT-000327` `EVT-000328` `EVT-000332` `EVT-000333` `EVT-000334` `EVT-000336` `EVT-000337` `EVT-000338` `EVT-000339` `EVT-000340` `EVT-000341` `EVT-000342` `EVT-000343` `EVT-000344` `EVT-000345` `EVT-000346` `EVT-000347` `EVT-000350` `EVT-000351` `EVT-000352` `EVT-000353` `EVT-000354` `EVT-000355` `EVT-000356` `EVT-000357` `EVT-000358` `EVT-000359` `EVT-000360` `EVT-000361` `EVT-000373` `EVT-000374` `EVT-000379` `EVT-000380` `EVT-000381` `EVT-000382` `EVT-000383` `EVT-000384` `EVT-000385` `EVT-000386` `EVT-000390` `EVT-000391` `EVT-000392` `EVT-000393` `EVT-000395` `EVT-000396` `EVT-000397` `EVT-000398` `EVT-000399` `EVT-000400` `EVT-000401` `EVT-000402` `EVT-000403` `EVT-000404` `EVT-000406` `EVT-000407` `EVT-000408` `EVT-000409` `EVT-000410` `EVT-000411` `EVT-000414` `EVT-000415` `EVT-000416` `EVT-000417` `EVT-000419` `EVT-000422` `EVT-000425` `EVT-000428` `EVT-000429` `EVT-000430` `EVT-000431` `EVT-000432` `EVT-000433` `EVT-000434` `EVT-000451` `EVT-000452` `EVT-000453` `EVT-000454` `EVT-000457` `EVT-000458` `EVT-000459` `EVT-000463` `EVT-000464` `EVT-000465` `EVT-000467` `EVT-000468` `EVT-000469` `EVT-000470` `EVT-000471` `EVT-000472` `EVT-000473` `EVT-000474` `EVT-000475` `EVT-000476` `EVT-000477` `EVT-000478` `EVT-000479` `EVT-000480` `EVT-000481` `EVT-000482` `EVT-000483` `EVT-000485` `EVT-000487` `EVT-000490` `EVT-000491` `EVT-000493` `EVT-000495` `EVT-000496` `EVT-000498` `EVT-000499` `EVT-000500` `EVT-000501` `EVT-000502` `EVT-000503` `EVT-000504` `EVT-000506` `EVT-000507` `EVT-000508` `EVT-000509` `EVT-000510` `EVT-000511` `EVT-000512` `EVT-000513` `EVT-000514` `EVT-000515` `EVT-000516` `EVT-000517` `EVT-000518` `EVT-000519` `EVT-000520` `EVT-000521` `EVT-000522` `EVT-000523` `EVT-000524` `EVT-000525` `EVT-000526` `EVT-000527` `EVT-000528` `EVT-000529` `EVT-000530` `EVT-000531` `EVT-000532` `EVT-000533` `EVT-000534` `EVT-000535` `EVT-000536` `EVT-000537` `EVT-000538` `EVT-000539` `EVT-000540` `EVT-000541` `EVT-000542` `EVT-000543` `EVT-000544` `EVT-000545` `EVT-000546`"

canonical_state:
  age: 25
  location: ENT-000087
  location_note: "Chicago, the Rogers Park apartment, 18:55 on 2026-08-19. `canonical_state.location` was stale at `ENT-000200` (the freight yard off Ashland, last correct as of the 2026-08-17 crew training) through the entire Class Quest span; corrected at `EVT-000536`. **The correction wrote the explanation into `location` itself**, replacing the typed reference with a quoted string — which breaks Decision 073 (*presence has exactly one structural owner… held as the typed Location reference*) and silently disabled `test_runtime_persistence_validation.ps1`'s P-01/P-02 fixtures, which read `^  location: ENT-NNNNNN$`. The field is restored to the typed form and the account it carried moved here, where narrating it costs the rule nothing."
  condition: |
      Health **333/520**, Mana **230/230, full** — **Level 30, System Rank B, 18:55 on 2026-08-19 (Wednesday)**, home at the Rogers Park apartment after four calls. Since the 16:35 anchor (`EVT-000541`-`EVT-000546`): a rift anchor set at the fenced warehouse (`ENT-000166`) under Silent Step and Keen Sense, natural 91 → effective 100, Legendary success — the Suppression Emitter tested deliberately and found a real undisclosed anomaly-sensing layer in the site's security, and the Gate Direction Finder read a live Gate signature inside the fence rather than mere secrecy. Reported to Rosalind Fenn, instructed to keep working paper only. Ada Reyes reached for work — an honest correction mid-call (natural 65, Success) surfaced a genuine C-Rank slot, which a canon-reconciliation ruling then confirmed as **Cicero Scar's reclaimed edge, under a standing BGM extraction permit** (`worlds/gatefall/210_PLACES.md` amended) — staging Thursday 2026-08-20, 06:00, accepted. Dale Pruitt: A-Rank correctly read as outside his contractor's reach; a roll for anything above routine C-Rank (natural 45, Partial success) surfaced a real, understaffed B-Rank lead, `OBJ-31` opened. Wade Bishop confirmed flatly that Ironline runs nothing at A-Rank, held the line under a skeptical push. Full detail: `160_CAMPAIGN_CHRONICLE.md` `EVT-000541`-`EVT-000546`.
  ...
  system_state:
    ...
    mana: "230/230"
    world_clock:
      last_ticked: "2026-08-19T14:05:00-05:00"
      next_tick: "2026-08-20T06:00:00-05:00"
      note: "**Section 9.1's daily world tick, authored at Profile 1.73** (`F-034`). At each 06:00 in-fiction day boundary the Runtime rolls the world **independently of the Bearer and before anything he does**: Gate count (Chicago `1d4+3`), each Gate's true Rank, **rarity every time** rather than when a scene wants one, Section 9.10 board timers and breaks, posting regeneration, and agenda initiations. **Each Gate and break is sited `d100` against his recorded day — `01-10` on his route, `11-30` within reach, `31-00` elsewhere — so proximity is an input rather than a veto.** Results are binding, including inconvenient ones. **A `last_ticked` behind the most recent day boundary at or before `campaign_time` is a readiness finding**: the world has not been run. Initialised at the 1.73 migration to the current anchor; **no Gate, break, posting or agenda advance is back-dated** for the ninety days played before the tick existed. **First tick falls 2026-08-20 06:00**, the same instant as the twenty-seventh daily and the Daily Premium rotation."
    temporal_state:
      campaign_time: "2026-08-19T18:55:00-05:00"
      mana_recovery_mode: resting
      mana_recovery_remainder_units: 0
      health_recovery_mode: resting
      health_recovery_remainder_units: 5640000
    ...
    skills_known:
      ...
      - "Keen Sense [A-Rank] ★★★☆☆ Adept · Mana 2 · +1 modifier step on detection **for the scene**, shared with **himself plus 7 allies** (8 subjects — A-Rank Adept computes `3 + 4 = 7` and **`scope_floor` 8 holds it at 8**; the ascension bought the category, not the count). Categories: **presence** (E); **intent and method** (D); **structure through barrier** (C) — the layout and extent of an unseen space beyond line of sight; **through concealment** (B) — pierces an *active* concealment effect or detection-blocking ward; **Provenance** (A) — the recent past of what he detects reads as clearly as its present: what passed through a place, how long ago, and which way it went. **Uses 67 · scenes 48 · mastery progress 2/3 toward Expert · ascensions 4 · scope_floor 8.** **A second qualifying scene at `EVT-000541`** — active alongside Silent Step at the fenced warehouse, materially distinct from the Prykowski stakeout (different site, different declared method). **A qualifying scene at `EVT-000539`** — the Section 8.4.5-adjacent Prykowski stakeout, Provenance read on the site's delivery history, a genuine contested detection use. **The withheld breakthrough was taken at `EVT-000524`**, System Rank B having lifted the ceiling exactly as this line predicted. **Mana 1 → 2** — the mastery reset undoes Section 7.4's -10%-per-level discount (`2 × 0.9² = 1.62`). **Advanced Expert → Master at `EVT-000419`; scope 7 → 8, Mana holds at 1.** **Now at Master *and* at its Rank ceiling simultaneously — Section 7.5 withholds the breakthrough rather than offering it**, recorded not silent, ascension-ready the instant System Rank reaches B at level 30. Three breakthroughs; full ascension and per-use history in `160_CAMPAIGN_CHRONICLE.md`."
      ...
      - "Sprint [D-Rank] ★★★☆☆ Adept · Mana 2 · +1 modifier step on movement, pursuit, and distance-closing actions, **for the whole scene** — Section 7.2 saturates duration at one Rank above native and D is one above E, so the window is Rank-derived and no longer mastery-derived. Category: **Broken ground** (D) — the step holds across footing that would otherwise demand its own check: rubble, ice, slick or shifting surfaces, moving debris. **Successful uses 13 · qualifying scenes total 12 · mastery progress 0/3 toward Expert · rank ascensions 1.** **Advanced Expert → Master at `EVT-000518`, then breakthrough E-Rank Master → D-Rank Adept at `EVT-000524`.** **The unauthored Master duration rung is retired rather than answered** — Rank saturates the window at D, so it can never bind. +1 use / +1 scene closing on the last two commons in the first Crypt dungeon (`EVT-000428`)."
    ...
    tracked_counters:
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 67 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 48 }
      ...
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 65 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 33 }
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 11 }
      ...
      - { path: skills.sprint.rank_ascensions, baseline_value: 0, baseline_as_of: EVT-000158, current_value: 1 }

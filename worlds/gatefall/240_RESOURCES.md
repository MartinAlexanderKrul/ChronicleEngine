...
canonical_state:
  ...
  price_table: "System shop sell (gold, Section 12.5), E-Rank/D-Rank/C-Rank/B-Rank/A-Rank/S-Rank: weapons 100/450/2,000/9,000/40,000/180,000 g; armor pieces 60/270/1,200/5,400/24,000/108,000 g; accessories 80/360/1,600/7,200/32,000/144,000 g. Rank-bearing Daily Premium offers cost 125% of their ordinary same-Rank category anchor, rounded upward to whole gold."
```
...
**Skill Rank ascension.** Instruction is no longer a one-time teaching. A rune teaching a technique the Bearer already knows, at a Rank above his current one, **ascends** that skill to the item's Rank and resets its mastery to Novice; a skill reaching Master mastery is instead offered a free **breakthrough** of one Rank, settling at Adept (`206` Section 7.5). Both are offers showing exact before-and-after values, and neither consumes an item nor settles unless accepted. No skill may exceed the Bearer's **System Rank + 1**, a ceiling binding acquisition as well as ascension — instruction above it does not consume and waits intact. The catalogue therefore stocks a rune for a skill at every Rank from its native Rank to that ceiling, and for a known skill only above its current Rank.

**Instructional binding.** Runes remain transferable physical goods, but their consumption eligibility is immutable and follows provenance (`206` Section 7.1). Profile 1.118 folded the former rarer "skill book" tier into the ordinary Skill Rune — one item, taught at its source's own Rank (`206` Section 11.3, `migrations/1.117_to_1.118.md`). Ordinary catalogue and Daily Random Box instruction is Bearer-bound. Daily Premium, public-Gate boss, instant-dungeon, Runic-Key, and future authored found/world instruction is unbound for already-awakened recipients unless explicitly authored otherwise. Mastery instruction is Bearer-bound; authored class instruction is class-bound. Complete holdings preserve the taught technique, teaching Rank, binding, provenance source kind/event, and unused status through every transfer.
...
| Selected skill rune (E/D/C/B/A/S-Rank) | 1,000 / 4,500 / 20,000 / 90,000 / 400,000 / 1,800,000 g |
...
aliases:
  - name: "System-shop consumables"
    quality: current
canonical_state:
  description: "Healing and Mana potions, antidote, appraisal scroll, stabilization seal, ranked key, selectable skill rune at any Rank from its native Rank to the Bearer's System Rank + 1, and stat elixir sold by the System shop for gold; the interface is reachable only by the Bearer. A 06:00 Daily Premium rotation guarantees one expiring quantity-one offer in all six shop categories."

...
provenance:
  source: EVT-000746
  game_date: "2026-08-26T13:30:00-05:00"
...
canonical_state:
  ...
  system_state:
    ...
    title:
      ...
      - The Unmeasured
      - Giantslayer
    title_note: "**Cartographer swapped for Prospector at `EVT-000553`, 2026-08-20 06:00, before the Cicero Scar mining assignment** — free and instant per Section 16.3; Cartographer's archetype-reveal is inert outside a Gate, Prospector's +2-crystals-per-deposit is directly on-point for harvest work. Cartographer is earned and now unequipped. **Superseded loadout history compressed at `EVT-000653`** — the Centurion/Ascetic swap (`EVT-000535`), the `EVT-000444` correction, and the Untouchable/Ascetic swap are held in full by `160_CAMPAIGN_CHRONICLE.md` and `170_CHANGELOG.md`. Live loadout is the four names in `title` above."
    titles:
      last_assessment: 90
      next_assessment: 100
      catalog_size: 32
      slots: 7
      slots_note: "**Profile 1.100 adoption (§16.4) corrected this: seven passed, not five** — levels 10/20/30/40/50 plus a sixth at the level-60 assessment and a seventh at 80, both already passed at `last_assessment: 90`. Re-settled this session (`EVT-000736`) against the checkpoint's stale `slots: 5`. **15 titles earned, 5 equipped, 2 slots open.** Godslayer remains unequipped by owner choice — its passive renders nothing he can't already infer. The second catalog (§16.4, 11 further entries) was re-tested against the whole record at the 60/70/80/90 assessments by owner ruling; only **Proven** [Ascendant] passed, at 60. Prior slot history: `170_CHANGELOG.md`."
      points_granted: 50
    ...
    titles_catalog:
      ...
      unearned_count: 7
      unearned_note: "Seven unheld, not rendered to the Bearer (Section 16.1). **Common:** Red Survivor — **`GB-14` entered and cleared this session (`EVT-000743`)**, criterion likely now satisfied; the System stays silent on it until the level-100 assessment tests the whole record (§16.1). Break-Breaker (`EVT-000270`). **Rare:** Deathless (streak restarted `EVT-000340`), Executioner (frozen ~20-25/50, System Rank S is the ceiling, nothing can stand above it), Warden (5/10, every clear since solo), Wellspring (no expenditure has approached twice his pool). **Singular:** Unbroken (streak 18/100). **Godslayer granted `EVT-000726` and Vanguard at `EVT-000591` both corrected off this list**, Vanguard's stale entry retired at this save."
    level: 96
    xp: "5817/9600"
    health: "16112/16112"
    mana: "8399/8414"
    ...
    temporal_state:
      campaign_time: "2026-08-26T13:30:00-05:00"
      mana_recovery_mode: resting
      mana_recovery_remainder_units: 0
      health_recovery_mode: resting
      health_recovery_remainder_units: 0
      note: "**Settled through `EVT-000746`, anchor 2026-08-26 06:00 -> 13:30.** The GB-14 incident-response callout in full: woke to the crisis, confirmed true Rank S via Flux Sight, cleared the entire population solo (eleven commons, two elites, one boss, zero exchanges reaching the ledge), rescued and fully healed two survivors, recovered ten dead, pledged auction proceeds, debriefed with Farraday (compensation and emergency-contact terms amended), returned home, completed the thirty-first daily, rotated a fresh Daily Premium cycle and bought the Crystal Key. Health never left cap throughout — no hit landed on him. Three level-up crossings (94/95/96) restored both pools to their new maxima each time; current standing **16,112/16,112** and **8,399/8,414**, the latter carrying 15 Mana of ordinary post-combat spend since the last restoration. Full history: `170_CHANGELOG.md`."
    quiet_days: 0
    ...
    unspent_points: 20                     # was 0; +5 at each of levels 94/95/96 (EVT-000740-743) = +15; +5 from the second-catalog Proven title at the level-60 assessment, re-run this session (EVT-000736); unallocated
    pending_rewards:
      ability_points: 16
    ...
    stats:
      ...
      intelligence: 4207
    effective_stats:
      strength: "4276 (base 4256 + equipment 20)"
      agility: "4004 (base 3945 + equipment 59)"
      vitality: "4028 (base 4027 + equipment 1)"
      perception: "3951 (base 3946 + equipment 5)"
      intelligence: "4207 (base 4207 + equipment 0)"
      note: "**2026-08-26, LEVEL 93 → 96 across the GB-14 clear** (`EVT-000740`-`EVT-000743`): +63/Stat at each of three crossings, +189 total automatic, no points allocated this span (5 unspent, unallocated, carried in `unspent_points` below). Equipment unchanged. **Max Health 15,356 → 16,112**; **max Mana 8,036 → 8,414**.
 ...
 **Prior crossings compressed** — every level-up and Stat movement through checkpoint 0123 is held in full by `160_CAMPAIGN_CHRONICLE.md` and `170_CHANGELOG.md`. **Load-bearing values live in `stats`, `effective_stats`, `tracked_counters` and `pending_rewards`, not in this note.**"
    system_rank: S
    equipment:
      main_hand: "Finished dagger [S-Rank] — Quickknife chassis, all-Agility · Agility +22, power 22 · **chassis ×1.85** re-derived at Dagger Mastery's [S-Rank] Novice rung (0.10 + 0.25×4 Rank, `EVT-000736`) · **DMG 7,951 standard** at eff. Strength 4,276, `(4276+22)×1.85=7951` · armed strike ×0.75 · recovered `EVT-000326`. **Not owned in any ordinary sense** — held rather than owned, a live Section 19 exposure risk."
      off_hand: "**Quickknife [S-Rank], Boss-Imprinted (Predator/Edge)** — Agility +23, power 22 · same ×1.85 chassis, **DMG 7,953 standard** at eff. Strength 4,276 · armed strike ×0.75 · Edge Echo, once/scene · Weathered finish · eight-dungeon batch boss 4 (`EVT-000731`). **EQUIPPED `EVT-000733`**, displacing a plain S-Rank Quickknife (`EVT-000730`), banked unsold, as is the earlier-retired Ghost Quickknife [A-Rank]."
      ...
      accessory_1: "**Warded Vambrace [A-Rank]** — Good · **no Stat line** · **once per exchange, a landed hit against Alexander takes −30% damage (multiplicative with worn reduction)** · bought from Walt Adamik 2026-08-11 for $2,200 of a $5,200 pair (`EVT-000280`). **EQUIPPED at `EVT-000385`**, unmoved this span — considered and deliberately not swapped for the looted Heartward Sigil [S-Rank] (`EVT-000731`), the Vambrace's proc judged worth more than a stat-line accessory at this scale."
      accessory_2: "**Warded Vambrace [A-Rank] (second)** — Good · **no Stat line** · **once per exchange, a landed hit against Alexander takes −30% damage (multiplicative with worn reduction)** · bought back from Walt Adamik for $3,000 on 2026-08-20 and **EQUIPPED at `EVT-000565`**, unmoved this span for the same reason as accessory 1. **Two vambraces run as two independent once-per-exchange procs**, each composing multiplicatively over the other and over worn reduction."
      total_physical_reduction: "**≈63.04%** (Coif [S] 23%, Torso [B] 12%, Gauntlets [C] 8%, Legs [S] 23%, Feet [S] 23%, multiplicative) as of `EVT-000730` — up from ≈51.45%. Torso/hands kept below S to preserve their Echoes; a full sweep reaches ≈72.93% but costs both. Echoes: Impact (torso), Edge (hands/off-hand), Guard (feet) — one per scene. Vambrace −30% is separate."
    skills_known:
      ...
      - "Rupture [S-Rank] ★★★★☆ Expert · Mana 11 · **reach 5 m** · a heavy strike at **×2.90 of its skill-rank baseline** (S-Rank baseline 1000, Section 7.2), resolving as `(1000 + effInt + focus power) × 2.90 × result` under §6.2 — **DMG ≈15,183 standard before reduction** at effective Intelligence 4,207, `(1000+4207)×2.90=15,110`. **`magnitude_floor` 290 binds.** Categories unchanged: **Compound** (D); **Structural** (C); **Ward-breaking** (B); **Propagating** (A); **`Unmaking`** (S) — ignores worn physical reduction entirely. **Successful uses 145 · qualifying scenes total 46 · mastery progress 1/3 toward Master · mastery level EXPERT (4) · rank ascensions 5 · magnitude_floor 260.** +1 use / +1 qualifying scene at `EVT-000741` — the GB-14 pack kill (Propagating double-kill), first qualifying credit under the S-Rank/Red-gate contest-test amendment (`EVT-000736`). `F-046`'s twenty-settlement `none` streak broke this session."
      - "Flash Step [S-Rank] ★☆☆☆☆ Novice · Mana 8 (native D) · **reach: line of sight, or a place he holds a live read of** — no metre band at any Rank. +1 step to the follow-up; duration saturated at first Rank above native, permanent. **`Twice`** (S) — the step may be taken a second time in one exchange. Rune-ascended [A]→[S] `EVT-000729`; re-derived `EVT-000736`. **Successful uses 86 · qualifying scenes total 31 · rank ascensions 4 · mastery progress 1/3.** +2 uses / +1 scene: closing to the survivors (`EVT-000740`), then the boss-kill follow-up (`EVT-000742`)."
      ...
      - "Twin Fang [S-Rank] ★☆☆☆☆ Novice · Mana 6 · follow one Quickknife strike with a separately rolled strike from the other in the same action, each on its own weapon power. Follow-up multiplier **×2.40** (1.00 + 0.35×4 Rank above native). Category `Both fangs` (B) still holds. Rune-ascended [B]→[S] `EVT-000729`. Re-derived `EVT-000736`. **Successful uses 139 · scenes 32 · ascensions 4 · mastery progress 1/3.** +1 use / +1 qualifying scene at `EVT-000743` — killed the GB-14 boss outright, first S-Rank content it has ever landed against, credited under the S-Rank/Red-gate contest-test amendment."
      ...
      - "Silent Step [S-Rank] ★☆☆☆☆ Novice · Mana 3 (native E-Rank base) · +1 modifier step on stealth and unseen-approach actions for the scene. Scope Rank-derived — **9 beneficiaries**, `scope_floor` 9. Category **`Concealment through action`** (D) held; **`Unremembered`** (S) — perception of him doesn't consolidate; a witness retains no usable account once the scene ends. Rune-ascended [D]→[S] at `EVT-000729`. Re-derived `EVT-000736`. **Successful uses 49 · qualifying scenes total 26 · rank ascensions 2 · mastery progress 1/3.** +1 use / +1 qualifying scene at `EVT-000742`, covering the GB-14 pack ambush volley."
      - "Mana Bolt [S-Rank] ★☆☆☆☆ Novice · Mana 5 (native E) · **no distance limit; a DETECTED but unseen target is legal** · `(1000 + effInt + focus) × 1.75 × result` (§6.2) — **corrected onto the S-Rank baseline this session**, the stale B-Rank 150 and unauthored ×1.90 both resolved: **DMG ≈9,112** at eff. Int 4,207. **`magnitude_floor` 175 binds.** **`Split`** (S) held. Re-derived `EVT-000736`. **Successful uses 90 · qualifying scenes total 23 · rank ascensions 3 · mastery progress 2/3.** +2 uses / +2 scenes: the elite kill (`EVT-000741`) and the Split triple (`EVT-000742`)."
      ...
      - "Dimensional Projection [S-Rank] ★☆☆☆☆ Novice · Mana 6 · withdraw owned portable objects and launch at perceived targets as a named multi-strike (§6.2), one strike per projectile, Agility to hit. **5 projectiles** (1 mastery + 4 Rank), **range 21 m** — the authored S-Rank Novice range is 17 m (5 + 3×4) and **`magnitude_floor` 21 binds over it**, so ascension costs no reach. The floor was never written at the `EVT-000729` ascension and read 0 until it was reconstructed from checkpoint 0122's pre-ascension line ([C-Rank] Expert, 5 projectiles, 21 m) and repaired. `Recall and launch` (D)/`Held read` (C) held; **`Volley`** (S). Re-derived `EVT-000736`. **Successful uses 29 · qualifying scenes total 18 · rank ascensions 2 · mastery progress 2/3.** +2 uses / +2 scenes: two volleys (`EVT-000741`, `EVT-000742`)."
      - "Sprint [S-Rank] ★☆☆☆☆ Novice · Mana 3 (native E-Rank base) · +1 modifier step on movement, pursuit, and distance-closing actions, **whole scene** — saturated at D and stays saturated. Categories held through S: **Broken ground** (D), **Vertical** (C), **Terrain denied** (B), **`No ground needed`** (S) — open air resolves as ground for its duration. Rune-ascended [B]→[S] at `EVT-000729`. Re-derived `EVT-000736`. **Successful uses 29 · qualifying scenes total 21 · rank ascensions 4 · mastery progress 1/3.** +1 use / +1 qualifying scene at `EVT-000740`, closing to Marta and Devon through the flooded gallery."
    ...
    tracked_counters:
      ...
      - { path: skills.rupture.successful_uses, baseline_value: 16, baseline_as_of: EVT-000130, current_value: 145 }
      - { path: skills.rupture.qualifying_scenes_total, baseline_value: 8, baseline_as_of: EVT-000130, current_value: 46 }
      ...
      - { path: skills.broken_rhythm.successful_uses, baseline_value: 0, baseline_as_of: EVT-000308, current_value: 98 }
      - { path: skills.broken_rhythm.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000308, current_value: 12 }
      ...
      - { path: skills.twin_fang.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 139 }
      - { path: skills.twin_fang.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 32 }
      ...
      - { path: skills.mana_bolt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 90 }
      - { path: skills.mana_bolt.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 23 }
      - { path: skills.mana_bolt.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000304, current_value: 2 }
      - { path: skills.mana_bolt.mastery_level, baseline_value: 1, baseline_as_of: EVT-000303, current_value: 1 }
      ...
      - { path: skills.sprint.successful_uses, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 29 }
      - { path: skills.sprint.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 21 }
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 49 }
      - { path: skills.silent_step.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 26 }
      ...
      - { path: skills.dimensional_projection.successful_uses, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 29 }
      - { path: skills.dimensional_projection.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 18 }
      - { path: skills.dimensional_projection.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 2 }
      - { path: skills.dimensional_projection.mastery_level, baseline_value: 1, baseline_as_of: EVT-000436, current_value: 1 }
      ...
      - { path: skills.twin_fang.mastery_level, baseline_value: 2, baseline_as_of: EVT-000158, current_value: 1 }
    ...
    gold: 45061681  # authoritative figure lives in 120_INVENTORY_AND_OWNERSHIP.md's Current Funds; this is a citation. 46,186,681 -1,125,000 (Crystal Key, Daily Premium, EVT-000746) = 45,061,681
    inventory:
      ...
      keys:
        - "**Crystal Key [S-Rank] × 1** — Daily Premium, Crimson series, bought 1,125,000 g (`EVT-000746`). Instant-dungeon key; mining treats the 3d6 result as 18. Banked, unused."
        - "**Instant-Dungeon Key [S-Rank] × 2** — the seventh and eighth bosses' own drops off the eight-dungeon batch (`EVT-000731`, 🎲 d100 89 and 🎲 d100 83). Free, off two bodies each already worth 900,000 g to meet. Banked, unused. (The prior S-Rank key — the Shattered City boss's drop — was spent opening the Hive instant dungeon at `EVT-000722`.)"
      ...
      custody:
        ...
        - "**Seer's Lens [D-Rank] x2** -- held by **Priscilla Nakamura** since **2026-08-22** (`EVT-000640`, `EVT-000641`). **Ends on:** the fusion resolving at Wednesday's standing session. Section 12.10 takes both out of play for the working's duration; frame and donor nominated irreversibly."
      materials:
        - "**Mana Crystal [S-Rank] x 498** — was 100; **+398 this session** off GB-14 (`EVT-000744`): 14 beast-drop (11 commons, 2 elites, the boss, one each) plus **384 mined** (🎲 3d6 -> 12, ×32 S-Rank multiplier). **300 of the 498 are earmarked for the pledged crystal/core auction** (`OBJ-40`, see `140_OBJECTIVES.md`) and are not available to the ordinary shop-sell or fusion economy until that resolves; the remaining 198 are unencumbered. Prior span total: 4,945 mined and looted, 4,945 sold, net zero against the held-back 100."
        - "**Beast Core [S-Rank] x 43** — was 40; **+3 this session** off GB-14's two elites and its boss (`EVT-000744`). All three are also earmarked for the pledged auction alongside the 300 crystals above. Shop refuses cores."
        ...
        - "Beast Core [D-Rank] x35 — was 22; **+13 from the five D-Rank instances** (`EVT-000616`). **Shop refuses cores (Section 12.5)** — artificer stock, not gold. Banked, unsold."

...
canonical_state:
  ...
  want: "**Unauthored** - no contact has occurred and her own stake is unestablished. What her role implies rather than establishes: a client who comes out of a press cycle with his own account intact."
  fear: "Unauthored."
  secret: "Unauthored."
  voice: "Unestablished by contact - no line of hers has been narrated."
  agenda: "**Pending rather than active.** The only thing owed here is the introduction itself: Kesha Morrison committed to passing Alexander's contact and having Marguerite ring him **by end of day 2026-08-24** (`EVT-000692`). Until that call happens she is a name and a referral, and her own agenda is unauthored because nothing in canon has given her one."
```

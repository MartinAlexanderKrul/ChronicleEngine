...
**Version:** 0.1 (World Rule Profile 1.125)
**Engine Compatibility:** Chronicle Engine 0.2.0; Data Model 0.1.6; Gatefall World Rule Profile 1.125
**Created:** 2026-07-22
...
- `270_THE_FAR_SIDE.md` — **Owner-only, and not for players.** The place behind the Gates, reachable solely by Profile Section 18.13's far door at level 100: five authored strata of the seed-library every Gate is cut from, the law that governs them (nothing there carries a Rank; mana saturation is the clock on every expedition), and the failed champions of worlds that lost the same exam Earth is sitting. Written to be consistent with `200_WORLD_BIBLE.md` Section 9 and never to restate it — do not open it looking for spoilers

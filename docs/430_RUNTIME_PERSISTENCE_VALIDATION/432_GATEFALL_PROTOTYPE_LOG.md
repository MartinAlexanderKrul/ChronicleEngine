...
**Checkpoints:** 111 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0111`)
...
| frozen | 0009–0111 | 103 |

**Latest capture:** `900_CHECKPOINT_0111` — kind `session-save`, profile 1.86 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0110`, source `EVT-000632`.

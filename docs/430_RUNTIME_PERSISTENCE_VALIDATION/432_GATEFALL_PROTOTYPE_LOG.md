...
**Checkpoints:** 123 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0123`)
...
| frozen | 0009–0123 | 115 |

**Latest capture:** `900_CHECKPOINT_0123` — kind `session-save`, profile 1.100 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0122`, source `EVT-000735`.

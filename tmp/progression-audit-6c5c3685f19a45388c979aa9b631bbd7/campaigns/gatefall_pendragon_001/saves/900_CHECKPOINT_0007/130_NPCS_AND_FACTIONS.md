...
canonical_state:
  ...
  situation: "Running the 2026-07-26 C-grade harvest-element job (confirmed grade, archetype Frozen Gallery) that Alexander signed onto through Kesha Morrison. Already knew his name and reputation as a reliable cutter from Ada Reyes's word passed through the contractor. Briefed him and the harvest crew at staging, then assigned him a first vein, a second richer one near a chamber edge, and a third, deepest vein near the strike line's flank (`EVT-000065`, `EVT-000066`, `EVT-000067`). Granted a first short break on request without suspicion, then — reading a deliberately performed exhaustion as genuine overexertion — pulled Alexander off the third vein for a mandatory fifteen-minute break, out of care rather than doubt. Later crossed the chamber directly and challenged him outright after a much longer, more visible stillness (the 50-crystal sale) — the first time genuine suspicion, not casual concern, was directed at him. Accepted Alexander's explanation (that reading a vein takes the same still focus as reading his own status window) but has been visibly more watchful since, giving his section a wider berth on subsequent rounds. Relayed the strike element's boss kill to the harvest crew and opened the declaration queue at the Gate mouth. Unaware of any of the five private System-shop sales Alexander has made, or of the tactical study Alexander made of the strike line during his enforced break."
```
...
state: "Two jobs completed or in progress: the Cicero Scar C-grade clear (2026-07-25, `EVT-000063`) — 7 declared C-crystals, ≈$5,700 harvest share pending — and the Frozen Gallery C-grade clear (2026-07-26, boss killed, clear window open, not yet exited, `EVT-000065`–`EVT-000067`), staffed by a different site coordinator (Dale, `ENT-000135`) who already knew Alexander by reputation from Ada Reyes. Three vein assignments worked at the Frozen Gallery, the third to genuine exhaustion: 91 crystals currently held in the declarable count pending formal declaration and exit; five separate sales (98 crystals total) sold privately through the System shop across the job and never entered this contract's declared pool — undeclared theft under the standard support-contract terms (Profile Section 13.2), unknown to Dale or the contractor despite Dale's heightened wariness after the largest sale drew his direct (successfully deflected) suspicion. No standing contract beyond a per-job basis; each job is taken individually through Kesha Morrison at the Coalition desk."

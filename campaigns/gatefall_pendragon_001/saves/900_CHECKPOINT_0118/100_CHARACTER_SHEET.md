...
provenance:
  source: EVT-000679
  game_date: "2026-08-23T09:52:00-05:00"
...
canonical_state:
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-23T09:52:00-05:00"
      mana_recovery_mode: active
      mana_recovery_remainder_units: 0
      health_recovery_mode: light
      health_recovery_remainder_units: 0
      note: "**Settled through `EVT-000679`, anchor 04:42 -> 09:52.** Active 04:42-05:10 (11 Mana spent against Conduit [S]); resting 05:10-09:40 (asleep, deficit closed, no damage at cap); active 09:40-09:52. Both pools close **3,008/3,008** and **1,512/1,512**. Full history: `170_CHANGELOG.md`."
    ...
    pending_rewards:
      ability_points: 0
      ability_points_claim_note: "`EVT-000665`: claimed at **+4** (Ascetic, at claim). Pending from `EVT-000605` and never written here; player-caught, ruled owed. Status Recovery was already inside the 20."
      ...
      status_recovery: 20
      daily_random_box: 0                  # opened at `EVT-000665` (1 -> 0), repaired from a stale 0
      unresolved_gate_loot: "**Fully resolved.** Nothing outstanding. Full history: `160_CAMPAIGN_CHRONICLE.md`."
      latest_settlement: "**2026-08-22 (`EVT-000605`): the thirtieth daily's regimen completed** (streak 14 → 15) — run and calisthenics closed en route to Ashfield staging. Three rewards created pending and **none claimed this span**: Ability Points +4 (Ascetic equipped), one further Status Recovery, one further Daily Random Box. Prior: **2026-08-20 (`EVT-000553`): the twenty-seventh daily's three rewards settled.** AP **+4** all to Vitality — base 126 → 130, effective 131, `maximum_health` re-derived 508 → **524**, filled from cap. Status Recovery **18 → 19**, unclaimed. Box opened standard (streak 13, not a multiple of seven): 🎲 d100 **81** → ranked gear at System Rank B; 🎲 d3 **1** → weapon, 🎲 d7 **1** → **Quickknife [B-Rank]**, Agility +11, power 11, Excellent, unbound — banked. Prior settlements: `160_CAMPAIGN_CHRONICLE.md`."
    ...
    tracked_counters:
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 99 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 68 }
    ...
    inventory:
      ...
      consumables:
        ...
        - "**Skill Rune — Mend [D-Rank]** — boss drop, first D-Rank instance (`EVT-000616`). **`unbound-awakened`, NPC-eligible.** Inert to Alexander (Mend at [A-Rank]). Resale 2,250 g; unsold."
        ...
        - "**Elixir of a stat x2** — was 1; **+1 from the fourth D-Rank instance** (`EVT-000616`). +1 base stat permanent, max 3 lifetime per stat for the Bearer, uncapped on another awakened (Section 12.5.1). **Owner ruling: the stat is fixed at consumption, not purchase** — both banked unassigned. Resale 2,500 g each."
      special:
    ...
    daily_quest:
      streak: 15
      last_completed: "2026-08-22"
      last_failed: "2026-08-07"
      active: true
      note: "**Twenty-eighth daily issued 2026-08-23 06:00** (`EVT-000678`, the world tick's coupled boundary event), streak still 15 pending this one's own completion or failure. Objectives 0/100 push-ups, 0/100 sit-ups, 0/100 squats, 0/10 km run — none started as of 09:52. Reward Ability Points +4 (Ascetic equipped), one Status Recovery, one Daily Random Box. Deadline 2026-08-24 00:00 local. Full streak history back to the fourteenth's deliberate failure: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures."
      current_quest: "The twenty-eighth, active, 0/100 across all three counted exercises and 0/10 km, issued this checkpoint. Twenty-fourth and twenty-fifth daily detail (superseded, historical): `160_CAMPAIGN_CHRONICLE.md` `EVT-000445`, `EVT-000463`."

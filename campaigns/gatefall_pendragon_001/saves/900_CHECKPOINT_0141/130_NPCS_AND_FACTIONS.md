...
canonical_state:
  ...
  condition: "Structural shell and power intact, built for staffed access (doors, interior monitoring already installed). Purchase price $2,800,000 (internal federal transfer via Sorcha Bellweather's office, `EVT-000900`). Usable immediately in its current staffed-facility-grade form; not yet fail-closed."
...
canonical_state:
  ...
  contents: "A bounded portion of the Ninth Quiet library, materialized `EVT-000800` for study — the full library does not fit (established at roughly 40-50 m of stack-depth across several times this bay's footprint) and the rest stays in the dimensional inventory. Nothing else stored here yet."
...
A CONSULT-controlled artificer, tailed from Loomis Street's fourth floor to a storage unit on the near west side on 2026-08-25 (`EVT-000707`-`EVT-000709`). **He has never seen Alexander and does not know he exists.** Identified entirely from a lifted wallet.
...
aliases:
  - name: "Peter Kwiatkowski"
    quality: current
canonical_state:
  rank: "**D-Rank per his own BGM card, read by Flux Sight at `EVT-000709`.** No combat rating on file. Health and Mana both intact, no injury - whatever CONSULT does to makers who cross its threshold has left no mark on this one."
  location: "Last seen walking north from Ironclad Self Storage (`ENT-000230`) on foot, 2026-08-25 ~09:20. **A residential address on the near northwest side is on his BGM ID**, in Alexander's possession."
  condition: "Physically unharmed. Badly frightened, and the fear is specific rather than general - he has just worked out what `COMPLETE` means and been told, politely, that the conversation about his own safety is over."
  ...
  knowledge: "**He does not know Alexander Pendragon exists.** No sighting, no name, no channel of any kind - he was tailed under Silent Step from Loomis Street to the storage unit and back out, and both thefts resolved without contact registering. **He knows only that his satchel vanished from his own grip in the street**, that he cannot explain how, and that he has to account for it to D on Thursday.\n\n  What he does know, from his own position inside CONSULT: that the arrangement requires clients to believe the work is his hand start to finish; that his own work was being assessed on 2026-08-25 by someone bored with how well it always goes; that the ledger's `COMPLETE` entries mark a pattern; and that a margin note reads `2nd time this qtr. Flag for D.` **He worked out the pattern himself and asked D directly whether he was safe.** He has no channel to anything on the Profile 14.4.1 register, to Marnie by name, or to what the earrings on that shelf were."
  want: "**To be told he is safe, by someone who would actually know.** He asked D outright - *'How many of these are there. I need to know if I'm actually safe here'* - and got a deflection and a deadline instead. Underneath it: to keep the work, because the work is the only thing about his position that is genuinely his."
  fear: "**That `COMPLETE` is about to have his name beside it.** He is not afraid of losing the satchel; he is afraid of what a man who keeps a quarterly manifest does about an asset who has become a problem, and he has just learned that decision has been made twice this quarter already."
  secret: "**He is now missing a satchel and a wallet he cannot explain, and has reported only the satchel.** The wallet went after the call. **Known to:** nobody. He has not noticed the second loss yet."
  ...
  beliefs:
    ...
    - claim: "The satchel was stolen by an ordinary thief who got lucky."
      ...
      accuracy: false
      since: EVT-000708
  agenda: "**Active; advances on the clock.**\n\n  - **He owes D an accounting on Thursday** and has nothing to bring. The instruction was *'Bring the satchel Thursday and we'll talk about what actually happened to it'* - and the satchel is gone.\n  - **Ordinary CONSULT commission work**, assessed periodically at Loomis Street's fourth floor.\n  - **He will discover the wallet missing** whenever he next reaches for it, and has no reason to connect it to the satchel."
  situation: "**First and only appearance, 2026-08-25 (`EVT-000707`-`EVT-000709`).** Observed under an assessment behind a keypad door on Loomis Street's fourth floor - his work walked through from the seating rather than the finish, by a conductor who already knew the answers. Left rattled, carrying the satchel. **Robbed twice in forty minutes without ever knowing anyone was there**: the satchel from his grip mid-stride in the street, the wallet from his back pocket while he worked a storage-unit door. Between the two, he found the ledger's pattern, texted D about his own safety, and was told he was overthinking a filing note.\n\n  **He is a live lead rather than an antagonist.** He is the only member of the CONSULT operation whose name, Rank, address and fear are all established - and the only one who has already proven he will ask the dangerous question out loud when frightened enough."
```
...
canonical_state:
  ...
  agenda: "**Two listings sourced, neither purchased this span** (`EVT-000808`). The Milwaukee property was the one actually visited; Alexander's Keen Sense demonstration against a reinforced door damaged it, $40,000 compensation paid, no purchase made. The Halsted listing remains unvisited."
...
state: "**`OBJ-54` open and active.** She is reaching out to Lukas Reinhardt (in, engaged) and Camille Aubrac (interested, wants in-person contact first) on Alexander's behalf. No commitment past that; nothing scheduled forward yet."
...
history: "Formed 2026-09-04 (`EVT-000841`), a phone call ahead of the Karlov Guild meeting; deepened the same day at the meeting itself and that evening at a Prague bar (`EVT-000842`-`EVT-000843`)."
```
...
state: "**`OBJ-54` open and active.** Kane is a real committed member, not merely a contact. Sparring taken up in person at Blue Island — his own `Standfast` tested three ways, one break, one structural failure, one clean hold; his first personal kill in years, core kept by agreement. Alexander offered to help him develop past `Standfast`'s defensive-only design. Next meeting held for 'next week,' no fixed date."
texture: "Two federal-adjacent and institutional-adjacent men, each held in reserve by an institution for years, whose ordinary friendship has become something warmer — genuine flirtation, reciprocated, now layered over a real working combat partnership rather than only a social one."
...
canonical_state:
  ...
  appearance: "**Authored on first physical description, 2026-09-08 (unnamed but entailed — Resident Core, 'Unnamed Is Not Absent').** Small and quick-built, nothing about her reads as durable — light frame, restless hands, weight always on the balls of her feet as though the next room is already the one she's actually in. Moves before she seems to have decided to. Dark, sharp eyes that read a room in the time it takes most people to notice they've entered one. Dressed in nothing that would slow her down — nothing loose, nothing that catches. There's an agelessness to her that doesn't read as old so much as *worn smooth*, the specific polish of four thousand years spent being agreeable to everyone she's ever needed something from. Her smile arrives easily and a half-second too fast — genuinely warm, and never once unconsidered."
...
state: "**Live, unresolved, mid-negotiation as of this checkpoint.** She has made a standing offer — instruction in exchange for a door left open — and Alexander has neither accepted nor refused it. The far door remains open; she remains near it. No trade has been struck, no technique taught, no promise made by either side."
...
canonical_state:
  ...
  appearance: "**Authored on first physical description, 2026-09-08 (unnamed but entailed — Resident Core, 'Unnamed Is Not Absent').** Broad and solidly built despite the useless Strength — the build of a man who's spent an age on his feet correcting other people's stances rather than throwing anything himself. Big, calloused, careful hands — a coach's hands, always half-reaching to adjust someone's grip before catching himself. Deep-set, tired eyes that soften considerably the moment he's actually teaching rather than talking about anything else. Plain, practical dress, nothing decorative — the look of someone who stopped caring how he presented a long time before he stopped caring whether he was useful. Carries himself a little apologetically for someone objectively the safest person on the whole far side to stand next to."
...
canonical_state:
  ...
  appearance: "**Authored on first physical description, 2026-09-08 (unnamed but entailed — Resident Core, 'Unnamed Is Not Absent').** Tall and heavily built — the highest Strength on the far side reads immediately, a frame that looks like it should be able to take a hit and, per his own sheet, genuinely cannot. Stands very still, the specific stillness of someone who has learned that patience is itself a weapon. Pale, deep-lined face, unreadable by default — the expression of a man doing arithmetic behind his eyes at all times, because he usually is. Dresses without ornament, nothing that would suggest status or softness. The wrongness in him is exactly the one the numbers describe: he looks like he could end a fight with one hand and would rather not start one, because he genuinely might not survive it either."
  ...
  beliefs: []
  agenda: "Respected Alexander's refusal to be persuaded on first contact; agreed to attend the group gathering. At Sevrin's ground, said he might reconsider his own count if the real enemy proves separable from mere outcome — the first thing all session that moved his stated position at all. **2026-09-08:** Alexander returned alone and pursued him physically; declined once as a trade for teaching, held firm on that refusal even under real seduction, then reciprocated fully once nothing was being asked for in return — his own words, first time he's let himself want anything in longer than he can count. Teaching position unchanged. Told Alexander he wouldn't mind him visiting again."
```
...
state: "Live, unresolved on the teaching question — his stated position holds, the one thing that could move it (proof the real enemy is separable from the outcome) still open. **Personally, no longer purely adversarial**: real physical intimacy occurred 2026-09-08, first time in an unmeasurable span he's let himself want anything according to his own account. No commitment made by either side; Alexander said he'd visit again, Orenne said he wouldn't mind."
texture: "Two people who each recognize the other is arguing honestly, even from opposed premises — and, as of this session, something warmer sitting alongside the argument rather than replacing it. **Owen has no channel to any of this.**"
history: "Formed this session (`EVT-000875`), met at the Long Shelf; deepened at the group gathering (`EVT-000878`). **2026-09-08:** Alexander returned alone, the encounter turned physical and became sexual — mutual, Orenne reciprocating fully once no trade was being asked for."
```
...
canonical_state:
  ...
  condition: "Healthy, unhurt."
  appearance: "**Authored on first physical description, 2026-09-08 (unnamed but entailed — Resident Core, 'Unnamed Is Not Absent').** Tall and spare, built for stillness rather than motion — nothing about him reads as a fighter, matching Strength 1,150 against everyone else on the far side. Long-fingered hands, precise and unhurried, built for turning pages rather than anything that needs force. Eyes disproportionately large and pale, an adaptation that reads at a glance as *for reading in poor light, for a very long time* — the visible shape of Perception 3,900. Skin has the indoor pallor of four centuries spent mostly under his own archive's dim light rather than any stratum's open sky. Dresses plainly, functionally, in layered wrappings the color of old paper — nothing performative in it, the same unimpressed economy his voice carries. Moves like a man permanently mid-thought."
  ...
  beliefs: []
  agenda: "Confronted Alexander directly over the robbed library and the anchor left in his home; heard the honest account (Mill creatures, an apparently abandoned house, an uncertain return), accepted a genuine apology, received the entire archive back in full. Offered to share the diagrams' contents privately, later, without an audience. Asked, unprompted, whether Earth has an internet — genuinely hungry for anything new to read."
```
...
state: "Reconciled. The archive returned in full (`EVT-000876`). Tolo owed a private conversation about the diagrams, and asked for reading material from Earth — nothing specific requested yet beyond his stated interests (self-correcting systems, honest first-draft records, rebuilding after loss)."
texture: "Started as confrontation, cooled into something like the beginning of a real exchange — the first far-side figure whose interest in Alexander runs toward what Earth itself holds, not toward the door or the process."
...
canonical_state:
  ...
  appearance: "**Authored on first physical description, 2026-09-08 (unnamed but entailed — Resident Core, 'Unnamed Is Not Absent').** Weathered in the specific way of someone who once held a literal line and has never fully stood down from it — square-set, scarred in places too old and too healed to read as recent, the bearing of a soldier rather than a scholar or a talker. Stands like there's still a bridge behind him. Moves rarely and never wastes the motion when he does. Eyes that hold on a question for an uncomfortably long time before answering it, exactly as his voice does. Wears something close to armor even here, where nothing has drawn a weapon on him in four thousand years — old habit outlasting the reason for it."
  ...
  beliefs: []
  agenda: "Objected once, plainly, to Ilith's presence, then honored his word to talk anyway. Offered to teach seam-work up to the point it would work against ending the process — a real, bounded offer. Asked Alexander a direct question in return: which outcome he'd actually choose, process-ending or a passed Earth, if it came to it — unanswered as of this session, deliberately deferred by Alexander rather than answered glibly."
```
...
state: "Live, unresolved. A real trade offer stands (seam-work instruction, bounded by his own goal). He asked a direct question Alexander deferred rather than answered; he approved of the deferral explicitly."
texture: "Adversarial in position, not in conduct — he tested him once (bringing Ilith) and, having voiced the objection, did not relitigate it."

...
**Checkpoints:** 103 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0103`)
...
**Latest capture:** `900_CHECKPOINT_0103` — kind `session-save`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0102`, source `EVT-000593`.

...
```yaml
current_funds:
  as_of_event: EVT-000712
  as_of_game_date: "2026-08-25T10:40:00-05:00"
  cash_usd: 329090.22
  gold: 1030081
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**2026-08-24 10:16 - 2026-08-25 10:40 (`EVT-000699`-`EVT-000712`): gold 1,530,081 -> 1,030,081; cash $329,287.22 -> $329,090.22.** Out (gold): **-500,000 g** on the Bulwark [A-Rank] rune from the live Ivory Daily Premium cycle, bought and consumed on the spot for the E->A ascension (`EVT-000701`). Out (cash): **-$197** on a long hooded weatherproof cloak and **four prepaid burner phones**, bought with cash under the counter's own ID threshold (`EVT-000711`). **Non-monetary movements are recorded on the character sheet rather than here**: three Greater Mana Potions from the thirtieth daily's box (`EVT-000705`); and **five finished artificer pieces plus a satchel and a wallet taken from the CONSULT operation** (`EVT-000708`-`EVT-000710`) — a worked bracer [B-Rank], a matched earring set [A-Rank] bearing Marnie's own mark, a ring [C-Rank] with a live nested working, a short blade [B-Rank], and a pendant [A-Rank] — **none purchased, none sold, all held as evidence rather than kit.** The wristguard Walt Adamik offered at $800 was appraised free and **declined** (`EVT-000702`). Prior: **2026-08-24 06:00-10:16 (`EVT-000689`-`EVT-000697`): gold 732,481 -> 1,530,081, the first seven-figure balance this campaign has held.** Out: -250,000 g on the Runic Key [A-Rank] (`EVT-000690`). In: +150,000 g System gold box (`EVT-000693`), +588,200 g and +309,400 g crystal sales (`EVT-000695`, `EVT-000697`). USD and gold do not exchange (Profile Section 12.5); no pending payouts outstanding. Full prior movement history: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures."
```

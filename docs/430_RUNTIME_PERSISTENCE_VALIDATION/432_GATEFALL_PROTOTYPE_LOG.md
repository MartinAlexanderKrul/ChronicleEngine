...
**Checkpoints:** 90 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0090`)
...
**Latest capture:** `900_CHECKPOINT_0090` — kind `manual`, profile 1.72 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0089`, source `EVT-000526`.

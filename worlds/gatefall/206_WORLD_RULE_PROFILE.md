# Gatefall — World Rule Profile 1.93
...
| Tier reached | No later than |
|---|---|
| **IV** | **2027-02-24** — six in-fiction months |
| **V** | **2027-05-24** — three more |
| *(the ramp's end)* | **2027-07-05** — six weeks more |
...
```text
     +1   a district reaches Strained          (Section 9.1.3, pressure 4)
     +3   a district reaches Cordon            (Section 9.1.3, pressure 7)
     +5   a break at A-Rank or above, anywhere in the jurisdiction
...
**An ordinary contained break credits nothing directly**, and that is deliberate: the city absorbing a break is the system working, and Section 9.1.3's pressure track already prices repetition. What credits here is the city **losing ground** — a district it has to cordon, a Rank the response could not reach, a wound it fences instead of healing. A campaign in which Chicago holds will reach tier IV on the clock and no sooner. A campaign in which a district falls will get there early, and the Bearer declining to intervene is a legitimate choice with a consequence, exactly as Section 9.1.3 already says.

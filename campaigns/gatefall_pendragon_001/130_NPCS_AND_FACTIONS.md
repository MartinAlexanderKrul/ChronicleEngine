...
scope: campaign
# This save: EVT-001140, EVT-001141, EVT-001142, EVT-001143, EVT-001144, EVT-001145, EVT-001146, EVT-001147 (21 entities
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 (real date), for portrait reference — no physical description existed in canon prior to this note. Early 30s, Latina, medium height, compact and solidly built, no interest in performing for a camera. Dark hair kept short and out of the way; a level, appraising gaze that studies a person before it warms. Plain practical gear with no guild markings, worn like tools rather than a uniform. Reads exactly as blunt as she talks."
...
canonical_state:
  ...
  fear: "Not yet established."
  secret: "Not yet established."
  voice: "Understated, delivers bad news as good manners, never raises her voice, treats tea as punctuation."
  agenda: "**2026-09-28 (`EVT-001137`).** Met him at the door at 18:12 London with the carpet undone, offered tea, said before he looked that **the rear service door still has the previous tenant's lock** (the guild's is booked Wednesday 2026-09-30) and that the hall for Tuesday's 19:00 London event is confirmed, walked twice. **Owes Detroit's front office a call the moment the lock is fitted.** The London tunnel stays closed until then."
...
canonical_state:
  ...
  appearance: "Authored 2026-09-22 (real date), for portrait reference — no physical description existed in canon prior to this note. Mid-30s, Israeli, medium-tall and solidly built, a face weathered by six years as his country's only reliable S-Rank response rather than by age. Close-cropped dark hair going grey at the temples, steady dark eyes, a composed and unhurried bearing. Plain, well-maintained field gear with no flourish — dresses like a man used to being the only one who shows up."

...
**At a glance — read this before narrating him.** Twenty-seven. **C-Rank licensed mender**, five years in the trade, staff at Edgewater Hospital in Chicago, lives in Rogers Park. Alexander Pendragon's partner since 2026-07-29 and, since 2026-08-04 (`EVT-000145`), **the only person alive who has been told the System by name**. As of 2026-08-10 he carries **two abilities** — his mending and Stone Skin — which is the first recorded instance in Gatefall of an awakened holding more than one, and nobody but Alexander knows it.
...
| Ability | Rank / mastery | Effect | Cost |
|---|---|---|---|
| **Mend** — his Awakening gift | C-Rank | Treatment touch; cleared a Severe injury outright (`EVT-000080`, Section 6.3) | ≈4–5 ordinary-severity patients per clear, as few as 2 for something severe; no hard cutoff, diminishing effect under load |
| **Stone Skin** — consumed rune, 2026-08-06 (`EVT-000178`) | D-Rank, Novice | 30% physical damage reduction while sustained; ends when it lapses or is dropped | Drawn from **the same well as his mending** — every activation is a person he cannot put back together |
...
- **The 2026-08-08/09 weekend was exactly that exception.** Saturday plus an eleven-hour Sunday, both outside his pattern, which is why he was given **Monday 2026-08-10** off in return.
...
**Do not play as settled.** He has **not** agreed to leave Priya Okafor's crew (`OBJ-12`) and has **not** agreed to become a permanent off-books Gate-goer. He deliberately declined to answer both on 2026-08-09 and asked that the non-answers be noticed as non-answers.

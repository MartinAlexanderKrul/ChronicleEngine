...
**Checkpoints:** 146 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0146`)
...
| frozen | 0009–0146 | 138 |

**Latest capture:** `900_CHECKPOINT_0146` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0145`, source `EVT-000949`.

...
- **Latest restorable checkpoint:** `saves/900_CHECKPOINT_0014/` — Ashgate chamber mop-up (all nine Broodlings confirmed dead), core extraction, and Rift closure, plus a ruling flagging the unauthored Rift-clear milestone XP magnitude and awarding only the confirmed per-kill XP (`EVT-000042`, `EVT-000043`).
...
**Condition:** Full 105/105 Health; 2/14 Mana (Fireball spent, not yet recovered); Level 2, 85/130 XP. Authoritative values in `100_CHARACTER_SHEET.md`.
...
- **A ruling gap is flagged, not invented:** the Rift-clear milestone XP bonus (Section 8.2) has no established magnitude anywhere in canon. Only per-kill XP was awarded for the Ashgate clear (54 XP, 31 to 85); the milestone bonus itself awaits an owner decision.
...
- **Health is full; Mana is low.** 105/105 Health; 2/14 Mana, unspent since the Fireball cast.
- **Ascension is settled.** Level 2, 85/130 XP, Mana Affinity 14, Fireball Strength 1, maximum Mana 14, maximum Health 105.
...
- **A ruling gap is flagged, not filled with an invented number.** Section 8.2's Rift-clear milestone bonus has no established magnitude anywhere in canon. Only per-kill XP was awarded for Ashgate; the milestone bonus awaits an owner decision and is not retroactively assumed.
...
7. **The Rift-clear milestone XP magnitude is an open ruling gap.** Section 8.2 promises a bonus with no specified value. It was deliberately not awarded (not invented) for the Ashgate clear; an owner decision on the formula is pending and may apply prospectively.
...
Resume just outside the collapsed Ashgate E-Rift. Health is full (105/105); Mana is low (2/14, unspent since the Fireball); Emberbrand is spent. All nine Ashgate Broodlings are confirmed dead, harvested for nine E-cores (core purse 55); the extracted Ashgate core is carried separately, unappraised. XP stands at 85/130 — per-kill XP only; the Rift-clear milestone bonus remains an open ruling gap, not yet assigned a value.

...
**Checkpoints:** 58 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0058`)
...
**Latest capture:** `900_CHECKPOINT_0058` — kind `manual`, profile 1.46 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0057`, source `EVT-000314`.

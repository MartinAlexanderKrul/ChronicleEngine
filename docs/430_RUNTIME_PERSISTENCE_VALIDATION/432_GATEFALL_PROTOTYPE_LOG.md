...
**Checkpoints:** 152 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0152`)
...
| frozen | 0009–0152 | 144 |

**Latest capture:** `900_CHECKPOINT_0152` — kind `session`, profile 1.116 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0151`, source `EVT-000998`.

...
```yaml
current_funds:
  as_of_event: EVT-000603
  as_of_game_date: "2026-08-21T21:20:00-05:00"
  cash_usd: 278155.22
  gold: 367341
  pending_payouts_usd: 52500.00
  pending_payout_count: 1
  note: "**Gold 367,501 -> 367,341 at `EVT-000603`**: two E-Rank Hunter’s Bands bought from the standard catalogue at 80 g each as disposable Seamwork practice stock. Cash unmoved. USD and gold do not exchange (Profile Section 12.5). Cash moves only through world-side transactions; gold moves only inside the System shop. One pending payout: Ada Reyes's Cicero Scar declaration, 21 crystals at the licensed C-Rank rate, filed 2026-08-20 (`EVT-000556`), not yet cleared."
```

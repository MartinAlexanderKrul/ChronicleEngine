...
provenance:
  source: EVT-000477
  game_date: "2026-08-18T15:30:00-05:00"
...
**Cash on hand: $293,810.02** — as of 2026-08-18 15:30 (`EVT-000477`). The three receipts above landed against the $2,174.00 held since 2026-08-17 evening (`EVT-000464`); no further cash transaction this span — the two instant-dungeon keys, the Mana Potions, and the crystal sales all moved gold, not cash. Gold **97,811 → 101,441** (two 10,000 g key purchases, 23,630 g in crystal sales — see `100_CHARACTER_SHEET.md`).

...
canonical_state:
  ...
  **Kesha's callback, 2026-08-11 afternoon (`EVT-000296`).** Reyna is genuinely interested but won't commit blind — her own words to Kesha: 'I got burned trusting a plan I never saw. Not doing that again.' She wants to meet Alexander and Owen in person before saying yes to anything. Kesha gave her Alexander's number. **Still not directly contacted; a meeting has not been arranged.**"
```
...
canonical_state:
  ...
  situation: "**Named, not yet met** (`EVT-000293`). One of four hunters Wade Bishop referred at Alexander's request for the new crew (`OBJ-26`). No contact made."
```

...
**Checkpoints:** 117 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0117`)
...
| frozen | 0009–0117 | 109 |

**Latest capture:** `900_CHECKPOINT_0117` — kind `session-save`, profile 1.90 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0116`, source `EVT-000670`.

...
**Checkpoints:** 76 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0076`)
...
**Latest capture:** `900_CHECKPOINT_0076` — kind `manual`, profile 1.57 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0075`, source `EVT-000435`.

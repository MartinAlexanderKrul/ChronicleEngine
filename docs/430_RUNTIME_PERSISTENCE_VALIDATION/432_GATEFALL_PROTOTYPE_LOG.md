...
**Checkpoints:** 126 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0126`)
...
| frozen | 0009–0126 | 118 |

**Latest capture:** `900_CHECKPOINT_0126` — kind `session-save`, profile 1.100 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0125`, source `EVT-000755`.

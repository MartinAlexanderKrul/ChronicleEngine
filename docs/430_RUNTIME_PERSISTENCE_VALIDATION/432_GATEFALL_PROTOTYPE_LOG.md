...
**Checkpoints:** 95 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0095`)
...
**Latest capture:** `900_CHECKPOINT_0095` — kind `manual`, profile 1.75 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0094`, source `EVT-000540`.

...
**Checkpoints:** 66 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0066`)
...
**Latest capture:** `900_CHECKPOINT_0066` — kind `manual`, profile 1.50 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0065`, source `EVT-000376`.

...
### Pending — declared 2026-08-11 (`EVT-000266`)

- **$2,137.50** — Alexander's half of the collapsed rail cutting Gate's declared pool (21 crystals + 3 cores), filed with Kesha Morrison 2026-08-11, processing 1–2 business days. Not yet received; not counted in cash on hand (**$54,729.60** as of `EVT-000280` — the Warded Vambrace and Dormant Core purchase, $59,929.60 → $54,729.60).

### Historical

**Nothing else currently outstanding.** The Denise Ferro share below cleared, overdue but landed.
...
### Pending income — two figures, both owed by end of day/tomorrow (`EVT-000345`)

- **Harvest-pool share** for the 20 declared B-Rank crystals — exact figure owed tonight, 2026-08-14, tighter than the standard one-to-two-business-day window (leverage-driven).
- **Combat-contribution claim** for the boss kill and swarm clear, filed by Wade to Brannigan's office as an out-of-contract contribution, same day as above — not yet a number, but stated as owed fact rather than a negotiating position.

...
Assert-Contains $profile 'World Rule Profile 1\.43' 'Gatefall profile is not version 1.43.'
...
Assert-Contains (Get-MigrationRecord '1.42' '1.43') '1\.42.+1\.43 compatibility treatment' 'The 1.42 to 1.43 migration record lacks its treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.43' 'Gatefall README does not advertise Profile 1.43.'
...
Assert-Contains $character 'profile_version: "1\.43"' 'Live Gatefall character has not adopted Profile 1.43.'

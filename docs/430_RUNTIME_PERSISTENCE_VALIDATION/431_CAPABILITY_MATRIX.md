...
| V03-09 | Structured profile metadata | New checkpoint records world, version, and freeze status, or explicit no-profile | Passed — gate and observed | Gatefall workshop-draft Checkpoint 0004; frozen Profile 1.6 / Data Model 0.1.2 Checkpoint 0014; frozen Profile 1.6 / Data Model 0.1.3 Checkpoint 0015; and frozen Profile 1.10 / Data Model 0.1.3 Checkpoint 0020. Older captures remain immutable and run their applicable readiness chain through 1.10. `test_checkpoint_contract.ps1` Contract 6. |

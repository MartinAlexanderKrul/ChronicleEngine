...
**Checkpoints:** 81 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0081`)
...
**Latest capture:** `900_CHECKPOINT_0081` — kind `manual`, profile 1.66 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0080`, source `EVT-000486`.

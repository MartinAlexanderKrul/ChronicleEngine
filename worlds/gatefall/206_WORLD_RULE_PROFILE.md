# Gatefall — World Rule Profile 1.97
...
```text
     ...
     past the metro it doubles at each further step out:
     another metro he has stood in                                      10
     another continent                                                  20
     the far side of the world                                          40
```

  **These are described bands, not measurements, and the Runtime picks the one the fiction is obviously in.** Where two could both fit, **the more expensive one governs** — ambiguity resolves *against* the Bearer, always, so a vaguely described destination is never the cheap one and nobody argues about a boundary mid-scene. **The shape is the point**: moving inside a fight costs almost nothing, and crossing the world is an undertaking.
...
╔══ ◈  R I F T S ═════════════════════════════════════════════════════════════
     ...
     Travelling step anywhere he has stood  <1|3|4|5, doubling past the metro>

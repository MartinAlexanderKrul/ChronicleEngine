...
moved_by_events: "**Every Event whose `participation_audits` claim it moved this record.** Decision 085 requires the record to *reference* such an Event; it has never required the record to *narrate* it, and `160_CAMPAIGN_CHRONICLE.md` narrates every one in full. This index exists so state fields can hold values while their reasoning lives where it is authoritative - citing and narrating are different obligations and only the first is cheap. Maintained at promotion.
  ...
  `EVT-000271` `EVT-000273` `EVT-000274` `EVT-000277` `EVT-000278` `EVT-000279` `EVT-000280` `EVT-000282` `EVT-000284` `EVT-000285` `EVT-000286` `EVT-000287` `EVT-000289` `EVT-000290` `EVT-000291` `EVT-000292` `EVT-000293` `EVT-000294` `EVT-000296` `EVT-000300` `EVT-000301` `EVT-000302` `EVT-000303` `EVT-000304` `EVT-000308` `EVT-000311` `EVT-000312` `EVT-000316` `EVT-000317` `EVT-000318` `EVT-000319` `EVT-000320` `EVT-000323` `EVT-000324` `EVT-000325` `EVT-000326` `EVT-000327` `EVT-000328` `EVT-000332` `EVT-000333` `EVT-000334` `EVT-000336` `EVT-000337` `EVT-000338` `EVT-000339` `EVT-000340` `EVT-000341` `EVT-000342` `EVT-000343` `EVT-000344` `EVT-000345` `EVT-000346` `EVT-000347` `EVT-000350` `EVT-000351` `EVT-000352` `EVT-000353` `EVT-000354` `EVT-000355` `EVT-000356` `EVT-000357` `EVT-000358` `EVT-000359` `EVT-000360` `EVT-000361` `EVT-000373` `EVT-000374` `EVT-000379` `EVT-000380` `EVT-000381` `EVT-000382` `EVT-000383` `EVT-000384` `EVT-000385` `EVT-000386` `EVT-000390` `EVT-000391` `EVT-000392` `EVT-000393` `EVT-000395` `EVT-000396` `EVT-000397` `EVT-000398` `EVT-000399` `EVT-000400` `EVT-000401` `EVT-000402` `EVT-000403` `EVT-000404` `EVT-000406` `EVT-000407` `EVT-000408` `EVT-000409` `EVT-000410` `EVT-000411` `EVT-000414` `EVT-000415` `EVT-000416` `EVT-000417` `EVT-000419` `EVT-000422` `EVT-000425` `EVT-000428` `EVT-000429` `EVT-000430` `EVT-000431` `EVT-000432` `EVT-000433` `EVT-000434` `EVT-000451` `EVT-000452` `EVT-000453` `EVT-000454` `EVT-000457` `EVT-000458` `EVT-000459` `EVT-000463` `EVT-000464` `EVT-000465` `EVT-000467` `EVT-000468` `EVT-000469` `EVT-000470` `EVT-000471` `EVT-000472` `EVT-000473` `EVT-000474` `EVT-000475` `EVT-000476` `EVT-000477` `EVT-000478` `EVT-000479` `EVT-000480` `EVT-000481` `EVT-000482` `EVT-000483` `EVT-000485` `EVT-000487` `EVT-000490` `EVT-000491` `EVT-000493` `EVT-000495` `EVT-000496` `EVT-000498` `EVT-000499` `EVT-000500` `EVT-000501` `EVT-000502` `EVT-000503` `EVT-000504` `EVT-000506` `EVT-000507` `EVT-000508` `EVT-000509` `EVT-000510` `EVT-000511` `EVT-000512` `EVT-000513` `EVT-000514` `EVT-000515` `EVT-000516` `EVT-000517` `EVT-000518` `EVT-000519` `EVT-000520` `EVT-000521` `EVT-000522` `EVT-000523` `EVT-000524` `EVT-000525` `EVT-000526` `EVT-000527` `EVT-000528` `EVT-000529` `EVT-000530` `EVT-000531` `EVT-000532` `EVT-000533` `EVT-000534` `EVT-000535` `EVT-000536` `EVT-000537` `EVT-000538` `EVT-000539` `EVT-000540` `EVT-000541` `EVT-000542` `EVT-000543` `EVT-000544` `EVT-000545` `EVT-000546` `EVT-000547` `EVT-000548` `EVT-000549` `EVT-000550` `EVT-000551` `EVT-000552` `EVT-000553` `EVT-000554` `EVT-000555` `EVT-000556` `EVT-000557` `EVT-000558` `EVT-000559` `EVT-000560` `EVT-000561` `EVT-000562` `EVT-000563` `EVT-000564` `EVT-000565` `EVT-000566` `EVT-000567` `EVT-000568` `EVT-000569` `EVT-000570` `EVT-000571` `EVT-000572` `EVT-000573`"

canonical_state:
  age: 25
  location: ENT-000087
  location_note: "The Rogers Park apartment (`ENT-000087`) he shares with Owen Callahan, Chicago, 15:35 on 2026-08-20 (Thursday), showered and in ordinary clothes, due at Priscilla Nakamura's bench at 18:00 and on Glenwood at 19:15. He has not left the flat since 12:55 except into an instance turned in his own living room."
  condition: |
      Health **1,480/1,480**, Mana **708/708**, both full — **Level 35, System Rank B, Combat Tier A, 15:35 on 2026-08-20 (Thursday)**, showered, in ordinary clothes, alone in the Rogers Park apartment. **Ten ability points unspent.**

      **The Section 7.5 offer left standing at the last barrier was taken first** (`EVT-000569`): **Silent Step [E-Rank] Master → [D-Rank] Adept**, buying **`Concealment through action`** — concealment survives one attack or manipulation — at the price of Mana 3 → 4 and a covered body, scope 5 → 4. It answers the exact failure that cost him twenty-three converging commons at the Hive.

      **A fourth B-Rank key, turned standing in his own living room at 13:00** (`EVT-000570`). Archetype **Overgrown Temple**: a shrine granting a bonus loot roll, guarded by a third elite. Thirteen commons, three elites, one boss, an 88-crystal seam — **seventeen of seventeen dead in an hour forty-five, for two hits taken**, both from commons that got lucky on a die. The new category proved out immediately: two commons killed by a legendary projection while **concealment held**, the survivors lifting their heads at the smell rather than at him. The boss **never took a turn** — a concealed Rupture for 1,895 into a body that had not begun to turn, and a 604 main-hand into the 505 left. **Level 34 → 35.** The shrine paid a **Dimensional Projection [C-Rank] rune**, consumed on the spot for two Ranks: 3 projectiles, 11 m, and **`Recall and launch`**, which deletes `EVT-000438`'s standing launch-or-recover limit outright.

      **Then an owner ruling that moved more than the afternoon did** (`EVT-000571`): **qualifying scenes count per scene, not per approach.** Section 7.4's *materially distinct* is not read to require a different method. Applied to the Temple as one scene that eleven skills contributed to, it crossed **five rungs at once** — **Keen Sense to Master** (10 subjects, and **at its ceiling**, so finished until System Rank A), **Flash Step to Master**, **Twin Fang to Expert** (×2.15), **Dagger Mastery to Expert** (chassis ×1.75, re-deriving every strike he owns), and **Resonance Extraction to Expert**, which also settled a stored line that had been claiming progress toward Master against a three-star Adept. **Both remaining offers were then taken**: **Flash Step [B] Master → [A] Adept**, spending a Master rung four minutes old and finally opening the reach band the line had promised since it was written — **100 m, sight or no sight** — plus `Return`; and the banked **Sprint rune, C → B**, buying **`Terrain denied`**, the category that would have deleted the morning's worst moment.

      **For the first time in the campaign there is no unanswered advancement anywhere in his list.** Nothing withheld, nothing pending ratification.

      **Derived state closes at:** base **319/302/369/303/351**, effective **333/346/370/308/354**; main-hand **621**, off-hand **611**, Twin Fang package **1,935**, Rupture **1,895**, Mana Bolt **603**; anchor cap **17**; defence **7.31** landed hits against A-Rank. **Gold 238,841** after 90 crystals sold for 67,500; cash unmoved at **$278,155.22**; 61 B-Rank crystals and 12 B-Rank cores banked.

      **Two things are waiting and they are the same evening.** Priscilla Nakamura at 18:00, opening the Dormant Core, with **two** uncategorised lots to bring now instead of one — the frost-fused plating and a heartwood core-mass still warm the way the Mana Reservoir is warm. Wade Bishop at 19:15, The Nook on Glenwood, back room held and an order already in, after saying *'Not chasing. Just so you've got it in writing'* and receiving a thumbs up. Owen home around 20:00, having been called a mender between a nail through a hand and a bead up a nose. **Nobody has called Priscilla to ask whether 18:00 can move**, which is the one lever available and the one nobody has pulled.

      Superseded anchor states are not held here. `160_CAMPAIGN_CHRONICLE.md` narrates every span in full, and `moved_by_events` above references every Event that claims to have moved this record -- Decision 085 requires the reference, never the narration. Thirty prior anchors were retired on that basis; read the chronicle for any of them.
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-20T15:35:00-05:00"
    ...
    tracked_counters:
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 80 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 52 }

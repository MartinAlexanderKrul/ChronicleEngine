...
```yaml
current_funds:
  as_of_event: EVT-000608
  as_of_game_date: "2026-08-22T12:30:00-05:00"
  cash_usd: 287587.22
  gold: 367341
  pending_payouts_usd: 52500.00
  pending_payout_count: 1
  note: "**Cash 278,155.22 -> 287,587.22 at `EVT-000606`/`EVT-000607`**: +$9,432 net across two D-Rank clears — the Ashfield crew run (party pool payout $4,332 against a $3,000 personal buy-in for the Seer's Lens, net +$1,332) and the unsanctioned Lakefront solo run with Owen (50:50 split of $16,200 sellable crystal/core value, +$8,100; the Channeling Focus kept rather than sold, so it never enters this figure). Gold unmoved this span. USD and gold do not exchange (Profile Section 12.5). One pending payout: Ada Reyes's Cicero Scar declaration, 21 crystals at the licensed C-Rank rate, filed 2026-08-20 (`EVT-000556`), not yet cleared."
```

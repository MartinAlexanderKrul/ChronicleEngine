...
- **13 C-crystals**, mined and physically held from the Frozen Gallery job's two vein assignments, not yet declared to Dale's manifest (`EVT-000065`). The job is in progress: no boss kill, no exit, no formal declaration yet. Of 30 total crystals mined at this site, 24 were sold privately through the System shop across two separate sales and never entered this declarable count.

System-shop gold (4,250 g, from three undeclared private crystal sales — 1 at the Cicero Scar, 2 of 12 each at the Frozen Gallery) is Bearer state, not mundane property — tracked in `100_CHARACTER_SHEET.md`'s `system_state`, not here, per World Rule Profile Section 14.1.

# Save Manifest — Gatefall Pendragon 001 — 900_CHECKPOINT_0123

**Campaign:** `campaigns/gatefall_pendragon_001/` · **World:** `worlds/gatefall/`
**Checkpoint:** `900_CHECKPOINT_0123` — thirty-nine levels, one title, fourteen skills, and a night nothing contested
**Kind:** session-save
...
```yaml
save_identity:
  checkpoint_type: session-save
  real_date: '2026-08-23T13:53:57+02:00'
  source: EVT-000735
...
versions:
  ...
  save_format: 0.1.0
lineage:
  parent_save: 900_CHECKPOINT_0122

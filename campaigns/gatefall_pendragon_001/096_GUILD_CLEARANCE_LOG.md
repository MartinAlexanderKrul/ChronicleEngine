...
**Automatic dispatch is counted, not listed.** From the 2026-10-01 06:00 tick, operational branches run Section 13.7.5's daily dispatch as a rate. Day one (`EVT-001201`), Chicago, Washington, Frankfurt and Paris: **E 8, D 6, C 5, B 1 — 20 clears.** Those days are totals in the world ledger's tick record, not rows here.

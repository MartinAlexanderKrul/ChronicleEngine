...
**Checkpoints:** 102 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0102`)
...
**Latest capture:** `900_CHECKPOINT_0102` — kind `session-save`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0101`, source `EVT-000587`.

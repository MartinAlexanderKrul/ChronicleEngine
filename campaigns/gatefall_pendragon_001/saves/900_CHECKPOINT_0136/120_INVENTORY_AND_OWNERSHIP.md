...
- **An entire archive** — every legible tablet/slate from the Ninth Quiet library (`EVT-000783`), stored whole into the dimensional inventory in one remote-storage action (Section 12.9: free, no roll, nothing contesting an abandoned civilization's shelving). Script unread; diagrams include Gate cross-sections and a recurring curve. Not catalogued individually — too large a set for per-item tracking, held as one bulk holding pending any future need to reference a specific piece.

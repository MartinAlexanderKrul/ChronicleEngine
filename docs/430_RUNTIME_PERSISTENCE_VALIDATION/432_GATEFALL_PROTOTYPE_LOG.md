...
**Checkpoints:** 156 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0156`)
...
| frozen | 0009–0156 | 148 |

**Latest capture:** `900_CHECKPOINT_0156` — kind `session`, profile 1.117 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0155`, source `EVT-001042`.

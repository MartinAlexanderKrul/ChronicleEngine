...
**Checkpoints:** 75 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0075`)
...
**Latest capture:** `900_CHECKPOINT_0075` — kind `manual`, profile 1.57 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0074`, source `EVT-000427`.

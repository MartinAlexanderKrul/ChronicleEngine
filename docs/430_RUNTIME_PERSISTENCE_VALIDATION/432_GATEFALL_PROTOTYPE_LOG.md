...
**Checkpoints:** 125 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0125`)
...
| frozen | 0009–0125 | 117 |

**Latest capture:** `900_CHECKPOINT_0125` — kind `session-save`, profile 1.100 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0124`, source `EVT-000748`.

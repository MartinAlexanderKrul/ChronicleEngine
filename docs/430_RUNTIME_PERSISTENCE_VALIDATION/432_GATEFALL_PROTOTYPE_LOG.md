...
**Checkpoints:** 130 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0130`)
...
| frozen | 0009–0130 | 122 |

**Latest capture:** `900_CHECKPOINT_0130` — kind `session-save`, profile 1.105 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0129`, source `EVT-000801`.

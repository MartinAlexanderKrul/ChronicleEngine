...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0008` | 2026-07-26 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 2 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0008`** (captured 2026-07-26, Alexander home for the evening, both harvest jobs closed). Protagonist Alexander Pendragon cleared his first Gate as a striker (Red Line Corridor, true grade E), then pivoted to harvest/support work once the corrected rule (`EVT-000062`, world-rule commit `d53114b`) established that his E-card only caps strike/combat contracts, not harvest work at any grade. He completed a C-grade harvest job at the Cicero Scar (`EVT-000063`; 7 declared C-crystals, ≈$5,700 pending, plus 170 undeclared System-shop gold from a private sale unknown to anyone) and completed a second C-grade job, the Frozen Gallery (`EVT-000064`–`EVT-000068`): three vein assignments (the third to genuine exhaustion), 41 C-crystals formally declared — the harvest crew's highest — for a ≈$24,663 harvest-share payout under the now-authored Section 13.2 formula, his largest pending payout yet. Seven undeclared private sales across both jobs (six at the Frozen Gallery: four of 12 crystals, two of 50) brought total private gold to 25,330, unknown to anyone, though two of the largest sales drew site coordinator Dale's direct, successfully-deflected suspicion. A break let Alexander study the strike element's tactics, gaining an externally-observed combat framework unknown to any NPC. Dale confirmed the contractor occasionally posts B-grade harvest work and named Alexander a strong future candidate. He is a Bearer, Level 2, XP 60/200, 3 unspent stat points (Strength 13, Agility 12, Vitality 10, Perception 11, Intelligence 10), daily-quest streak 2/7, grant accepted — unknown to everyone. The checkpoint was captured under **Gatefall World Rule Profile 1.0, a workshop draft (unfrozen)** — restoring it surfaces the *unfrozen — not save-trustworthy* warning (Rules Section 14.6, Decision 074). The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` restores `900_CHECKPOINT_0008`.

...
```yaml
current_funds:
  as_of_event: EVT-000613
  as_of_game_date: "2026-08-22T14:00:00-05:00"
  cash_usd: 329287.22
  gold: 313341
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**Cash 287,587.22 -> 329,287.22**: +$52,500.00 as Ada Reyes's Cicero Scar declaration finally cleared (`EVT-000609`, filed 2026-08-20, well past the standard 1-2 business day window), then -$10,800 at Walt Adamik's (`EVT-000611`: mana-null disc $1,800, 400-capacity mana-storage cell $9,000). **Gold 367,341 -> 313,341**: -30,000 for the Adaptive Gale Torso [A-Rank] (Daily Premium Cobalt cycle) and -24,000 for a catalogue Arcanist Feet [A-Rank], both at `EVT-000609`. USD and gold do not exchange (Profile Section 12.5). No pending payouts outstanding."
```

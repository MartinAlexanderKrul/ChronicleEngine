...
**Checkpoints:** 145 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0145`)
...
| frozen | 0009–0145 | 137 |

**Latest capture:** `900_CHECKPOINT_0145` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0144`, source `EVT-000924`.

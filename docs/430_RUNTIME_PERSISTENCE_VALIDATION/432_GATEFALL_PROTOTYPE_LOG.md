...
**Checkpoints:** 134 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0134`)
...
| frozen | 0009–0134 | 126 |

**Latest capture:** `900_CHECKPOINT_0134` — kind `player-requested`, profile 1.110 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0133`, source `EVT-000852`.

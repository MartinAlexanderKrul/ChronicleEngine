...
scope: campaign
# This save (`EVT-001169`-`EVT-001179`): no cash or gold movement; fuel drawn from the dimensional inventory and consumed (a fill, never itemised); Orenne\'s remains stored, one special holding (`EVT-001175`).
...
## This Checkpoint's Movement (`EVT-001195`-`EVT-001206`) — the fence, Evanston, GB-63

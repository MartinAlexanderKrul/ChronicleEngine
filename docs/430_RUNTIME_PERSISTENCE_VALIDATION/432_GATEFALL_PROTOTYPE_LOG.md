...
**Checkpoints:** 143 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0143`)
...
| frozen | 0009–0143 | 135 |

**Latest capture:** `900_CHECKPOINT_0143` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0142`, source `EVT-000913`.

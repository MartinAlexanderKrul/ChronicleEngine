...
Striker and crew lead running her own undersubscribed five-hunter crew, short a fifth for about a week; solid reputation, nothing flashy. Not related to BGM Region V's director Naomi Okafor (`ENT-000107`) as far as anyone at the Coalition desk has established. Alexander has not yet met her in person — arranged through Kesha Morrison by phone on 2026-07-27.
...
relationships:
  - REL-000065
canonical_state:
  location: "unestablished; not yet met in person"
  condition: "Unestablished — described to Alexander only secondhand, through Kesha Morrison"
  capabilities: "Striker; leads her own five-hunter crew. Reputation at the Coalition desk: decent, unremarkable — 'nothing flashy' in Kesha's words. No further capability detail established."
  personality: "Unestablished beyond Kesha's secondhand read: not unreasonable about scheduling requests."
  situation: "Has been short a fifth crew slot for about a week. On 2026-07-27 Kesha Morrison passed along Alexander's interest and his request to stage at 9 AM rather than the morning generally; Okafor's answer on the exact time was still pending confirmation from Kesha as of this checkpoint. The job is a distinct, separately posted unconfirmed E-D Gate contract (Assessment reading low-confidence D), timer breaking 2026-07-29 at midnight, staging tentatively 2026-07-28."
```
...
endpoints:
  ...
  - ENT-000136
type: crew-membership
qualities: "Alexander's arranged fifth slot on Priya Okafor's five-hunter crew, a peer-crew combat/striker role (not harvest-hire like `REL-000064`) for a distinct unconfirmed E-D Gate contract. Arranged entirely through Kesha Morrison by phone; Alexander and Okafor have not yet spoken or met."
state: "Pending. Alexander verbally committed to Kesha ('I will take it') on 2026-07-27 and asked for a 9 AM staging time; Kesha undertook to relay the request to Okafor and confirm back, defaulting to 9 AM unless Alexander hears otherwise. No contract has been signed or filed with BGM Region V yet. Gate timer breaks 2026-07-29 at midnight; staging tentatively 2026-07-28."
history: "Formed 2026-07-27 when Kesha Morrison, following up on her promised morning callback (`EVT-000069`), reported two open E-D waiver-tier crew slots; Alexander asked after Okafor's posting specifically and committed to it over the phone."
```

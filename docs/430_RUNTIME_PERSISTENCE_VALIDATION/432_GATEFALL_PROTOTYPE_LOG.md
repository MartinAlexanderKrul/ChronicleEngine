...
**Checkpoints:** 96 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0096`)
...
**Latest capture:** `900_CHECKPOINT_0096` — kind `manual`, profile 1.75 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0095`, source `EVT-000546`.

...
provenance:
  source: EVT-000787
  game_date: "2026-08-27 ~11:45 -05:00"
  real_date: "2026-08-25"
moved_by_events: >
  `EVT-000786` `EVT-000787`
type: Character
...
aliases:
  - name: "Renata Okonkwo-Vance"
    quality: current
canonical_state:
  location: "Unestablished this call — worked entirely by phone. Confirmed she can be in Chicago Thursday, 2026-08-27."
  ...
  want: "An actual working line to a solo S-Rank the National office has never had leverage over — not to run him, to have a contact who picks up."
  fear: "That this goes the way it's gone with every prior unaffiliated S-Rank the office has tried to reach — cordial once, then nothing, because there was never a reason to call back a second time."
  secret: "She's read his Region V file closer than Farraday's summary would suggest, and already knows more about the shape of his last week than she said on this call."
  ...
  agenda: "**Thursday, 2026-08-27, meeting agreed** — she clears her afternoon, travels to Chicago, and leaves venue choice to Alexander ('somewhere with two exits and nobody who'll recognize either of us'). **Venue owed by Alexander, due 2026-08-26 end of day.** **Agreed to forward Alexander's contact information to the US S-Rank roster on her own initiative, today** — framed explicitly as consent-routing rather than a contact list handoff: she'll carry the request to each of them and let them decide whether to reach out, not hand out their information in return. Whether any of the eleven actually contact him is theirs to decide, not tracked here as a commitment on her part."
  knowledge: "Knows Alexander is a confirmed solo/unaffiliated S-Rank, recently carded, referred by Farraday/Region V. No channel to anything about the far door, the Stacks, the Mill fight, the Ninth Quiet, or any System-Bearer-only quantity — the call never touched any of it."
```
...
endpoints:
  ...
  - ENT-000233
type: working-source
qualities: "New and entirely untested in person — one phone call, professional on both sides, no friction. She offered him a real choice (venue, timing) rather than dictating terms; he asked for more than the introduction itself (the national roster, not just her) and she didn't treat that as overreach."
state: "**One call, 2026-08-27 ~11:45** (`EVT-000787`). Thursday, 2026-08-27, meeting agreed; venue owed by Alexander, 2026-08-26 EOD. She is forwarding his contact to the US S-Rank roster today, on her own initiative."
texture: "Businesslike, mutual, no small talk — closer in register to the Farraday relationship than to Teresa Vance's. Both ended the call without lingering."
history: "**No prior contact.** Reached via Farraday's direct-line handoff (`EVT-000786`) after Alexander answered the promised National introduction with 'Tell me time and place, I'll be there.'"
```

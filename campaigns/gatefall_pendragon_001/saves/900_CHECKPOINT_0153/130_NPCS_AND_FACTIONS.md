...
| Elias Kane (`ENT-000242`) | Owen Callahan's existence, the fight, the breakup, or anything about Alexander's relationship history before this week | 2026-09-16 | Alexander telling him directly. No channel established either way; treat as unknown to Kane until told, not as common knowledge |
...
history: "Formed 2026-09-04 (`EVT-000841`), a phone call ahead of the Karlov Guild meeting; deepened the same day at the meeting itself and that evening at a Prague bar (`EVT-000842`-`EVT-000843`). Four-way meeting venue confirmed 2026-09-14 (`EVT-000957`)."
```
...
state: "Live, confirmed. Wednesday 2026-09-16, ~20:00 local, The Sidecut, Chicago (`ENT-000211`) — his choice of city, Alexander's choice of place after Renata pointed him at it."
texture: "Two quick, easy texts — direct, low on pretense, no friction settling a real date."
history: "Introduction via Renata Okonkwo-Vance, `EVT-000847` (2026-09-05). First direct contact `EVT-000909` (2026-09-10). Meeting confirmed by text, `EVT-000917` (2026-09-11)."
```

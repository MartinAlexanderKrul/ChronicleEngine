...
**First entity block minted for her; authored in `270_THE_FAR_SIDE.md` Section 4.2, position `Let it finish`.** Met in person this session; heard Alexander's refusal to be persuaded before deciding, and respected it.
...
canonical_state:
  ...
  capabilities: "One Line, Refined and nineteen techniques ensuring it lands. Would rather talk than fight, and the file says a Runtime should let her."
  personality: "Unhurried, courteous, genuinely willing to lose an argument. Never raises her voice — which is what makes her frightening when she finally moves."
  ...
  fear: "That she is wrong. She has argued for billions of deaths on a conclusion she cannot check."
  secret: "She has begun to doubt her own count; something in the last two centuries doesn't fit, and she hasn't recounted, afraid of what it would oblige her to have done differently."
  voice: "Unhurried, courteous; asks what he thinks and waits for the answer."
  beliefs: []
  agenda: "Respected Alexander's refusal to be persuaded on first contact; agreed to attend the group gathering. At Sevrin's ground, said she might reconsider her own count if the real enemy proves separable from mere outcome — the first thing all session that moved her stated position at all."
```
...
endpoints:
  ...
  - ENT-000261
type: adversarial-negotiation
qualities: "A courteous adversary rather than an enemy — she wants his failure and says so plainly, without malice, and respects him more for declining to argue back before he'd heard everything."
state: "Live, unresolved. Attended the group gathering; her stated position held through it, but she named the one thing that could move her — proof the real enemy is separable from the outcome itself."
texture: "Two people who each recognize the other is arguing honestly, even from opposed premises."
history: "Formed this session (`EVT-000875`), met at the Long Shelf; deepened at the group gathering (`EVT-000878`)."
```
...
**First entity block minted for her; authored in `270_THE_FAR_SIDE.md` Section 4.2, position `Stop it`.** Met in person this session, over her own stated objection to Ilith's presence — Alexander brought the whole group anyway.
...
canonical_state:
  ...
  location: "Her own ground, deep in the Stacks."
  condition: "Healthy, unhurt. Cannot out-damage Alexander and knows it; her real threat is Closing Word — a lockdown that outlasts his far-side Mana pool, not a fight she could win directly."
  capabilities: "Twenty denial techniques — Stillwater, Doorward, Refuse the Opening, Weight of the Span, Every Seam She Has Walked, and more. No damage output at all."
  personality: "Short sentences, long pauses. Asks a question and waits past the point of comfort for the answer."
  want: "To end the entire process that made her and all five of them what they are — not Alexander's win or loss specifically, the process itself."
  fear: "That the plan she's carried four thousand years is wrong, and she'll never find out."
  secret: "She has been to the Weir's deepest seam and seen what's on the other side. Will not say what, and it is not the Adjudicator."
  voice: "Short sentences, long pauses; asks and waits."
  beliefs: []
  agenda: "Objected once, plainly, to Ilith's presence, then honored her word to talk anyway. Offered to teach seam-work up to the point it would work against ending the process — a real, bounded offer. Asked Alexander a direct question in return: which outcome he'd actually choose, process-ending or a passed Earth, if it came to it — unanswered as of this session, deliberately deferred by Alexander rather than answered glibly."
```
...
endpoints:
  ...
  - ENT-000263
type: adversarial-negotiation
qualities: "The most guarded of the five on first meeting, and the one whose respect Alexander most visibly earned — by declining to answer her hardest question glibly."
state: "Live, unresolved. A real trade offer stands (seam-work instruction, bounded by her own goal). She asked a direct question Alexander deferred rather than answered; she approved of the deferral explicitly."
texture: "Adversarial in position, not in conduct — she tested him once (bringing Ilith) and, having voiced the objection, did not relitigate it."

...
scope: campaign
# This save: EVT-001213, EVT-001214, EVT-001215, EVT-001217 (Dario ENT-000265 -- the morning, HQ, the lesson plan; Anjali ENT-000288 -- the 38 A-Rank pieces, a standing instruction;
...
canonical_state:
  ...
  location: "**BGM National, Washington, DC — in contact by text and phone on 2026-10-01** (`EVT-001203`, `EVT-001209`); her early lot window runs on Eastern time. Last seen in person at the Pendragon Guild's Washington recruitment evening. Prior: the Averlon Room, 200 N Michigan Ave, Chicago, 2026-08-27, where the standing agreement was signed over dinner (`EVT-000801`)."
...
history: "Formed 2026-09-06 (`EVT-000854`, texted contact via Renata's roster-forward; `EVT-000857`, met in person at The Sidecut, Cermak Road). Carried-over call completed 2026-09-10 08:00 (`EVT-000904`). Sparring and Blue Island 2026-09-10 (`EVT-000906`) — Standfast tested, his first personal kill in years, flirtation reciprocated. Winnetka house visit 2026-09-12 — teleported over for a beer, house tour, real personal disclosure both directions. *You're mine now* -- *Yours*, 2026-10-01 (`EVT-001213`); asked directly whether he wanted to go to National, and said yes for himself (`EVT-001213`)."
moved_by_events: "`EVT-001003` `EVT-001008` `EVT-001011` `EVT-001021` `EVT-001023` `EVT-001033` `EVT-001041` `EVT-001045` `EVT-001048` `EVT-001050` `EVT-001051` `EVT-001092` `EVT-001093` `EVT-001148` `EVT-001153` `EVT-001210` `EVT-001211` `EVT-001213`"
```
...
canonical_state:
  ...
  location: "**The Pendragon Guild HQ, Detroit, 2026-10-01 afternoon** (`EVT-001214`), preparing the menders' session. Home: San Francisco."
  condition: "Healthy; no adverse condition established."
...
history: "Introduction via Renata Okonkwo-Vance, `EVT-000847` (2026-09-05). First direct contact `EVT-000909` (2026-09-10). Meeting confirmed by text, `EVT-000917` (2026-09-11). First in-person meeting, network pitch, and teleportation disclosure, `EVT-001015` (2026-09-16). Prague dinner and overnight stay, `EVT-001021`-`EVT-001023` (2026-09-17). Own home named (Oakland), dropped there directly, `EVT-001026` (2026-09-18). The morning at Winnetka, and the disclosure, 2026-10-01 (`EVT-001210`, `EVT-001211`). *You're mine now* -- *Yeah. Okay. Yeah*, 2026-10-01 (`EVT-001213`)."
```

...
Assert-Contains $profile 'World Rule Profile 1\.41' 'Gatefall profile is not version 1.41.'
...
Assert-Contains (Get-MigrationRecord '1.40' '1.41') '1\.40.+1\.41 compatibility treatment' 'The 1.40 to 1.41 migration record lacks its treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.41' 'Gatefall README does not advertise Profile 1.41.'
...
Assert-Contains $character 'profile_version: "1\.41"' 'Live Gatefall character has not adopted Profile 1.41.'

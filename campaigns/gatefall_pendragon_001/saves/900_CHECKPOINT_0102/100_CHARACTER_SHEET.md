...
canonical_state:
  ...
  condition: |
      Health **1,664/1,664**, Mana **824/824**, both full — **Level 37, System Rank B, Combat Tier A, 13:01 on 2026-08-21 (Friday)**, at the Rogers Park apartment with nothing scheduled until 19:30. **Five ability points unspent. Gold 305,251**, the campaign's highest.

      **Fenn's shell met the fence** (`EVT-000580`): the alias on Marnie's storage unit is a three-layer shell, and **it is the same structure that owns the fenced warehouse**. She will not claim Marnie rented the box — three readings survive on paper. *Don't go to the unit; the access log is theirs.* Asked with *no obligations* attached to work off record, she separated **off the invoice (yes) from off the law (no)**; Alexander corrected her coldly for pre-warning a man who had not pressed, and she conceded it entirely. **Mandate now standing.**

      **He told Owen before instead of after** (`EVT-000581`) — alarm set in front of him, destination named unprompted, **and the Rank given straight** when asked the mender's question. *'I'm proud of you. Not for the B-Rank. For telling me before.'* Owen does not know the roster was five against eight and did not ask.

      **The morning changed the Ironline thread permanently** (`EVT-000583`). A 06:04 advisory made filed rosters spot-auditable; Wade **held the run**, told five people himself, and finally got an answer to the question he had asked three times. **Alexander wants him in Brannigan's chair with the guild held through him, and handed over the unfiled roster report to get him there** — the leverage underwriting the relationship since the fourteenth, given without renegotiating a term. Then the diagnosis: **the padding is margin, not laziness**, and the unfindable third lever is **supply** — which is Wade's four hundred and eleven phone numbers. `OBJ-36` opens.

      **Two Gates for training, neither reported.** The **Ashfield** (`EVT-000584`) had its archetype **deleted by Shrug Off**, proved Flash Step's 100 m no-sight band, and established that **Twin Fang cannot credit at C-Rank at all** — his main hand exceeds every body there. **Rupture crossed to Expert for no magnitude**, held by its own floor. The **Crypt** (`EVT-000586`) was the week's first archetype not folded by a passive, and Keen Sense read it whole in the dark regardless: **fifteen of fifteen, zero damage, four mastery rungs on one scene**, and Twin Fang credited again against the smallest body that can survive him.

      **Level 35 → 37**, nineteen points spent (+12 Intelligence, +7 Strength). **A Runtime error caught by the player**: the Mana Bolt breakthrough was rendered as a −21 loss before `magnitude_floor` was applied; §7.3 forbids it, and the correct figure is **+149**. Mana Bolt closes at **907**.

      **The campaign's first streak-upgraded box** (`EVT-000585`) gave two futures and he kept the **Field Command [C-Rank] rune** — four hours after telling a man with four hundred and eleven numbers to start calling them.

      Superseded anchor states are not held here. `160_CAMPAIGN_CHRONICLE.md` narrates every span in full, and `moved_by_events` above references every Event that claims to have moved this record -- Decision 085 requires the reference, never the narration. Thirty-two prior anchors were retired on that basis; read the chronicle for any of them.
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-21T13:01:00-05:00"
    ...
    skills_known:
      ...
      - "Rupture [A-Rank] ★★★★☆ Expert · Mana 10 · **reach 5 m** · a heavy strike at **×2.60** of its A-Rank skill-rank baseline (375, §7.2), resolving as `(375 + effInt + focus power) × 2.60 × result` under §6.2 — **DMG 2,046 standard before reduction** at effective Intelligence 412 (`(375+412)×2.60=2,046.2`). **`magnitude_floor` 260 holds ×2.60 over the rung the mastery level authors** — Expert authors ×2.45 and the floor still wins, so the Expert crossing paid nothing in magnitude. Categories: **Compound** (D); **Structural** (C); **Ward-breaking** (B); **Propagating** (A) — carries to one further target in contact with or immediately behind the first. **Successful uses 120 · qualifying scenes total 37 · mastery progress 1/3 toward Master · mastery level EXPERT (4) · rank ascensions 4 · magnitude_floor 260.** Adept → Expert at `EVT-000584`. Full ascension history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Flash Step [A-Rank] ★★★☆☆ Adept · Mana 7 · **reach: any point within 100 m, sight or no sight** — the metre band this line promised from the day it was written and withheld until A-Rank. Grants +1 modifier step to the follow-up action; at Adept the window covers the immediate action plus **two further exchanges** (Section 7.4's utility ladder). Category **`Return` (A):** once, inside the follow-up window, step back to the point left from without paying again. **Breakthrough B-Rank Master -> A-Rank Adept at `EVT-000571`**, taken on a Master rung four minutes old, Mana 6 -> 7 the earned road's price. **At its System Rank B+1 ceiling; no further offer.** Retained **Through the barrier** (C): crosses a closed constructed barrier rather than only open distance, given a held read of the far side; never a Gate boundary, §9.6 seal or §17 wall. **Successful uses 62 · qualifying scenes total 25 · mastery progress 1/3 toward Expert · rank ascensions 3.** **Reach band first tested at `EVT-000584`** — ninety metres through a wall, no line of sight. Crossed to Master at `EVT-000571` and spent that rung on the breakthrough in the same exchange. Qualifying scene at `EVT-000567` — a flanking cross through terrain that existed only because Sprint's **Vertical** was running. Two ascensions and one mastery advance before this span; full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Keen Sense [A-Rank] ★★★★★ Master · Mana 1 · +1 modifier step on detection **for the scene**, shared with **himself plus 9 allies** (10 subjects — A-Rank Master computes `5 + 4 = 9`; `scope_floor` 8 no longer binds). Categories: **presence** (E); **intent and method** (D); **structure through barrier** (C) — layout and extent of an unseen space beyond line of sight; **through concealment** (B) — pierces an active concealment or detection-blocking ward; **Provenance** (A) — what passed through a place, how long ago, and which way. **Uses 83 · scenes 55 · mastery progress complete · mastery level MASTER (5) · ascensions 4 · scope_floor 8.** **Expert → MASTER at `EVT-000571`. At its Section 7.5 ceiling** ([A] = System Rank B + 1), so no breakthrough opens; finished until System Rank A. Qualifying scene at `EVT-000564` — a read establishing a boss's *motive* rather than its position, `Provenance` resolving two bodies as one paired nest. Three breakthroughs; full ascension and per-use history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Broken Rhythm [E-Rank] ★★★☆☆ Adept · Passive · Reading a live opponent's weight-shift and tell-cadence to react before the movement completes; +1 modifier step on evasion/reaction against any perceived attacker's telegraphed action — not limited to surprise/ambush exchanges the way Pre-empt is. **Mastery widens scope — 1/2/3/4/5 beneficiaries** (Novice through Master): at Novice it benefits Alexander alone, and each level extends the step to one further ally who can perceive him, against an attacker whose cadence he has read and named aloud; the ally reacts on the read as though it were his own. **Successful uses 92 · qualifying scenes total 8 · mastery progress 2/3 toward Adept · scope_floor 0.**"
      - "Dagger Mastery [B-Rank] ★★★★☆ Expert · Passive · adds **+1.00** to a Quickknife chassis multiplier (×0.75 → **×1.75**), on both equipped Quickknives (Section 7.4 +0.05/level). Categories: **Any blade** (D); **Thrown** (C). **Uses 235 · scenes 31 · mastery progress 2/3 toward Master · mastery level EXPERT (4) · ascensions 3.** **Adept → EXPERT at `EVT-000571`**, ×1.70 → ×1.75. **`Thrown` (C) ruled at `EVT-000563` to cover a blade launched by Dimensional Projection** — a projected Quickknife resolves at ×1.70, not bare ×0.75; `Any blade` (D) covers a projected Longsword the same way. Both categories granted at `EVT-000391` under Profile 1.52's magnitude-axis ladder — a deferral paid rather than a new grant. Until then this skill had ascended twice and gained nothing but a larger multiplier, which is what raised `F-014`. Full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Twin Fang [C-Rank] ★★★★☆ Expert · Mana 4 · while two Quickknives are equipped, follow one ordinary Quickknife strike against a single target with a separately rolled strike from the other Quickknife in the same action. Each strike uses only its own weapon power; the skill-enabled second strike has a **×2.15** Twin Fang mastery multiplier at C-Rank Expert — `1.00 + 0.35 × 2 + 0.15 × 3` (`EVT-000393`) — **1,314 standard**, package **1,935** with the main-hand. Twin Fang occupies the action's offensive active-skill position and cannot combine with Rupture. **Successful uses 121 · qualifying scenes total 24 · mastery progress 1/3 toward Master · mastery level EXPERT (4) · rank ascensions 2 · magnitude_floor ×1.60.** **Its credit rule is now a content gate**: zero uses across an entire C-Rank Gate at `EVT-000584`, because his main hand exceeds every body there. **The smallest thing that can still train it is a B-Rank elite at 1,200 Health.** **Adept → EXPERT at `EVT-000571`.** **Second-strike DMG re-derived to 1,108**, package **1,672**, at effective Strength 310 (`EVT-000568`). **A successful use is recorded only when the second strike lands and materially contributes**; a target dying to the first strike spends the Mana and credits nothing (`EVT-000512`). Full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Exploit Pattern [A-Rank] ★★★★★ Master · Passive · a successful deliberate tactical read establishes an active Pattern on an opponent, behavior, weakness, or structure; +1 modifier step on every personal action genuinely exploiting it until the scene ends or it becomes invalid. Never restricts ordinary analysis; no stacking from one finding. **9 concurrent Patterns** — A-Rank Master computes `5 + 4 = 9`; `scope_floor` 8 no longer binds; the ascension bought the category, not the count. Categories: **Persistence** (D); **Group coordination** (C); **Composite read** (B) — two Patterns exploited together as one; **Anticipatory** (A) — a Pattern reaches what the subject has **not yet done**, so he may exploit an action before it is declared. **Uses 71 · scenes 38 · progress complete · mastery level MASTER (5) · ascensions 4 · scope_floor 8. Expert → MASTER at `EVT-000586`; AT ITS §7.5 CEILING**, finished until System Rank A.  ADVANCED Adept → EXPERT at `EVT-000568`** — `3 + 5 = 8` concurrent Patterns — already held there by `scope_floor`, so the rung pays nothing in count and the gain is entirely in what a Pattern may be. Its third qualifying scene is `EVT-000563` — a **temporal** Pattern on groups cycling between pockets, rather than the structural reads this skill has always done."
      - "Silent Step [D-Rank] ★★★★☆ Expert · Mana 4 · +1 modifier step on stealth and unseen-approach actions for the scene. **Scope is mastery's axis — 1→5 beneficiaries, scene-long at every level** (§7.4), plus one per Rank above native; at Expert, **5**. Category **`Concealment through action` (D):** concealment survives **one** attack or manipulation — strike, cut, lift, open or take once without the effect ending; it ends on the second. It needs terrain that can hide someone; a cast with nowhere to break to is refused before it costs anything. **Successful uses 26 · qualifying scenes total 15 · mastery progress 0/3 toward Master · mastery level EXPERT (4) · rank ascensions 1.** Breakthrough [E] Master → [D] Adept at `EVT-000569`; Adept → Expert at `EVT-000586`. Per-scene history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Mana Bolt [B-Rank] ★★★☆☆ Adept · Mana 6 · **no distance limit; a target DETECTED but not seen is a legal target** · a ranged bolt at **×1.60 of the B-Rank skill-rank baseline** (155, §7.2), resolving as `(155 + effInt + focus power) × 1.60 × result` under §6.2 — **DMG 907 standard before reduction** at effective Intelligence 412 (`(155+412)×1.60=907.2`). **`magnitude_floor` 160 binds** — Adept authors ×1.30, and §7.3's ratchet holds the higher figure, which is why the [C]→[B] breakthrough paid **+149** rather than costing 21. Mana 5 → 6: the floor protects magnitude, not cost. Categories: **Arcing** (D) — the bolt bends around intervening cover; **Unsighted** (B) — a resolved Keen Sense or held read substitutes for eyesight. Never crosses a Gate boundary, a §9.6 seal, or a §17 instance wall. **Successful uses 57 · qualifying scenes total 15 · mastery progress 0/3 toward Expert · mastery level ADEPT (3) · rank ascensions 2 · magnitude_floor 160.** Master, then breakthrough to [B-Rank] Adept, both at `EVT-000586`."
      - "Field Command [C-Rank] ★☆☆☆☆ Novice · Passive · relay one active Exploit Pattern by a brief actionable call to allies who can perceive and understand Alexander. Each recipient treats the Pattern as personally understood, needs no separate tactical read, and gains its +1 modifier step on genuinely exploiting actions; Alexander may update the call before a recipient's roll, never afterward. Ordinary communication conveys information but not the Pattern's mechanical benefit. **Scope is mastery's axis — 1→5 simultaneous recipients** (Section 7.4), plus one per Rank above native; at C-Rank Novice, **3** — exactly what Adept already gave, so **the ascension bought the categories and nothing else**. Categories: **`Relay at range` (D)** — recipients need not perceive him; the call carries to anyone he has spoken with in the scene, by radio, phone or prearranged signal. **`Composite relay` (C)** — relay **two** Patterns at once. **Uses 19 · scenes 8 · progress 0/3 · mastery level NOVICE (1) · ascensions 1.** **Rune-ascended [E] Adept → [C] Novice at `EVT-000585`**, two Ranks. Ceiling A."
      - "Resonance Extraction [D-Rank] ★★★★☆ Expert · Passive · a successful read establishes a Resonance Pattern for one vein, +1 modifier step on extraction until exhausted/shifted. **At Expert, three further miners may follow his calls** (Section 7.4's scope ladder, 0/1/2/3/4 Novice through Master). **Uses 33 · scenes 19 · progress 2/3 toward Master · mastery level EXPERT (4).** **Adept → EXPERT at `EVT-000571`**, settling a stored line that had read *progress toward Master* against a three-star Adept for two spans, skipping Expert — the `F-037` shape. Qualifying scene at `EVT-000567` — a natural 100 stripping **96 of 96**, nothing left in the wall. Passive, so the Mana axis does not apply."
      - "Flux Sight [A-Rank] · Stat Passive · reads Rank/Health/Mana of monsters and hunters; confirms Gates one Rank above System Rank; new at B, appraises an unidentified item's Rank/stats on sight (Section 4.4). **Uses 62 · Perception 349 · [S-Rank] held: System Rank ceiling** — it stands at A-Rank, which *is* the Section 4.4 ceiling (System Rank B + 1); that ceiling rose with System Rank B (`EVT-000515`), and S needs both Perception 80 and System Rank A. Flux Sight is authored to S-Rank so the Section 4.4 authoring clamp never binds it, but the **System Rank + 1 ceiling does**: at System Rank C its ceiling is B-Rank, where it already sits. Perception buys this skill nothing until System Rank reaches B — the A-Rank stat threshold at 66 would be held by the ceiling even if reached."
      - "Overpower [A-Rank] · Stat Passive · sustained restraint; break ranked structures; **redirection** — a foe he holds becomes a weapon, thrown or driven into another target with the strike transferring to it, and a creature can be shifted off its own footing mid-exchange, denying it a chosen line (Section 4.4). **Uses 5 · Strength 372 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`**: restrain up to three Ranks above, and **break ranked inanimate structures one Rank above the skill**. No Stat moved to earn it."
      - "Pre-empt [A-Rank] · Stat Passive · shared warning — allies act normally in a surprise exchange alongside him; **first blade** — in any exchange he opens he resolves before any opponent up to B-Rank acts, whatever order the fiction implies (Section 4.4). **Uses 24 · Agility 348 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`; first blade now runs up to A-Rank.** Held off the surprise penalty from his own botched entry (`EVT-000339`)."
      - "Conduit [A-Rank] · Stat Passive · Mana recovery **+25 percentage points** at both Section 5.2 rates — **35%/hr active, 50%/hr resting** against the 10/25 baseline (A-Rank rung, `EVT-000515`). **Uses 0 · Intelligence 409 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`.** Held rung rose A→S at `EVT-000487`: base Intelligence 84→80 reaches the S threshold exactly. Rank actual unchanged at B under the ceiling. Rank derives from the same Intelligence 84 Multitask held, so no Stat moved in the exchange. Composition order is fixed (Section 5.2): base, Conduit, environmental halving, then any title multiplier; a Frozen Gallery halves 30/45 rather than 10/25. It cannot reach inside a fight — recovery settles from elapsed time, an exchange is not an hour, and Section 5.3's exhaustion is untouched."
      ...
      - "Shrug Off [A-Rank] · Stat Passive · ignores minor-wound penalty; **threshold absorption** — once/scene, a hit crossing the injury threshold inflicts damage only; **total suppression** — **every** wound's modifier-step penalty is suppressed until scene end rather than one, and environmental hazards up to B-Rank cause no onset at all rather than halved onset (Section 4.4). **Uses 5 · Vitality 415 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`."
    ...
    tracked_counters:
      ...
      - { path: skills.rupture.successful_uses, baseline_value: 16, baseline_as_of: EVT-000130, current_value: 120 }
      - { path: skills.rupture.qualifying_scenes_total, baseline_value: 8, baseline_as_of: EVT-000130, current_value: 37 }
      - { path: skills.rupture.mastery_progress, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 1 }
      - { path: skills.flash_step.successful_uses, baseline_value: 6, baseline_as_of: EVT-000130, current_value: 62 }
      - { path: skills.flash_step.qualifying_scenes_total, baseline_value: 4, baseline_as_of: EVT-000130, current_value: 25 }
      - { path: skills.flash_step.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 1 }
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 83 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 55 }
      ...
      - { path: skills.dagger_mastery.successful_uses, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 235 }
      - { path: skills.dagger_mastery.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 31 }
      - { path: skills.dagger_mastery.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 2 }
      - { path: skills.twin_fang.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 121 }
      - { path: skills.twin_fang.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 24 }
      - { path: skills.twin_fang.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 1 }
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 71 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 38 }
      - { path: skills.exploit_pattern.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 0 }
      - { path: skills.mana_bolt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 57 }
      - { path: skills.mana_bolt.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 15 }
      ...
      - { path: skills.mana_bolt.magnitude_floor, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 160 }
      ...
      - { path: skills.resonance_extraction.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 33 }
      - { path: skills.resonance_extraction.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 19 }
      - { path: skills.resonance_extraction.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 2 }
      - { path: skills.flux_sight.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 62 }
      ...
      - { path: skills.sprint.successful_uses, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 17 }
      - { path: skills.sprint.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 15 }
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 26 }
      - { path: skills.silent_step.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 15 }
      ...
      - { path: skills.dimensional_projection.successful_uses, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 17 }
      - { path: skills.dimensional_projection.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 9 }
    ...
    daily_premium:
      ...
      offers:
        ...
        rune: "Premium Rune — teaches **Rupture** · [S-Rank] · UNBOUND · NPC-ELIGIBLE · 2,250,000 g · unpurchased — Alexander already holds Rupture at [A-Rank] Expert (`EVT-000584`); S-Rank content is unauthored below System Rank A (Section 7.3), so this is priced but flagged unusable rather than resolved either way"

...
**Checkpoints:** 112 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0112`)
...
| frozen | 0009–0112 | 104 |

**Latest capture:** `900_CHECKPOINT_0112` — kind `session-save`, profile 1.86 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0111`, source `EVT-000643`.

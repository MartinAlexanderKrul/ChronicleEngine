...
### Five Solo Instant-Dungeon Clears and Their Sales (2026-07-31 to 2026-08-02) — **compressed, fully superseded**

Per-clear populations, rolls, drops and gold traces are in `160_CAMPAIGN_CHRONICLE.md` at `EVT-000096`-`EVT-000114`. Every crystal and every piece of gear from these five clears has since been sold; nothing from them remains individually held, so the detail is not restated here.

- **Clears:** Overgrown Temple and Hive (2026-07-31, `EVT-000097`/`EVT-000099`), Frozen Gallery (2026-07-31, `EVT-000101`), Crypt (2026-08-01, `EVT-000109`), and a Serpentine-boss instance (2026-08-02, `EVT-000113`). Never hit in any of them.
- **Acquired and kept from this span:** the **Ghost Quickknife [B-Rank]** (Daily Premium, 18,000 g, `EVT-000096`) — still the equipped main hand; **Keen Sense** and **Dagger Mastery** both learned from 1,000 g catalogue runes (`EVT-000114`); and the E-Rank cores that fed the later Walt Adamik trade (`EVT-000212`).
- **Sold or consumed:** all E-Rank crystals across the span (bench sale `EVT-000102` plus per-clear sales), the Gale Torso [E-Rank] (15 g), and the Quickstep Charm [E-Rank] (later sold, `EVT-000118`).
- **Position at the end of the span:** 0 E-Rank crystals, 11 E-Rank cores, gold **920**.
...
### Pending — as of 2026-08-16 15:00

- **$221,540.00** — Wade Bishop's trial payout, filed 2026-08-14, processing. **Now three days out on a stated 1-2 business day window.**
- **$9,418.60** — Cicero Scar harvest cut (`EVT-000398`, 12/43 declared, 20% of a $168,750 clear), filed 2026-08-15, processing.
- **$60,677.42** — Dale Pruitt B-Rank harvest cut (`EVT-000415`, 19/31 declared, 20% of a ≈$495,000 clear), filed 2026-08-16, processing.

**Total pending, unreceived: $291,636.02.**

**Cash on hand is unchanged at $45,074.00 and has been since 2026-08-15** — no mundane-economy transaction has occurred in two days. Gold unchanged at **47,561**; no shop transaction.

### Owed Out — as of 2026-08-15 22:30

- **$800.00** — Priscilla Nakamura (`ENT-000203`), identification of the Dormant Core [S-Rank], billed at her difficulty rate at `EVT-000410` and **not paid at the workshop**. No due date named; the next natural settlement point is the Tuesday 2026-08-18 session.
- **$400.00** — Duane (`ENT-000199`), the freight yard off Ashland, cash on arrival Monday 2026-08-17 (`EVT-000373`). Unchanged.

**Cash on hand is unchanged at $45,074.00** — no mundane-economy transaction occurred this evening. Gold unchanged at **47,561**; no shop transaction.

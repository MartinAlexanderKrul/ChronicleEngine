# Gatefall — World Rule Profile 1.61
...
**Full read on first perception of a subject in a scene.** Thereafter that subject's pools re-render **only in an exchange the Bearer's own resolved action changed them**, as a bare line in the Section 14.5.1 grammar carrying the subject — the same rule his own numbers already follow, pointed outward:

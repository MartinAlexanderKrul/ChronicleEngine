...
Assert-Contains $profile 'World Rule Profile 1\.32' 'Gatefall profile is not version 1.32.'
...
Assert-Contains $readme 'World Rule Profile 1\.32' 'Gatefall README does not advertise Profile 1.32.'
...
Assert-Contains $character 'profile_version: "1\.32"' 'Live Gatefall character has not adopted Profile 1.32.'

...
**Checkpoints:** 105 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0105`)
...
**Latest capture:** `900_CHECKPOINT_0105` — kind `session-save`, profile 1.86 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0104`, source `EVT-000604`.

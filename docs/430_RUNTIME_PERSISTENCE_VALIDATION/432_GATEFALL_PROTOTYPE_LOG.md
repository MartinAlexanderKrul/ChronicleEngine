...
**Checkpoints:** 179 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0179`)
...
| frozen | 0009–0179 | 171 |

**Latest capture:** `900_CHECKPOINT_0179` — kind `manual`, profile 1.124 (frozen), schema 0.1.8, parent `900_CHECKPOINT_0178`, source `EVT-001225`.

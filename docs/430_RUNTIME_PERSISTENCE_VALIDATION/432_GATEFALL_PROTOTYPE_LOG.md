...
**Checkpoints:** 144 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0144`)
...
| frozen | 0009–0144 | 136 |

**Latest capture:** `900_CHECKPOINT_0144` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0143`, source `EVT-000916`.

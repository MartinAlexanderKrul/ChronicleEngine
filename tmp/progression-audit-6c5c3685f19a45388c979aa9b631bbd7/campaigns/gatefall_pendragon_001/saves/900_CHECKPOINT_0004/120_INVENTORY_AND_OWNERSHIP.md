...
System-shop gold (170 g, from an undeclared private crystal sale) is Bearer state, not mundane property — tracked in `100_CHARACTER_SHEET.md`'s `system_state`, not here, per World Rule Profile Section 14.1.

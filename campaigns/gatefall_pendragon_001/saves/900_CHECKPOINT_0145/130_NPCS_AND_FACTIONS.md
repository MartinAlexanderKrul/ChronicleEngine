...
canonical_state:
  ...
  note: "Not yet set as a rift anchor — he has stood here (the walkthrough), so the ground is available whenever he chooses to hold it (Section 6.2's no-roll zone for uncontested, unambiguous ground)."
```
...
canonical_state:
  ...
  portrait_note: "**Stale — generated against the pre-2026-09-13 'pale' description, before the player's own deliberate revision to a heavily muscled Black man. Needs regenerating.**"

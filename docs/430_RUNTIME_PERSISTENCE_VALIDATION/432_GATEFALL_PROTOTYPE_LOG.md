...
**Checkpoints:** 62 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0062`)
...
**Latest capture:** `900_CHECKPOINT_0062` — kind `manual`, profile 1.46 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0061`, source `EVT-000337`.

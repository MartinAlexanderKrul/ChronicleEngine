...
System-shop gold (25,330 g, from seven undeclared private crystal sales total across both harvest jobs) is Bearer state, not mundane property — tracked in `100_CHARACTER_SHEET.md`'s `system_state`, not here, per World Rule Profile Section 14.1.

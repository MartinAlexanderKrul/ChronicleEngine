...
**Checkpoints:** 121 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0121`)
...
| frozen | 0009–0121 | 113 |

**Latest capture:** `900_CHECKPOINT_0121` — kind `session-save`, profile 1.98 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0120`, source `EVT-000712`.

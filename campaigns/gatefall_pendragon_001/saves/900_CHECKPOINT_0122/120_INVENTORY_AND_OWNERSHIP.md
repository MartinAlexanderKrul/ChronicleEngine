...
```yaml
current_funds:
  as_of_event: EVT-000721
  as_of_game_date: "2026-08-25T12:30:00-05:00"
  cash_usd: 329090.22
  gold: 5124181
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**2026-08-25 10:40-12:30 (`EVT-000713`-`EVT-000721`): gold 1,030,081 -> 5,124,181; cash unchanged at $329,090.22.** Out: **-200,000 g** A-Rank instant-dungeon key (`EVT-000714`); **-200,000 g** second A-Rank key (`EVT-000716`); **-900,000 g** S-Rank instant-dungeon key, the first bought at his own System Rank (`EVT-000719`). In: **+744,600 g** selling 219 A-Rank crystals off the first clear's kills and mined deposit; **+625,600 g** selling 184 A-Rank crystals off the second clear; **+4,023,900 g** selling 263 of 363 S-Rank crystals off the third clear at **15,300 g each** — a ruled price, now Profile 1.99 law (`worlds/gatefall/migrations/1.98_to_1.99.md`), since Section 12.5's crystal table had never carried an S-Rank row (`EVT-000720`). **100 S-Rank crystals remain unsold.** **Non-monetary movements recorded on the character sheet**: 8 A-Rank cores, 3 S-Rank cores; a second S-Rank instant-dungeon key (boss drop, unspent); three redundant unbound instructional items (a Mend rune [E-Rank], a Flash Step skill book [A-Rank], a Silent Step rune [E-Rank] — all below or at techniques already held). Prior: **2026-08-24 10:16 - 2026-08-25 10:40 (`EVT-000699`-`EVT-000712`): gold 1,530,081 -> 1,030,081; cash $329,287.22 -> $329,090.22.** Full prior movement history: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures."
```

...
- **63 C-crystals**, mined and physically held from the Frozen Gallery job's three vein assignments, not yet declared to Dale's manifest (`EVT-000065`, `EVT-000066`). The job is in progress: no boss kill, no exit, no formal declaration yet. Of 104 total crystals mined at this site, 48 were sold privately through the System shop across four separate sales of 12 each and never entered this declarable count.

System-shop gold (8,330 g, from five undeclared private crystal sales — 1 at the Cicero Scar, 4 of 12 each at the Frozen Gallery) is Bearer state, not mundane property — tracked in `100_CHARACTER_SHEET.md`'s `system_state`, not here, per World Rule Profile Section 14.1.

...
**Checkpoints:** 141 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0141`)
...
| frozen | 0009–0141 | 133 |

**Latest capture:** `900_CHECKPOINT_0141` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0140`, source `EVT-000908`.

...
**Cash on hand: $2,174.00** — as of 2026-08-17 19:45 (`EVT-000453`). Down from $45,074.00, which it had held since 2026-08-15. Three transactions on 2026-08-17: two at Walt Adamik's shop (`EVT-000446`, `EVT-000447`) — **−$2,500.00** for the Mana Reservoir [C-Rank], and **−$40,000.00** as the opening capital of the `OBJ-29` partnership — and **−$400.00** to Duane (`ENT-000199`), paid cash on arrival at the freight yard as agreed (`EVT-000453`). Gold unchanged at **97,811**; no System-shop transaction this span.

**This is the thinnest Alexander's cash has been since 2026-08-03, and the nearer live obligation is now cleared:** the $400 due to Duane is paid in full. $800 is still owed to Priscilla Nakamura with no due date named, comfortably covered by $2,174. The margin is real but not urgent — the $291,636.02 that would erase the thinness is a processing queue rather than money he holds. He committed the $40,000 knowing the pending column, not the cleared one.

### Owed Out — as of 2026-08-17 19:45

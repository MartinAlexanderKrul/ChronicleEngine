...
As of 2026-07-26 repository time, ordinary play has advanced the campaign to twenty-three canonical-form checkpoints (`900_CHECKPOINT_0001`–`0023`). Checkpoint 0015 is the first automatic Context-Preservation capture under Data Model 0.1.3; Checkpoint 0020 is the first capture under frozen Gatefall Profile 1.10; Checkpoints 0022–0023 are immutable Profile 1.11 / Data Model 0.1.3 captures, with 0023 latest. Live state has since advanced to Profile 1.12 and Data Model 0.1.4; every checkpoint remains immutable and runs the applicable readiness chain before play.

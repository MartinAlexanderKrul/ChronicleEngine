...
- **Engine Rules:** 0.3.0
- **Data Model:** 0.1.6
- **Campaign time:** **2026-08-15 (Saturday), 22:30 CDT (`-05:00`)** — day closed at the Rogers Park apartment. The twenty-second daily completed, streak 8. **Both of tonight's commitments are done:** Reyna Castillo met at 19:00, Priscilla Nakamura met at 21:00. Next daily issues 2026-08-16 06:00.
- **Latest restorable checkpoint:** `saves/900_CHECKPOINT_0072/` — the artificer answered, and the last candidate met.
...
- **Health:** **416/416. Mana: 122/122. Both full**, no injury. Maxima re-derived by today's level-up (`EVT-000401`); Mana then spent to 77/122 across the boss fight (`EVT-000402`) and **refilled entirely by the 2h15m from the dungeon exit to now** — settled at `EVT-000406` after `EVT-000403` asserted it rather than computing it. Conduit at B-Rank (45%/hr resting) restores 123 against a 122 pool, so the span caps it with room to spare.
...
- **B-Rank crystals: 35 banked, undeclared** (was 40) — **5 given to Nakamura tonight**. See `140_OBJECTIVES.md` `OBJ-27` and `100_CHARACTER_SHEET.md` for the 25 further B-Rank crystals and 1 core still sitting undivided in the trial Gate's combat pool.
- **C-Rank crystals: 140 banked** (147 after today's mining, **−7 to Nakamura**). **C-Rank cores: 5 banked** (7 after the dungeon, **−2 to Nakamura**). **D-Rank cores: 20** (was 28, **−8**). **E-Rank cores: 0** — the line is closed, the last one given.
- **Total given to Priscilla Nakamura tonight (`EVT-000410`), as an unprompted deposit of intent:** 5 B-Rank crystals, 7 C-Rank crystals, 2 C-Rank cores, 8 D-Rank cores, 1 E-Rank core. No cash, no gold, nothing declared or sold — a straight transfer of undeclared and largely unsaleable stock. Her own read: *"a licensed harvest crew's good month."*
...
- **Current location:** home, Rogers Park apartment, **22:30 Saturday night**, in bed. Owen was asleep on the couch when he got in and was carried to bed without waking — the second recorded instance after `EVT-000243`.
- **TODAY, Saturday 2026-08-15 — all settled:**
  ...
  - **Reyna Castillo met, 19:00, the Loyola lakefront** (`OBJ-26`, `EVT-000409`) — **attending Monday as an evaluator, not signed.** `REL-000095` formed.
  - **Priscilla Nakamura met, 21:00, her workshop off LaSalle** (`OBJ-16`, `EVT-000410`) — **the Dormant Core identified and a working arrangement struck.** `REL-000096` formed.
  - **The daily quest is complete** (streak 8) — no penalty risk. Next issues 2026-08-16 06:00.
  - **The Daily Premium tab's 06:00 rotation boundary has still not resolved live** — it resolves at the next `/system shop`.
  - **The two evening commitments never did get checked against each other for travel time** — it turned out not to matter; 19:20 to 20:54 across town was comfortable.
...
**Live canon is promoted through `EVT-000412`.** Since Checkpoint 0071 (canon through `EVT-000406`): **`EVT-000407`-`EVT-000412`.** `EVT-000412` is the promotion-barrier batch settlement — `gatefall.skill_formation` and `gatefall.skill_credit` both explicit `none` across the evening, with the two non-combat candidate questions asked on their own terms and answered.
...
```yaml
trigger_telemetry:
  as_of: "2026-08-15T22:30:00-05:00"

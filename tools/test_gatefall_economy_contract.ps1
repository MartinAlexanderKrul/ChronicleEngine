...
Assert-Contains $profile 'World Rule Profile 1\.47' 'Gatefall profile is not version 1.47.'
...
Assert-Contains $readme 'World Rule Profile 1\.47' 'Gatefall README does not advertise Profile 1.47.'
...
Assert-Contains $character 'profile_version: "1\.47"' 'Live Gatefall character has not adopted Profile 1.47.'

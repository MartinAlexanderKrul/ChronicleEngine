...
**Checkpoints:** 124 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0124`)
...
| frozen | 0009–0124 | 116 |

**Latest capture:** `900_CHECKPOINT_0124` — kind `session-save`, profile 1.100 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0123`, source `EVT-000747`.

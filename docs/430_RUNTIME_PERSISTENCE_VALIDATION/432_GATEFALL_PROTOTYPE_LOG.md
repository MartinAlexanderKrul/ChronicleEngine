...
**Checkpoints:** 74 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0074`)
...
**Latest capture:** `900_CHECKPOINT_0074` — kind `manual`, profile 1.57 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0073`, source `EVT-000419`.

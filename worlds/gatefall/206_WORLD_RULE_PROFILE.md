# Gatefall — World Rule Profile 1.101
...
The Bearer chooses one. The choice is permanent; it attaches the class's `/system` panel (Section 15.5) and sets the Console's `Class` line. Each class has a later **evolution quest** — an authored class-quest at **level 50** — that deepens it along its own line, and a **second and final permanent choice at level 100**, the subclass of Section 18.12.
...
| **Evolution** | one authored unlock at level 50, and a **subclass** at level 100 (Section 18.12) | the far horizon, already carried by all five |

...
**Checkpoints:** 122 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0122`)
...
| frozen | 0009–0122 | 114 |

**Latest capture:** `900_CHECKPOINT_0122` — kind `session-save`, profile 1.99 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0121`, source `EVT-000721`.

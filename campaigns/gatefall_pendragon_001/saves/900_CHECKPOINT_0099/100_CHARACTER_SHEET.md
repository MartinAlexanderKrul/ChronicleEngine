...
provenance:
  source: EVT-000568
  game_date: "2026-08-20T12:55:00-05:00"
...
moved_by_events: "**Every Event whose `participation_audits` claim it moved this record.** Decision 085 requires the record to *reference* such an Event; it has never required the record to *narrate* it, and `160_CAMPAIGN_CHRONICLE.md` narrates every one in full. This index exists so state fields can hold values while their reasoning lives where it is authoritative - citing and narrating are different obligations and only the first is cheap. Maintained at promotion.
  ...
  `EVT-000271` `EVT-000273` `EVT-000274` `EVT-000277` `EVT-000278` `EVT-000279` `EVT-000280` `EVT-000282` `EVT-000284` `EVT-000285` `EVT-000286` `EVT-000287` `EVT-000289` `EVT-000290` `EVT-000291` `EVT-000292` `EVT-000293` `EVT-000294` `EVT-000296` `EVT-000300` `EVT-000301` `EVT-000302` `EVT-000303` `EVT-000304` `EVT-000308` `EVT-000311` `EVT-000312` `EVT-000316` `EVT-000317` `EVT-000318` `EVT-000319` `EVT-000320` `EVT-000323` `EVT-000324` `EVT-000325` `EVT-000326` `EVT-000327` `EVT-000328` `EVT-000332` `EVT-000333` `EVT-000334` `EVT-000336` `EVT-000337` `EVT-000338` `EVT-000339` `EVT-000340` `EVT-000341` `EVT-000342` `EVT-000343` `EVT-000344` `EVT-000345` `EVT-000346` `EVT-000347` `EVT-000350` `EVT-000351` `EVT-000352` `EVT-000353` `EVT-000354` `EVT-000355` `EVT-000356` `EVT-000357` `EVT-000358` `EVT-000359` `EVT-000360` `EVT-000361` `EVT-000373` `EVT-000374` `EVT-000379` `EVT-000380` `EVT-000381` `EVT-000382` `EVT-000383` `EVT-000384` `EVT-000385` `EVT-000386` `EVT-000390` `EVT-000391` `EVT-000392` `EVT-000393` `EVT-000395` `EVT-000396` `EVT-000397` `EVT-000398` `EVT-000399` `EVT-000400` `EVT-000401` `EVT-000402` `EVT-000403` `EVT-000404` `EVT-000406` `EVT-000407` `EVT-000408` `EVT-000409` `EVT-000410` `EVT-000411` `EVT-000414` `EVT-000415` `EVT-000416` `EVT-000417` `EVT-000419` `EVT-000422` `EVT-000425` `EVT-000428` `EVT-000429` `EVT-000430` `EVT-000431` `EVT-000432` `EVT-000433` `EVT-000434` `EVT-000451` `EVT-000452` `EVT-000453` `EVT-000454` `EVT-000457` `EVT-000458` `EVT-000459` `EVT-000463` `EVT-000464` `EVT-000465` `EVT-000467` `EVT-000468` `EVT-000469` `EVT-000470` `EVT-000471` `EVT-000472` `EVT-000473` `EVT-000474` `EVT-000475` `EVT-000476` `EVT-000477` `EVT-000478` `EVT-000479` `EVT-000480` `EVT-000481` `EVT-000482` `EVT-000483` `EVT-000485` `EVT-000487` `EVT-000490` `EVT-000491` `EVT-000493` `EVT-000495` `EVT-000496` `EVT-000498` `EVT-000499` `EVT-000500` `EVT-000501` `EVT-000502` `EVT-000503` `EVT-000504` `EVT-000506` `EVT-000507` `EVT-000508` `EVT-000509` `EVT-000510` `EVT-000511` `EVT-000512` `EVT-000513` `EVT-000514` `EVT-000515` `EVT-000516` `EVT-000517` `EVT-000518` `EVT-000519` `EVT-000520` `EVT-000521` `EVT-000522` `EVT-000523` `EVT-000524` `EVT-000525` `EVT-000526` `EVT-000527` `EVT-000528` `EVT-000529` `EVT-000530` `EVT-000531` `EVT-000532` `EVT-000533` `EVT-000534` `EVT-000535` `EVT-000536` `EVT-000537` `EVT-000538` `EVT-000539` `EVT-000540` `EVT-000541` `EVT-000542` `EVT-000543` `EVT-000544` `EVT-000545` `EVT-000546` `EVT-000547` `EVT-000548` `EVT-000549` `EVT-000550` `EVT-000551` `EVT-000552` `EVT-000553` `EVT-000554` `EVT-000555` `EVT-000556` `EVT-000557` `EVT-000558` `EVT-000559` `EVT-000560` `EVT-000561` `EVT-000562` `EVT-000563` `EVT-000564` `EVT-000565` `EVT-000566` `EVT-000567` `EVT-000568`"

canonical_state:
  age: 25
  location: ENT-000087
  location_note: "The Rogers Park apartment (`ENT-000087`) he shares with Owen Callahan, Chicago, 12:55 on 2026-08-20 (Thursday), back from the third instant dungeon of the morning and due on Glenwood at 19:15. Reached by anchored rift-step from Walt Adamik's warehouse-district shop (`EVT-000567`). Prior: the Cicero Scar's reclaimed edge (`ENT-000091`)."
  condition: |
      Health **1,229/1,388**, Mana **642/662** — **Level 34, System Rank B, Combat Tier A, 12:55 on 2026-08-20 (Thursday)**, at the Rogers Park apartment, two hours and ten minutes after the Dale call. **Five ability points unspent.**

      **Three B-Rank instant dungeons cleared solo in one morning** (`EVT-000563`, `EVT-000564`, `EVT-000567`) — the banked `EVT-000501` key, then two bought at 45,000 g each and both abandoned with most of their two hours still on the clock. **The Hive**: 26 commons on a doubled-commons twist, held at a shaft junction through six waves after a natural-1 broke stealth four minutes in; boss drop a **Sprint [B-Rank] rune**, unconsumed. **The Beast Den**: a second boss-Rank alpha rolled onto the floor and was behind him inside six minutes, killed in the opening exchange because Pre-empt's *first blade* resolves him first whatever the fiction implies; a **Reacharm [B-Rank]** dropped and was assessed as stock, since a polearm surrenders both blades and Twin Fang. **The Shattered City**: a natural-5 fumble dropped him through a slab for 241 through both vambraces — his lowest Health of the day, taken from a floor rather than a monster — answered with **the campaign's first-ever Status Recovery claim** (19 → 18) and a natural-100 Sprint that stopped the instance from having terrain at all; extraction then came up **natural 100, 96 of 96 crystals, nothing left in the wall**.

      **Level 30 → 34** across four crossings, Profile 1.80's B rung paying +23 to every base Stat each time; 15 banked points allocated +5 Strength / Intelligence / Vitality, 5 more unspent. Pools **1,000/468 → 1,388/662**, anchor cap **11 → 16**, main-hand **408 → 564**, Rupture **1,583 → 1,836**. **Combat Tier moved B → A** — the defence axis finally cleared five landed A-Rank hits (6.85), which is what has pinned it since the migration. **Three mastery advances at the barrier** (`EVT-000568`): Silent Step to **Master**, Exploit Pattern to **Expert**, Dimensional Projection to **Adept**. **A Section 7.5 breakthrough offer stands open and unanswered — Silent Step [E-Rank] Master → [D-Rank] Adept**, buying *Concealment through action*.

      **Walt Adamik** (`EVT-000565`) refused the crystals outright — his own term 5 makes them stock once the operation runs, not startup capital, and fifty B-Rank crystals four days into a seven-day build makes him a fence; come back Monday. He took **13 gear holdings as partner contribution** instead (~$38,000-42,000 on movement, `OBJ-29`), split honestly across a licensed shelf and a grey one, and sold back the **second Warded Vambrace [A-Rank] for $3,000** — now equipped in Acc.2 over the Ascendant Hunter's Band, two independent −30% procs. Cicero's Quiet declined at $35,000. The first genuinely cold exchange between them came from Alexander's side, and Walt answered it by naming what he has been tracking for three visits: a man who turns up with his hands full and keeps asking whether anything interesting has come in. **Term 4 ruled to run Walt → Alexander only.**

      **Wade Bishop** (`EVT-000566`) meets him **19:15-19:30 tonight, a bar on Glenwood** (`OBJ-34`), address by text. Alexander said 'our partnership'; Wade noted flatly that neither of them has used that word, said he would rather it were true, and said he is not in a position to ask. Friday's filing is still five people against a roster of eight.

      **Gold 129,341 → 216,341** (236 B-Rank crystals sold for 177,000 g, 90,000 g spent on keys). **Cash $281,155.22 → $278,155.22.** 8 B-Rank cores banked, unsold — the shop refuses cores. Forty-nine kills, five boss-Rank bodies, no classified injury, and 95 minutes left unused on the last key. Full detail: `160_CAMPAIGN_CHRONICLE.md` `EVT-000563`-`EVT-000568`.

      Superseded anchor states are not held here. `160_CAMPAIGN_CHRONICLE.md` narrates every span in full, and `moved_by_events` above references every Event that claims to have moved this record -- Decision 085 requires the reference, never the narration. Twenty-nine prior anchors were retired on that basis; read the chronicle for any of them.
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-20T12:55:00-05:00"
    ...
    skills_known:
      ...
      - "Shrug Off [A-Rank] · Stat Passive · ignores minor-wound penalty; **threshold absorption** — once/scene, a hit crossing the injury threshold inflicts damage only; **total suppression** — **every** wound's modifier-step penalty is suppressed until scene end rather than one, and environmental hazards up to B-Rank cause no onset at all rather than halved onset (Section 4.4). **Uses 5 · Vitality 346 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`. Threshold immunity covers a creature MORE THAN ONE Rank below the skill, so at A it does not cover B-Rank** — misread once and corrected at `EVT-000517`. **Triggered for the first time** (`EVT-000340`) — a 266-dmg critical vs. 232 max Health inflicted damage only, no classified injury. Vitality 115→95→100 across `EVT-000357` and `EVT-000360` carried it past the 66 (A) and 80 (S) thresholds in one session. **Rose C→B at `EVT-000363`**; the authoring clamp is gone and the **ceiling binds alone**, holding a full S-Rank of Vitality against System Rank C — A at level 40, S at level 50."
    ...
    tracked_counters:
      ...
      - { path: skills.rupture.successful_uses, baseline_value: 16, baseline_as_of: EVT-000130, current_value: 115 }
      - { path: skills.rupture.qualifying_scenes_total, baseline_value: 8, baseline_as_of: EVT-000130, current_value: 34 }
      - { path: skills.rupture.mastery_progress, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 1 }
      - { path: skills.flash_step.successful_uses, baseline_value: 6, baseline_as_of: EVT-000130, current_value: 59 }
      - { path: skills.flash_step.qualifying_scenes_total, baseline_value: 4, baseline_as_of: EVT-000130, current_value: 23 }
      - { path: skills.flash_step.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 2 }
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 79 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 51 }
      ...
      - { path: skills.dagger_mastery.successful_uses, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 213 }
      - { path: skills.dagger_mastery.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 28 }
      - { path: skills.dagger_mastery.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 2 }
      - { path: skills.twin_fang.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 118 }
      - { path: skills.twin_fang.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 22 }
      - { path: skills.twin_fang.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 2 }
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 68 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 35 }
      - { path: skills.exploit_pattern.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 0 }
      - { path: skills.mana_bolt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 47 }
      ...
      - { path: skills.resonance_extraction.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 30 }
      - { path: skills.resonance_extraction.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 16 }
      - { path: skills.resonance_extraction.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 2 }
      - { path: skills.flux_sight.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 51 }
      - { path: skills.overpower.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 5 }
      - { path: skills.pre_empt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 21 }
      ...
      - { path: skills.sprint.successful_uses, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 15 }
      - { path: skills.sprint.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 13 }
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 17 }
      - { path: skills.silent_step.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 12 }
      ...
      - { path: skills.dimensional_projection.successful_uses, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 11 }
      - { path: skills.dimensional_projection.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 6 }
    ...
    inventory:
      ...
      keys:
        ...
        # No B-Rank key banked. Three were turned on 2026-08-20 and all three are spent:
      ...
      consumables:
        ...
        - "**Skill Rune — Sprint [B-Rank]** — boss drop, the Hive (`EVT-000563`, 🎲 d100 49 → rune band, 🎲 d8 1). **`unbound-awakened`, so NPC-eligible.** **A live ascension offer, unconsumed** — he holds Sprint at [C-Rank] Novice, so this teaches: **C → B**, one further category rung, mastery already at its floor so nothing resets. Banked, intact, owned."
      ...
      gear:
        ...
        - "**Ascendant Mindspun Loop [C-Rank]** — accessory · Intelligence +4. Daily Random Box drop at `EVT-000487`. Banked, **unequipped** — both accessory slots full; since `EVT-000565` they hold two Warded Vambraces, and taking this slot back trades a second once-per-exchange −30% for +4 Intelligence — a live option, and a worse one than it was."

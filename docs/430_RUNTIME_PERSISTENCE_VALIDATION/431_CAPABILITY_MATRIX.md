...
| V03-09 | Structured profile metadata | New checkpoint records world, version, and freeze status, or explicit no-profile | Passed — gate and observed | Gatefall workshop-draft Checkpoint 0004; frozen Profile 1.6 / Data Model 0.1.2 Checkpoint 0014; frozen Profile 1.6 / Data Model 0.1.3 Checkpoint 0015; Profile 1.10 checkpoints 0020–0021; and Profile 1.11 checkpoints 0022–0023. Older captures remain immutable and run their applicable readiness chain through Data Model 0.1.4 / Profile 1.12. `test_checkpoint_contract.ps1` Contract 6. |
...
| V03-19 | Prototype findings are dispositioned | The live prototype may reveal and drive changes to Rules, Data Model, Runtime, or other architecture; every finding must be explicitly classified, governed, versioned, migrated, and revalidated, with no known architectural gap left unaddressed at postmortem | In progress — Decisions 076–077 and the Checkpoint 0020 agency refinement implemented and revalidated | Decision 076 closes Relationship Texture loss at Data Model 0.1.3. Decision 077 closes real/game-date ambiguity at Data Model 0.1.4 with explicit immutable-checkpoint migration. Checkpoint 0020 exposed two compression-time Player Agency violations; Resident Core 1.5 and its contract test cover both. Final determination remains the 0.3 postmortem. |

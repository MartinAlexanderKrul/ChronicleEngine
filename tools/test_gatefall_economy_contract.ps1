...
Assert-Contains $profile 'World Rule Profile 1\.42' 'Gatefall profile is not version 1.42.'
...
Assert-Contains (Get-MigrationRecord '1.41' '1.42') '1\.41.+1\.42 compatibility treatment' 'The 1.41 to 1.42 migration record lacks its treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.42' 'Gatefall README does not advertise Profile 1.42.'
...
Assert-Contains $character 'profile_version: "1\.42"' 'Live Gatefall character has not adopted Profile 1.42.'

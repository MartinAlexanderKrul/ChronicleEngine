...
```yaml
current_funds:
  as_of_event: EVT-000911
  as_of_game_date: "2026-09-10T21:15:00-05:00"
  cash_usd: 232015490.22
  gold: 255018381
  pending_payouts_usd: 138400000.00
  pending_payout_count: 1
  note: "**This span (`EVT-000909`-`EVT-000911`):** the worked-leather satchel (banked `EVT-000700`) given away to Peter Kwiatkowski (`ENT-000226`), unattributed — no monetary value, no longer held. The Blue Island auction filing clears (`EVT-000909`): 301 S-Rank crystals + 1 S-Rank core at **$118,900,000**, co-op cut already deducted. Cash $113,115,490.22 -> **$232,015,490.22.** Gold unchanged. Pending payouts: **2 -> 1**, the standing Red Gate filing alone, ≈$138,400,000, still uncleared. **Full movement history, every prior span: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures under `saves/`.**"
```

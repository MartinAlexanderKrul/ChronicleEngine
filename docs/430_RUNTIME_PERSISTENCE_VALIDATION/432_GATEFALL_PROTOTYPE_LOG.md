...
**Checkpoints:** 73 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0073`)
...
**Latest capture:** `900_CHECKPOINT_0073` — kind `manual`, profile 1.57 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0072`, source `EVT-000418`.

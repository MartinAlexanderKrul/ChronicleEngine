...
- **Flagged for an owner ruling, deliberately not promoted.** The Lakeline Residential letting agent's authored given name collides with the existing **Denise Ferro** (`ENT-000148`). **No Persistent Entity was minted for her** — only a recorded greeting has been heard — and none should be until the collision is ruled on.

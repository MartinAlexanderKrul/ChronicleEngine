...
**Checkpoints:** 99 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0099`)
...
**Latest capture:** `900_CHECKPOINT_0099` — kind `session-save`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0098`, source `EVT-000568`.

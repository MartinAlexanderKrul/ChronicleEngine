# Gatefall — World Rule Profile 1.100
...
| **Sealbreaker** | **five** Section 9.6 red gates entered, cleared, and walked out of | +1 modifier step on all actions inside any sealed instance, and the exchange in which a seal closes around him costs no Mana |
...
| **Cordonholder** | a district carried from **Cordon** (Section 9.1.3, pressure 7) back to **Normal**, the Bearer part of it | +1 modifier step on all actions in any district standing at Strained or worse, and pressure decays **one further** per clear week in any district he cleared a Gate in that week |
...
| **The Standing Name** | carded at a Rank his Section 19.4 contract cap was lifted to, with **ten** clears filed publicly under it | **+2 modifier steps** on any action of standing, negotiation or testimony with a regulator, a guild, or the press |
...
| **The Ledger's End** | **every entry in Section 16.2 held** — all twenty-one | every **earned** title's resource, recovery and yield effects apply **while dormant**; only modifier steps, reductions and stated capabilities still require a slot |
| **Before the Confluence** | a Gate cleared while the world stood at escalation **tier VII** (Section 9.2.1) | the escalation tier's anomaly band applies to him at **one tier above** the world's own, and he takes +1 modifier step on every action in the first exchange of any anomaly |

**`The Ledger's End` is the one entry that reads the catalog rather than the world**, and it is deliberately the hardest thing in this profile to hold: twenty-one criteria including three Singulars, one of which (`Unbroken`) is a hundred consecutive dailies and another of which (`The Unmeasured`) is **foreclosed the moment he cards up**. A Bearer who took the Section 19.4 trade can never complete the first catalog, and that is the cost of the trade rather than an oversight. **It is stated here so nobody discovers it at level 90.**

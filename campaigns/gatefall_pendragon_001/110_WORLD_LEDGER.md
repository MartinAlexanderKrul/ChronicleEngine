...
Not visible to Alexander at start: BGM Region V's internal Grading Bench field notes flagging the Red Line Gate's mana-pressure curve as climbing faster than a true D (`EVT-000051`'s non-public detail), the identities or agendas of any of Gatefall's notable figures beyond ordinary public reputation, and anything about the System — because at campaign start there is nothing System-side to know. He is not yet the Bearer of anything.

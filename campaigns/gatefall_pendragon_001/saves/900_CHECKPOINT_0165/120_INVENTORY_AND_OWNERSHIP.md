...
scope: campaign
# This save (`EVT-001109`-`EVT-001120`): cash and gold UNCHANGED, nothing landed. One Greater Mana Potion
...
```yaml
current_funds:
  as_of_event: EVT-001120
  as_of_game_date: "2026-09-27T15:30:00-05:00"
  cash_usd: 697398490.22
  gold: 355598131
  pending_payouts_usd: 113760000.00
  pending_payout_count: 3
  note: "**This span (`EVT-001109`-`EVT-001120`). Cash and gold UNCHANGED - nothing has landed; the three pending payouts stand (Tulsa $1,650,000, Karlin ~$2,310,000 Monday 2026-09-28, the S-Rank auction lot ~$109,800,000 now dated Tuesday 2026-09-29 14:00 Eastern, `EVT-001118`). One Greater Mana Potion consumed (x42 -> x41).** PRIOR SPAN (`EVT-001097`-`EVT-001108`). Cash and gold UNCHANGED - nothing had landed. Three payouts owed, all estimates until they clear: **Tulsa $1,650,000** (his, next business day, `EVT-001097`); **Karlin ~$2,310,000** (his, Monday 2026-09-28, `EVT-001106`); **the S-Rank auction lot ~$109,800,000** (267 crystals + 3 cores through Renata, no fixed date, `EVT-001106`). **Calumet's $3,300,000 is the GUILD's, not his**, and is not counted here. Derivations and the full movement table sit below under this checkpoint's movement. PRIOR SPAN (`EVT-001079`-`EVT-001087`). Both pending payouts landed: the combined S-Rank auction lot cleared at 🎲 67 -> ~101.4% of its $75,317,500 estimate -> **+$76,370,000**; the federal lot closed flat at its quoted estimate, **+$130,200,000**. Cash $490,828,490.22 -> **$697,398,490.22.** Pending payouts 2 -> 0. Gold: +650,000 (Daily Random Box #65, System gold, `EVT-001082`) -3,350 (5x D-Rank armor + 1x C-Rank Longsword bought for Prague's crew, `EVT-001084`) — 354,951,481 -> **355,598,131.** Full session detail: `160_CAMPAIGN_CHRONICLE.md`.
...
**Gold unchanged at 355,598,131. Cash unchanged at $697,398,490.22. Pending payouts 0 → 3 (≈$113,760,000 combined estimated).**

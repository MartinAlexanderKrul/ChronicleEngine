...
Assert-True ($character -match 'profile_version: "1\.25"') "Live Gatefall character was not migrated to Profile 1.25."
...
Assert-True ($startup -match 'world_rule_profile: "Gatefall World Rule Profile 1\.25"') "Campaign startup does not bind Profile 1.25."
...
Assert-True ($index -match 'World Rule Profile 1\.25, frozen') "World index does not advertise frozen Profile 1.25."

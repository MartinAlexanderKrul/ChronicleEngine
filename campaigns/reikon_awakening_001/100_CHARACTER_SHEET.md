...
relationships:
  ...
  - REL-000047
canonical_state:
  location: "Verholt's tannery district, just outside the collapsed tannery E-Rank Rift (ENT-000084)"
  ...
  knowledge: "Aurology training; observed Broodling, Swarmer, pack-leader, and Breaker behavior; mapped Warehouse 7 and fully documented its basement core chamber. Four D-Rank Breakers used a coordinated guard formation and are now dead. The metre-tall burgundy core pulses every three seconds, radiates heat, and is energetically integrated with an organic crystalline framework and eight-metre floor pattern. Direct extraction failed. Safe severance methodology, the D-Rank anomaly's cause, and the core's relation to Rift stability remain unestablished."
  ...
  situation: "Warehouse 7 is fully and permanently resolved: independent contractor Wren Ashcombe (ENT-000083), brought in through proper channels with Thorne's and the Institute's approval, extracted the bonded core via a matched resonance pulse after several careful attempts (one near-miss, caught early). No injuries, no casualties, full clear — the clearing act was Wren's, so no Rift-clear milestone XP to Daedalus. The tannery E-Rank Rift held no guardians at all: an unopposed core extraction Daedalus performed himself, correctly earning the full 70 XP E-Rank milestone (EVT-000049). Daedalus is unhurt, at full Mana after a night's rest and a day without spellcasting, carrying the tannery core (ENT-000085) and the Ashgate sale proceeds (24 vells, ENT-000086), with a formal Association request pending on any Warehouse 7 completion bonus (EVT-000050). His 8 Ascension points are fully allocated (EVT-000046)."
...
#   effective Rank  <- 206 S3.1 from max_mana
#   20% phys. reduction <- 206 S5, Reinforced Body
system:
  official_rank: E              # certified at Awakening; not what he is
  level: 3
  xp: 95                         # 25 (post-Ascension remainder, EVT-000044) + 70 (tannery E-Rank Rift clear milestone, EVT-000049, 206 S8.2) = 95; T(3)=170 not crossed

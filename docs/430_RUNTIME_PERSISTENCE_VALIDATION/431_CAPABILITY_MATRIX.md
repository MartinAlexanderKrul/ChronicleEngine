...
| V03-09 | Structured profile metadata | New checkpoint records world, version, and freeze status, or explicit no-profile | Passed — gate and observed | Gatefall workshop-draft Checkpoint 0004; frozen Profile 1.6 / Data Model 0.1.2 Checkpoint 0014; frozen Profile 1.6 / Data Model 0.1.3 Checkpoint 0015; and frozen Profile 1.10 / Data Model 0.1.3 Checkpoints 0020–0021. Older captures remain immutable and run their applicable readiness chain through current Profile 1.11. `test_checkpoint_contract.ps1` Contract 6. |
...
| V03-19 | Prototype findings are dispositioned | The live prototype may reveal and drive changes to Rules, Data Model, Runtime, or other architecture; every finding must be explicitly classified, governed, versioned, migrated, and revalidated, with no known architectural gap left unaddressed at postmortem | In progress — Decision 076 and the Checkpoint 0020 agency refinement implemented and revalidated | Decision 076 records the foundational Architecture-Freeze exception; Data Model 0.1.3 and its explicit immutable-checkpoint migration close the discovered Relationship Texture gap. Automatic Checkpoint 0015 proves native 0.1.3 promotion and export. Checkpoint 0020 exposed two compression-time Player Agency violations; Resident Core 1.5 now constrains summaries to the declared intent envelope, with `test_player_agency_contract.ps1` covering both observed failure classes. Final determination remains the 0.3 postmortem. |

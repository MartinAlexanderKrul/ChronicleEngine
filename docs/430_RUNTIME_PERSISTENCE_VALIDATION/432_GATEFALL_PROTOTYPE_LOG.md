...
**Checkpoints:** 98 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0098`)
...
**Latest capture:** `900_CHECKPOINT_0098` — kind `manual`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0097`, source `EVT-000562`.

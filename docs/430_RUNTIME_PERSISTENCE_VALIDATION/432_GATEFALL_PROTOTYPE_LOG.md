...
**Checkpoints:** 89 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0089`)
...
**Latest capture:** `900_CHECKPOINT_0089` — kind `manual`, profile 1.71 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0088`, source `EVT-000520`.

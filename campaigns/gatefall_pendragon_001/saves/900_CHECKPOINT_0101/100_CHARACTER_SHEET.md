...
provenance:
  source: EVT-000579
  game_date: "2026-08-20T22:06:00-05:00"
...
moved_by_events: "**Every Event whose `participation_audits` claim it moved this record.** Decision 085 requires the record to *reference* such an Event; it has never required the record to *narrate* it, and `160_CAMPAIGN_CHRONICLE.md` narrates every one in full. This index exists so state fields can hold values while their reasoning lives where it is authoritative - citing and narrating are different obligations and only the first is cheap. Maintained at promotion.
  ...
  `EVT-000271` `EVT-000273` `EVT-000274` `EVT-000277` `EVT-000278` `EVT-000279` `EVT-000280` `EVT-000282` `EVT-000284` `EVT-000285` `EVT-000286` `EVT-000287` `EVT-000289` `EVT-000290` `EVT-000291` `EVT-000292` `EVT-000293` `EVT-000294` `EVT-000296` `EVT-000300` `EVT-000301` `EVT-000302` `EVT-000303` `EVT-000304` `EVT-000308` `EVT-000311` `EVT-000312` `EVT-000316` `EVT-000317` `EVT-000318` `EVT-000319` `EVT-000320` `EVT-000323` `EVT-000324` `EVT-000325` `EVT-000326` `EVT-000327` `EVT-000328` `EVT-000332` `EVT-000333` `EVT-000334` `EVT-000336` `EVT-000337` `EVT-000338` `EVT-000339` `EVT-000340` `EVT-000341` `EVT-000342` `EVT-000343` `EVT-000344` `EVT-000345` `EVT-000346` `EVT-000347` `EVT-000350` `EVT-000351` `EVT-000352` `EVT-000353` `EVT-000354` `EVT-000355` `EVT-000356` `EVT-000357` `EVT-000358` `EVT-000359` `EVT-000360` `EVT-000361` `EVT-000373` `EVT-000374` `EVT-000379` `EVT-000380` `EVT-000381` `EVT-000382` `EVT-000383` `EVT-000384` `EVT-000385` `EVT-000386` `EVT-000390` `EVT-000391` `EVT-000392` `EVT-000393` `EVT-000395` `EVT-000396` `EVT-000397` `EVT-000398` `EVT-000399` `EVT-000400` `EVT-000401` `EVT-000402` `EVT-000403` `EVT-000404` `EVT-000406` `EVT-000407` `EVT-000408` `EVT-000409` `EVT-000410` `EVT-000411` `EVT-000414` `EVT-000415` `EVT-000416` `EVT-000417` `EVT-000419` `EVT-000422` `EVT-000425` `EVT-000428` `EVT-000429` `EVT-000430` `EVT-000431` `EVT-000432` `EVT-000433` `EVT-000434` `EVT-000451` `EVT-000452` `EVT-000453` `EVT-000454` `EVT-000457` `EVT-000458` `EVT-000459` `EVT-000463` `EVT-000464` `EVT-000465` `EVT-000467` `EVT-000468` `EVT-000469` `EVT-000470` `EVT-000471` `EVT-000472` `EVT-000473` `EVT-000474` `EVT-000475` `EVT-000476` `EVT-000477` `EVT-000478` `EVT-000479` `EVT-000480` `EVT-000481` `EVT-000482` `EVT-000483` `EVT-000485` `EVT-000487` `EVT-000490` `EVT-000491` `EVT-000493` `EVT-000495` `EVT-000496` `EVT-000498` `EVT-000499` `EVT-000500` `EVT-000501` `EVT-000502` `EVT-000503` `EVT-000504` `EVT-000506` `EVT-000507` `EVT-000508` `EVT-000509` `EVT-000510` `EVT-000511` `EVT-000512` `EVT-000513` `EVT-000514` `EVT-000515` `EVT-000516` `EVT-000517` `EVT-000518` `EVT-000519` `EVT-000520` `EVT-000521` `EVT-000522` `EVT-000523` `EVT-000524` `EVT-000525` `EVT-000526` `EVT-000527` `EVT-000528` `EVT-000529` `EVT-000530` `EVT-000531` `EVT-000532` `EVT-000533` `EVT-000534` `EVT-000535` `EVT-000536` `EVT-000537` `EVT-000538` `EVT-000539` `EVT-000540` `EVT-000541` `EVT-000542` `EVT-000543` `EVT-000544` `EVT-000545` `EVT-000546` `EVT-000547` `EVT-000548` `EVT-000549` `EVT-000550` `EVT-000551` `EVT-000552` `EVT-000553` `EVT-000554` `EVT-000555` `EVT-000556` `EVT-000557` `EVT-000558` `EVT-000559` `EVT-000560` `EVT-000561` `EVT-000562` `EVT-000563` `EVT-000564` `EVT-000565` `EVT-000566` `EVT-000567` `EVT-000568` `EVT-000569` `EVT-000570` `EVT-000571` `EVT-000572` `EVT-000573` `EVT-000574` `EVT-000575` `EVT-000576` `EVT-000577` `EVT-000578` `EVT-000579`"

canonical_state:
  age: 25
  location: ENT-000087
  location_note: "The street outside Priscilla Nakamura's workshop, a side street off LaSalle north of the river, Chicago, 22:06 on 2026-08-20 (Thursday), coat on and phone in hand having just read it for the first time in four hours. Twenty minutes from the Rogers Park apartment, where Owen is awake. Prior: the apartment (`ENT-000087`) through 16:50."
  condition: |
      Health **1,480/1,480**, Mana **707/708** — **Level 35, System Rank B, Combat Tier A, 22:06 on 2026-08-20 (Thursday)**, on the street outside Priscilla Nakamura's workshop with his coat on and his phone in his hand. **Ten ability points unspent.** One Mana short of full, and that single point is the whole of what this evening cost him mechanically.

      **The first span of this campaign with no combat in it at all.** No die against a live threat, no Gate, no instance, no damage in either direction. What moved was relational and evidentiary.

      **Retroactivity closed** (`EVT-000574`): the Section 7.4 ruling runs forward only, Checkpoint 0099's credits stand.

      **He washed a coffee mug** (`EVT-000575`), which is the first thing he did today that was not optimisation, and unpacked the last box — and what stopped him was reaching for *his* shelf and *Owen's* shelf and finding the shelving does not work that way any more.

      **He cancelled Wade Bishop** (`EVT-000576`) from the workshop doorway, calling it *'nothing much important'* — the same conversation he had opened that morning by calling it *our partnership*. Wade, already ten minutes from Glenwood with a booth held and an order in, said *'Right. Not a problem'* immediately, offered the meeting a third time in one day, and then said the true thing once and flatly: **'This morning you called it our partnership. Now it's nothing much. Those are pretty far apart, and I'd rather know which one it is than guess.'** Then let it go entirely, set 06:30 at the grain terminal, and **hung up first, which he has never done. He will not offer a fourth time.**

      **The Dormant Core was opened** (`EVT-000577`). A `Provenance` read before the boundary — Keen Sense at Master since that afternoon, against an S-Rank housing two Ranks above his own — established the fused signatures are **not the same age** and the housing is the youngest thing present: gathered over years, closed recently. Three hours of boundary work; **at 19:40 the seam parted and the older signature moved**, and she refused help because it was *equalising*, not attacking. **It is not dormant. It is asleep, and the newer signature is not a lid but a sedative** — maintenance, renewed repeatedly by someone who kept coming back.

      **Then a maker, across three objects.** She found a tool habit on the seam's inside face she has seen once in thirty years. He put the **S-Rank dagger** off Marnie's dock and the **keyed document wallet** on the bench and asked four words — *same hand?* — **deliberately separating the identification from the disclosure**, no name and no missing person. *'Same hand. All three.'* And unasked, an ordering: wallet oldest, **dagger the best thing on her bench in a decade**, and the core a *span* whose **last two renewals are the same hand and not the same care — faster, heavier. Hurry, not sloppiness. Sloppy doesn't come back.**

      **Then he told her the maker is missing, and she worked out the real problem herself** (`EVT-000578`): **nobody has renewed the sedative since they went missing.** It has been running down in a pawn shop, a pocket dimension and on her bench, and she opened it tonight because she wanted to. She named her own part in that as an audit rather than an apology, refused to invent an interval, **declined his offer to carry the risk himself on craft grounds**, and decided out loud: it stays, she watches it twice daily for a week at **$150/day billed at the end regardless**, and **find them** — she now has a professional reason to want it done. **She waived the night's fee outright.** Next session **Sunday**.

      **Three objects are now in her custody** — Dormant Core [S], frost-fused carapace plating [B], heartwood core-mass [B] — all out of the dimensional inventory, ownership unchanged, no fee against any of them. The plating question queued since the Frozen Gallery is finally answered: **the System's silence is about its catalogue, not about the material**, which is real, sound, and worth working rather than selling. The heartwood is **warm nine hours after the kill with no mechanism for being warm**, and it is sitting eight feet from a sedative nobody is renewing.

      **His phone lay face-down from 18:04 to 21:52.** Owen: *'home. food's in the oven on low'*, then *'not chasing you either, just tell me if it's a late one so i stop listening for the door'* — **the same three words Wade used at 14:58, from a completely different place, received twice in one day from two people who each decided not to ask him for anything.** And **Rosalind Fenn: three missed calls, no voicemail**, and one message. *'It's not nothing.'* **'And don't go to the storage unit until we've talked.'** She wants a call before midnight. The Marnie report was due today.

      Superseded anchor states are not held here. `160_CAMPAIGN_CHRONICLE.md` narrates every span in full, and `moved_by_events` above references every Event that claims to have moved this record -- Decision 085 requires the reference, never the narration. Thirty-one prior anchors were retired on that basis; read the chronicle for any of them.
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-20T22:06:00-05:00"
    ...
    skills_known:
      ...
      - "Rupture [A-Rank] ★★★☆☆ Adept · Mana 10 · **reach 5 m** · a heavy strike at **×2.60 of its skill-rank baseline** (A-Rank baseline 375, Section 7.2), resolving as `(375 + effective Intelligence + equipped focus power) × 2.60 × result multiplier` under Section 6.2 — **DMG 1,895 standard before reduction** at effective Intelligence 354 (`(375+354)×2.60=1,895.4`). **A-Rank Adept authors ×2.30; `magnitude_floor` 260 holds it at ×2.60**, the Section 7.2 ratchet doing exactly what 1.54 built it for. Categories: **Compound** (D); **Structural** (C); **Ward-breaking** (B); **Propagating** (A) — the rupture carries to one further target in contact with, or immediately behind, the first. **Successful uses 118 · qualifying scenes total 35 · mastery progress 2/3 toward Expert · rank ascensions 4 · magnitude_floor 260.** **DMG re-derived 1,583 → 1,836** at effective Intelligence 331 (`EVT-000568`). **Breakthrough B-Rank Master → A-Rank Adept at `EVT-000524`**, taken on the System Rank B ceiling lift; baseline 150 → 375. Full ascension history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Flash Step [A-Rank] ★★★☆☆ Adept · Mana 7 · **reach: any point within 100 m, sight or no sight** — the metre band this line promised from the day it was written and withheld until A-Rank. Grants +1 modifier step to the follow-up action; at Adept the window covers the immediate action plus **two further exchanges** (Section 7.4's utility ladder). Category **`Return` (A):** once, inside the follow-up window, step back to the point left from without paying again. **Breakthrough B-Rank Master -> A-Rank Adept at `EVT-000571`**, taken on a Master rung four minutes old, Mana 6 -> 7 the earned road's price. Retained **Through the ward** (B, `EVT-000504`). **At its System Rank B+1 ceiling; no further offer.** Retained: **Through the barrier** — the step crosses a closed constructed barrier (door, shutter, partition, hatch, fence) rather than only open distance, provided Alexander already holds a read of the far side (a prior look, a resolved Keen Sense, or a relayed Pattern), else it resolves as an uncertain action under Rules Section 4; it never crosses a Gate boundary, a Section 9.6 seal, or a Section 17 instance wall (Section 7.3). **Successful uses 61 · qualifying scenes total 24 · mastery progress 0/3 toward Expert · rank ascensions 3.** Crossed to Master at `EVT-000571` and spent that rung on the breakthrough in the same exchange. Qualifying scene at `EVT-000567` — a flanking cross through terrain that existed only because Sprint's **Vertical** was running. Two ascensions and one mastery advance before this span; full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Keen Sense [A-Rank] ★★★★★ Master · Mana 1 · +1 modifier step on detection **for the scene**, shared with **himself plus 9 allies** (10 subjects — A-Rank Master computes `5 + 4 = 9`; `scope_floor` 8 no longer binds). Categories: **presence** (E); **intent and method** (D); **structure through barrier** (C) — the layout and extent of an unseen space beyond line of sight; **through concealment** (B) — pierces an *active* concealment effect or detection-blocking ward; **Provenance** (A) — the recent past of what he detects reads as clearly as its present: what passed through a place, how long ago, and which way it went. **Uses 81 · scenes 53 · mastery progress complete · mastery level MASTER (5) · ascensions 4 · scope_floor 8.** **Expert → MASTER at `EVT-000571`. At its Section 7.5 ceiling** ([A] = System Rank B + 1), so no breakthrough opens; finished until System Rank A. Qualifying scene at `EVT-000564` — a read establishing a boss's *motive* rather than its position, `Provenance` resolving two bodies as one paired nest. **Advanced Adept → Expert at `EVT-000550`**, Mana 2 → 1; the withheld breakthrough was taken at `EVT-000524` on the System Rank B ceiling lift. Three breakthroughs; full ascension and per-use history in `160_CAMPAIGN_CHRONICLE.md`."
      ...
      - "Dagger Mastery [B-Rank] ★★★★☆ Expert · Passive · adds **+1.00** to a Quickknife chassis multiplier (×0.75 → **×1.75**), on both equipped Quickknives (Section 7.4 +0.05/level). Categories: **Any blade** (D); **Thrown** (C). **Uses 225 · scenes 29 · mastery progress 0/3 toward Master · mastery level EXPERT (4) · ascensions 3.** **Adept → EXPERT at `EVT-000571`**, ×1.70 → ×1.75. **`Thrown` (C) ruled at `EVT-000563` to cover a blade launched by Dimensional Projection** — a projected Quickknife resolves at ×1.70, not bare ×0.75; `Any blade` (D) covers a projected Longsword the same way. Both categories granted at `EVT-000391` under Profile 1.52's magnitude-axis ladder — a deferral paid rather than a new grant. Until then this skill had ascended twice and gained nothing but a larger multiplier, which is what raised `F-014`. Full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Twin Fang [C-Rank] ★★★★☆ Expert · Mana 4 · while two Quickknives are equipped, follow one ordinary Quickknife strike against a single target with a separately rolled strike from the other Quickknife in the same action. Each strike uses only its own weapon power; the skill-enabled second strike has a **×2.15** Twin Fang mastery multiplier at C-Rank Expert — `1.00 + 0.35 × 2 + 0.15 × 3` (`EVT-000393`) — **1,314 standard**, package **1,935** with the main-hand. Twin Fang occupies the action's offensive active-skill position and cannot combine with Rupture. **Successful uses 119 · qualifying scenes total 23 · mastery progress 0/3 toward Master · mastery level EXPERT (4) · rank ascensions 2 · magnitude_floor ×1.60.** **Adept → EXPERT at `EVT-000571`.** **Second-strike DMG re-derived to 1,108**, package **1,672**, at effective Strength 310 (`EVT-000568`). **A successful use is recorded only when the second strike lands and materially contributes**; a target dying to the first strike spends the Mana and credits nothing (`EVT-000512`). Full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Exploit Pattern [A-Rank] ★★★★☆ Expert · Passive · a successful deliberate tactical read establishes an active Pattern on an opponent, behavior, weakness, or structure; +1 modifier step on every personal action genuinely exploiting it until the scene ends or it becomes invalid. Never restricts ordinary analysis; does not stack with another modifier from the same finding. **8 concurrent Patterns** — A-Rank Expert computes `3 + 5 = 8`, which `scope_floor` 8 was already holding; the ascension bought the category, not the count. Categories: **Persistence** (D); **Group coordination** (C); **Composite read** (B) — two or more established Patterns read and exploited together as one; **Anticipatory** (A) — a Pattern reaches what the subject has **not yet done**: its next choice reads as an established tell, and he may exploit an action before it is declared. **Uses 69 · scenes 36 · progress 1/3 toward Master · ascensions 4 · scope_floor 8. ADVANCED Adept → EXPERT at `EVT-000568`** — `3 + 5 = 8` concurrent Patterns — already held there by `scope_floor`, so the rung pays nothing in count and the gain is entirely in what a Pattern may be. Its third qualifying scene is `EVT-000563` — a **temporal** Pattern on groups cycling between pockets, rather than the structural reads this skill has always done. **Breakthrough B-Rank Master → A-Rank Adept at `EVT-000524`.** Four ascensions; full history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Silent Step [D-Rank] ★★★☆☆ Adept · Mana 4 · +1 modifier step on stealth and unseen-approach actions for the scene. **Mastery is scope — beneficiaries 1→5, scene-long at every level** (§7.4); at Adept **4** (`3 + 1 Rank above native`). **Learned 2026-08-09 (`EVT-000235`)**, Dungeon 3 boss-drop rune. **Successful uses 20 · qualifying scenes total 13 · mastery progress 1/3 toward Expert · mastery level ADEPT (3) · rank ascensions 1.** Category **`Concealment through action` (D):** concealment survives **one** attack or manipulation — strike, cut, lift, open or take once without the effect ending; it ends on the second. **Breakthrough [E] Master → [D] Adept at `EVT-000569`**, earned road; Mana 3 → 4, **scope 5 → 4** until Expert, mastery reset, lifetime counters carried. Its third qualifying scene is `EVT-000567` — an approach down a sheer collapsed face, only executable because Sprint's **Vertical** was running. **A Section 7.5 breakthrough offer is OPEN and unanswered: [E-Rank] Master → [D-Rank] Adept, gaining *Concealment through action*** — staying unseen through one attack or manipulation rather than only while moving. It needs terrain that can hide someone; a cast with nowhere to break to is refused before it costs anything (`EVT-000513`). Per-scene history in `160_CAMPAIGN_CHRONICLE.md`."
      - "Mana Bolt [C-Rank] ★★★★☆ Expert · Mana 5 · **no distance limit, line of sight required** · a ranged bolt at **×1.45 of the C-Rank skill-rank baseline** (62, Section 7.2 — `native ×1.0 + 0.15 × (mastery_level - 1)`, Rank-independent, Rank entering through the baseline alone), resolving as `(62 + effective Intelligence + equipped focus power) × 1.45 × result multiplier` under Section 6.2 — **DMG 603 standard before reduction** at effective Intelligence 354 (`(62+354)×1.45=603.2`). **`magnitude_floor` 115 no longer binds.** Intelligence governs both control and magnitude (Profile 1.56); the die resolves whether it lands. **Successful uses 51 · qualifying scenes total 13 · mastery progress 1/3 toward Master · rank ascensions 1.** Re-derived 429 → 570 → 603 across `EVT-000568` and `EVT-000573`; ×1.15 was rendered against an Expert counter for two rungs and corrected at `EVT-000523` (`F-037`'s shape). **Advanced Adept → Expert at `EVT-000518`.** **No distance limit; line of sight required** — the ladder relaxes the sense, not the reach, and it never crosses a Gate boundary, a Section 9.6 seal, or a Section 17 instance wall. Category held at D-Rank and carried through ascension: **Arcing** — the bolt bends around intervening cover, a known position sufficing where a clear line was required."
      ...
      - "Shrug Off [A-Rank] · Stat Passive · ignores minor-wound penalty; **threshold absorption** — once/scene, a hit crossing the injury threshold inflicts damage only; **total suppression** — **every** wound's modifier-step penalty is suppressed until scene end rather than one, and environmental hazards up to B-Rank cause no onset at all rather than halved onset (Section 4.4). **Uses 5 · Vitality 369 · [S-Rank] held: System Rank ceiling.** **Rose B → A at `EVT-000515`. Threshold immunity covers a creature MORE THAN ONE Rank below the skill, so at A it does not cover B-Rank** — misread once and corrected at `EVT-000517`. **Triggered for the first time** (`EVT-000340`) — a 266-dmg critical vs. 232 max Health inflicted damage only, no classified injury. Vitality 115→95→100 across `EVT-000357` and `EVT-000360` carried it past the 66 (A) and 80 (S) thresholds in one session. **Rose C→B at `EVT-000363`**; the authoring clamp is gone and the **ceiling binds alone**, holding a full S-Rank of Vitality against System Rank C — A at level 40, S at level 50."
      ...
      - "Dimensional Projection [C-Rank] ★☆☆☆☆ Novice · Mana 6 · **3 projectiles · range 11 m** · withdraw owned portable objects into unoccupied points in range and launch them at perceived targets as a **named multi-strike** (§6.2) — **one ranged physical strike per projectile**, **Agility to hit**, ordinary Bearer physical-damage formula on *that object's* power and chassis. Projectiles **split freely**; a failed placement does not spend the others. Never inside a creature, object, barrier or occupied space. Launched objects are real afterward. **Recovery is Section 12.9 remote storage, but inside an exchange it spends the exchange's one inventory change however many were launched — so he may launch *or* recover, never both** (`EVT-000438`). A stored weapon grants no equipped Stat bonus; ranked steel carries its Section 11.5 power. Holds the action's offensive active-skill position — no combining with Rupture, Twin Fang or a split dual strike. Mana is paid **once for the action**, never per projectile. Mastery: **projectiles 1/2/2/3/3**, range **5/7/10/15/20 m**, Mana **6/5/5/4/4**, plus **+1 projectile and +3 m per Rank above native** — **currently C-Rank Novice: 3, 11 m, 6**; **+1 projectile and +3 m per Rank above native**. **Successful uses 13 · qualifying scenes total 7 · mastery progress 1/3 toward Practiced · rank ascensions 1 · magnitude_floor 0.** **Rune-ascended [E] Adept → [C] Novice at `EVT-000570`, two Ranks**: projectiles 2 → 3, range 10 → 11 m, Mana 5 → 6, mastery reset. Categories: **`Recall and launch` (D)** — launch and recovery no longer contest the exchange's one inventory change, **deleting `EVT-000438`'s limit**; **`Held read` (C)** — a point perceived but not currently seen qualifies where a read is held, never through a sealed barrier, Gate boundary, §9.6 seal or §17 wall. Its third qualifying scene is `EVT-000564` — a projected Longsword thrown as a finisher **alongside an ordinary dagger strike**, legal because an ordinary strike does not contest this skill's offensive slot. **Its stored line rendered Novice values against a Practiced counter through two spans, the `F-037` shape**; rewritten from the counter here."
      - "Sprint [B-Rank] ★☆☆☆☆ Novice · Mana 4 · +1 modifier step on movement, pursuit, and distance-closing actions, **for the whole scene** — Section 7.2 saturates duration at one Rank above native and C is one above the D it was ascended from, so the window is Rank-derived and no longer mastery-derived. Categories: **Broken ground** (D) — the step holds across footing that would otherwise demand its own check; **Vertical** (C) — vertical and overhanging surfaces count as ground while the effect holds; **Terrain denied** (B) — hostile or hazardous footing authored by an archetype twist or environment imposes **no movement penalty and forces no check at all**. **Successful uses 16 · qualifying scenes total 14 · mastery progress 0/3 toward Practiced · rank ascensions 3.** **Rune-ascended C → B Novice at `EVT-000571`** (the `EVT-000563` drop). Mastery was already at floor but **`mastery_progress` 2/3 → 0**. **`Vertical` used for the first time** (`EVT-000563`, `EVT-000567`); the qualifying scene is a natural 100 that made an entire fall-hazard archetype into ordinary ground for a whole instance. **Rune-ascended D-Rank Adept → C-Rank Novice at `EVT-000547`** — a stored inventory comparison had gone stale (Sprint had already broken through past the rune's assumed baseline); corrected before consumption. Mastery reset to Novice; lifetime `successful_uses`/`qualifying_scenes_total` carried forward unchanged. Not used since ascension."
      - "Rift-step [Riftwalker] · Class ability · Mana 6 · **once per exchange** · a true teleport to any point in **line of sight**, and at System Rank B also **through an obstruction he has perceived past**. **Grants +1 modifier step to the immediate follow-up action.** Reach is sight, not distance — no metre figure until A-Rank. **A step to a set anchor does not consume this once-per-exchange step** and is priced separately (`system_state.riftwalker`). **Owner ruling (`EVT-000551`): a passenger may be carried below S-Rank while physical contact is maintained through the step, at 10× ordinary Mana cost** until System Rank S normalizes it. **Successful uses 7** — **two anchored steps 2026-08-20** (`EVT-000565`, `EVT-000567`), the first use of the anchor network as transport rather than tactics; each required leaving the instance first, since Section 7.3 forbids crossing a Section 17 instance wall. Prior: first use `EVT-000549` (solo, home), two passenger steps `EVT-000551` (balcony, then home), one solo step `EVT-000553` (reclaimed-edge anchor), one solo step `EVT-000554` (warp heart back to the reclaimed edge). Granted `EVT-000519`."
      - "Micro-rift deflection [Riftwalker] · Class ability · Mana 8 · **a reaction**, not an action · **60% damage reduction** on one incoming hit at System Rank B, composing **multiplicatively** under Section 7.3, or turns a projectile aside. 70% at A-Rank. **Successful uses 3** — first uses since the grant, all 2026-08-20 (`EVT-000563`, `EVT-000564`, `EVT-000567`). Granted `EVT-000519`."
    skill_rulings:
    ...
    tracked_counters:
      ...
      - { path: skills.rupture.successful_uses, baseline_value: 16, baseline_as_of: EVT-000130, current_value: 118 }
      - { path: skills.rupture.qualifying_scenes_total, baseline_value: 8, baseline_as_of: EVT-000130, current_value: 35 }
      - { path: skills.rupture.mastery_progress, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 2 }
      - { path: skills.flash_step.successful_uses, baseline_value: 6, baseline_as_of: EVT-000130, current_value: 61 }
      - { path: skills.flash_step.qualifying_scenes_total, baseline_value: 4, baseline_as_of: EVT-000130, current_value: 24 }
      - { path: skills.flash_step.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 0 }
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 81 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 53 }
      ...
      - { path: skills.dagger_mastery.successful_uses, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 225 }
      - { path: skills.dagger_mastery.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 29 }
      - { path: skills.dagger_mastery.mastery_progress, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 0 }
      - { path: skills.twin_fang.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 119 }
      - { path: skills.twin_fang.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 23 }
      - { path: skills.twin_fang.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 0 }
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 69 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 36 }
      - { path: skills.exploit_pattern.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 1 }
      - { path: skills.mana_bolt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 51 }
      - { path: skills.mana_bolt.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000303, current_value: 13 }
      ...
      - { path: skills.resonance_extraction.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 31 }
      - { path: skills.resonance_extraction.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 17 }
      - { path: skills.resonance_extraction.mastery_progress, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 0 }
      - { path: skills.flux_sight.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 56 }
      - { path: skills.overpower.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 5 }
      - { path: skills.pre_empt.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 24 }
      ...
      - { path: skills.sprint.successful_uses, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 16 }
      - { path: skills.sprint.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000149, current_value: 14 }
      ...
      - { path: skills.silent_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 20 }
      - { path: skills.silent_step.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000235, current_value: 13 }
      ...
      - { path: skills.dimensional_projection.successful_uses, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 13 }
      - { path: skills.dimensional_projection.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000436, current_value: 7 }
      ...
      - { path: skills.resonance_extraction.mastery_level, baseline_value: 1, baseline_as_of: EVT-000158, current_value: 4 }
      ...
      - { path: skills.rift_step.successful_uses, baseline_value: 0, baseline_as_of: EVT-000519, current_value: 7 }
    ...
    inventory:
      ...
      consumables:
        ...
        - "**Skill Rune — Keen Sense [C-Rank]** — boss drop, third Crypt (`EVT-000507`, 🎲 d100 51 → rune, 🎲 d8 6). **`unbound-awakened`, so NPC-eligible.** **Inert to Alexander**: he holds Keen Sense at [A-Rank] Master and Section 7.5 ascends only instruction *above* current Rank, so it teaches him nothing and stays intact and owned. One of very few transferable instructional items he has ever held."
      ...
      special:
        ...
        - "**Frost-fused carapace plating [B-Rank] × 1 lot** — five pieces cut from the B-Rank Frozen Gallery boss (`EVT-000502`). **Flux Sight returns no Rank and no stats — not *unidentified*, uncategorised.** **RULED [B-Rank] at `EVT-000522`** under Profile 1.72's §11.1 (every holding carries a Rank, defaulting to its source's). Function and value still unauthored — the beast-part question queued for Priscilla Nakamura (`ENT-000203`). Cores are what artificers forge from (§12.8); this is not a core."
        ...
        - "**Ironline trial roster report, unfiled** — the physical folder Wade Bishop brought to the Region V lot for review under the `EVT-000345` terms, drawn into the dimensional inventory at `EVT-000384` once the lot was empty. Three pages on Ironline letterhead: the payout breakdown, Alexander's retroactive inclusion as contributing field lead, and a **roster of eight** against five actually present — Priyanka Osei, Marcus Delray and Toby Fenwick listed as combat-rated and on site, none of them there. **Documentary evidence of a falsified filing**, held by Alexander rather than Wade. No mechanical line; worth is entirely evidentiary."
      gear:
        ...
        - "**Unmarked motion-sensor rig [D-Rank]** — bundled with the wallet above, same purchase, same auto-identify roll (real d6: 2 → D-Rank, `EVT-000323`). Battery-powered, unbranded housing. A Keen Sense read (`EVT-000323`) established its intent: it logs detected movement to a remote destination rather than displaying locally — surveillance, not security. Where the log goes is unread. Banked."

...
**Checkpoints:** 67 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0067`)
...
**Latest capture:** `900_CHECKPOINT_0067` — kind `manual`, profile 1.50 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0066`, source `EVT-000377`.

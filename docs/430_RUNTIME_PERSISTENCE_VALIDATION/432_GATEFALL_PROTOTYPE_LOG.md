...
**Checkpoints:** 101 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0101`)
...
**Latest capture:** `900_CHECKPOINT_0101` — kind `session-save`, profile 1.80 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0100`, source `EVT-000579`.

# Gatefall — World Rule Profile 1.72
...
| System Rank | Rift-step reach | Deflection | Anchor use |
|---|---|---:|---|
| **C** | line of sight | 50% | one anchored step per scene |
| **B** | line of sight, or **through** an obstruction he has perceived past | 60% | two per scene |
| **A** | any point within 100 m, sight or no sight | 70% | unlimited |
| **S** | any point in the instance | 70%, and a deflection may **return** the attack to its source | unlimited, and an ally he touches may be sent instead |
...
╟──  A N C H O R S  ──…──╢
     <name>          <place>              <anchored steps remaining this scene>
╚══…
```
...
╟──  A N C H O R S  ──…──╢
     The landing     Rogers Park stairwell          1 of 1 remaining
     Coldwater       Frozen Gallery, third vein     1 of 1 remaining
     The lot         behind Ironline Region V       1 of 1 remaining
╚══…
```

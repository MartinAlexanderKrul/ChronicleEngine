...
**The Ace's Circle** — the S-Rank hunter's personal trainers, handlers, and inner staff, whose job is keeping the one asset Horizon cannot replace alive, sharp, and un-burned-out. They fight Investor Relations over every prestige contract that reads better on a press release than it does on a risk assessment.
...
Horizon Tower (ENT-000092) and everything above its public lobby — the contract negotiation suites, the internal ranking lab, and the ace's private training level; the largest single share of Chicago's high-Rank clearance contracts; a recruitment pipeline that skims the most promising newly measured awakened before Ironline or the Coalition ever hear their names.
...
canonical_state:
  ...
  doctrine_goals: "Win the city's highest-Rank clearance contracts, protect and publicize its drafted S-Rank ace, and maintain market dominance over Ironline Guild and the freelance floor beneath it."
  knowledge_stance: "Publicizes clears and Ranks that build the trophy wall and the investor narrative; keeps contract losses, near-misses, and internal risk assessments strictly off the record."
```

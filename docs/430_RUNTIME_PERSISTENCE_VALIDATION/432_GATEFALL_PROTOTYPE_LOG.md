...
**Checkpoints:** 116 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0116`)
...
| frozen | 0009–0116 | 108 |

**Latest capture:** `900_CHECKPOINT_0116` — kind `session-save`, profile 1.88 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0115`, source `EVT-000664`.

...
- **2026-07-23 — Structural migration: schema 0.1.2 (Decision 073).** Closed terminal campaign; representation only. Live records bumped to schema 0.1.2. No location fields changed: the protagonist is deceased (final location remains historical prose in `180_CURRENT_STATE.md`), and the two individually tracked resources rest at their recorded places, not carried.

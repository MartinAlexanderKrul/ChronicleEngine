...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0007` | 2026-07-26 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 2 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0007`** (captured 2026-07-26, the Frozen Gallery job at its close, boss dead, Alexander mid-queue to declare). Protagonist Alexander Pendragon cleared his first Gate as a striker (Red Line Corridor, true grade E), then pivoted to harvest/support work once the corrected rule (`EVT-000062`, world-rule commit `d53114b`) established that his E-card only caps strike/combat contracts, not harvest work at any grade. He completed a C-grade harvest job at the Cicero Scar (`EVT-000063`; 7 declared C-crystals, ≈$5,700 pending, plus 170 undeclared System-shop gold from a private sale unknown to anyone) and worked a second C-grade job, the Frozen Gallery (`EVT-000064`–`EVT-000067`), to its close: three vein assignments (the third to genuine exhaustion), 91 crystals in the current declarable count, five undeclared private sales (four of 12 crystals, one of 50) — total private gold now 16,830, unknown to anyone though the largest sale drew site coordinator Dale's direct, successfully-deflected suspicion. A break let Alexander study the strike element's tactics, gaining an externally-observed combat framework unknown to any NPC. The strike element then killed the Gate's boss off-screen, opening the two-hour clear window; Alexander is queued mid-line to declare, not yet exited. He is a Bearer, Level 2, XP 60/200, 3 unspent stat points (Strength 13, Agility 12, Vitality 10, Perception 11, Intelligence 10), daily-quest streak 2/7, grant accepted — unknown to everyone. The checkpoint was captured under **Gatefall World Rule Profile 1.0, a workshop draft (unfrozen)** — restoring it surfaces the *unfrozen — not save-trustworthy* warning (Rules Section 14.6, Decision 074). The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` restores `900_CHECKPOINT_0007`.

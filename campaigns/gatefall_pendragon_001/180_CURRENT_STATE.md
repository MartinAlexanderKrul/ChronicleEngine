...
- **`shop_holdings` is now `inventory`, grouped by kind** (`EVT-000366`, Profile 1.50 at `EVT-000367`) — after a `/system gear` render dropped the Gate Direction Finder off it. **27 holdings, one per entry: keys 3 · consumables 6 · special 4 · gear 10 · materials 4.** Nothing owned changed; a repository check now holds the shape.
...
- **Health:** 420/420, full. **Mana:** 118/120. No injury. Both maxima were re-derived from this session's allocation, not by recovery — Health 248→400→420 and Mana 112→120, with the 2 missing Mana carried across under §4.1's missing-amount rule.
...
- **Cash:** $43,779.60, unchanged. **Gold: 47,561** — 6,061 at Checkpoint 0064, +8,500 from the Daily Random Box (`EVT-000358`), +33,000 from the crystal sale (`EVT-000359`). The largest gold balance of the campaign by a wide margin, and none of it is money: USD and gold do not exchange, so it does nothing for the tuition minimum or the training venue. **Pending income:** $2,137.50 (processing, older), plus two new figures owed by Wade Bishop tonight — an exact harvest-pool share for 20 declared B-Rank crystals ($11,000 each licensed) and a formal combat-contribution claim for the boss kill and swarm clear.
- **B-Rank crystals: 40 banked, undeclared.** 104 were mined at `EVT-000342`, 20 declared to Wade's pool and 84 kept (`EVT-000343`); **44 of those sold to the System shop at `EVT-000359`** for 750 g each. The System shop is the only channel that will take the rest — they were withheld from a pool already filed — and selling is also what stops them being objects anyone could find.
- **Consumables, reconciled at `EVT-000368`:** **12 Lesser Healing, 10 Lesser Mana, 2 Standard Mana**, 2 Antidotes, Mender's and Stabilization Seals. Both figures previously here were wrong, and **no potion was drunk this session** — the two Mana restorations were Status Recovery.
- **Current location:** Loomis Street, alone, standing on the pavement opposite an unsigned building he has just read and not approached.
- **Immediate obligations:**
  - **Crew — the blocker is closed.** The first training is set: **Monday 2026-08-17, 18:00**, and **ten people hold the date** (`EVT-000350`-`EVT-000351`). Marcus, Theo, Grant recruited and confirmed; Iris and Soraya's standing contingency **met**, both now committed to attend; Reyna confirmed but explicitly judging on what she sees; Corbin, Felix, Dana, Warren attending to decide. **Two new obligations of his own: the training location, owed to all ten by 2026-08-15, and Soraya's unanswered question about whether gear is mandatory.**
  - **Wade Bishop owes exact mining-share and combat-contribution figures tonight, 2026-08-14** — tighter than the standard window, a direct term of the leverage arrangement (`OBJ-27`).
  - **UNRESOLVED — the trial Gate's beast drops were never taken** (`EVT-000341`, recorded owed at `EVT-000369`). The clear killed 24 commons and a boss and recorded no crystal, core, or boss-drop roll; only the mined deposit was tracked. §11.1 fixes **25 B-Rank crystals and 1 B-Rank core** without a roll; §11.2 owes **one d100 boss drop at B, still unrolled** — resolve it live, never at a checkpoint. §13.2 puts all three in the **combat pool**, so the split rides on Wade's figures above. Full statement in `100_CHARACTER_SHEET.md` `pending_rewards.unresolved_gate_loot`.
  ...
  - **Marnie:** still missing, and both remaining leads are now worked. Walt Adamik's supplier inquiry was **asked and failed** (`EVT-000352`) — his contact was frightened by the word 'CONSULT' and cut the call, which closes that channel and establishes how protected this is. **Loomis Street is located and read** (`EVT-000353`): one unsigned, professionally guarded building, contents unknown, no approach made. The operation has a physical seat; Marnie does not.
...
- **First crew training is set: Monday 2026-08-17, 18:00 — ten people hold the date.** No longer a blocker. **The location is now the live obligation, owed to all ten by 2026-08-15**, with nothing booked or scouted; Soraya's question about whether gear is mandatory is also unanswered.
- **Marnie is still missing, and the search has hit its first real wall.** The Loomis Street building is located, read, and untouched — an unsigned, professionally guarded space whose contents are unknown. Walt Adamik's channel has **closed**: his supplier was frightened by the word alone. Remaining approaches, all open: enter or approach the building; find a second independent account of the CONSULT stranger; or work the S-Rank dagger's provenance, the one object tying the operation to Marnie's own hand.
- **Wade Bishop owes exact payout figures tonight (2026-08-14)** and the separate Ironline decision call tomorrow (2026-08-15) — both now shaped by genuine leverage, not just Wade's own pitch.
...
- **Four new crew contacts** (Corbin, Felix, Dana, Warren) — genuine interest, nothing scheduled.
...
- **40 undeclared B-Rank crystals** banked, unsold — 44 of the original 84 sold at `EVT-000359`.
...
- **A second Instant-Dungeon Key [E-Rank]** and one **Instant-Dungeon Key [D-Rank]** banked, unused.
...
```yaml
trigger_telemetry:
  as_of: "2026-08-14T14:30:00-05:00"
...
**Reading it.** Counts hold. The Marnie thread was worked hard this checkpoint (`EVT-000352`-`EVT-000353`) but **no new Hidden pointer attached**: `ENT-000193` ('Who Runs the CONSULT Operation') remains authored-but-unattached because Section 8.4.3's proximity/clue test asks for a resolved clue about the concealed subject, and what Loomis Street produced is the operation's building, which is the same subject the record already names — real progress on an attached quest, not a second attachment. `hidden_dry_days` holds at 1 for the same reason. `urgent_dry_days` advances to 21; no Urgent offer issued, and nothing this checkpoint met Section 8.4.2's criteria — the Loomis Street building presents no immediate threat to life, no actionable route, and no statable objective as read from the street. `concealed_records_available` unchanged at 15. `tracked_postings` unchanged, not re-checked.

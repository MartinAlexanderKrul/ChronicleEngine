# Gatefall — World Rule Profile 1.121
...
11. **The wider map.** Roll **d100** once on Section 9.1.6 for whether anywhere else in the country produced something the regions could not answer. **This step rolls three event kinds and nothing else** — an S-Rank Gate with nothing in range, a red gate at A-Rank or above, a break already loose — because everywhere that is not Chicago or Prague runs a light tick rather than this one. Steps 1–9 never leave the two simulated cities. **On a week's first tick, also roll Section 9.1.7** for the world outside the United States, which runs on the weekly clock beside Section 9.1.4 rather than this daily one.
...
**This is deliberately not a second Section 9.1.** Ten steps across thirty metros a day is a bookkeeping load no table survives, and nearly all of it would be Gates other people clear off-screen — which is already what the trade does in Chicago, in numbers, under step 4. **What the wider map owes is not simulation; it is the three things that reach a national asset**: an S-Rank Gate nothing is in range of, a red gate no regional bench will enter, and a break already loose that outran the team sent to it. Those are rolled and written. **Nothing else is rolled at all.**
...
| D | — | — | — | ~30 (same harvest basis as E) | ~$85,000 |

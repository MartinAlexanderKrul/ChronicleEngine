...
**Checkpoints:** 108 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0108`)
...
| frozen | 0009–0108 | 100 |

**Latest capture:** `900_CHECKPOINT_0108` — kind `session-save`, profile 1.86 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0107`, source `EVT-000619`.

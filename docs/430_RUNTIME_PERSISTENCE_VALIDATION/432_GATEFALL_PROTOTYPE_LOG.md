...
**Checkpoints:** 83 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0083`)
...
**Latest capture:** `900_CHECKPOINT_0083` — kind `manual`, profile 1.71 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0082`, source `EVT-000492`.

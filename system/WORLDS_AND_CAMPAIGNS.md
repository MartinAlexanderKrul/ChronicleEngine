...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0009` | 2026-07-27 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 2 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0009`** (captured 2026-07-27, Alexander mid-morning after his rest day). Protagonist Alexander Pendragon cleared his first Gate as a striker (Red Line Corridor, true grade E), then pivoted to harvest/support work once the corrected rule (`EVT-000062`, world-rule commit `d53114b`) established that his E-card only caps strike/combat contracts, not harvest work at any grade. He completed a C-grade harvest job at the Cicero Scar (`EVT-000063`) and a second C-grade job, the Frozen Gallery (`EVT-000064`–`EVT-000068`), declaring 41 C-crystals — the crew's highest — for a ≈$24,663 harvest-share payout, his largest pending payout yet, alongside ≈$2,313 (Red Line) and ≈$5,700 (Cicero Scar). Seven undeclared private System-shop sales across both jobs brought private gold to 25,330, unknown to anyone, though two draws of site coordinator Dale's suspicion were both deflected. A break let Alexander study the strike element's tactics, gaining an externally-observed combat framework unknown to any NPC.\n\n  On his 2026-07-26 evening/2026-07-27 rest day (`EVT-000069`) he spent 2,500 gold on a C-grade dagger and an instant-dungeon key [E-band] (gold now 22,520), privately drilled the pocket-dimension dagger-swap and confirmed the summon/store exchange is truly instantaneous, completed a third daily quest (streak 3/7, XP 70/200, its stat/full-restore grant deliberately deferred and banked), and allocated his 3 already-held unspent points entirely into Strength (13→16, now 0 unspent). Through a call with Kesha Morrison he arranged (not yet confirmed) a fifth crew slot with striker Priya Okafor (`ENT-000136`) for a distinct unconfirmed E-D Gate, timer breaking 2026-07-29 midnight, tentatively staging 2026-07-28 around 9 AM (`REL-000065`).\n\n  The World Rule Profile **froze at version 1.0 on 2026-07-24** (Rules Section 14.6, Decision 074); this checkpoint and `900_CHECKPOINT_0008` (captured 2026-07-26) were both captured after the freeze and are save-trustworthy — `900_CHECKPOINT_0008`'s manifest still carries a pre-freeze \"workshop draft (unfrozen)\" warning label written before the freeze was declared in the repository, a stale label on an otherwise-valid checkpoint. The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` restores `900_CHECKPOINT_0009`.

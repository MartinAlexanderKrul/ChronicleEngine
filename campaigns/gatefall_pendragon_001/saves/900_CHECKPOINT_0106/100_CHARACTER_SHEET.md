...
provenance:
  source: EVT-000608
  game_date: "2026-08-22T12:30:00-05:00"
...
canonical_state:
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-22T12:30:00-05:00"
      mana_recovery_mode: resting
      mana_recovery_remainder_units: 0
      health_recovery_mode: resting
      health_recovery_remainder_units: 0
      note: "Five scalars, by owner ruling 2026-08-10. How the anchor advanced is narrated by the promotion Event that moved it and by `170_CHANGELOG.md`, neither of which can drift from the clock the way a note sitting beside it can. Health closed this span at full cap; Mana closed 12 short of cap (four skill activations this span — two Keen Sense at 2 each, one Dimensional Projection at 6 — spent since the last full settlement, no elapsed-time recovery narrated between them) and its remainder is zeroed pending the next settled rest span."
    ...
    tracked_counters:
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 87 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 59 }
      ...
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 80 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 42 }
    ...
    daily_premium:
      ...
      model_bags:
        settled_through: "2026-08-21 rotation (`EVT-000603`)"
        weapon:
      ...
      purchased: "0/6 on the live Verdant cycle — nothing bought. **ROTATED at `EVT-000603`** when `/system shop` was opened past the 2026-08-22 boundary... corrected: past the 2026-08-21 06:00 boundary, the stored Umbral cycle having been generated 2026-08-20 at System Rank B. This is the campaign's **first rotation generated at System Rank A**. Twelve real draws: fabrication series d8 5 → **Verdant**; Rank d100s weapon 7 (A, flat at System Rank), armor 78 (+1 → S), accessory 26 (A, flat), rune 15 (A, flat), key 91 (+2 → S). Model bags: weapon → **Aegis Guard Shield**, armor → **feet/Arcanist**, accessory → **Quickstep Charm**, consumable → **Sovereign Panacea**, key → **Alchemist Key**. Rune skill d10 5 → **Flash Step**. Offers stand until 2026-08-22 06:00. Prior cycle, retired: 1/6 on the Umbral cycle — the Ghost Quickknife [A-Rank] (50,000 g, `EVT-000557`). The remaining five are available until 2026-08-21 06:00."
      offers:
        weapon: "Aegis Guard Shield [A-Rank] · off hand · Vitality +18 (16 budget + 2 premium) · physical reduction 17%+5pp = **22%** · 50,000 g · unpurchased — an off-hand that trades a −30% vambrace proc for flat worn reduction, which is the axis Combat Tier S actually reads"
        armor: "Adaptive Arcanist Feet [S-Rank] · feet · Intelligence +12 (10 budget + 2 adaptive) · physical reduction 23%+3pp = **26%** · 135,000 g · unpurchased — **the first S-Rank equipment ever offered to this Bearer**, and its ceiling is above every worn piece he owns"
        accessory: "Ascendant Quickstep Charm [A-Rank] · accessory · Agility +12 (9 budget + 3 ascendant) · 40,000 g · unpurchased"
        consumable: "Sovereign Panacea · clears one poison, venom, or disease regardless of Rank · 600 g · unpurchased"
        rune: "Premium Rune — teaches **Flash Step** · [A-Rank] · UNBOUND · NPC-ELIGIBLE · 500,000 g · unpurchased — **inert to him**: he holds Flash Step at [A-Rank] Expert and §12.5 stocks a known skill only above its current Rank, so this teaches him nothing and is transferable stock only"
        key: "Alchemist Key [S-Rank] · instant-dungeon key, boss drops a guaranteed potion cache in addition to its normal roll · 1,125,000 g · unpurchased"
      previous_cycle: "**2026-08-20, Umbral series — 1/6 purchased** (Ghost Quickknife [A-Rank], 50,000 g, `EVT-000557`); generated at System Rank B and expired unbought on the rest at the 2026-08-21 rotation. Prior: **2026-08-19, Prismatic series — 3/6 purchased** (Restoration Draught, Crystal Key [B-Rank], Adaptive Titan Legs [B-Rank]), expired unbought on the rest at this rotation."
    non_daily_quests:
      capacity_total: 6
      active:

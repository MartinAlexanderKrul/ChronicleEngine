...
scope: campaign
# This save (`EVT-001219`-`EVT-001225`): the IST-ICN flight (-$4,850); ten S-Rank keys (-9,000,000 g), one spent; 397 S-Rank crystals sold (+6,074,100 g); +2 S-Rank cores, a Bulwark rune [S]; the GB-63 lot unsold and relisted.
# Prior save (`EVT-001213`-`EVT-001218`): 38 A-Rank pieces bought at the System shop for the guild's A-Rank members (-1,200,000 g), carried to HQ basement storage and handed to Anjali Desai (`EVT-001216`, `EVT-001217`).
# Prior save (`EVT-001207`-`EVT-001212`): GB-63's haul in (394 S-Rank crystals, 2 S-Rank cores, a Guard Shield [S], `EVT-001208`); the standing-agreement filing, +$6,500,000, and the lot to Renata's 13:00 slot (`EVT-001209`).
# Prior save (`EVT-001169`-`EVT-001179`): no cash or gold movement; fuel drawn from the dimensional inventory and consumed (a fill, never itemised); Orenne\'s remains stored, one special holding (`EVT-001175`).
# Earlier per-save notes: sealed (Decision 094), see `sealed/`.
# 2026-09-24, out of play, at the player's direction: holdings brought to what their own Events establish. No Event moved, no fictional time. The banked Heartward Sigil [S] was a duplicate of the worn one (`EVT-000731`/`EVT-000813`) and is struck; Quickknife [A] reads its A-Rank budget (Agility +16, power 16) and Titan Coif [A] (Brute) Strength +8, reduction 17%; Gale Feet [S] (Carapaced) reads Agility +10, Vitality +1; `EVT-001001`'s second Longsword [S] is restored, and its six boss drops carry imprints rolled today (dungeon d10, body family d6, signature d8, finish d6; one reroll where a one-boss key came up twice); the Karlin elixir (`EVT-001104`) makes Elixir of a stat x4; the plain Quickknife [S] collected at `EVT-000829` leaves custody for gear; the Assay archive entrusted to Tolo at `EVT-000989` moves from special to custody.
...
# EVT-000285 EVT-000300 EVT-000323 EVT-000324 EVT-000326 EVT-000327 EVT-000328 EVT-000339 EVT-000342
# EVT-000343 EVT-000358 EVT-000359 EVT-000398 EVT-000399 EVT-000400 EVT-000401 EVT-000402 EVT-000403
# EVT-000407 EVT-000410 EVT-000411 EVT-000415 EVT-000416 EVT-000417 EVT-000420 EVT-000422 EVT-000423
# EVT-000424 EVT-000425 EVT-000428 EVT-000429 EVT-000430 EVT-000431 EVT-000432 EVT-000433 EVT-000434
# EVT-000435 EVT-000446 EVT-000447 EVT-000464 EVT-000469 EVT-000472 EVT-000473 EVT-000474 EVT-000476
# EVT-000479 EVT-000480 EVT-000481 EVT-000485 EVT-000487 EVT-000494 EVT-000496 EVT-000548 EVT-000550
# EVT-000556 EVT-000557 EVT-000563 EVT-000564 EVT-000565 EVT-000567 EVT-000570 EVT-000572 EVT-000578
# EVT-000583 EVT-000584 EVT-000586 EVT-000587 EVT-000588 EVT-000589 EVT-000592 EVT-000606 EVT-000607
# EVT-000609 EVT-000611 EVT-000616 EVT-000618 EVT-000674 EVT-000676 EVT-000680 EVT-000690 EVT-000693
# EVT-000694 EVT-000695 EVT-000696 EVT-000697 EVT-000713 EVT-000714 EVT-000715 EVT-000716 EVT-000717
# EVT-000718 EVT-000719 EVT-000720 EVT-000722 EVT-000735 EVT-000781 EVT-000788 EVT-000802 EVT-000803
# EVT-000808 EVT-000809 EVT-000810 EVT-000812 EVT-000813 EVT-000832 EVT-000852 EVT-000853 EVT-000858
# EVT-000885 EVT-000891 EVT-000892 EVT-000901 EVT-000902 EVT-000908 EVT-001013 EVT-001020 EVT-001021
# EVT-001026 EVT-001032 EVT-001033 EVT-001042 EVT-001043 EVT-001049 EVT-001052 EVT-001065 EVT-001077
# EVT-001080 EVT-001082 EVT-001083 EVT-001084 EVT-001097 EVT-001108 EVT-001109 EVT-001116 EVT-001118
# EVT-001120 EVT-001121 EVT-001123 EVT-001128 EVT-001129 EVT-001131 EVT-001132 EVT-001134 EVT-001135
# EVT-001139 EVT-001148 EVT-001154 EVT-001162 EVT-001168
subjects: []
```
...
```yaml
current_funds:
  as_of_event: EVT-001225
  as_of_game_date: "2026-10-01T19:47:00-05:00"
  cash_usd: 808570790.93
  gold: 352682231
  pending_payouts_usd: 159600000.00
  pending_payout_count: 1
  note: "**This span (`EVT-001219`-`EVT-001225`). Cash $808,575,640.93 -> $808,570,790.93 (-$4,850: Istanbul-Incheon, business, one way, Fri 10-02, `EVT-001219`). Gold 355,608,131 -> 346,608,131 (-9,000,000: ten Instant-Dungeon Keys [S], `EVT-001220`) -> 352,682,231 (+6,074,100: 397 S-Rank crystals at 15,300 g, `EVT-001221`).** The GB-63 lot did not sell (bids stopped at $131M under the ≈$148M reserve after two new registrations withdrew together; `EVT-001222`); relisted Mon 10-05 13:00 Chicago, still one pending payout at its ≈$159,600,000 estimate. **PRIOR SPAN (`EVT-001213`-`EVT-001218`). Gold 356,808,131 -> 355,608,131 (-1,200,000: 38 A-Rank pieces at the System shop -- 14 weapons x 40,000, 16 armor x 24,000, 8 accessories x 32,000 -- for the guild's A-Rank members, a gift from him to the guild, `EVT-001216`; left in HQ basement storage for Anjali Desai's distribution, `EVT-001217`).** Cash unchanged; the GB-63 lot still pending (13:00 auction, figure by 18:00). **PRIOR SPAN (`EVT-001207`-`EVT-001212`). Cash $802,075,640.93 -> $808,575,640.93 (+$6,500,000: GB-63 under the standing agreement, $500,000 flat + $6,000,000 severity, filed and countersigned 08:33 and settled on countersignature, `EVT-001209`).** Pending payouts 0 -> 1: the GB-63 lot, 394 S-Rank crystals + 2 S-Rank cores, ≈$159,600,000 at ≈$400,000/crystal and ≈$1,000,000/core, Renata's private early window 2026-10-01 14:00 Eastern (13:00 Chicago), reserve ≈$148,000,000 unless he says otherwise by noon, confirmed figure owed by 18:00 Chicago. Gold unchanged. Stored gear +1 (Guard Shield [S], not for sale). PRIOR: **Out of play, 2026-09-25 (owner ruling): September guild salaries paid by Alexander, -$9,082,849.29** (every member from their signing day to 30 September, prorated; E-A at Section 13.7.3 rates with A at $600,000 authored; itemised in `096_GUILD_CLEARANCE_LOG.md`, Founder Spending). Cash $811,158,490.22 -> $802,075,640.93. From October the guild pays. **This span (`EVT-001195`-`EVT-001206`). Cash and gold unchanged; no stored-gear movement.** The Evanston break's cores and crystals went to the Chicago branch, which held the contract (`EVT-001202`). GB-63's loot -- the Kilnfather's core [S] and crystal [S], a Guard Shield [S], 384 S-Rank crystals in deposits -- lies unclaimed at the close, inside the clear window (`EVT-001205`). PRIOR SPAN (`EVT-001180`-`EVT-001194`). Cash and gold unchanged; no stored-gear movement.** The penalty zone drops no loot (Section 8.3). The guild bought 176 C-Rank and 58 B-Rank pieces for members (about $5.39M) from guild funds, not his (`EVT-001191`); Dario paid for dinner. Beer at the house: five Urquell and six Oakland, not itemised. PRIOR SPAN (`EVT-001169`-`EVT-001179`). Cash and gold unchanged; no stored-gear movement. One special holding in: Orenne's remains, sealed (`EVT-001175`).** PRIOR SPAN (`EVT-001162`-`EVT-001168`). Gold $356,898,131 -> $356,808,131 (-90,000: a B-Rank Torso bought at the System shop and gifted to Trevor Yamashita, `ENT-000342`). Cash unchanged.** PRIOR SPAN (`EVT-001148`-`EVT-001154`). Cash $701,358,490.22 -> $811,158,490.22 (+$109,800,000): Renata confirmed the combined S-Rank auction lot flat at its quoted estimate, landing on schedule at 18:00 Chicago (`EVT-001154`). Pending payouts 1 -> 0. Gold unchanged. No stored-gear movement.** PRIOR SPAN (`EVT-001132`-`EVT-001139`). Cash $697,398,490.22 -> $701,358,490.22 (+$3,960,000: Tulsa $1,650,000, the next business day after its 2026-09-26 filing, and Karlin $2,310,000, by 17:00 Chicago on Monday 2026-09-28; both landed at their estimates). Pending payouts 3 -> 1: the S-Rank auction lot (~$109,800,000) stands, Tuesday 2026-09-29 14:00 Eastern. Gold unchanged. Stored gear +2 (a Greatarm [S-Rank] and a Hunter's Band [A-Rank]).** PRIOR SPAN (`EVT-001121`-`EVT-001128`). Gold 355,598,131 -> 356,898,131 (+1,300,000: Daily Random Boxes #66 and #67, System gold, `EVT-001123`). Cash unchanged; the three pending payouts stand (Tulsa $1,650,000, Karlin ~$2,310,000 Monday 2026-09-28, the S-Rank auction lot ~$109,800,000 Tuesday 2026-09-29 14:00 Eastern). Greater Healing Potion 34 -> 36, Greater Mana Potion 41 -> 42 (Box #68).** PRIOR SPAN (`EVT-001109`-`EVT-001120`): cash and gold unchanged, one Greater Mana Potion consumed (x42 -> x41). PRIOR SPAN (`EVT-001097`-`EVT-001108`). Cash and gold UNCHANGED - nothing had landed. Three payouts owed, all estimates until they clear: **Tulsa $1,650,000** (his, next business day, `EVT-001097`); **Karlin ~$2,310,000** (his, Monday 2026-09-28, `EVT-001106`); **the S-Rank auction lot ~$109,800,000** (267 crystals + 3 cores through Renata, no fixed date, `EVT-001106`). **Calumet's $3,300,000 is the GUILD's, not his**, and is not counted here. Derivations and the full movement table sit below under this checkpoint's movement. PRIOR SPAN (`EVT-001079`-`EVT-001087`). Both pending payouts landed: the combined S-Rank auction lot cleared at 🎲 67 -> ~101.4% of its $75,317,500 estimate -> **+$76,370,000**; the federal lot closed flat at its quoted estimate, **+$130,200,000**. Cash $490,828,490.22 -> **$697,398,490.22.** Pending payouts 2 -> 0. Gold: +650,000 (Daily Random Box #65, System gold, `EVT-001082`) -3,350 (5x D-Rank armor + 1x C-Rank Longsword bought for Prague's crew, `EVT-001084`) — 354,951,481 -> **355,598,131.** Full session detail: `160_CAMPAIGN_CHRONICLE.md`."
  note_prior: "**Prior span (`EVT-001065`-`EVT-001077`).** West Loop (directed assignment, population-anomaly A-carded/S-populated, solo): 256 mined + 10 beast-drop A/S-mixed crystal sold licensed instant (+$12,800,000) + op determination (+$3,200,000) = +$16,000,000. Pilsen (directed assignment, true A-Rank, solo): 112 mined + 12 beast-drop A-Rank crystal + 2 A-Rank cores sold licensed instant (+$6,450,000) + op determination (+$3,200,000) = +$9,650,000. Gary (NAMED S-Rank directed assignment, solo): op determination +$3,200,000 initial, corrected +$4,800,000 to the S-Rank-scaled rate (2.5x the flat A-Rank figure, per Section 3.4's own kill-XP ratio), + a $500,000 reporting bonus for the West Loop instrument-failure flag = +$8,500,000. **Guild-HQ purchase, the Detroit logistics campus (Delia Okonjo, walked personally; corrected from an earlier misidentification as Denver — the Denver property is Alexander's own separate cage/containment facility, `EVT-001086`): -$90,000,000**, closed and signed. Cash $546,678,490.22 -> **$490,828,490.22.** **Gary's 298 mined+beast-drop S-Rank crystal + 3 S-Rank cores folded into West Loop's 10 S-Rank crystal + 2 S-Rank cores as one combined private-auction lot** (308 crystal, 5 cores) — auction-only, no posted price; estimated ≈$75,317,500 on the established Rank-ladder trend (≈$235,000/crystal, ≈$587,500/core), 2-3 days to close. Pending payouts: **1 -> 2** — the federal lot ($130,200,000, closing 09-24) plus the new combined S-Rank lot (≈$75,317,500 estimated). No gold movement. **A new campaign pricing ruling established this span (`EVT-001077`, Walt Adamik's counter):** an unbound-awakened skill rune's market appraisal is always priced against the combined crystal/core haul of a Gate **two Ranks higher** than the rune's own Rank — 1x that figure for a defensive/utility rune, 1.5x for an offensive one — never against its own Rank's haul. Two items from Walt's own stock (not Alexander's inventory) are listed for sale under this rule and the standing `OBJ-29` profit-share terms: an unbound-awakened Keen Sense [D-Rank] rune and an unidentified-turned-**Hunter's Band [A-Rank]** accessory, both read by Flux Sight this span, neither purchased back by Alexander.

  **Prior (`EVT-001056`-`EVT-001063`).** Renata's standing-agreement payout on the Winnetka lakefront Gate landed on schedule: $500,000 flat + $6,000,000 severity = **+$6,500,000.** Cash $540,178,490.22 -> **$546,678,490.22.** Pending payouts: **2 -> 1** — only the federal lot (~$130,200,000, closing 2026-09-24) remains outstanding. No gold movement this span.

  **Prior (`EVT-001043`-`EVT-001052`).** The Winnetka lakefront S-Rank Gate, OFFERED and cleared solo, filed to Renata by text (`EVT-001050`). **Pending 1:** $500,000 flat + $6,000,000 severity, processing by 2026-09-21 17:00 CT. **Pending 2:** the federal lot, 313 S-Rank crystals × ~$400,000 + 5 S-Rank cores × ~$1,000,000 = **~$130,200,000 estimated**, closing 2026-09-24 17:00 ET, transfer after close. Cash and gold unchanged. **EUR:USD is 1:1 by campaign convention** (`EVT-001043`); Sanne's €80,000 stands at $80,000.00.

  **Prior (`EVT-001033`-`EVT-001042`).** System shop: Instant-Dungeon Key [S-Rank], -900,000 g (`EVT-001036`); 394 S-Rank Mana Crystals (8 beast-drop + 386 mined) sold @ 15,300 g, +6,028,200 g. Gold 349,823,281 -> **354,951,481.** **Sanne Verhoeven's premium-tier shoot, €80,000 wired (`EVT-001036`), booked at $80,000.00** — the figure live play narrated; no EUR:USD rate has ever been ruled for this campaign and none is invented here. Cash $540,258,490.22 -> **$540,178,490.22.** Pending payouts unchanged, none.

  **Prior (`EVT-001021`-`EVT-001032`).** A NAMED A-Rank Gate cleared solo (`EVT-001026`), filed through Renata under the standing solo terms: 193 A-Rank crystals (17 beast-drop + 176 mined) × $50,000 + 2 A-Rank cores × $125,000 + $500,000 flat fee + $2,500,000 severity = **+$12,900,000.** Cash $527,358,490.22 -> **$540,258,490.22.** No gold movement.

  **Prior (`EVT-001013`-`EVT-001020`).** 100 Elixirs of Intelligence bought for Kane at the System shop (5,000 g each, `EVT-001013`): -500,000 g. Gold 350,323,281 -> **349,823,281.** No cash movement.

  **Prior (`EVT-000999`-`EVT-001012`).** Ten self-opened S-Rank instant dungeons (`EVT-001001`): -9,000,000 g (keys). 52nd daily's Random Box (`EVT-001004`, 🎲 59): +650,000 g. **Every Mana Crystal in the dimensional inventory sold to the System shop, all Ranks, including the never-before-sold 100-crystal S-Rank floor, player's explicit instruction (`EVT-001005`):** 3,784 S-Rank @ 15,300 g (+57,895,200 g), 110 A-Rank @ 3,400 g (+374,000 g), 50 B-Rank @ 750 g (+37,500 g), 50 D-Rank @ 40 g (+2,000 g), 50 C-Rank @ 170 g (+8,500 g) — total +58,317,200 g. Gold 292,006,081 -> **350,323,281.** **The Brno S-Rank auction filing cleared** through Renata Okonkwo-Vance's office, backed by Director Beran's CGA clearance certificate — the last pending payout on the books. Cash $402,358,490.22 -> **$527,358,490.22.** Pending payouts: **1 -> 0**, nothing outstanding.

  **Prior (`EVT-000984`, `OBJ-64`),** the second A-Rank Chicago directed-assignment Gate, cleared with Elias Kane (`EVT-000953`) the second A-Rank Chicago directed-assignment Gate, cleared with Elias Kane (`EVT-000953`)** — 13 beast-drop + 208 mined A-Rank crystals (221 total) × $50,000 = $11,050,000; 3 A-Rank cores × $125,000 = $375,000; standing $500,000 flat fee + $2,500,000 severity (ordinary A-Rank rate, `OBJ-43`/Pilsen precedent). **Total $14,425,000, filed through Renata Okonkwo-Vance and settled same-day.** Cash $387,933,490.22 -> **$402,358,490.22.** Pending payouts unchanged, **1**, the Brno S-Rank auction filing, ≈$125,000,000, still uncleared. **`OBJ-62`, the first A-Rank Chicago directed-assignment Gate, cleared solo (`EVT-000950`)** — 16 beast-drop + 160 mined A-Rank crystals (176 total) × $50,000 = $8,800,000; 2 A-Rank cores × $125,000 = $250,000; standing $500,000 flat fee + $2,500,000 severity. **Total $12,050,000.** Cash $375,883,490.22 -> **$387,933,490.22.** **A nine-city book-buying circuit (`EVT-000946`)** — Chicago, Boston, New York, DC, Miami, Houston, Dallas, Seattle, San Francisco, each reached by anchored rift-step — filled the Winnetka library floor to ceiling. Total ≈$340,000, cash. Cash $376,223,490.22 -> **$375,883,490.22.** **Ten S-Rank instant dungeons (`EVT-000944`)** — 10 keys bought (9,000,000 g) and spent solo; loot crystals sold down to the standing 100-floor (+53,687,700 g). Gold $246,668,381 -> **$300,356,081.** **Brno S-Rank Gate haul filed to auction (`EVT-000937`)** — 310 S-Rank Mana Crystal + 1 S-Rank Beast Core, backed by Director Miloš Beran's CGA clearance certificate as provenance, filed through Renata Okonkwo-Vance the same way the Red Gate haul cleared. Estimated ≈$125,000,000 at the GB-14 precedent rate, **not yet cleared** — the one pending payout on the books. No cash movement yet. **Winnetka furnishing, rush same-day order and install (`EVT-000925`, `ENT-000271`)** — Alexander rejected Thornquist's standard staged-delivery quote and paid for immediate turnaround instead: in-stock sourcing across three vendors, rush freight, overtime multi-crew install, fully furnished and installed the same day. Master bedroom, a second bedroom as standing guest room, a third converted to a home gym, the study, an adjoining library conversion (modular massive-oak shelving rather than built-in millwork — physically impossible same-day), and general living space. **Total $748,000, paid in full same-day** — no deposit/balance split; the premium over the original $420,000 bespoke quote is the cost of buying available stock and rush labor instead of waiting on a build. Cash $376,971,490.22 -> **$376,223,490.22.** **The Winnetka lakefront house bought outright (`EVT-000923`)** — negotiated by Delia Okonjo from $17,500,000 ask to **$17,100,000**, closed same-day per Alexander's own instruction (try to negotiate, pay full ask rather than let it drag). Cash $394,071,490.22 -> **$376,971,490.22.** **The standing Red Gate S-Rank auction filing clears (`EVT-000921`)** — open since `EVT-000896` (2026-09-08), the longest-uncleared pending payout on the books. 336 S-Rank crystals + 4 S-Rank cores, estimated $138,400,000 at the GB-14 precedent rate; real auction result 🎲 95 -> **+9% over estimate -> $150,856,000**, the actual bidding running hot on genuinely rare S-Rank material. Cash $243,215,490.22 -> **$394,071,490.22.** Pending payouts: **1 -> 0**, nothing outstanding. **This span (`EVT-000918`-`EVT-000920`):** 48th daily's Random Box (🎲 59) -> System gold +650,000 (255,018,381 -> **255,668,381**). **The Pilsen Gate (`ENT-000269`, NAMED A-Rank BGM National assignment, solo) cleared** — corrected in place, `F-`-class miss caught by the player: the first pass counted only beast-drop crystals and missed the mineable deposit, the elite/boss core drops, and the boss-drop roll entirely. **Full accounting**: 17 beast-drop crystals (16 commons + 1 elite) + 82 mined-deposit crystals (🎲 3d6 5 × A-Rank ×16 = 80, +2 Prospector) = **99 A-Rank crystals × $50,000 = $4,950,000**. 2 A-Rank cores (elite + boss) × $125,000 = **$250,000**. Boss drop (🎲 34 -> Equipment, chassis 🎲 34 -> Greatarm [A-Rank]) — banked, off-build, not equipped. **Crystals and cores sold to USD on the licensed market, filed through Renata Okonkwo-Vance under the standing BGM National agreement — not the System shop, confirmed with her directly.** Standing $500,000 flat fee + $2,500,000 severity (ordinary A-Rank rate, `OBJ-43` precedent). **Total this clear: $5,200,000 (crystals/cores) + $500,000 (flat) + $2,500,000 (severity) = $8,200,000**, all filed and settled same-day. Cash $232,015,490.22 -> **$243,215,490.22.** Pending payouts unchanged, **1**, the standing Red Gate filing alone, ≈$138,400,000, still uncleared. **Full movement history, every prior span: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures under `saves/`.**"
```


---

## This Checkpoint's Movement (`EVT-001219`-`EVT-001225`) — keys, a strip sold, a lot unsold

**Cash $808,575,640.93 → $808,570,790.93 (−$4,850). Gold 355,608,131 → 352,682,231 (−9,000,000 keys, +6,074,100 crystals). Pending payouts still 1 (the GB-63 lot, relisted Monday).** In: Instant-Dungeon Key [S-Rank] ×10 (one spent, ×9 held), Beast Core [S-Rank] +2, Rune — Bulwark [S-Rank] ×1, 397 Mana Crystal [S-Rank] (sold the same hour). The Glasswalker carried out of the instance is a live creature, not a holding (`EVT-001221`).

## Prior Checkpoint's Movement (`EVT-001213`-`EVT-001218`) — 38 A-Rank pieces for the guild

**Gold 356,808,131 → 355,608,131 (−1,200,000, `EVT-001216`). Cash unchanged at $808,575,640.93. Pending payouts still 1 (the GB-63 lot).** Thirty-eight A-Rank pieces bought at the System shop (14 weapons, 16 armor, 8 accessories, each to its member's request) and unloaded into HQ basement storage (`EVT-001217`): **the guild's, not his**, distributed by Anjali's office by Friday evening. Nothing else in or out.

## Prior Checkpoint's Movement (`EVT-001207`-`EVT-001212`) — GB-63 stripped, the filing

**Cash $802,075,640.93 → $808,575,640.93 (+$6,500,000, `EVT-001209`). Gold unchanged at 356,808,131. Pending payouts 0 → 1 (the GB-63 lot, ≈$159,600,000, 13:00 Chicago today).** Into the dimensional inventory (`EVT-001208`): Mana Crystal [S-Rank] +394 (384 mined in a 45-minute full strip, 9 Thrall drops, the Kilnfather's), Beast Core [S-Rank] +2 (the Kilnfather's, the Ember Warden's), Guard Shield [S-Rank] (Carapaced/Projection, Bound). The crystals and two cores are filed to auction; the shield is held back.

## Prior Checkpoint's Movement (`EVT-001195`-`EVT-001206`) — the fence, Evanston, GB-63

**No money of his moved, and nothing entered the inventory.** Kit and launched weapons drawn and stored again (`EVT-001202`); the Kilnfather's leavings are on the ground at the close (`EVT-001205`).

## Prior Checkpoint's Movement (`EVT-001180`-`EVT-001194`) — Region V, the contract towns, the Hive

**No money of his moved.** Cash and gold stand as in Current Funds. Kit drawn from the pocket dimension for the Hive and stored again on return; gym shorts and a training shirt drawn at `EVT-001190`. The guild's gear purchases (`EVT-001191`) and the contract towns' payments (`EVT-001188`) are guild money and are not his holdings.

## Prior Checkpoint's Movement (`EVT-001169`-`EVT-001179`) — the cage room

**No money moved.** Cash and gold stand as in Current Funds.

**Out: fuel, a fill.** At `EVT-001175` Alexander drew fuel from the dimensional inventory to burn Orenne's body. The sheet never itemised any, so this is recorded as a fill — an unlisted quantity that existed and is now consumed — not as a correction to a holding.

**In: Orenne's remains**, sealed in a lidded metal container, ash, char and shattered bone fragments (`EVT-001175`). One special holding in `100_CHARACTER_SHEET.md`'s dimensional inventory. No Rank, no catalogue line, no market; nothing Section 18.13.1 would price.

---

## Prior Checkpoint's Movement (`EVT-001097`-`EVT-001108`) — Karlín stripped clean; three payouts owed

**Gold 355,598,131 → 356,898,131 (+1,300,000, Boxes #66 and #67, `EVT-001123`). Cash unchanged at $697,398,490.22. Pending payouts still 3 (≈$113,760,000 combined estimated). Greater Healing Potion 34 → 36, Greater Mana Potion 41 → 42 (Box #68).** Prior movement below (`EVT-001097`-`EVT-001108`): gold unchanged at 355,598,131; pending payouts 0 → 3.

| Movement | Detail |
|---|---|
| **+267 S-Rank Mana Crystal, then −267** | The Karlín A/S Gate (`EVT-001104`): 11 beast drops (8 commons, 2 elites, 1 boss) + 256 mined (🎲 3d6 = 8 × 32, the S multiplier). Solo clear, so no support share and no split. **All 267 filed straight to auction** (`EVT-001106`) rather than banked — stock closes at **0**. |
| **+3 S-Rank Beast Core, then −3** | 2 elites and the boss. Filed to the same lot; stock returns to its prior figure. |
| **+1 Elixir of a stat [S-Rank]** | Boss drop 🎲 d100 99 → Elixir (Section 11.2): a permanent **+1 to one Stat**, max 3 lifetime per Stat. **Banked, unconsumed, and the Stat is NOT yet named** — tracked as `OBJ-75`. |
| **No equipment, no rune, no potion cache** | The 99 resolved to Elixir; the chassis, rune and cache sub-rolls made alongside it do not apply and were discarded. |
| **Nothing spent** | No shop purchase, no commission, no gear movement this span. The daily's Box #66 is **unopened**. |

**Drops were read at S-Rank, not at the Gate's assessed A.** Section 6.7 reads every drop table at the Rank the content *actually ran at*, and this Gate ran S-populated by the `EVT-001103` owner ruling.

---

## Prior Checkpoint's Movement (`EVT-001056`-`EVT-001063`) — Renata's payout lands; Delia engaged

**Gold unchanged at 354,951,481. Cash $540,178,490.22 → $546,678,490.22. Pending payouts 2 → 1 (~$130,200,000, the federal lot only).**

| Movement | Detail |
|---|---|
| **+$6,500,000 cash** | Renata's standing-agreement payout on the Winnetka lakefront Gate ($500,000 flat + $6,000,000 severity), processed on schedule at 17:00. |
| **-1 Greater Mana Potion** | Drunk at the Denver facility, `EVT-001062`, to afford closing the far door a second time. Stock 38 → **37**. |
| **Guild HQ purchase — commissioned, not yet spent** | Delia Okonjo sourcing existing, ready-to-use, best price-to-size candidates; results due the following morning. No funds committed this span. |
| **Twenty-city office-lease rollout — commissioned, not yet spent** | All under the guild's name, speed over cost, no ceiling set. Leases to close city by city; no funds committed this span. |

---

## Prior Checkpoint's Movement (`EVT-001043`-`EVT-001052`) — the Winnetka lakefront Gate

**Gold unchanged at 354,951,481. Cash unchanged at $540,178,490.22. Pending payouts 0 → 2 (~$136,700,000).**

| Movement | Detail |
|---|---|
| **+313 S-Rank Mana Crystal** | 23 beast drops (18 commons, 4 elites, 1 boss) + 290 mined (🎲 3d6 9 × 32 + 2 Prospector), `EVT-001050`. **Earmarked for the federal lot**, not sold to the shop. Stock 0 → **313**. |
| **+5 S-Rank Beast Core** | 4 elites and the boss. Stock 202 → **207**, the 5 new ones earmarked for the lot. |
| **Skill Rune — Stone Skin [S-Rank]** | Boss drop (🎲 d100 61 → Rune, d8 4). Duplicate, giftable, banked. |
| **12 banked weapons thrown and recalled** | Dimensional Projection volleys; all recovered, no condition change. |
| **Filed to Renata** | $500,000 flat + $6,000,000 severity due today; lot proceeds due after 2026-09-24. |

---

## Prior Checkpoint's Movement (`EVT-001033`-`EVT-001042`) — the shoot, the Frozen Gallery on camera, and the fifth circuit

**Gold 349,823,281 → 354,951,481. Cash $540,258,490.22 → $540,178,490.22.**

| Movement | Detail |
|---|---|
| **Instant-Dungeon Key [S-Rank], bought and spent** | System shop, 900,000 g (`EVT-001036`). Opened in Sanne Verhoeven's studio; Frozen Gallery, 8 commons / 1 elite / 1 boss, cleared solo on camera, no damage. Key consumed. |
| **+394 S-Rank Mana Crystal, then sold** | 8 beast-drop + 386 mined (🎲 3d6 12 × 32 + 2 Prospector). All sold to the System shop the same evening @ 15,300 g, **+6,028,200 g**. Stock 0 → 394 → **0**. |
| **+2 S-Rank Beast Core** | Elite and boss. Stock 200 → **202**. Shop refuses cores; banked. |
| **Skill Rune — Flash Step [S-Rank]** | Boss drop (🎲 d100 46 → Rune, d8 5). Duplicate, banked intact. |
| **Greater Mana Potion −1** | Drunk at `EVT-001038` to cover the far door's 2,500 close at 1,323 Mana. Stock 40 → **39**. |
| **Sanne Verhoeven's fee, €80,000** | Wired `EVT-001036`, booked **$80,000.00** as narrated; no exchange rate ruled. NDA + separate method clause (`REL-000119`). |
| **Two Kölsch, two more beers at home** | Hospitality at Reinhardt's and at Winnetka; no ledger value. |

---

## This Checkpoint's Movement (`EVT-000902`-`EVT-000908`) — the Jiu Valley kill and the Blue Island S-Rank Gate

**Cash $107,615,490.22 → $113,115,490.22. Gold unchanged at 255,018,381.**

| Movement | Detail |
|---|---|
| **Jiu Valley Exclusion kill, solo, no damage taken** | A unique unpopulated kill outside any Gate; no loot banked, no market recovery attempted (`EVT-000905`). |
| **Blue Island S-Rank Gate, solo with Elias Kane concealed alongside, real Health lost and recovered** | Boss restrained then finished by Kane's own hand, core kept by Kane under agreement, never banked. 301 S-Rank crystals + 1 S-Rank core filed to auction (no posted S-Rank price) rather than sold, +$5,500,000 flat fee + severity settled same-day (`EVT-000906`). |
| **+1 S-Rank Beast Core** | The elite kill at Blue Island; the boss's own core went to Kane. Stock 147 → **148**. |
| **Pending payouts** | Blue Island's auction filing (301 crystals + 1 core, ≈$121,400,000 est.) joins the standing Red Gate filing (≈$138,400,000, uncleared) — 1 → **2, ≈$259,800,000 combined estimated, neither cleared.** |

---

## This Checkpoint's Movement (`EVT-000859`-`EVT-000868`) — the Indianapolis break, a level, and a stat allocation

**Cash $81,315,490.22 → $89,340,490.22. Gold 115,986,881 → 116,636,881.**

| Movement | Detail |
|---|---|
| **Indianapolis break-containment, solo, no damage** | 17 A-Rank commons + 1 A-Rank boss (Hive archetype) killed; 28 A-Rank crystals + 1 A-Rank core recovered and sold licensed same-day, +$1,525,000 (`EVT-000862`-`EVT-000863`). Urgent quest "Contain the Indianapolis Break" completed, +6,800 XP. |
| **Two severity bonuses settled** | +$2,500,000 (2026-09-06 A-Rank clear) and +$4,000,000 (today's containment), both filed and paid same session, closing both `OBJ-43` pending threads (`EVT-000863`). |
| **New pending payout** | $500,000 flat fee, today's response, processing tonight — 1 payout pending. |
| **Level 133 → 134** | Kill/quest XP crossed the threshold; +1 all base Stats (past-100 rung), automatic (`EVT-000862`). |
| **91 stat points allocated** | +10 Strength, +40 Vitality, +41 Intelligence (16 claimed Ability Points + 75 held), player-directed (`EVT-000866`). |
| **Three Daily Random Boxes opened** | Potion cache (+2 S-Rank Healing, +1 S-Rank Mana Potion); System gold purse (+650,000g); a Stone Skin [S-Rank] rune, duplicate, banked unconsumed (`EVT-000866`). |
| **31 Mana spent (rift-step/Mend)** | 6 in-scene hops to Midway, ~25 combat (Dimensional Projection, Mana Bolt, Rupture, procs), 6 Mend on the wounded operative, 5 anchored step home — fully recovered by the level-up and the subsequent stat allocation. |

**Loadout unchanged this span** — no equipment moved.

---

## This Checkpoint's Movement (`EVT-000853`-`EVT-000858`) — Wade Bishop, three instant dungeons, and Elias Kane

**Cash unchanged at $81,315,490.22. Gold unchanged at 115,986,881.**

| Movement | Detail |
|---|---|
| **Three S-Rank instant dungeons (last three of ten purchased keys, solo, no damage, no mastery credit)** | Crypt (5 commons, 1 elite, 1 boss) — potion cache, +3 Greater Mana Potions. Crypt (9 commons, 1 elite, 1 boss) — rune, **Dagger Mastery [S], unbound-awakened**, genuinely NPC-giftable, distinct from the bearer-only duplicate already sold. Frozen Gallery (9 commons, 1 elite, 1 boss) — **Elixir of a stat**, banked, choice deferred (`EVT-000855`). |
| **+1,178 S-Rank Mana Crystal** | Mined 448+320+384=1,152, beast-drop 6+10+10=26, across the three dungeons. **Banked, not sold** — no crystal sell-down this span (`EVT-000855`). |
| **+6 S-Rank Beast Core** | 3 elites + 3 bosses across the three dungeons. Stock 69 → **75** (`EVT-000855`). |
| **630 Mana spent** | A passenger rift-step to the Prague hotel-room balcony anchor (`EVT-000843`, 5 Mana, anchored) and back via an ordinary intercontinental travelling step (625 Mana, "another continent" band, no anchor at The Sidecut) — both anchors already set, no new anchor spent (`EVT-000857`). |

**Loadout unchanged this span** — no equipment moved. Nothing new gear-shaped was acquired.

---

## This Checkpoint's Movement (`EVT-000832`-`EVT-000852`) — Prague, the Karlov meeting, and three world ticks

**Cash $13,733,790.22 → $81,315,490.22. Gold 64,964,281 → 115,986,881.**

| Movement | Detail |
|---|---|
| **+$2,050,000.00** | Desmond Farraday's GB-14 determination, paid (`EVT-000835`). |
| **+$49,200,000.00** | The GB-14 S-Rank auction clears, $123M total, 60/40 split — Alexander's 40% share (`EVT-000835`). `OBJ-40` closes. |
| **+$12,750,000.00** | The A-Rank directed-assignment Gate clear's loot, sold on the licensed market (`EVT-000851`). |
| **+$3,581,700.00** | Walt Adamik's sale — eight gear pieces and five material lines (`EVT-000850`). Full breakdown below. |
| **+900,000g** | Dagger Mastery [S] rune, chosen from the 2026-09-04 Daily Random Box (streak 28, multiple of 7) and resold to the System shop at the standard 50% rate against its own catalogue value (`EVT-000836`). |
| **S-Rank Mana Crystal, pre-session correction -300** | An auction-accounting correction found while reconciling the GB-14 filing (`EVT-000835`) — 1,638 held pre-session corrects to **1,338**, the true GB-14 grant. |
| **+$18,975,400 / -1,238 S-Rank crystals, -10 A-Rank crystals** | The corrected pre-session stock (1,338 S-Rank, 10 A-Rank) sold in full on the licensed market before either dungeon batch ran (`EVT-000835`). S-Rank stock to **100**; A-Rank crystal stock to **0**. |
| **-4,500,000g** | First 5 S-Rank Instant-Dungeon Keys bought (`EVT-000837`). |
| **First S-Rank dungeon batch (5 dungeons, solo, no damage, no mastery credit)** | +1,957 S-Rank Mana Crystal, +15 S-Rank Beast Core; boss drops **Longsword [S]** (Beast Den, dungeon 2 — given a Boss Imprint, Predator/Edge, +1 Agility, Section 11.2.1), a duplicate **Stone Skin rune [S]** (unbound), a duplicate **Sprint book [S]** (unbound); +3 Greater Healing Potions, +3 Greater Mana Potions (`EVT-000837`). |
| **+29,942,100g / -1,957 S-Rank crystals** | The batch's full crystal yield sold (`EVT-000838`). S-Rank stock: 100+1,957=2,057 → **100**. |
| **-4,500,000g** | Second 5 S-Rank Instant-Dungeon Keys bought (`EVT-000838`); only 2 spent this batch — **3 unused, banked**. |
| **Second S-Rank dungeon batch (2 dungeons, solo, no damage, no mastery credit)** | +667 S-Rank Mana Crystal (corrected), +5 S-Rank Beast Core; boss drops **Mindspun Loop [S] Boss-Imprinted**, a second **Hunter's Band [S] Boss-Imprinted** (`EVT-000839`). |
| **+10,205,100g / -667 S-Rank crystals** | The second batch's full crystal yield sold (`EVT-000840`). S-Rank Mana Crystal stock: 100+667=767 → **0, line closed for now**. |
| **S-Rank Beast Core reconciled to 69** | 52 true pre-session (53 minus the 1 already consumed re-coring `EVT-000829`, not yet folded into this ledger's materials line) -3 (the auction correction's own core share) = 49 baseline; +15 (first batch) +5 (second batch) = **69** (`EVT-000840`). |
| **+1 Keen Sense rune [A-Rank], unbound-awakened, genuinely giftable** | A-Rank Gate boss drop (`EVT-000851`) — distinct from the Dagger Mastery rune sold above and from existing banked Keen Sense duplicates. |
| **+250 A-Rank Mana Crystal** | The A-Rank directed-assignment Gate clear (`EVT-000851`). Stock 0 → **250**, sold on the licensed market for the cash line above. |
| **+2 A-Rank Beast Core** | The A-Rank directed-assignment Gate clear (`EVT-000851`). Pre-session 13 +2 = **15**. |
| **-15 A-Rank Beast Core** | Sold to Walt Adamik (`EVT-000850`). Stock 15 → **0, drops from the panel**. |
| **-13 B-Rank Beast Core** | Sold to Walt Adamik (`EVT-000850`), pre-session stock 13. Stock → **0, drops from the panel**. |
| **-38 C-Rank Beast Core** | Sold to Walt Adamik (`EVT-000850`), pre-session stock 38. Stock → **0, drops from the panel**. |
| **-30 C-Rank Mana Crystal** | Sold to Walt Adamik (`EVT-000850`), off the last-cited stock in this ledger's own history. |
| **-30 D-Rank Mana Crystal** | Sold to Walt Adamik (`EVT-000850`), off the last-cited stock in this ledger's own history. |
| **D-Rank Beast Core, B-Rank Mana Crystal** | Unchanged this span. |
| **Vltavska Break loot (D-Rank, 25 commons + 1 boss-equivalent, `EVT-000834`)** | D-Rank crystals and a small D-Rank materials haul, sold to the System shop on ordinary terms alongside the rest of this span's crystal movement; no boss-Rank gear drop. |
| **-Longsword [B-Rank] plain, -Reacharm [B-Rank] x2, -Adaptive Titan Coif [B-Rank], -Adaptive Titan Legs [B-Rank], -Ascendant Warlord's Loop [A-Rank], -Arcanist Feet [A-Rank], -Greatarm [A-Rank], -Ghost Quickknife [A-Rank]** | Sold to Walt Adamik (`EVT-000850`), part of the $3,581,700.00 cash line above. None of these was equipped — all eight were banked spares/duplicates. |

**Loadout unchanged this span** — no equipment moved. None of the new gear above (Longsword [S], Mindspun Loop [S], the second Hunter's Band [S], the Keen Sense rune [A]) has been equipped or bound.

---

## This Checkpoint's Movement (`EVT-000827`-`EVT-000830`) — reconciliation, Boston, and Prague

**Cash $13,783,790.22 → $13,733,790.22. Gold unchanged at 64,964,281.**

| Movement | Detail |
|---|---|
| **-$50,000.00** | Corwin Ashvale's fee (`EVT-000829`) — commissioning a re-coring attempt on the homebrew Mana-storage cell (A-Rank-equivalent ceiling, 750). |
| **S-Rank Beast Core -1** | Consumed as re-coring material (`EVT-000829`). Result pending — five-day bench working, due 2026-09-08. |
| **Plain Quickknife [S] returned** | Collected from Corwin Ashvale's custody, unchanged — no fusion, no forging (`EVT-000829`). Closes `OBJ-47`'s Quickknife deliverable. |

---

## This Checkpoint's Movement (`EVT-000815`-`EVT-000826`) — a National tour's tail, a Houston Gate, and three new BGM threads

**Cash $11,259,590.22 → $13,783,790.22. Gold unchanged at 64,964,281.**

| Movement | Detail |
|---|---|
| **+$1,677,500.00** | Houston Gate loot sold standard (`EVT-000817`): 140 B-Rank crystals ($1,540,000), 3 B-Rank cores ($82,500), 1 B-Rank Reacharm ($55,000). |
| **+$850,000.00** | BGM incident invocation under `OBJ-43` (`EVT-000817`) — $500,000 flat + $350,000 severity bonus, a confirmed B-Rank Gate contained clean, no casualties. |
| **-$3,000.00** | Storage-bay furniture — bed, heater, desk (`EVT-000826`). |
| **-$300.00** | One night, downtown Chicago hotel (`EVT-000823`). |
| **Beast Core [B-Rank] 14→13, [A-Rank] 14→13** | Seamwork material spent on the storage-cell working (`EVT-000820`) — one failure, two successes, capacity 400→750, ceiling reached. |
| **+1 Arcanist Boots [S-Rank]** | Daily Random Box (`EVT-000816`). |
| **+1 Reacharm [B-Rank] (second, identical line)** | Houston Gate boss drop (`EVT-000817`); quantity-collapsed with the existing one. |
| **Greater Healing Potion 16→19, Greater Mana Potion 14→20** | Three Daily Random Boxes across the span (`EVT-000821`, `EVT-000823`, `EVT-000824`). |

Six new real anchors (18-23), six new BGM/civilian contacts, three new objectives (`OBJ-49`, `OBJ-50`, `OBJ-51`), and `OBJ-46` spent and closed. Full detail: `160_CAMPAIGN_CHRONICLE.md`.

---

## Checkpoint 0131's Movement (`EVT-000802`-`EVT-000813`) — two Gates, a declined lease, and a fusion arc

**Cash $319,090.22 → $11,259,590.22. Gold unchanged at 64,964,281.**

| Movement | Detail |
|---|---|
| **+$9,850,000.00** | 197 A-Rank crystals sold on the licensed USD market at $50,000/crystal (`EVT-000803`), off the Argyle Street Gate's 207 collected (192 mined + 15 beast-drop). 10 kept personally, unbanked. |
| **+$1,144,000.00** | 104 B-Rank crystals sold on the licensed USD market (`EVT-000810`), the Newark Gate's full mined deposit, sold same day — the B-Rank crystal stock's round trip, unchanged at 50. |
| **-$40,000.00** | Compensation paid to the Milwaukee data-center listing's owner (`EVT-000808`) after a Keen Sense strength demonstration damaged a reinforced door. No purchase made. |
| **-$2,500.00** | Corwin Ashvale's fee, the Warlord's Loop fusion (`EVT-000813`) — 1 A-Rank Beast Core also consumed. |
| **-$8,000.00** | Corwin Ashvale's fee, the Arcanist Torso/Gauntlets forge (`EVT-000813`) — 2 S-Rank Beast Cores also consumed. |
| **-$3,000.00** | Corwin Ashvale's fee, the main-hand dagger's Projection Echo fusion (`EVT-000813`) — 1 S-Rank Beast Core also consumed. |
| **+207 / -197 A-Rank crystals** | Argyle Street Gate haul, net **+10 held**. |
| **+2 A-Rank Beast Core** | Argyle Street Gate (one elite, one boss) — net **+1** after 1 consumed fusing the Warlord's Loop. |
| **-5 S-Rank Beast Core** | Corwin's fusion arc: 2 (Torso/Gauntlets forge) + 1 (dagger fusion) + 2 (the failed power-ceiling experiment, no result produced). |
| **+1 Instant-Dungeon Key [B-Rank]** | Newark Gate boss drop (`EVT-000809`). |
| **+1 Skill Book — Mana Bolt [S], duplicate** | 33rd daily's doubled Random Box (`EVT-000806`). |
| **+1 Skill Book — Silent Step [B], duplicate** | Argyle Street Gate boss drop (`EVT-000802`). |
| **Watcher Torso [B], Gale Hunter's Gauntlets [C], Warded Vambrace [A] x2** | All four fully **consumed** as fusion donors at Corwin's workshop (`EVT-000813`) — gone, not retired. |
| **A plain Quickknife [S] (the EVT-000793 drop)** | **Destroyed** in the failed power-ceiling experiment (`EVT-000813`), alongside the 2 S-Rank cores above. |
| **A second plain Quickknife [S] (the EVT-000730 item)** | Left in **Corwin Ashvale's custody** for 2 more days of research (`EVT-000813`); `OBJ-47`, due 2026-08-31. |
| **Dormant Core [S], Frost-fused carapace plating [B]** | Returned by Priscilla Nakamura, no next-step finding (`EVT-000812`) — back in Alexander's own dimensional inventory. |
| **Heartwood core-mass** | Moved from Nakamura's custody to **Corwin Ashvale's** (`EVT-000812`), $500/day ongoing storage fee. |

**A deliberate, standing discrepancy, not an open thread.** The filing to Renata Okonkwo-Vance under `OBJ-43`'s terms overstated the Argyle haul by 10 crystals (217 filed, 197 physically sold) — Alexander's own choice, banking on Section 12.9's dimensional inventory being unwitnessable by BGM. Recorded on `ENT-000233`'s own record as a secret he is carrying, per the player's explicit instruction that this is settled and not a loose end.

---

## This Checkpoint's Movement (`EVT-000959`-`EVT-000983`) — the Assay's channel

**No gold, cash, System crystal, or System core moved.** No shop transaction occurred; every figure below is either Mana (owned by `100_CHARACTER_SHEET.md`, cited here for completeness) or a physical/documentary item taken by hand, none of it Ranked, none of it convertible through the ordinary System economy.

- **One Greater Mana Potion consumed** (`EVT-000969`), full Mana reset. Stock 42 → 41. Owned by `100_CHARACTER_SHEET.md`.
- **The Assay's local archive — every case file from the stretch of shelving Alexander could reach in the channel, taken whole into the dimensional inventory** (`EVT-000983`), on the same "stored whole, no partial retention" basis already established for Tolo's Ninth Quiet library at `EVT-000783`. Filed as **Special** (Section 12.9 kind 3 — provenance and legibility both unresolved for most of it). Includes Earth's own reopened case file, pulled with the rest. **Entrusted to Tolo (`ENT-000262`) for joint study, `EVT-000989`** — his physical custody now, ownership unchanged, no longer sitting idle in the inventory. No licensed-market or System-shop path exists for any of it — this is evidence and leverage, not loot with a sale price.
- **No weapons, gear, or currency recovered from the seven bodies.** Consistent with the Auditor's own established record ("no equipment ever catalogued") and Section 18.13.1 (a killed champion in Assay service drops no core, no rune, no gear) — champions here carry no equipment line at all; their techniques are the only thing there was ever going to be to take, and that went through Succession instead (`100_CHARACTER_SHEET.md`).

---

## This Checkpoint's Movement (`EVT-000781`-`EVT-000788`) — the far side

**No gold, cash, System crystal, or System core moved.** Everything below is real, physical, dimensional-inventory matter — none of it Ranked, none of it appraisable by Flux Sight (which returned empty on every one of them), none of it convertible through the ordinary shop economy.

- **Seven unranked mana crystals** — cut from the Mill pack (`EVT-000782`), one per body on the same physical basis as an ordinary beast-drop crystal, but carrying no Rank line and no catalogue value. Real weight in the dimensional inventory; no buyer has been tested.
- **One hide sample and one claw**, cut from the same pack — carrying an unidentified seared brand (a "shelf-mark," per what he physically observed; meaning unconfirmed). Evidence, not loot.
- **Twenty-odd phone photographs** — the pack's brands and the Ninth Quiet's library terrace, taken on his own phone, no signal, camera-only. Not a dimensional-inventory item; ordinary phone storage.
- ~~An entire archive — every legible tablet/slate from the Ninth Quiet library~~ **RETURNED IN FULL to Tolo (`ENT-000262`), `EVT-000876`.** Stored whole into the dimensional inventory at `EVT-000783`, held since then, and given back complete the first time its owner was actually met — no partial retention, nothing sold or kept back. No longer a held asset.

**Both far-door costs were Mana, not currency** (`100_CHARACTER_SHEET.md`, 4,000 each way) — this section exists to make explicit that a very large session produced zero movement on `current_funds` above.
...
## This Checkpoint's Movement (`EVT-000688`-`EVT-000697`)

**Gold 732,481 -> 1,530,081. Cash unchanged. Two A-Rank instant dungeons, both self-opened, neither dangerous.**

| Movement | Detail |
|---|---|
| **-250,000 g** | Runic Key [A-Rank], Ivory Daily Premium cycle (`EVT-000690`). Bought at 06:02 and spent at 08:00 on the same morning. |
| **+150,000 g** | Daily Random Box, twenty-ninth daily (`EVT-000693`). 🎲 d100 55 -> System gold; the purse pays the System Rank A core-buy value. |
| **+588,200 g** | 173 Mana Crystal [A-Rank] sold at 3,400 g (`EVT-000695`). |
| **+309,400 g** | 91 Mana Crystal [A-Rank] sold at 3,400 g (`EVT-000697`). |
| **+264 / -264 A-Rank crystals** | 162 mined + 11 dropped in the first instance, 82 mined + 9 dropped in the second; **all 264 sold the same morning**, so the holding closes unchanged at 100. Prospector paid +2 per personally-worked deposit in both. |
| **+7 Beast Core [A-Rank]** | 1 -> 8. Two elites and a boss in the first instance, three elites and a boss in the second. The shop refuses cores; these hold value only through an artificer or the licensed market. **Section 12.10's fusion price is one A-Rank core, so the unfused Warded Vambrace pair is now affordable several times over.** |
| **+1 Greatarm [A-Rank]** | Boss drop, second instance (`EVT-000696`). Banked unequipped - a two-handed chassis costs him Twin Fang, Dagger Mastery's multiplier and the off-hand entirely. |
| **+1 Skill Book - Rupture [A-Rank]** | Boss drop, first instance. `unbound-awakened`. **Intact, unconsumed** - he holds Rupture at [S-Rank], so Section 7.1's known-at-or-above branch applies with no reroll. |
| **+1 Skill Rune - Keen Sense [A-Rank]** | The Runic Key's guaranteed extra rune result. `unbound-awakened`, intact on the same grounds. |
| **+3 Greater Healing Potion** | The twenty-eighth daily's banked box, opened the night before (`EVT-000688`). 10 -> 13. |

**The two unbound instructional items are the quiet result.** Neither teaches him anything - both name techniques he already holds above their Rank - but `unbound-awakened` instruction is the one class of loot he can hand to another awakened, and Owen Callahan now carries a 139-Mana pool nothing in this world has measured.

---

## Prior Checkpoint's Movement (`EVT-000646`-`EVT-000653`)

### 211 A-Rank Mana Crystals, and a Building's Worth of Machinery

**`Mana Crystal [A-Rank] × 211`** — the first A-Rank crystal holding this campaign has ever carried, mined out of the Flooded Mine instance behind the fenced warehouse (`EVT-000651`, `EVT-000652`). The instance seeded `3d6 = 13 × 16 = 208` under Profile §11.1's Rank multiplier; Alexander stripped **203 of 208** across four separately worked seams, leaving five in strata too deep to reach without excavation. **Prospector applies per personally extracted deposit, not per haul** — four deposits worked, **+8** — for a final **211**. Unsold; A-Rank crystal has no established resale figure in this ledger yet and none is invented here.

**Containment plant [unranked, industrial]** — the fenced warehouse's suppression apparatus, taken whole into the dimensional inventory at `EVT-000648` under Profile §12.9's storage clause (inanimate, unheld by any person, uncontested, no distance limit beyond perception, no practical capacity limit; `EVT-000326`'s crates-and-workbench precedent governs the scale). Its trunk lines sheared where they left the machine and remain in the warehouse slab. **Flux Sight reads it as suppression apparatus disguised as building services, not climate control.** It is not gear, carries no Rank line, occupies no equipment slot, and grants nothing — it is **evidence and a component**, and it is the physical proof that the site was a containment operation. Filed under **Special** for `/system gear` grouping purposes (Profile §15.3.2). **Nobody has been shown it.**

**Consumed / spent this span.** The **mana-null disc [E-Rank]** ran its full ~10-minute window against the main shell's side door (`EVT-000646`) and is dry; the record authors no recharge cycle and none is invented, so it is carried as **spent, reusability unestablished**. The **Suppression Emitter [E-Rank]** ran its full 20 minutes continuous (20:44–21:04) and is likewise dry, recharging at its authored 1 minute per 5 idle. Both are retained, undamaged.

**Nothing sold, nothing bought.** Gold unchanged at **330,881**; cash unchanged at **$329,287.22**.

---

## Prior Checkpoint's Movement (`EVT-000588`-`EVT-000589`)
...
### Tolo's Library — a Little Over 100 Earth Books (2026-09-08)

Ordered the prior evening (Amazon, $1,847.63, Alexander's own card), delivered to the Rogers Park apartment, moved into dimensional inventory the same morning. Held for delivery whenever the far door next opens — Tolo (`ENT-000262`) asked for Earth's own long record: self-correcting systems without central oversight, honest first-draft accounts of getting things wrong in real time, and first-person records of rebuilding after loss, plus a general shelf. No Rank, no gold or cash value — ordinary Earth goods, carries no System price.
...
**Two days in Nakamura's custody produced a first pass, not an answer (2026-08-20 evening through 2026-08-22, `EVT-000637`, recalibrated `EVT-000639`).** She ran an ordinary identification working on it more than once across those two days, the same kind that reads every other boss-drop cleanly. **Partial traction**: material class confirms, the [B-Rank] derivation holds up under an honest attempt rather than resting on default (`EVT-000522`). What won't come is anything past the surface — no function, no provenance, no reason for the fusion. Harder than ordinary, easier than the Dormant Core, which took three hours to open at all. No conclusion stated. Filed under the same `EVT-000502` question, deepened rather than closed.
...
- **+$9,450** — the Ashfield clear settlement, filed true by Priya Menon on 2026-07-30 and posted by BGM Region V this morning. The ≈$9,000 Sable & Kern harvest share is still processing on its first business day.

...
```yaml
current_funds:
  as_of_event: EVT-001012
  as_of_game_date: "2026-09-16T16:00:00-05:00"
  cash_usd: 527358490.22
  gold: 350323281
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**This span (`EVT-000999`-`EVT-001012`).** Ten self-opened S-Rank instant dungeons (`EVT-001001`): -9,000,000 g (keys). 52nd daily's Random Box (`EVT-001004`, 🎲 59): +650,000 g. **Every Mana Crystal in the dimensional inventory sold to the System shop, all Ranks, including the never-before-sold 100-crystal S-Rank floor, player's explicit instruction (`EVT-001005`):** 3,784 S-Rank @ 15,300 g (+57,895,200 g), 110 A-Rank @ 3,400 g (+374,000 g), 50 B-Rank @ 750 g (+37,500 g), 50 D-Rank @ 40 g (+2,000 g), 50 C-Rank @ 170 g (+8,500 g) — total +58,317,200 g. Gold 292,006,081 -> **350,323,281.** **The Brno S-Rank auction filing cleared** through Renata Okonkwo-Vance's office, backed by Director Beran's CGA clearance certificate — the last pending payout on the books. Cash $402,358,490.22 -> **$527,358,490.22.** Pending payouts: **1 -> 0**, nothing outstanding.

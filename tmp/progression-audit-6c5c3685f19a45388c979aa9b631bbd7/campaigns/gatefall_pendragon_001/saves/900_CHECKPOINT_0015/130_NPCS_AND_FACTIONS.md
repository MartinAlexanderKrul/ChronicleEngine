...
relationships:
  - REL-000066
canonical_state:
  location: "a diner two blocks from his apartment, Rogers Park, Chicago (ENT-000087)"
  condition: "Healthy, and comprehensively wrecked in the ordinary way — dragged out at dawn for Alexander's training regimen on the morning of 2026-07-30 (`EVT-000084`), he ran 2.4 km, quit, and then completed a scaled 30 push-ups, 30 sit-ups and 30 squats across five rounds rather than take the offered exit. **The first time in his life he has pushed his own body for anything.** His one spent per-clear touch — used to clear Alexander's Severe rib injury mid-boss-fight (`EVT-000080`) — belonged to that clear and does not carry forward. Eating breakfast opposite Alexander, sweat-damp, hair ruined, entirely pleased with himself."

...
```yaml
current_funds:
  as_of_event: EVT-000698
  as_of_game_date: "2026-08-24T10:16:00-05:00"
  cash_usd: 329287.22
  gold: 1530081
  pending_payouts_usd: 0.00
  pending_payout_count: 0
  note: "**2026-08-24 06:00-10:16 (`EVT-000689`-`EVT-000697`): gold 732,481 -> 1,530,081, the first seven-figure balance this campaign has held. Cash unchanged at $329,287.22.** Out: **-250,000 g** on the Runic Key [A-Rank] from the Ivory Daily Premium cycle (`EVT-000690`), spent the same morning. In: **+150,000 g** from the twenty-ninth daily's Random Box (`EVT-000693`, 🎲 d100 55 -> the 36-60 System gold band, paid at the System Rank A core-buy value of 150,000 g); **+588,200 g** for 173 Mana Crystal [A-Rank] at 3,400 g (`EVT-000695`); **+309,400 g** for a further 91 at the same rate (`EVT-000697`). **Net +797,600 g on the morning**, against two spent A-Rank instant-dungeon keys - one bought at 250,000 g, one free off the first instance's shrine. **Non-monetary movements are recorded on the character sheet rather than here**: 264 A-Rank crystals in and the same 264 out (the holding closes unchanged at 100), seven A-Rank Beast Cores in (1 -> 8, and the shop refuses cores), a **Greatarm [A-Rank]** boss drop banked unequipped, a **Skill Book - Rupture [A-Rank]** and a **Skill Rune - Keen Sense [A-Rank]** both `unbound-awakened` and both intact-unconsumed under Section 7.1's known-at-or-above branch, and three Greater Healing Potions from the earlier box (`EVT-000688`). USD and gold do not exchange (Profile Section 12.5); no pending payouts outstanding. Prior: **2026-08-23 09:52-23:30 (`EVT-000680`-`EVT-000687`): no money moved in either direction.** Gold held at 732,481, cash $329,287.22. Two items given away free - Skill Rune Mend [D-Rank] and one Elixir of a Stat, both to Owen Callahan - neither a sale. Full prior movement history: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures."
```

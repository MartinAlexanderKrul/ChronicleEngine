...
**Checkpoints:** 132 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0132`)
...
| frozen | 0009–0132 | 124 |

**Latest capture:** `900_CHECKPOINT_0132` — kind `player-requested`, profile 1.110 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0131`, source `EVT-000826`.

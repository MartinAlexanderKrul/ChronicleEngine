...
canonical_state:
  ...
  system_state:
    ...
    temporal_state:
      campaign_time: "2026-08-22T16:00:00-05:00"
    ...
    unspent_points: 5                      # rendering of `ability_points_earned - sum(allocated)` = 328 - 323 (Profile 1.82)
    pending_rewards:
      ability_points: 4
    ...
    stats:
      ...
      intelligence: 551
    effective_stats:
      strength: "518 (base 504 + equipment 14)"
      agility: "524 (base 480 + equipment 44)"
      vitality: "563 (base 562 + equipment 1)"
      perception: "486 (base 481 + equipment 5)"
      intelligence: "558 (base 551 + equipment 7)"
    ...
    tracked_counters:
      ...
      - { path: progression.ability_points_earned, baseline_value: 323, baseline_as_of: EVT-000597, current_value: 328 }
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 88 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 60 }
      ...
      - { path: skills.dagger_mastery.successful_uses, baseline_value: 2, baseline_as_of: EVT-000130, current_value: 300 }
      ...
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 81 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 43 }
      ...
      - { path: skills.resonance_extraction.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 40 }
      ...
      - { path: skills.mend.successful_uses, baseline_value: 0, baseline_as_of: EVT-000148, current_value: 0 }
    ...
    inventory:
      ...
      materials:
        ...
        - "**Mana Crystal [D-Rank] × 50** — **+186 from five D-Rank instances** (`EVT-000616`: 63 drops, 123 mined with Resonance Extraction's `Yield` +20%); **136 sold** for 5,440 g (`EVT-000618`), back to 50. Matches the 50 held at [B-Rank] and [C-Rank]."
    ...
    daily_premium:
      ...
      offers:
        ...
        rune: "Premium Rune — teaches **Mana Bolt** · [A-Rank] · UNBOUND · NPC-ELIGIBLE · 500,000 g · unpurchased — **not inert**: he holds Mana Bolt at [B-Rank] Adept, and this offers ascension to [A-Rank], genuinely above current Rank"

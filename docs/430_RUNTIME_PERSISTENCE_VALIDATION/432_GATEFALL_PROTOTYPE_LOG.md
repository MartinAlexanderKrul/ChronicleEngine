...
**Checkpoints:** 142 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0142`)
...
| frozen | 0009–0142 | 134 |

**Latest capture:** `900_CHECKPOINT_0142` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0141`, source `EVT-000911`.

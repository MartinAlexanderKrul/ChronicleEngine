...
**Checkpoints:** 77 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0077`)
...
**Latest capture:** `900_CHECKPOINT_0077` — kind `manual`, profile 1.63 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0076`, source `EVT-000449`.

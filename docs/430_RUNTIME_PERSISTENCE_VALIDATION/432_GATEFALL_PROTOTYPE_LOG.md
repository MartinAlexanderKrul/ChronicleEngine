...
**Checkpoints:** 92 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0092`)
...
**Latest capture:** `900_CHECKPOINT_0092` — kind `manual`, profile 1.73 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0091`, source `EVT-000530`.

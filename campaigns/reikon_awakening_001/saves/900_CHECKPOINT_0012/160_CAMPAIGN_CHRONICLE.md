...
Daedalus stands in his own rented room in Verholt's working quarter at dawn, Level 2, 31/130 XP, at full 105/105 Health and 14/14 Mana after a night's proper rest. The Warehouse 7 basement clear is logged with the Hunters' Authority, and the same-day obligation to Dr. Kalens is met and honoured: the Institute — Kalens, Soren, and Marta — now holds the complete chamber data and one D-core, and is actively investigating a safe severance method for the bonded core, which remains unextracted where he left it. No Institute findings have come back yet.

A fresh System intervention, Emberbrand, is active: one use, forcing a critical-success damage band on his next successful Fireball or Combustion Touch, expiring at the next sunrise if unused. The System gave no reason for it.

...
| `campaigns/gatefall_pendragon_001/` | `worlds/gatefall/` | Alexander Pendragon | In progress | `900_CHECKPOINT_0003` | 2026-07-25 |
...
- **`campaigns/gatefall_pendragon_001/`** — Gatefall's first campaign. Session 1 is in progress; **latest restorable checkpoint `900_CHECKPOINT_0003`** (captured 2026-07-25, after the Red Line Corridor Gate exit, loot split, the System's first daily quest, and a same-day correction to the E-card contract-tier cap). Protagonist Alexander Pendragon cleared his first Gate — true grade E, one below the unconfirmed D assessment — with no crew casualties, and the System attached to him mid-fight per the onset ruling (World Rule Profile Section 14.7): he is now a Bearer, Level 2, XP 50/200, 6 unspent stat points, daily-quest streak 1/7, unknown to his crew. The Red Line contract is closed and split (his ≈$2,313 share pending 1-2 business days); he's weighing a rail-yard D-grade harvest slot (filed for 2026-07-26 07:00) against E-D crew work, and — per the corrected rule (`EVT-000062`, world-rule commit `d53114b`) — harvest/support work at C-grade or higher is legally open to him regardless of his E-card, which only caps strike/combat contracts. The checkpoint was captured under **Gatefall World Rule Profile 1.0, a workshop draft (unfrozen)** — restoring it surfaces the *unfrozen — not save-trustworthy* warning (Rules Section 14.6, Decision 074). The campaign has **no baseline checkpoint**, so `/restart` is unavailable; `/continue` restores `900_CHECKPOINT_0003`.

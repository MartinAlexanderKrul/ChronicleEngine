...
**Checkpoints:** 79 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0079`)
...
**Latest capture:** `900_CHECKPOINT_0079` — kind `manual`, profile 1.66 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0078`, source `EVT-000477`.

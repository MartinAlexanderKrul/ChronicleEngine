...
**Checkpoints:** 158 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0158`)
...
| frozen | 0009–0158 | 150 |

**Latest capture:** `900_CHECKPOINT_0158` — kind `session`, profile 1.117 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0157`, source `EVT-001055`.

...
**Checkpoints:** 104 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0104`)
...
**Latest capture:** `900_CHECKPOINT_0104` — kind `migration`, profile 1.82 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0103`, source `EVT-000600`.

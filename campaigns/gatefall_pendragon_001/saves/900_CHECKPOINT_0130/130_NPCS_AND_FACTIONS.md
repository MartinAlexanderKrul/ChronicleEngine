...
moved_by_events: >
  `EVT-000603` `EVT-000634` `EVT-000640` `EVT-000641` `EVT-000713` `EVT-000754` `EVT-000756` `EVT-000768`
type: Character
subtype: artificer
scope: local
lifecycle: active
...
provenance:
  ...
  real_date: "2026-08-25"
moved_by_events: >
  `EVT-000786` `EVT-000787` `EVT-000796` `EVT-000801`
type: Character
...
canonical_state:
  ...
  secret: "She's read his Region V file closer than Farraday's summary would suggest, and already knows more about the shape of his last week than she said on the first call. **Did not know about the teleportation** — genuinely surprised at dinner, by her own admission; her deeper reading never reached it, consistent with the Bearer-Only Register (Profile §14.4.1) having no channel for anyone but him."
...
state: "**Standing agreement signed, 2026-08-27 19:00-onward** (`EVT-000801`), The Averlon Room. National incident-response, $500,000 flat + uncapped bonus, direct line, solo loot his outright against a same-day filing. She is brokering national artificer/collector introductions this week and a fly-list itinerary by morning (`OBJ-44`). Still forwarding Alexander's contact to the US S-Rank roster, in progress. He is going to the North Side Gate tonight, alone, under the agreement's own terms."
...
canonical_state:
  ...
  rank: "**Unconfirmed.** Remote mana-flux reading estimated roughly B-Rank before the survey drone's signal was lost. True Rank unresolved under Profile Section 9.5 — first entry (or an unentered break) rolls it."
  break_timer: "**Detected 2026-08-24** (per Renata's own check at dinner). B-Rank's Section 9.3 timer is 4 days from detection; roughly 1 day remained as of `EVT-000801` (2026-08-27, 19:00), assuming the unconfirmed read holds — a higher true Rank would mean less time, not more."
  assignment: "**Unassigned.** No BGM crew, no posting — an unclassified Gate with a lost drone reading is not a job anyone has taken. Alexander is responding under the newly-signed National standing agreement (`OBJ-43`), solo, same night, no backup arranged because none exists."
  note: "Not yet entered as of this checkpoint. True Rank, archetype, and population are unresolved."
```

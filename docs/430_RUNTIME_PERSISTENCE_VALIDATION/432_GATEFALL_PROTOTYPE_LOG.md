...
**Checkpoints:** 157 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0157`)
...
| frozen | 0009–0157 | 149 |

**Latest capture:** `900_CHECKPOINT_0157` — kind `session`, profile 1.117 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0156`, source `EVT-001052`.

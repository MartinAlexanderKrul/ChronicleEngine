...
**Checkpoints:** 136 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0136`)
...
| frozen | 0009–0136 | 128 |

**Latest capture:** `900_CHECKPOINT_0136` — kind `session-save`, profile 1.110 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0135`, source `EVT-000868`.

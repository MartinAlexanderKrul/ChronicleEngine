...
canonical_state:
  age: 25
  location: ENT-000087
  condition: "Health and Mana full (40/40, 20/20) — restored via a claimed daily-quest grant after taking a near-lethal hit (0/40) fighting a C-grade common beast above his band; no lasting injury, the restore was total. The System has attached (see `system_state`); he is no longer an ordinary licensed hunter, though nothing about him looks different to anyone who can't see what he can."
  ...
  system_state:
    ...
    mana: "20/20"
    unspent_points: 3
    pending_grants: "TWO grants banked, both (+3 stat points, full Health/Mana restore), claimable individually or together at will: (1) the leftover daily-quest grant from 2026-07-28's fourth quest (never answered when the accept/defer prompt was shown before staging, so it sits pending exactly as a deferred one would — EVT-000070); (2) the fresh level-up grant (Level 2→3) from the C-grade beast kill (EVT-000070). The third daily-quest grant (from 2026-07-27) and the original level-2 grant have already been claimed; unspent_points above already reflects the one grant claimed mid-fight to survive a lethal hit."
    stats:
      strength: 16
      agility: 12
      vitality: 10

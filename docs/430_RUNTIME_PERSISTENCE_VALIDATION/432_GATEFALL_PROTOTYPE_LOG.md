...
**Checkpoints:** 61 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0061`)
...
**Latest capture:** `900_CHECKPOINT_0061` — kind `manual`, profile 1.46 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0060`, source `EVT-000336`.

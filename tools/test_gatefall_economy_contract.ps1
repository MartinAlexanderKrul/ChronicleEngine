...
Assert-Contains $profile 'World Rule Profile 1\.49' 'Gatefall profile is not version 1.49.'
...
Assert-Contains $readme 'World Rule Profile 1\.49' 'Gatefall README does not advertise Profile 1.49.'
...
Assert-Contains $character 'profile_version: "1\.49"' 'Live Gatefall character has not adopted Profile 1.49.'

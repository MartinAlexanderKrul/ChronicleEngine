...
**Checkpoints:** 178 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0178`)
...
| frozen | 0009–0178 | 170 |

**Latest capture:** `900_CHECKPOINT_0178` — kind `manual`, profile 1.124 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0177`, source `EVT-001218`.

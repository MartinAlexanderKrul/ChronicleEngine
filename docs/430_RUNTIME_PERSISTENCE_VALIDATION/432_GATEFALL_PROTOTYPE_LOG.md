...
**Checkpoints:** 153 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0153`)
...
| frozen | 0009–0153 | 145 |

**Latest capture:** `900_CHECKPOINT_0153` — kind `session`, profile 1.116 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0152`, source `EVT-001012`.

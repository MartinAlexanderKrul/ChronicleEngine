...
**Checkpoints:** 69 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0069`)
...
**Latest capture:** `900_CHECKPOINT_0069` — kind `manual`, profile 1.51 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0068`, source `EVT-000390`.

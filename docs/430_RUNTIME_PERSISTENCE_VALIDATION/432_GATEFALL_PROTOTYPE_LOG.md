...
**Checkpoints:** 161 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0161`)
...
| frozen | 0009–0161 | 153 |

**Latest capture:** `900_CHECKPOINT_0161` — kind `session`, profile 1.117 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0160`, source `EVT-001077`.

...
## Cast in Play — `campaigns/prototype_beta/`

**File:** `campaigns/prototype_beta/135_CAST_IN_PLAY.md`
**Status:** Active
...
|---|---|---|---|---|---|
| `ENT-000023` | Tollen Var | Character | active | Halden | — |
| `ENT-000024` | Sister Avel | Character | active | Halden | `REL-000025` |
| `ENT-000025` | Brant | Character | active | Halden | `REL-000026` |
| `ENT-000026` | Edrin Vale | Character | active | Halden | — |
| `ENT-000027` | Lysa Vale | Character | active | Halden | — |
| `ENT-000028` | Unidentified wrong-stair man | Character | active | Halden | — |
| `ENT-000029` | Caldus | Character | active | Halden | — |

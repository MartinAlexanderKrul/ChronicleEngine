...
**Checkpoints:** 115 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0115`)
...
| frozen | 0009–0115 | 107 |

**Latest capture:** `900_CHECKPOINT_0115` — kind `session-save`, profile 1.87 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0114`, source `EVT-000658`.

...
### ENT-000147 — The Pawnbroker

Owner of an unnamed pawn-adjacent shop in Chicago's warehouse district, dealing in mundane salvage, licensed small goods, and — quietly — items with murkier provenance. Not yet given a proper name in play.
...
state: "First transaction completed 2026-08-04: one E-Rank core sold for $220 cash, below the $375 licensed anchor, reflecting the pawnbroker's own risk/movement discount on a first-time, no-track-record sale. He indicated the rate improves with demonstrated trust and repeat business. Also showed Alexander **Cicero's Quiet [C-Rank]** (a named artifact, confirmed genuine), quoted at $35,000; not purchased."
history: "Formed 2026-08-04 when Alexander, window-shopping ahead of a 14:00 harvest job, entered the shop, asked about the locked case, and later tested the pawnbroker's willingness to buy unprovenanced goods."
```
...
state: "One completed C-Rank job (2026-08-04): twenty C-Rank crystals declared from Alexander's own marked section, standard 80/20 split, ≈$40,000 net pending Coalition processing. No standing arrangement for future postings; Denise indicated no strong opinion either way."

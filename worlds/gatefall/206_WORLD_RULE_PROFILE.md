# Gatefall — World Rule Profile 1.94
...
| **III** | **2026 — present** | **1d4+3** | **1d2** | **50%** | **25%** | **15%** | **7%** | **2.5%** | **0.5%** | **93–00** |
| **IV** | the ramp bites | 1d4+4 | 1d2+1 | 42% | 24% | 18% | 10% | 5% | 1% | 90–00 |
| **V** | the shoulder | 1d4+5 | 1d2+2 | 33% | 22% | 20% | 14% | 9% | 2% | 86–00 |

**Tier III is exactly what this profile has always said**, so nothing about the present moment moves on adoption. Tiers I and II are the retroactive explanation of the Bible's own timeline; tiers IV and V are where the curve goes.

**What actually doubles is the top, not the total.** Chicago's daily count rises only 5.5 → 7.5 across three tiers (about 36%), while **A-Rank density goes 0.14 → 0.33 → 0.68 per day and S-Rank goes 0.028 → 0.065 → 0.15** — roughly ×2.4 and ×2.3 a tier. E-Rank density is almost flat (2.75 → 2.5 per day). This is what *"Ranks climb"* means and why the trade notices it as a change in the **character** of the work long before it notices a change in the volume: the bottom of the ladder is the same job it always was, and the top of it is arriving twice as often every rung.

**The Section 9.1 header rates are tier III figures.** Chicago ≈35 and Prague ≈8 Gates a week are the present tier's aggregates; they move with the tier and are not independent constants.
...
| Tier reached | No later than | From adoption |
|---|---|---|
| **IV** | **2026-09-07** | 14 in-fiction days |
| **V** | **2026-09-14** | 7 more |
| *(the ramp's end)* | **2026-09-18** | 4 more |

**The cadence is set against how fast this world is actually played, and that is a deliberate correction (1.94).** Version 1.93 first authored this schedule at six months, three months and six weeks — intervals borrowed from the Bible's decade-scale 2016–2026 timeline. Measured against the campaign that exists, that was a ramp that could never fire: **`gatefall_pendragon_001` covered 33 in-fiction days, level 1 to 48, an unawakened E-Rank card to a carded S-Rank, and the whole System Rank ladder** — so a first rung 184 days out sat more than five times the campaign's entire length past the end of it. A countdown that expires after the story does is a table, not a clock.

**The Bible's curve is geometric, not calendar-bound**, and the interval that matters is the one the protagonist experiences. A world that produces a champion in a month is a world the Assay is escalating against in weeks, not seasons — the ramp keeps pace with the candidate's clock because that is the clock the process is racing.

**Pressure pulls it forward and never pushes it back.** `escalation_credit` accrues on the world's own losses, and at **20 the next tier arrives immediately**, resetting the credit to 0. The schedule above still applies independently — whichever comes first:
...
**What this is worth in practice.** At tier III, Chicago's own take rates leave roughly **1.1 breaks a day** across the metro — overwhelmingly E and D, exactly as Section 9.4 says cheap jobs sit. That is about **+1.2 credit a day**, so a city under ordinary pressure reaches 20 in about **17 days** while the clock floor stands at 14. **The two routes are now the same order of magnitude**, which is the whole point: the schedule usually leads, a bad stretch pulls it in, and neither is decorative. A metro that suddenly starts holding its board will fall back to the clock; one that loses a district will beat it comfortably.
...
**The roll.** For each Gate the Section 9.1 step 2 siting places **on his route** (`01-10`), roll **d100** against the share above. Auditions are drawn only from that band — never from `within reach`, never from `elsewhere`, and never from a Section 9.11 directed assignment, which is a real operation with a real command structure and real witnesses.

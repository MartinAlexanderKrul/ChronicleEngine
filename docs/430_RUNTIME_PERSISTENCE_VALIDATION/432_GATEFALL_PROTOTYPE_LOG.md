...
**Checkpoints:** 87 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0087`)
...
**Latest capture:** `900_CHECKPOINT_0087` — kind `manual`, profile 1.71 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0086`, source `EVT-000510`.

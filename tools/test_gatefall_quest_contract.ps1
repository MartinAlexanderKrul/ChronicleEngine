...
$latestCheckpointPath = Join-Path $repo "campaigns/gatefall_pendragon_001/saves/900_CHECKPOINT_0025/100_CHARACTER_SHEET.md"
...
Assert-True ($startup -match 'latest_restorable_checkpoint: campaigns/gatefall_pendragon_001/saves/900_CHECKPOINT_0025') "Campaign startup does not target the latest checkpoint."
Assert-True ($startup -match 'Sections 8\.4 and 14\.3 before readiness completes') "Gatefall startup does not preload the proactive quest contract."

...
**Checkpoints:** 118 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0118`)
...
| frozen | 0009–0118 | 110 |

**Latest capture:** `900_CHECKPOINT_0118` — kind `session-save`, profile 1.91 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0117`, source `EVT-000679`.

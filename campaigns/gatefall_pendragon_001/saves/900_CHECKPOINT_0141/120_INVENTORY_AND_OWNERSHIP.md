...
```yaml
current_funds:
  as_of_event: EVT-000908
  as_of_game_date: "2026-09-10T14:00:00-05:00"
  cash_usd: 113115490.22
  gold: 255018381
  pending_payouts_usd: 259800000.00
  pending_payout_count: 2
  note: "**2026-09-10: the Jiu Valley kill and the Blue Island S-Rank Gate.** Jiu Valley (`EVT-000905`): a unique unpopulated kill outside any Gate, no loot banked — no market recovery attempted from the restricted international zone, an open world fact rather than a resolved haul. Blue Island (`EVT-000906`): the accepted S-Rank Gate (assessed A, populated S, OFFERED via BGM National), cleared dagger-and-Far-Side-skills-only with Elias Kane concealed alongside — the boss restrained rather than killed and finished by Kane's own hand, its core kept by Kane under agreement rather than banked. **301 S-Rank crystals + 1 S-Rank core filed to auction** (no posted S-Rank price, Section 12.1) rather than sold — flat fee + severity settled same-day, **+$5,500,000 cash.** Cash $107,615,490.22 -> **$113,115,490.22.** Gold unchanged at **255,018,381** — no shop transaction this span. Pending payouts: the standing Red Gate auction (≈$138,400,000, uncleared) joined by Blue Island's own filing (301 crystals @~$400,000 + 1 core @~$1,000,000 est. = ≈$121,400,000) — **1 -> 2, ≈$259,800,000 estimated combined, neither cleared.** Non-monetary: **Beast Core [S-Rank] 147 -> 148** (+1, the elite kill at Blue Island; the boss's own core went to Kane, never banked). No potions, gear, or materials moved otherwise this span. Prior note, superseded (`EVT-000891`): two solo A-Rank Gate clears, five S-Rank instant dungeons, a crystal sell-down, and the Denver facility purchase.** Ashworth's confirmed A-Rank (`EVT-000895`): 175 A-Rank crystals + 4 A-Rank cores sold licensed ($8,750,000+$500,000) + $500,000 flat + $2,500,000 severity = +$12,250,000. The offered/unconfirmed op (`EVT-000896`) revealed a **Red Gate** on entry (Section 11.4 loot Rank-bump to S): +$500,000 flat + $3,500,000 severity = +$4,000,000 cash; its 336 S-Rank crystals + 4 S-Rank cores filed to auction instead (S-Rank has no posted licensed price, Section 12.1) — **≈$138,400,000 estimated, pending, not yet cleared, one payout.** Five S-Rank instant-dungeon keys bought (`EVT-000897`, -4,500,000g) and spent opening five solo S-Rank dungeons (`EVT-000898`): +1,641 S-Rank crystals (73 beast-drop, 1,568 mined), +15 S-Rank cores, +3 Greater Mana Potions, a duplicate Mend book, three duplicate Keen Sense runes, an S-Rank Watcher Gauntlets. **S-Rank crystal stockpile sold down to the standing 100-crystal floor** (`EVT-000899`): the Red Gate's 336 went to auction, not this stockpile. Sellable stock: 1,178 (pre-session) + 1,641 (the five dungeons) = 2,819, kept 100, **2,719 sold at 15,300g/each = +41,600,700g.** A late-caught arithmetic slip (73 beast-drop crystals first miscounted as 72, yielding 2,818/2,718/$41,585,400) was corrected here before promotion. **Denver facility purchase** (`EVT-000900`): a decommissioned BGM-surplus containment facility bought outright, $2,800,000, plus a $9,200,000 retrofit to the no-access/fail-closed spec (6-8 weeks), existing on-site monitoring retained pending an air-gap check — **-$12,000,000 total.** New Place entity minted: `ENT-000264`. `OBJ-51` (interim lease) closes, superseded by the purchase. Cash $103,365,490.22 -> $115,615,490.22 -> $119,615,490.22 -> **$107,615,490.22.** Gold 217,267,681 +650,000 (45th daily) -4,500,000 (five keys) +41,600,700 (sell-down) = **255,018,381.** Pending payouts: 0 -> **1, ≈$138,400,000 estimated.** Non-monetary: Beast Core [S-Rank] 128 -> **147**; Mana Crystal [S-Rank] closes at the standing **100** floor; Greater Mana Potion 41 -> **44**. Prior note, superseded (`EVT-000891`): the Gate-7 A-Rank directed-assignment clear (Farraday's channel, solo), all payouts settled instantly.** Cash $89,340,490.22 +10,525,000.00 (208 A-Rank crystals @$50,000 + 1 A-Rank core @$125,000, licensed market sale, filed to Renata Okonkwo-Vance) +500,000.00 (Gate-7 flat national-asset fee) +2,500,000.00 (Gate-7 severity bonus — clean confirmed operation, no complications, same formula reading as 2026-09-06) +500,000.00 (the Indianapolis flat fee, carried pending since 2026-09-07, closes the same instant) = **$103,365,490.22**. Gold unchanged. Pending payouts: **zero — nothing carried forward.** Non-monetary: **+2 Greater Healing Potions, +1 Greater Mana Potion** (boss drop, d100 78, potion cache, greater tier off the A-Rank Gate). **Correction made post-checkpoint, caught rendering `/system all`:** checkpoint 0138's own save credited crystals and the named boss-table drops for both ten-dungeon batches but never settled the separate per-creature core drop (Section 11.1: every elite and boss drops one core). **+53 S-Rank Beast Core** (33 elites + 20 bosses across `EVT-000880`/`EVT-000882`) — 75 -> **128**. Also reconciled while re-deriving the delta chain: **Greater Healing Potion 19 (last stated total) +2 (`EVT-000866`, mislabeled 'S-Rank' in that note, same item) +5 (this session) = 26**; **Greater Mana Potion 20 (last stated total) +3 (`EVT-000835`) +3 (`EVT-000855`) +1 (`EVT-000866`) +13 (this session) = 40**. Neither correction touches gold, cash, or crystals, which were already correctly settled. With this checkpoint's own +2/+1 above (`EVT-000891`), **Greater Healing Potion now stands at 28** and **Greater Mana Potion at 41**; **Beast Core [S-Rank]** is untouched by the Gate-7 clear and remains **128**. **This span (`EVT-000870`-`EVT-000884`): the far-side excursion, the Standing gathering, and two ten-dungeon S-Rank training batches.** Cash unchanged. Gold 116,636,881 -9,000,000 (`EVT-000880`, 10 S-Rank keys) +61,200,000 (`EVT-000881`, 4,000 S-Rank crystals sold @15,300g, ruled Profile 1.99 rate) -7,200,000 (`EVT-000882`, 8 more S-Rank keys, plus 2 looted keys reused) +55,630,800 (`EVT-000883`, 3,636 S-Rank crystals sold @15,300g) = **217,267,681**. Pending payouts unchanged. Non-monetary: **+4,052 S-Rank Mana Crystal mined then -4,000 sold (batch 1)**, **+3,636 S-Rank Mana Crystal mined then all sold (batch 2)** — net **+52 banked**. Boss drops across 20 bosses: **2 Elixirs of a stat** (unclaimed, banked, now 5 held total with the prior 3), **6 Greater Potion caches** (net +5 Greater Healing, +13 Greater Mana), **2 S-Rank Instant-Dungeon Keys** (both immediately reused opening batch 2, net 0 banked), **5 duplicate runes** (Silent Step, Flash Step, Mana Bolt, Stone Skin x2 — all already held at S-Rank, banked intact, nothing consumed), **5 equipment pieces**: Gale Torso [S], Quickknife [S] Boss-Imprinted, Greatarm [S] Boss-Imprinted, Hunter's Band [S] Boss-Imprinted (a second one), and one d20-20 free-chassis pick **left player-unresolved, banked as a placeholder pending choice**. The Ninth Quiet library, held in dimensional inventory since `EVT-000783`, **returned in full to Tolo** (`ENT-000262`) this span — removed from inventory, no partial retention, nothing sold or kept back. Prior note, superseded (`EVT-000859`-`EVT-000868`): Indianapolis break-containment and its aftermath. Cash $81,315,490.22 +1,525,000.00 (28 A-Rank crystals + 1 A-Rank core, licensed market sale, `EVT-000863`) +2,500,000.00 (severity bonus, the 2026-09-06 A-Rank clear, filed and settled `EVT-000863`) +4,000,000.00 (severity bonus, today's Indianapolis containment, `EVT-000863`) = **$89,340,490.22**. Gold 115,986,881 +650,000 (Daily Random Box, System gold purse, `EVT-000866`) = **116,636,881**. Pending payouts: both prior severity bonuses cleared this span; **one new pending payout opened** — the $500,000 flat fee for the Indianapolis response, filed same-day, processing tonight per Renata Okonkwo-Vance. Non-monetary: **+2 S-Rank Healing Potions, +1 S-Rank Mana Potion** (Daily Random Box potion cache, `EVT-000866`), **+1 banked, unconsumed Stone Skin [S-Rank] rune** (duplicate — already known at that Rank, `EVT-000866`). Full breakdown below. Prior note, superseded (`EVT-000853`-`EVT-000858`): unchanged span, three S-Rank instant dungeons, no crystal sell-down. **+1,178 S-Rank Mana Crystal** (banked, not sold), **S-Rank Beast Core 69 → 75** (+6, 3 elites + 3 bosses), **+3 Greater Mana Potions**, **+1 unbound-awakened giftable Dagger Mastery [S] rune** (boss drop), **+1 Elixir of a stat** (now 3 held). Prior note, superseded: **This span (`EVT-000832`-`EVT-000852`).** Cash: 13,733,790.22 +2,050,000.00 (`EVT-000835`, Farraday's GB-14 determination) +49,200,000.00 (`EVT-000835`, the GB-14 auction share, `OBJ-40` closed) +12,750,000.00 (`EVT-000851`, the A-Rank directed-assignment Gate clear's licensed sale) +3,581,700.00 (`EVT-000850`, Walt Adamik's sale) = **81,315,490.22**. Gold: 64,964,281 +900,000 (`EVT-000836`, Dagger Mastery [S] rune resale) +18,975,400 (`EVT-000835`, 1,238 S-Rank crystals + 10 A-Rank crystals sold) -4,500,000 (`EVT-000837`, first 5 S-Rank keys) +29,942,100 (`EVT-000838`, 1,957 S-Rank crystals sold) -4,500,000 (`EVT-000838`, second 5 S-Rank keys, only 2 spent) +10,205,100 (`EVT-000840`, 667 S-Rank crystals sold) = **115,986,881**. Pending payouts: both prior payouts cleared this span (Farraday's determination, the GB-14 auction share); **one new pending payout opened** — `OBJ-43`'s A-Rank severity bonus, filed 2026-09-06 (`EVT-000851`), amount undetermined, 'before end of day' never landed this session. Non-monetary: full materials reconciliation below. Prior note, superseded: **This span (`EVT-000827`-`EVT-000830`).** Cash: 13,783,790.22 -50,000.00 (`EVT-000829`, Corwin Ashvale's fee for commissioning a re-core attempt on the homebrew Mana-storage cell) = **13,733,790.22**. Gold unchanged at **64,964,281**. Pending payouts unchanged — `OBJ-40`'s auction share and Desmond Farraday's GB-14 determination (due 2026-09-04) both still uncleared. Non-monetary: **S-Rank Beast Core 1 consumed** as re-coring material (`EVT-000829`) — result not yet known, five-day bench working, due 2026-09-08. The second plain Quickknife [S] returned from Corwin's custody, unchanged (`EVT-000829`) — closes `OBJ-47`'s Quickknife deliverable. Prior note, superseded: **This span (`EVT-000815`-`EVT-000826`).** Cash: 11,259,590.22 +1,677,500.00 (`EVT-000817`, Houston Gate loot sold standard — 140 B-Rank crystals, 3 B-Rank cores, 1 B-Rank Reacharm) +850,000.00 (`EVT-000817`, BGM incident invocation under `OBJ-43` — $500,000 flat + $350,000 severity bonus) -3,000.00 (`EVT-000826`, storage-bay furniture — bed, heater, desk) -300.00 (`EVT-000823`, one night at a downtown Chicago hotel) = **13,783,790.22**. Gold unchanged at **64,964,281** — nothing this span touched the System shop. Pending payouts unchanged — `OBJ-40`'s auction share and `OBJ-41`'s remaining item still uncleared. Non-monetary: Beast Core [B-Rank] 14->13 and [A-Rank] 14->13 (Seamwork material spent on the storage-cell working); Arcanist Boots [S] and a second Reacharm [B] added to gear; Greater Healing Potion 16->19 and Greater Mana Potion 14->20 from Daily Random Boxes. Prior note, superseded: **This span (`EVT-000802`-`EVT-000813`).** Cash: 319,090.22 +9,850,000.00 (`EVT-000803`, 197 A-Rank crystals sold licensed USD, Argyle) +1,144,000.00 (`EVT-000810`, 104 B-Rank crystals sold licensed USD, Newark) -40,000.00 (`EVT-000808`, Milwaukee door-test compensation) -2,500.00 (`EVT-000813`, Warlord's Loop fusion fee) -8,000.00 (`EVT-000813`, Arcanist Torso/Gauntlets forge fee) -3,000.00 (`EVT-000813`, dagger fusion fee) = **11,259,590.22**. Gold unchanged at **64,964,281** — neither Gate sale this span touched the System shop; both were licensed USD market transactions, and the failed power-ceiling experiment's cost was cores and the item itself, not gold. Pending payouts unchanged — `OBJ-40`'s auction share and `OBJ-41`'s remaining item still uncleared. **A genuine, deliberate discrepancy carried as fact, not corrected**: Alexander's filing to Renata Okonkwo-Vance overstated the Argyle crystal count by 10 (217 filed vs. 197 true crystals sold, 10 kept unbanked) — recorded on `ENT-000233`'s own record as a standing secret, not an open thread. Prior note, superseded: **This span (`EVT-000789`-`EVT-000801`).** Gold: 60,361,681 -900,000 (`EVT-000791`, S-Rank key) +7,527,600 (`EVT-000792`, 492 S-Rank crystals sold) -1,125,000 (`EVT-000792`, Armory Premium Key) -900,000 (`EVT-000794`, S-Rank key) = **64,964,281**. Cash: 328,490.22 -400.00 (`EVT-000796`, The Averlon Room reservation, minimum spend) -9,000.00 (`EVT-000798`, Rockwell Street bay, first and last month) = **319,090.22**. Pending payouts unchanged — the BGM National standing agreement (`OBJ-43`) prices future incidents, nothing has settled yet. Prior note, superseded: no gold or cash moved `EVT-000781`-`EVT-000788`. The far door's Mana cost is Mana, not currency, and everything recovered from the far side — seven unranked mana crystals, a hide/claw sample, and an entire alien library — carries no Rank and no System price (`worlds/gatefall/206_WORLD_RULE_PROFILE.md` Section 18.13: *'The System pays nothing for any of it... nothing on the far side carries a Rank'*), so none of it converts to gold or cash on pickup the way ordinary Gate loot does. See 'This Checkpoint's Movement' below for the non-monetary detail. Prior note, superseded: **2026-08-27 morning: a second pending payout filed.** Desmond Farraday's written Determination of Compensation for the GB-14 callout (`EVT-000756`) — $2,050,000, payable in 7 business days from 2026-08-26 — joins the existing $49,200,000 auction share, both filed and uncleared. No gold or cash moved this session: no purchase, no sale, no fee. **2026-08-26 evening: cash $329,090.22 -> $328,490.22.** -$600 fee, Priscilla Nakamura's bench, the Seer's Lens fusion (Section 12.10) — her first, resolved success band, a D-Rank Beast Core spent alongside the donor Lens as material. **Her $200/hour rate is specifically for teaching/practical instruction — nothing was taught tonight, only a fusion assisted and a second one commissioned, so the standing hourly line does not apply and the earlier -$200 is reversed.** No fixed session length is owed where nothing billed by the hour occurred; tonight's actual content (banter, one resolved fusion, one commissioning conversation) is what it is, not padded to fill a slot. Earlier, unpromoted span since `EVT-000746`: gold 45,061,681 -> 60,361,681.** Three more self-opened S-Rank instant dungeons on the Crystal Key and both remaining Instant-Dungeon Keys [S-Rank] (all three now spent) — level 96 to 102, a level-100 Title Assessment (Red Survivor, Deep Water), nine mastery-level crossings. **+15,300,000 g**: 1,000 S-Rank crystals sold at the ruled 15,300 g/each (Profile 1.99), sold entirely out of unencumbered stock — the 300 earmarked to the pledged GB-14 auction untouched, 700 unencumbered remain of 1,700. Non-monetary movements this span (character sheet): +916 further S-Rank crystals (20 beast-drop, 896 mined) and +5 S-Rank cores off the two follow-on dungeons, on top of the Crystal Key's own +586/+2; a duplicate Keen Sense book, an off-build S-Rank Greatarm, a duplicate Silent Step rune. Not yet promoted to a checkpoint. Prior: **2026-08-26 06:00-13:30 (`EVT-000736`-`EVT-000746`): gold 46,186,681 -> 45,061,681; cash unchanged at $329,090.22.** Out: **-1,125,000 g** Crystal Key [S-Rank], Daily Premium Crimson series (`EVT-000746`). No crystal sell-down this span. **In, non-monetary and not yet realised: 398 S-Rank crystals and 3 S-Rank cores off the GB-14 clear** (`EVT-000743`) — 14 beast-drop plus a 384-crystal mined deposit. **These do not convert to gold and are not free stock**: 300 crystals and all 3 cores are earmarked against the pledged auction below. **PENDING PAYOUT, $49,200,000 estimated** — Alexander's own 40% share of the S-Rank crystal and core auction, the other 60% ($73.8M est.) pledged on BGM's record to the ten GB-14 families and the two survivors (`EVT-000743`, `OBJ-40`). Estimated at ~$400,000/crystal and ~$1,000,000/core against a $123M total; **auction-only goods with no posted price, so every figure here is an estimate and none of it has cleared.** Prior: **2026-08-25 12:30-23:10 (`EVT-000722`-`EVT-000735`): gold 5,124,181 -> 46,186,681; cash unchanged at $329,090.22.** Out: **-900,000 g** S-Rank key (`EVT-000726`); **-2,700,000 g** three S-Rank keys (`EVT-000727`); **-23,400,000 g** thirteen S-Rank skill runes (`EVT-000729`); **-396,000 g** off-hand/head/legs at S-Rank (`EVT-000730`); **-7,200,000 g** eight S-Rank keys (`EVT-000731`). In: **+6,165,900 g** 403 S-Rank crystals (`EVT-000723`); **+5,140,800 g** 336 S-Rank crystals (`EVT-000727`); **+19,048,500 g** 1,245 S-Rank crystals (`EVT-000728`); **+45,303,300 g** 2,961 S-Rank crystals (`EVT-000732`), each sell-down at the ruled 15,300 g/each, Profile 1.99. **100 S-Rank crystals held back throughout, unchanged.** **Non-monetary movements recorded on the character sheet**: 37 S-Rank cores (3 -> 40), two free S-Rank instant-dungeon keys, seven boss-imprinted gear pieces (two Longswords, a Reacharm, a Channeling Focus, a Hunter's Band, a Heartward Sigil, plus the Predator/Edge Quickknife now equipped), a duplicate Sprint rune and Silent Step skill book, three Greater Healing Potions. Prior: **2026-08-25 10:40-12:30 (`EVT-000713`-`EVT-000721`): gold 1,030,081 -> 5,124,181; cash unchanged at $329,090.22.** Full prior movement history: `160_CAMPAIGN_CHRONICLE.md` and prior checkpoint captures."
```

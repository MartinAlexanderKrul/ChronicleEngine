...
**Checkpoints:** 147 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0147`)
...
| frozen | 0009–0147 | 139 |

**Latest capture:** `900_CHECKPOINT_0147` — kind `session`, profile 1.112 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0146`, source `EVT-000956`.

...
canonical_state:
  ...
  situation: "Led the five-hunter Red Line Corridor clear (true grade E, one below the unconfirmed D assessment) to a full, no-casualty clear on 2026-07-24 (`EVT-000059`). Recruited Alexander to fill an open slot after he committed at the Coalition case table; by the clear's end her assessment of him has shifted from a calculated risk to genuine respect — his read broke the elite's pattern for her opening kill, and again broke the boss's pattern for the finishing blow. Currently in the post-boss two-hour window with the crew, looting and treating wounded before the walk out."
```
...
state: "Active. Contract signed 2026-07-23 and filed with BGM Region V by Kesha Morrison. On 2026-07-24 the crew cleared the Red Line Corridor Gate in full (`EVT-000059`) with no casualties; Alexander's read of the elite and the boss materially opened both kills, and Tanya's regard for him has moved from a calculated risk taken on his commitment to genuine respect earned in the Gate. No loot has yet been split — the crew is in the post-boss window."

...
**Checkpoints:** 68 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0068`)
...
**Latest capture:** `900_CHECKPOINT_0068` — kind `manual`, profile 1.51 (frozen), schema 0.1.6, parent `900_CHECKPOINT_0067`, source `EVT-000388`.

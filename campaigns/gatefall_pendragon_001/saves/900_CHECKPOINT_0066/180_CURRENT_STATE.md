...
- **Latest restorable checkpoint:** `saves/900_CHECKPOINT_0066/` — The instant dungeon Marnie waited on, and the leads that started chasing themselves.
...
- **A fresh Instant-Dungeon Key [C-Rank]** (this session's boss drop), a second **Instant-Dungeon Key [E-Rank]**, and one **Instant-Dungeon Key [D-Rank]** banked, unused. The banked Crystal Key [C-Rank] is spent — it opened this session's clear.

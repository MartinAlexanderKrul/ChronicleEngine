...
**Checkpoints:** 107 (`900_CHECKPOINT_0001`–`900_CHECKPOINT_0107`)
...
**Latest capture:** `900_CHECKPOINT_0107` — kind `session-save`, profile 1.86 (frozen), schema 0.1.7, parent `900_CHECKPOINT_0106`, source `EVT-000613`.

...
scope: campaign
# This save (`EVT-001132`-`EVT-001139`): **Tulsa ($1,650,000) and Karlin ($2,310,000) landed**, cash +$3,960,000, pending payouts 3 -> 1 (only the S-Rank auction lot, ~$109,800,000, Tuesday 2026-09-29 14:00 Eastern); gold unchanged; a Greatarm [S-Rank] (Box #69) and a Hunter's Band [A-Rank] added to stored gear (`EVT-001134`, `EVT-001135`).
...
```yaml
current_funds:
  as_of_event: EVT-001139
  as_of_game_date: "2026-09-28T17:27:00-05:00"
  cash_usd: 701358490.22
  gold: 356898131
  pending_payouts_usd: 109800000.00
  pending_payout_count: 1
  note: "**This span (`EVT-001132`-`EVT-001139`). Cash $697,398,490.22 -> $701,358,490.22 (+$3,960,000: Tulsa $1,650,000, the next business day after its 2026-09-26 filing, and Karlin $2,310,000, by 17:00 Chicago on Monday 2026-09-28; both landed at their estimates). Pending payouts 3 -> 1: the S-Rank auction lot (~$109,800,000) stands, Tuesday 2026-09-29 14:00 Eastern. Gold unchanged. Stored gear +2 (a Greatarm [S-Rank] and a Hunter's Band [A-Rank]).** PRIOR SPAN (`EVT-001121`-`EVT-001128`). Gold 355,598,131 -> 356,898,131 (+1,300,000: Daily Random Boxes #66 and #67, System gold, `EVT-001123`). Cash unchanged; the three pending payouts stand (Tulsa $1,650,000, Karlin ~$2,310,000 Monday 2026-09-28, the S-Rank auction lot ~$109,800,000 Tuesday 2026-09-29 14:00 Eastern). Greater Healing Potion 34 -> 36, Greater Mana Potion 41 -> 42 (Box #68).** PRIOR SPAN (`EVT-001109`-`EVT-001120`): cash and gold unchanged, one Greater Mana Potion consumed (x42 -> x41). PRIOR SPAN (`EVT-001097`-`EVT-001108`). Cash and gold UNCHANGED - nothing had landed. Three payouts owed, all estimates until they clear: **Tulsa $1,650,000** (his, next business day, `EVT-001097`); **Karlin ~$2,310,000** (his, Monday 2026-09-28, `EVT-001106`); **the S-Rank auction lot ~$109,800,000** (267 crystals + 3 cores through Renata, no fixed date, `EVT-001106`). **Calumet's $3,300,000 is the GUILD's, not his**, and is not counted here. Derivations and the full movement table sit below under this checkpoint's movement. PRIOR SPAN (`EVT-001079`-`EVT-001087`). Both pending payouts landed: the combined S-Rank auction lot cleared at 🎲 67 -> ~101.4% of its $75,317,500 estimate -> **+$76,370,000**; the federal lot closed flat at its quoted estimate, **+$130,200,000**. Cash $490,828,490.22 -> **$697,398,490.22.** Pending payouts 2 -> 0. Gold: +650,000 (Daily Random Box #65, System gold, `EVT-001082`) -3,350 (5x D-Rank armor + 1x C-Rank Longsword bought for Prague's crew, `EVT-001084`) — 354,951,481 -> **355,598,131.** Full session detail: `160_CAMPAIGN_CHRONICLE.md`.

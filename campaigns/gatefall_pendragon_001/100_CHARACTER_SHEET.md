...
provenance:
  source: EVT-000664
  game_date: "2026-08-23T04:15:00-05:00"
...
canonical_state:
  ...
  system_state:
    ...
    skills_known:
      ...
      - "Rupture [S-Rank] ★★★★☆ Expert · Mana 11 · **reach 5 m** · a heavy strike at **×2.90 of its skill-rank baseline** (S-Rank baseline 1000, Section 7.2), resolving as `(1000 + effInt + focus power) × 2.90 × result` under §6.2 — **DMG 4,727 standard before reduction** at effective Intelligence 630 (`(1000+630)×2.90=4,727`; re-derived at `EVT-000616`'s level-41 crossing from 4,336 at effective Intelligence 495). **`magnitude_floor` 290 binds** — S-Rank Adept authors ×2.30, and Profile 1.83 clause 1 ratcheted the floor ×2.60 → **×2.90** on the two levels this skill climbed under a swallowing floor (`EVT-000601`). Categories: **Compound** (D); **Structural** (C); **Ward-breaking** (B); **Propagating** (A) — carries to one further target in contact with or behind the first; **`Unmaking`** (S) — **the strike ignores worn physical reduction entirely.** **Successful uses 128 · qualifying scenes total 42 · mastery progress 0/3 toward Master · mastery level EXPERT (4) · rank ascensions 5 · magnitude_floor 260.** **At its §7.5 ceiling (System Rank A + 1); finished until System Rank S.**"
      ...
      - "Mana Bolt [B-Rank] ★★★★★ Master · Mana 6 · **no distance limit; a target DETECTED but not seen is a legal target** · a ranged bolt resolving as `(150 + effInt + focus power) × result_multiplier` under §6.2 — **DMG 1,602 standard before reduction** at effective Intelligence 693 (`(150+693)×1.90=1,602`; re-derived at `EVT-000653`'s level-43 crossing from 1,482 at effective Intelligence 630). **The stored ×1.75/×1.90 discrepancy on this line predates this checkpoint and is unrepaired here — flagged, not resolved** (see `170_CHANGELOG.md`). **`magnitude_floor` 175 binds.** Categories: **Arcing** (D) — the bolt bends around intervening cover; **Unsighted** (B) — a resolved Keen Sense or held read substitutes for eyesight. Never crosses a Gate boundary, a §9.6 seal, or a §17 instance wall. **Successful uses 87 · qualifying scenes total 21 · mastery progress complete Master · mastery level MASTER (5) · rank ascensions 2 · magnitude_floor 160.** **Expert → MASTER at `EVT-000650`**, third qualifying scene: six A-Rank commons in a Flooded Mine ambush, all one-shot on critical or strong results, none landed in return."
      ...
      - "Rift-step [Riftwalker] · Class ability · Mana 6 · **once per exchange** · a true teleport to any point in **line of sight**, and at System Rank B also **through an obstruction he has perceived past**. **Grants +1 modifier step to the immediate follow-up action.** Reach is sight, not distance — no metre figure until A-Rank. **A step to a set anchor does not consume this once-per-exchange step** and is priced separately (`system_state.riftwalker`). **Owner ruling (`EVT-000551`): a passenger may be carried below S-Rank while physical contact is maintained through the step, at 10× ordinary Mana cost** until System Rank S normalizes it. **Successful uses 11** — +3 this span (`EVT-000646`, `EVT-000649`): the anchored step to the fence line, the **passenger step carrying Hollis Rennard clear at 50 Mana** (ten times ordinary cost below System Rank S while contact holds), and the solo step back to the containment floor. Prior: one further anchored step home from a service alley off LaSalle (`EVT-000581`), taken out of the streetlight and out of a camera's cone because a man carded E-Rank does not fold space on a public corner. Prior: **two anchored steps 2026-08-20** (`EVT-000565`, `EVT-000567`), the first use of the anchor network as transport rather than tactics; each required leaving the instance first, since Section 7.3 forbids crossing a Section 17 instance wall."
    ...
    tracked_counters:
      ...
      - { path: progression.ability_points_earned, baseline_value: 323, baseline_as_of: EVT-000597, current_value: 342 }
      ...
      - { path: skills.keen_sense.successful_uses, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 96 }
      - { path: skills.keen_sense.qualifying_scenes_total, baseline_value: 1, baseline_as_of: EVT-000130, current_value: 66 }
      ...
      - { path: skills.exploit_pattern.successful_uses, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 86 }
      - { path: skills.exploit_pattern.qualifying_scenes_total, baseline_value: 0, baseline_as_of: EVT-000132, current_value: 47 }
      ...
      - { path: skills.flux_sight.successful_uses, baseline_value: 0, baseline_as_of: EVT-000130, current_value: 94 }
    ...
    inventory:
      ...
      special:
        - "**Hand-instrument (unresolved)** -- anomaly and Gate-signature reader, taken off the containment-room floor at 04:00 on 2026-08-23 (`EVT-000660`) after its owner (`ENT-000213`) was incapacitated and dropped it. **Its last completed cycle is still on the screen, pinned hard past the top of its own scale** -- the same device that reported *C-Rank, stable, no change* twice a day for eleven weeks, reading a Gate with no lid on it. Special under Section 15.3.2's ordering test: function and provenance unresolved."
      ...
      gear:
        ...
        - "**Mana-null disc** — mundane. Blinds passive mana-signature scanning through a surface it's pressed to, ~10 min; no effect on awakened senses or a System. Walt Adamik, $1,800 (`EVT-000611`). Banked."
        ...
        - "**Seer's Lens [D-Rank]** — accessory · Boss Imprint · Perception +2 (base) · Agility +1 (Predator body-family imprint) · Mobility Echo — +1 modifier step, once/scene, on a movement/pursuit/escape/evasion action · Ashfield boss drop, the D-Rank Ashfield crew clear (`EVT-000606`, 🎲 d100 39 → equipment, d20 18 → accessory). Crystalline finish, cinder-steel/ember-red Ashfield palette. Bought out of the crew's own pool for $3,000 rather than sold to the market. Banked, unequipped."
        ...
        - "**Seer's Lens [D-Rank] (second)** — accessory · Boss Imprint · boss drop, second D-Rank instance (`EVT-000616`). **Identical to the Lens above and at the same ceiling, which is what Section 12.10 fusion requires.** Resale 90 g; unsold."

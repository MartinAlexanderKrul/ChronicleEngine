...
Assert-Contains $profile 'World Rule Profile 1\.39' 'Gatefall profile is not version 1.39.'
...
Assert-Contains (Get-MigrationRecord '1.38' '1.39') '1\.38.+1\.39 compatibility treatment' 'The 1.38 to 1.39 migration record lacks its treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.39' 'Gatefall README does not advertise Profile 1.39.'
...
Assert-Contains $character 'profile_version: "1\.39"' 'Live Gatefall character has not adopted Profile 1.39.'

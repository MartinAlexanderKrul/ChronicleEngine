...
**Version:** 0.1 (World Rule Profile 1.7)
**Engine Compatibility:** Chronicle Engine 0.2.0; Data Model 0.1.3; Gatefall World Rule Profile 1.7
**Created:** 2026-07-22
...
- `206_WORLD_RULE_PROFILE.md` — **World Rule Profile 1.7 (authoritative).** Every mechanic: levels/XP, causal base/effective stats, equipment power and item bonuses, mana, vitality and injury, skills, the daily quest and penalty zones, Gates, loot, economy, parties, the System's behavioral contract, the `/system` command and its panels, titles, instant dungeons, the class quest and hidden classes, exposure and re-ranking, pacing and lethality

...
Assert-Contains $profile 'World Rule Profile 1\.29' 'Gatefall profile is not version 1.29.'
Assert-Contains $profile '1\.28.+1\.29 compatibility treatment' 'Gatefall profile lacks the 1.28 to 1.29 compatibility treatment.'
...
Assert-Contains $readme 'World Rule Profile 1\.29' 'Gatefall README does not advertise Profile 1.29.'
...
Assert-Contains $character 'profile_version: "1\.29"' 'Live Gatefall character has not adopted Profile 1.29.'

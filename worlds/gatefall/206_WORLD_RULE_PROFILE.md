# Gatefall — World Rule Profile 1.107
...
|---|---:|---|---|---:|
| **S-Rank Gate** | 0.55 | nothing carded S is in range inside its two-day timer — eleven S-Ranks over ten regions, two of them in one city, several contract-locked and some on Jiu rotation | **1 in 5** | 0.11 |
| **Red gate** | 2.64 | its true Rank is **A or above**, which no regional bench enters sealed without a national asset | **3%**, Section 9.2.1's A+S tail | 0.08 |
| **Break already loose** | 0.44 | the Gate is **C-Rank or above**, so the release outruns the strike team that reached it | **25%**, Section 9.2.1's C-and-above tail | 0.11 |
| | | | **Total** | **≈ 0.30** |
...
**One d100 on each tick, in step 11.** It is the daily national stream above, at 30 in 100:

```text
     01-70   THE WIDER MAP HOLDS       Ten regions answered their own. Written
                                       as `none`, and `none` is a result.
     71-81   AN S-RANK GATE WITH       Nothing carded S inside its Section 9.3
             NOTHING IN RANGE          two-day timer.
     82-89   A RED GATE AT A OR ABOVE  A sealed instance (Section 9.6) no
...
**The rate is anchored on the United States, which Section 9.1.6 already derived two independent ways**: ≈116 Gates a day across ~340 million people is **0.34 Gates per million people per day**, and the world's ~1.6 million awakened at 1 in 5,000 confirms the same ~8.1 billion denominator.

| Region | Population | Gates/day at tier III | Resident S-Ranks | Days of S-Rank cover | What that means |
|---|---:|---:|---:|---:|---|
| **Asia** | ~4.3B | ~1,460 | ~80 | **11** | The densest Gate region on Earth and the most mature trade; Japan and South Korea export doctrine, China publishes nothing |
| **Africa** | ~1.5B | ~510 | ~15 | **5.9** | **The thinnest cover on this table.** Under-ranked Gates, thin agency reach, and a real toll far above the reported one |
| **Europe** | ~745M | ~253 | ~45 | **35** | European Gate Council, licence reciprocity, the deepest cover per capita; the Czech Republic's ~3.6 a day sits here, Prague's 1.5 inside that |
| **North America** | ~600M | ~204 | ~25 | **24** | The BGM and its counterparts. **The United States' ~116 of this is Section 9.1.6's**; the remainder is Canada, Mexico, Central America and the Caribbean |
| **Middle East** | ~500M | ~170 | ~15 | **18** | Gulf states import S-Ranks like any other luxury, so cover tracks the border rather than the population behind it |
| **South America** | ~440M | ~150 | ~12 | **16** | Uneven: strong states hold their own, weak ones endure |
| **Oceania** | ~45M | ~15 | ~8 | **100** | Australia, New Zealand and the Pacific. **The deepest cover on Earth by an order of magnitude** |
| **World** | ~8.1B | **~2,760** | **~200** | **14** | |

**Both columns close.** The regions' S-Ranks sum to the Bible's **~200 worldwide**, and their Gate counts sum to **~2,760 a day**, which is 8.1 billion at the same 0.34 per million the United States produced. Nothing here is a second rate; it is the one rate applied to the rest of the map.

**Days of S-Rank cover is the number this table exists to produce.** It is `resident S-Ranks ÷ (Gates/day × Section 9.2.1's 0.5% S-Rank share)` — how long one region's S-Rank roster could answer its own S-Rank Gates if each took one. **It is a ratio, not a schedule**, and it is the honest shape of the Bible's own sentence about who dies to Gates: **Africa runs under six days of cover against Oceania's hundred.**

**A consequence the setting already states, and this table makes arithmetic.** At ~2,760 Gates a day the world opens **~13.8 S-Rank Gates every day** against 200 living S-Ranks, so the overwhelming majority are answered the way Section 9.3 already says they are — *"the nearest adequate force plus military containment"*, massed licensed hunters under a cordon, not a famous name. **And in the thin regions many are not answered at all.** That is `200_WORLD_BIBLE.md` Section 5's *"quiet scandal the European Gate Council debates and does nothing about"* stated as a rate.

**It does not demote the Jiu Valley.** The Exclusion is the shared wound of the *profession* because it happened in a well-covered region, to a counted population, with multiple S-Ranks dying in a containment the whole trade watched fail. That losses elsewhere go unnamed is the Bible's point about whose deaths get counted, not a contradiction of it, and a Runtime plays it that way rather than levelling the two.
...
**Then site it — d100, weighted by traffic against cover**, which is the region table's own last column and not a fresh preference:

```text
     01-40   ASIA             1,460 a day against eleven days of cover
     41-66   AFRICA           under six days of cover, the thinnest here
     67-76   SOUTH AMERICA
     77-85   MIDDLE EAST
     86-92   EUROPE
     93-98   NORTH AMERICA    Canada, Mexico, Central America, the Caribbean.
                              The United States is Section 9.1.6's own roll
                              and is never sited here.
     99-00   OCEANIA
```

The bands are the table's `flow ÷ cover` composition **rounded so that every region stays reachable** — an unrounded weighting puts 86% of the world's news in two regions, which is arithmetically defensible and makes five continents scenery.
